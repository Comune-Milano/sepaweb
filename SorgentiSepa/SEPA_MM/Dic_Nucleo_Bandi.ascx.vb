        ...
        If ListBox1.SelectedIndex >= 0 Then
            ...
            Else
                ...
                For I = 0 To CType(Page.Form.FindControl("Dic_Patrimonio1").FindControl("listbox1"), ListBox).Items.Count - 1
                    If Trim(par.Elimina160(CType(Page.Form.FindControl("Dic_Patrimonio1").FindControl("listbox1"), ListBox).Items(I).Value)) = Trim(par.Elimina160(ListBox1.Items(ListBox1.SelectedIndex).Value)) Then
                ...
                For I = 0 To CType(Page.Form.FindControl("Dic_Patrimonio1").FindControl("listbox2"), ListBox).Items.Count - 1
                    If Trim(par.Elimina160(CType(Page.Form.FindControl("Dic_Patrimonio1").FindControl("listbox2"), ListBox).Items(I).Value)) = Trim(par.Elimina160(ListBox1.Items(ListBox1.SelectedIndex).Value)) Then
                ...
                For I = 0 To CType(Page.Form.FindControl("Dic_Reddito1").FindControl("listbox1"), ListBox).Items.Count - 1
                    If Trim(par.Elimina160(CType(Page.Form.FindControl("Dic_Reddito1").FindControl("listbox1"), ListBox).Items(I).Value)) = Trim(par.Elimina160(ListBox1.Items(ListBox1.SelectedIndex).Value)) Then
                ...
                For I = 0 To CType(Page.Form.FindControl("Dic_Integrazione1").FindControl("listbox1"), ListBox).Items.Count - 1
                    If Trim(par.Elimina160(CType(Page.Form.FindControl("Dic_Integrazione1").FindControl("listbox1"), ListBox).Items(I).Value)) = Trim(par.Elimina160(ListBox1.Items(ListBox1.SelectedIndex).Value)) Then
                ...
                For I = 0 To CType(Page.Form.FindControl("Dic_Integrazione1").FindControl("listbox2"), ListBox).Items.Count - 1
                    If Trim(par.Elimina160(CType(Page.Form.FindControl("Dic_Integrazione1").FindControl("listbox2"), ListBox).Items(I).Value)) = Trim(par.Elimina160(ListBox1.Items(ListBox1.SelectedIndex).Value)) Then
