<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoDistinte.aspx.vb" Inherits="RisultatoDistinte" %>
                    ...
                    <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="DATA">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_DIS") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_DIS") %>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
