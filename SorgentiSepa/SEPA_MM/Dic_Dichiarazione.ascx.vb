...
Partial Class Dic_Dichiarazione
            ...
            If txtCF.Text <> "" Then
                If par.ControllaCFNomeCognome(UCase(txtCF.Text), txtCognome.Text, txtNome.Text) = True Then
                    ...
                    If txtbinserito.Text = "0" Then
                        CType(Page.Form.FindControl("Dic_Nucleo1").FindControl("ListBox1"), ListBox).Items(0).Text = par.MiaFormat(UCase(txtCognome.Text), 25) & " " & par.MiaFormat(UCase(txtNome.Text), 25) & " " & par.MiaFormat(txtDataNascita.Text, 10) & " " & par.MiaFormat(UCase(txtCF.Text), 16) & " " & par.MiaFormat("CAPOFAMIGLIA", 25) & " " & par.MiaFormat("0", 6) & " " & par.MiaFormat("-----", 5) & " " & par.MiaFormat("NO", 2)
                    ...
                    If Correlazioni(UCase(txtCF.Text)) = True Then
                        ...
                        CFLABEL.Attributes.Add("OnClick", "javascript:window.open('correlazioni.aspx?" & "CF=" & par.VaroleDaPassare(txtCF.Text) & "&ID=" & txtId.Text & "&NUOVA=" & Label20.Text & "','Correlazioni','top=0,left=0,width=600,height=400');")
                    End If
                    If CLng(txtId.Text) >= 500000 Then
                        If Correlazioni1(UCase(txtCF.Text)) = True Then
                            ...
                            LinkButton1.Attributes.Add("OnClick", "javascript:window.open('correlazioni1.aspx?" & "CF=" & par.VaroleDaPassare(txtCF.Text) & "&ID=" & txtId.Text & "&NUOVA=" & Label20.Text & "','Correlazioni','top=0,left=0,width=600,height=400');")
                        End If
                    End If
                    ...
                    If CLng(txtId.Text) >= 500000 Then
                        If Correlazioni2(UCase(txtCF.Text)) = True Then
                            ...
                            LinkButton2.Attributes.Add("OnClick", "javascript:window.open('correlazioni2.aspx?" & "CF=" & par.VaroleDaPassare(txtCF.Text) & "&ID=" & txtId.Text & "&NUOVA=" & Label20.Text & "','Correlazioni','top=0,left=0,width=600,height=400');")
                        End If
                    End If
                    ...
                    If CorrelazioniVSA(UCase(txtCF.Text)) = True Then
                        ...
                        If CFLABEL.Text = "" Then
                            ...
                            CFLABEL.Attributes.Add("OnClick", "javascript:window.open('correlazioni3.aspx?" & "CF=" & par.VaroleDaPassare(txtCF.Text) & "&ID=" & txtId.Text & "&NUOVA=" & Label20.Text & "','Correlazioni','top=0,left=0,width=600,height=400');")
                        Else
                            If LinkButton1.Visible = False Then
                                LinkButton1.Visible = True
                                LinkButton1.Text = "Trovato in GEST.LOCATARI!"
                                LinkButton1.Attributes.Add("OnClick", "javascript:window.open('correlazioni3.aspx?" & "CF=" & par.VaroleDaPassare(txtCF.Text) & "&ID=" & txtId.Text & "&NUOVA=" & Label20.Text & "','Correlazioni','top=0,left=0,width=600,height=400');")
                            Else
                                If LinkButton2.Visible = False Then
                                    LinkButton2.Visible = True
                                    LinkButton2.Text = "Trovato in GEST.LOCATARI!"
                                    LinkButton2.Attributes.Add("OnClick", "javascript:window.open('correlazioni3.aspx?" & "CF=" & par.VaroleDaPassare(txtCF.Text) & "&ID=" & txtId.Text & "&NUOVA=" & Label20.Text & "','Correlazioni','top=0,left=0,width=600,height=400');")
                                End If
                            End If
                        End If
                    End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtCF.Attributes.Add("OnChange", "javascript:document.getElementById('txtModificato').value='1';document.getElementById('H1').value='0';")
            txtCognome.Attributes.Add("OnChange", "javascript:document.getElementById('txtModificato').value='1';document.getElementById('H1').value='0';AzzeraCF(Dic_Dichiarazione1$txtCF,Dic_Dichiarazione1$txtbinserito);")
            txtNome.Attributes.Add("OnChange", "javascript:document.getElementById('txtModificato').value='1';document.getElementById('H1').value='0';AzzeraCF(Dic_Dichiarazione1$txtCF,Dic_Dichiarazione1$txtbinserito);")
