<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Dic_Dichiarazione.ascx.vb" Inherits="Dic_Dichiarazione" %>
...
<div id="dic" style="border-right: lightsteelblue 1px solid; border-top: lightsteelblue 1px solid;
    ...
    &nbsp;&nbsp;
    <asp:TextBox ID="txtCognome" runat="server" Columns="53" 
        Font-Bold="False" Font-Names="TIMES" Font-Size="8pt" ForeColor="Blue" MaxLength="50" Style="z-index: 100; left: 76px;
    ...
    <p>
        <asp:TextBox ID="txtNome" runat="server" Columns="53" Font-Bold="False"
            Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="50" Style="z-index: 104; left: 390px; position: absolute; top: 74px"
            TabIndex="5" CssClass="CssMaiuscolo"></asp:TextBox>
    </p>
    ...
    <p>
        <asp:Label ID="Label3" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
            ...
            top: 4px" Width="410px">QUADRO A: DATI ANAGRAFICI DEL RICHIEDENTE</asp:Label>
        &nbsp;&nbsp;
    <asp:DropDownList ID="cmbNazioneNas" runat="server" AutoPostBack="True" Style="z-index: 120;
        left: 76px; position: absolute; top: 161px" Width="168px" 
            CssClass="CssComuniNazioni" Font-Names="TIMES" Font-Size="8pt" 
    ...
    <asp:TextBox ID="txtCF" runat="server" AutoPostBack="True" Columns="22"
        Font-Bold="False" Font-Names="TIMES" Font-Size="8pt" ForeColor="Blue" MaxLength="16" Style="z-index: 122; left: 76px; position: absolute;
        top: 105px" TabIndex="6" CssClass="CssMaiuscolo"></asp:TextBox>
    <asp:TextBox ID="txtDataNascita" runat="server" Columns="7"
        Font-Bold="True" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="10" Style="z-index: 123; left: 573px; position: absolute;
        top: 162px" TabIndex="11" CssClass="CssMaiuscolo"></asp:TextBox>
    <asp:TextBox ID="txtData1" runat="server" Columns="7"
        Font-Bold="True" Font-Names="TIMES" Font-Size="8pt" ForeColor="Blue"
        MaxLength="10" Style="z-index: 124; left: 76px; position: absolute; top: 28px;"
        TabIndex="3" Width="76px" CssClass="CssMaiuscolo" Height="20px"></asp:TextBox>
    <asp:TextBox ID="txtIndRes" runat="server" Columns="36" Font-Bold="False"
        Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="40"
        Style="z-index: 125; left: 144px; position: absolute; top: 248px" TabIndex="16" CssClass="CssMaiuscolo" Width="180px"></asp:TextBox>
    <asp:TextBox ID="txtCivicoRes" runat="server" Columns="4"
        Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="5" Style="z-index: 126; left: 393px; position: absolute;
        top: 248px" TabIndex="17" CssClass="CssMaiuscolo"></asp:TextBox>
    <asp:TextBox ID="txtTelRes" runat="server" Columns="13" Font-Bold="False"
        Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="15"
        Style="z-index: 127; left: 551px; position: absolute; top: 248px" TabIndex="19" CssClass="CssMaiuscolo"></asp:TextBox>
    <asp:TextBox ID="txtCAPRes" runat="server" Columns="4" Font-Bold="False"
        Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="5" Style="z-index: 128; left: 475px; position: absolute; top: 248px"
        TabIndex="18" CssClass="CssMaiuscolo"></asp:TextBox>
    &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
    <p>
        ...
        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <asp:TextBox ID="txtId" runat="server" Style="left: 120px; position: absolute;
            top: 29px" Visible="False" Width="14px" Height="12px"></asp:TextBox>
        &nbsp;
    ...
    <asp:DropDownList ID="cmbComuneNas" runat="server" Style="z-index: 140; left: 387px;
        ...
        <asp:CheckBox ID="chTitolare" runat="server" CssClass="CssLabel" Font-Bold="True"
            ...
            top: 275px" Text="Nel nucleo famigliare del richiedente esistono titolari di un contratto di assegnazione di alloggio di edilizia residenziale pubblica"
            Width="619px" />
    </p>
