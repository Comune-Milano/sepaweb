<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Dic_Nucleo.ascx.vb" Inherits="Dic_Nucleo" %>
...
<!--
    ...
    function ModificaNucleo() {
        ...
        if (obj1.selectedIndex == -1) {
            ...
            window.showModalDialog("com_nucleo.aspx?OP=1&RI=" + obj1.selectedIndex + "&COGNOME=" + cognome + "&NOME=" + nome + "&DATA=" + data + "&CF=" + cf + "&PARENTI=" + parenti + "&INV=" + inv + "&ASL=" + asl + "&ACC=" + acc + "&TESTO=" + obj1.options[obj1.selectedIndex].text + "&PR=" + a + "&NCOMP="+ ncomp +"&DATAINGR="+dataingr, '', 'status:no;dialogWidth:433px;dialogHeight:340px;dialogHide:true;help:no;scroll:no');
        }
    }
...
<div id="nuc" style="border-right: lightsteelblue 1px solid; border-top: lightsteelblue 1px solid;
    ...
    <p style="z-index: 114; left: 0px; position: absolute; top: 0px">
        ...
        <asp:Label ID="Label2" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
            Font-Size="8pt" Height="18px" Style="left: 4px; position: absolute; top: 197px"
    ...
    <div style="border-right: 1px solid; border-top: 1px solid; left: 7px; overflow: auto;
        ...
        <asp:ListBox ID="ListBox1" runat="server" Font-Names="Courier New" Font-Size="8pt"
            ...
            z-index: 124;" Width="1120px" Rows="7"></asp:ListBox>
