<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Statistiche.aspx.vb" Inherits="Statistiche" %>
            ...
            <tr>
                <td align="middle" bgcolor="floralwhite" style="height: 23px; text-align: left" valign="bottom">
                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                        ForeColor="Navy">Statistiche</asp:Label></td>
            </tr>
            <tr>
                <td align="middle" bgcolor="floralwhite" style="height: 88px; text-align: left;" valign="bottom">
                    <table id="Table2" align="center" bgcolor="floralwhite" border="0" bordercolor="#000000"
                        ...
                        <tr>
                            <td style="width: 189px; height: 52px; text-align: center">
                        ...
                        <tr>
                            <td style="width: 189px; height: 14px; text-align: left">
                                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Small"
                                    Style="z-index: 100; left: 0px; position: relative; top: 0px">Operatore</asp:Label></td>
                            <td style="width: 189px; height: 14px; text-align: center">
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 189px; height: 52px; text-align: left">
                                <asp:TextBox ID="txtOperatore" runat="server" Style="z-index: 100; left: 0px; position: relative;
                                    top: 0px"></asp:TextBox></td>
                            <td style="width: 189px; height: 52px; text-align: center">
                            </td>
                        </tr>
                    </table>
                    <asp:CheckBox ID="CH1" runat="server" Font-Bold="True" Style="z-index: 100; left: 0px;
                        position: static; top: 0px" Text="Visualizza Solo i giorni con produzione" Width="307px" /></td>
            </tr>
            <tr>
                <td align="middle" bgcolor="floralwhite" style="height: 39px; text-align: center"
                    ...
                    <asp:Button ID="btnChiudi" runat="server" CausesValidation="False" Height="28px"
                        Style="z-index: 100; left: 0px; position: static; top: 0px" Text="Chiudi" />&nbsp;<br />
                </td>
            </tr>
            <tr>
