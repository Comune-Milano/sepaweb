<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_ComEdifici.ascx.vb" Inherits="CENSIMENTO_Tab_ComEdifici" %>
    ...
    <tr>
        <td style="vertical-align: top; width: 589px; height: 81px; text-align: left" 
            ...
            <asp:datagrid id="DataGrid1" runat="server" Font-Names="Arial" 
                    ...
                    style="z-index: 105; left: 0px; top: 48px" BackColor="White" Font-Bold="False" 
                    ...
                    Font-Underline="False" GridLines="None">
							...
							<Columns>
                                ...
                                <asp:BoundColumn DataField="COD_EDIFICIO" HeaderText="cod" ReadOnly="True" 
...
<asp:ImageButton
                ID="btnNewEdi" runat="server" ImageUrl="~/CENSIMENTO/IMMCENSIMENTO/Img_Nuovo.png"
