<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_SanitRubinet.ascx.vb" Inherits="CENSIMENTO_Tab_SanitRubinet" %>
...
<table width="97%">
    ...
    <tr>
                <td class="style1" style="font-family: Arial">
                    <strong>SANITARI E RUBINETTERIE</strong></td>
    </tr>
    <tr>
                        ...
                        <table id="table1" align="center" runat="server" width="100%" cellpadding="0">
                         ...
                         <td>
                           ...
                           <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">
                                                <asp:DataGrid ID="dgDatiUI" runat="server" AutoGenerateColumns="False" 
                                                    CellPadding="4" Font-Bold="False" Font-Italic="False" Font-Names="Arial" 
                                                    Font-Overline="False" Font-Size="8pt" Font-Strikeout="False" 
                                                    Font-Underline="False" ForeColor="#333333" GridLines="None" Width="97%">
                                                    <ItemStyle BackColor="#EFF3FB" />
                                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" 
                                                        Mode="NumericPages" Position="Top" VerticalAlign="Top" />
                                                    ...
                                                    <Columns>
                                                     ...
                                                     <asp:BoundColumn DataField="ID_STATO_MAN" HeaderText="ID_STATO_MAN" Visible="False"></asp:BoundColumn>
                                                       ...
                                                       <asp:BoundColumn DataField="ID_MANUT2" HeaderText="ID_MANUT2" Visible="False"></asp:BoundColumn>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="STATO1">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:CheckBox ID="stato1" Text='<%#DataBinder.Eval(Container, "DataItem.MANUT1")%>' runat="server" />
                                                         ...
                                                         <asp:TemplateColumn HeaderText="STATO2">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:CheckBox ID="stato2" Text='<%#DataBinder.Eval(Container, "DataItem.MANUT2")%>' runat="server" />
                                                         ...
                                                         <asp:TemplateColumn HeaderText="STATO3">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:CheckBox ID="stato3" Text='<%#DataBinder.Eval(Container, "DataItem.MANUT3")%>' runat="server" />
                                                         ...
                                                         <asp:TemplateColumn HeaderText="STATO4">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:CheckBox ID="stato4" Text='<%#DataBinder.Eval(Container, "DataItem.MANUT4")%>' runat="server" />
