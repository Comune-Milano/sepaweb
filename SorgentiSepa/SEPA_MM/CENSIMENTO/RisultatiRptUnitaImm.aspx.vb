...
Partial Class CENSIMENTO_RisultatiRptUnitaImm
    ...
    Private Sub SettaValoriRicerca()
        Try
            ...
            StringaSQL = "SELECT PROGRAMMAZIONE_INTERVENTI.DESCRIZIONE AS PROGR_INTERVENTI,IDENTIFICATIVI_CATASTALI.FOGLIO,IDENTIFICATIVI_CATASTALI.NUMERO,IDENTIFICATIVI_CATASTALI.SUB, SISCOM_MI.UNITA_IMMOBILIARI.ID AS ID_UI, SISCOM_MI.UNITA_IMMOBILIARI.COD_UNITA_IMMOBILIARE AS CODICE_UI, SISCOM_MI.EDIFICI.CONDOMINIO, SISCOM_MI.TIPOLOGIA_UNITA_IMMOBILIARI.DESCRIZIONE AS TIPOLOGIA, " _
                       ...
                       & "(SELECT MAX (SISCOM_MI.DIMENSIONI.VALORE) FROM SISCOM_MI.DIMENSIONI WHERE SISCOM_MI.DIMENSIONI.COD_TIPOLOGIA = 'SUP_NETTA' AND SISCOM_MI.DIMENSIONI.ID_UNITA_IMMOBILIARE = UNITA_IMMOBILIARI.ID) AS SUPNETTA, " _
                       & "(SELECT MAX (SISCOM_MI.DIMENSIONI.VALORE) FROM SISCOM_MI.DIMENSIONI WHERE SISCOM_MI.DIMENSIONI.COD_TIPOLOGIA = 'SUP_UR' AND SISCOM_MI.DIMENSIONI.ID_UNITA_IMMOBILIARE = UNITA_IMMOBILIARI.ID) AS SUPUTILE, " _
                       & "(SELECT MAX (SISCOM_MI.DIMENSIONI.VALORE) FROM SISCOM_MI.DIMENSIONI WHERE SISCOM_MI.DIMENSIONI.COD_TIPOLOGIA = 'BALCONI' AND SISCOM_MI.DIMENSIONI.ID_UNITA_IMMOBILIARE = UNITA_IMMOBILIARI.ID) AS BALCONI, " _
                       & "(SELECT MAX (SISCOM_MI.DIMENSIONI.VALORE) FROM SISCOM_MI.DIMENSIONI WHERE SISCOM_MI.DIMENSIONI.COD_TIPOLOGIA = 'SUP_COMM' AND SISCOM_MI.DIMENSIONI.ID_UNITA_IMMOBILIARE = UNITA_IMMOBILIARI.ID) AS SUPCOMM, " _
                       & "(SELECT MAX (SISCOM_MI.DIMENSIONI.VALORE) FROM SISCOM_MI.DIMENSIONI WHERE SISCOM_MI.DIMENSIONI.COD_TIPOLOGIA = 'SUSCO' AND SISCOM_MI.DIMENSIONI.ID_UNITA_IMMOBILIARE = UNITA_IMMOBILIARI.ID) AS SUPESCLUSIVA " _
                       & "FROM SISCOM_MI.PROGRAMMAZIONE_INTERVENTI,SISCOM_MI.IDENTIFICATIVI_CATASTALI,SISCOM_MI.UNITA_IMMOBILIARI, SISCOM_MI.TIPOLOGIA_UNITA_IMMOBILIARI, SISCOM_MI.INDIRIZZI, SISCOM_MI.SCALE_EDIFICI, SISCOM_MI.PIANI, " _
                       ...
                       & "WHERE PROGRAMMAZIONE_INTERVENTI.ID (+)=UNITA_IMMOBILIARI.ID_PRG_EVENTI AND UNITA_IMMOBILIARI.ID_CATASTALE = IDENTIFICATIVI_CATASTALI.ID (+) AND SISCOM_MI.TIPOLOGIA_UNITA_IMMOBILIARI.COD(+) = SISCOM_MI.UNITA_IMMOBILIARI.COD_TIPOLOGIA AND " _
                       ...
                       & "SISCOM_MI.UNITA_IMMOBILIARI.ID_EDIFICIO <> 1"
