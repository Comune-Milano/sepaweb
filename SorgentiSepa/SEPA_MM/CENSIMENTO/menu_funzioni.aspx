<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni.aspx.vb" Inherits="CENSIMENTO_menu_funzioni" %>
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image2" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                Style="left: 608px; position: absolute; top: 32px" Width="4px" Visible="False" />
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_PED_LOTTO.png" Style="left: 26px;
                position: absolute; top: 3px" />
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" 
                Style="left: 615px; position: absolute; top: 33px; height: 15px;" 
                ToolTip="Chiudi Applicazione" Visible="False">Chiudi</asp:LinkButton>
            &nbsp;
        </form>
		<script type="text/javascript">
		function spegni()
