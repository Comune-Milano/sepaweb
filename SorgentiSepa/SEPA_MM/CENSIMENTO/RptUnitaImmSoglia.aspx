<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptUnitaImmSoglia.aspx.vb"
    Inherits="CENSIMENTO_RptUnitaImmSoglia" %>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" Text="Sottosoglia" runat="server" Font-Names="Arial" Font-Size="8pt" />&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td>
                                            <asp:DropDownList runat="server" ID="cmbSottosoglia" Font-Names="Arial" 
                                    ...
                                    <tr>
                                        <td>
                                            <div style="width: 100%; height: 175px; overflow: auto;">
                                                <asp:CheckBoxList ID="cbltipologia" runat="server" Font-Names="Arial" 
                                                    Font-Size="8pt" Enabled="False">
                                                </asp:CheckBoxList>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <center>
                                                <asp:Button ID="btntipologia" runat="server" Text="Seleziona/Deseleziona" Font-Names="Arial"
                                                    Font-Size="8" Enabled="False" /></center>
                                        </td>
                                        <td>
                                            <center>
                            ...
                            <td colspan="8">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:CheckBox ID="cbsolofiltrati" runat="server" Font-Names="Arial" Font-Size="8pt"
                                                Text="Visualizza tutti i contratti" Font-Bold="True" Checked="True" 
                                                Visible="False" />
                                        </td>
                                        <td>
                                            &nbsp;
