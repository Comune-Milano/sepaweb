<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiRptUnitaImm.aspx.vb"
    Inherits="CENSIMENTO_RisultatiRptUnitaImm" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td style="width: 100%; text-align: center">
                <asp:Label ID="Titolo" runat="server" Font-Bold="True" Font-Names="Arial" 
                    Font-Size="12pt" style="text-align: center">Report Unità Immobiliari</asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 100%; text-align: center">
                <asp:Label ID="lblSottotitolo" runat="server" Font-Bold="False" 
                    Font-Names="Arial" Font-Size="8pt" style="text-align: justify">Report Unità Immobiliari</asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 100%">
                <asp:DataGrid runat="server" ID="dgvRptUnitaImm" AutoGenerateColumns="False" CellPadding="1"
                    ...
                    <AlternatingItemStyle BackColor="White" ForeColor="#000000" Font-Bold="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="INDIRIZZO" HeaderText="INDIRIZZO">
                            ...
                            <HeaderStyle Width="200px" Font-Bold="False" Font-Italic="False" 
                        ...
                        <asp:BoundColumn DataField="DATO_CONTRATTO" HeaderText="DATO_CONTRATTO" 
