<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UiDisponibiliAmm.aspx.vb"
...
<body>
    ...
    <div>
        ...
        <table width="100%">
            <tr>
                <td align="center">
                    <span style="font-family: Arial"><strong style="text-align: center">Dati Amministrativi
                        Unità Immobiliari Libere</strong></span>
                </td>
            </tr>
        </table>
        <table width="200%">
            ...
            <tr>
                <td style="text-align: left; height: 21px;" class="style1">
                    * Unità libere, Stato Alloggio = Agibile
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="height: 20px">
                    <asp:DataGrid ID="DataGridUnitDispo" runat="server" AutoGenerateColumns="False" CellPadding="5"
                        ...
                        BorderWidth="2px" AllowPaging="True" PageSize="500">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="INFO PRENOTAZIONE/ASSEGNAZIONE">
                                <ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="DATA POST-SLOGGIO">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_POST_SLOGGIO") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:TemplateColumn HeaderText="DESTINAZIONE USO U.I.">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.USO_UI") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:TemplateColumn HeaderText="DATA DISPONIB. PRESUNTA">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_DISP") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:TemplateColumn HeaderText="FINE LAVORI">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FINE_LAVORI") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:TemplateColumn HeaderText="DATA INSERIM.(data disdetta)">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_DISDETTA_EVENTO") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:TemplateColumn HeaderText="DATA INSERIM.(data sloggio)">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_SLOGGIO_EVENTO") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:BoundColumn DataField="SOTTO_SOGLIA" HeaderText="SOTTO SOGLIA">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ZONA" HeaderText="ZONA">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="COSTO_INTERVENTO" HeaderText="COSTO INTERVENTO" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                            </asp:BoundColumn>
                        </Columns>
