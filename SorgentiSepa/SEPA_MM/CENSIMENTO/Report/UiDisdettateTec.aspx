<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UiDisdettateTec.aspx.vb"
            ...
            <tr>
                <td align="center">
                    <span style="font-family: Arial"><strong style="text-align: center">Dati Tecnici Unità
                        Immobiliari Disdettate</strong></span>
                </td>
            </tr>
        </table>
        <table width="200%">
            ...
            <tr>
                <td style="text-align: left; height: 21px;">
                    * <span class="style1">Unità immobiliari libere </span>
                </td>
            </tr>
            <tr>
                <td style="text-align: left; height: 21px;">
                    ...
                    <asp:DataGrid ID="DataGridUnitDispo" runat="server" AutoGenerateColumns="False" CellPadding="5"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="DATA DISDETTA">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_DISDETTA") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
