<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UiDisponibili.aspx.vb" Inherits="CENSIMENTO_UiDisponibili" %>
...
<body>
    ...
    <div>
        ...
        <table width="100%">
            <tr>
                <td align="center">
                    <span style="font-family: Arial"><strong style="text-align: center">Dati Tecnici Unità
                        Immobiliari Libere</strong></span>
                </td>
            </tr>
        </table>
        <table width="200%">
                ...
                <td style="height: 20px">
                    <asp:DataGrid ID="DataGridUnitDispo" runat="server" AutoGenerateColumns="False" CellPadding="5"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="PRGINTERVENTI" HeaderText="PROGR. INTERVENTI"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ZONA" HeaderText="ZONA"></asp:BoundColumn>
                            <asp:BoundColumn DataField="COSTO_INTERVENTO" HeaderText="COSTO INTERVENTO" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"></asp:BoundColumn>
                        </Columns>
