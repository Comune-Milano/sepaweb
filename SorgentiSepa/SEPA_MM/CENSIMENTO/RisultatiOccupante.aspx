<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiOccupante.aspx.vb" Inherits="PED_RisultatiOccupante" %>
...
<body style="background-attachment: fixed; background-image: url(../NuoveImm/SfondoMascheraContratti.jpg); background-repeat:no-repeat;">
    ...
    <div>
        ...
        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            PageSize="20" 
            Style="z-index: 101; left: 3px; position: absolute; top: 65px; width: 778px;">
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="DATI">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.ID", "InserimentoUniImmob.aspx?ID={0}&C=RisultatiOccupante") %>'
        ...
        &nbsp;
        <table style="left: 0px; width: 792px;
        ...
        <asp:ImageButton ID="btnRicerca" runat="server" ImageUrl="~/NuoveImm/Img_NuovaRicerca.png"
            Style="z-index: 106; left: 574px; position: absolute; top: 480px" 
            ToolTip="Nuova Ricerca" />
        <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
            Style="z-index: 107; left: 718px; position: absolute; top: 480px" 
            ToolTip="Home" />
