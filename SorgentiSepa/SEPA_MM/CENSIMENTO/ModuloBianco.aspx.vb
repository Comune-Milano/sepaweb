...
Partial Class CENSIMENTO_ModuloBianco
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim sr1 As StreamReader = New StreamReader(Server.MapPath("ModuloBianco.htm"), System.Text.Encoding.GetEncoding("iso-8859-1"))
