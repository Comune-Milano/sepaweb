<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_PavimRivest.ascx.vb"
    Inherits="CENSIMENTO_Tab_PavimRivest" %>
<style type="text/css">
    .style1
    {
        color: #0000CC;
...
<table width="97%">
    <tr>
        <td class="style1" style="font-family: Arial">
            <strong>PAVIMENTI, RIVESTIMENTI E TAVOLATI</strong>
        </td>
    </tr>
    <tr>
