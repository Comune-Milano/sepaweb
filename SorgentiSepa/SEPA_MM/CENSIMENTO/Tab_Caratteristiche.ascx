<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_Caratteristiche.ascx.vb" Inherits="CENSIMENTO_Tab_Caratteristiche" %>
<style type="text/css">
    .style1
    {
        width: 242px;
...
<table style="width: 645px; height: 95px">
    <tr>
            ...
            <div 
                ...
                <asp:DataGrid ID="DgvCaratteristiche" runat="server" AllowSorting="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="TIPODOTAZIONE" HeaderText="DOTAZIONE"></asp:BoundColumn>
                        <asp:BoundColumn DataField="QUANT" HeaderText="QUANTITA'"></asp:BoundColumn>
                    </Columns>
        ...
        <td style="vertical-align: top; width: 38px; text-align: left; height: 81px;">
            <asp:Image ID="imgAddConv" onclick="myOpacCaratt.toggle();"
                runat="server"
 ...
 <div id="Caratteristiche"
    ...
    style="border: thin none #3366ff; left: 0px; width: 797px; position: absolute; top: 0px; height: 539px; background-color: #dedede; visibility :hidden; vertical-align: top; text-align: left; z-index: 201; background-image: url('../NuoveImm/SfondoMascheraContratti.jpg'); margin-right: 10px;">
               <asp:Image ID="Image1" runat="server" BackColor="White" ImageUrl="~/ImmDiv/DivMGrande.png"
                    
                   
                   
                   Style="z-index: 100; left: 41px; position: absolute; top: 78px; height: 309px; width: 678px;" />
               <table style="width: 77%; position: absolute; top: 118px; left: 71px; z-index: 800; height: 72px;">
                   <tr>
                       <td class="style2">
                   ...
                   <tr>
                       ...
                       <td style="text-align: right">
            <img id="imgAnnulla" alt="Annulla" onclick="myOpacCaratt.toggle();"
...
<script type="text/javascript">
    myOpacCaratt = new fx.Opacity('Caratteristiche', { duration: 200 });
    myOpacCaratt.hide();
</script>
