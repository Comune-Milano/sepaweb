...
Partial Class CENSIMENTO_ModuloPresloggio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                Dim sr1 As StreamReader = New StreamReader(Server.MapPath("ModuloPresloggio.htm"), System.Text.Encoding.GetEncoding("iso-8859-1"))
                ...
                'Response.Write("<script>self.close();window.open('../FileTemp/" & nomefile & "','Modulo','');self.focus();</script>")
