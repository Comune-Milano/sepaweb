<%@ Page Language="VB" AutoEventWireup="false" Inherits="CM.pagina_home" CodeFile="pagina_home.aspx.vb" EnableSessionState="ReadOnly" %>
	...
	<body bgColor="#f2f5f1" onload="document.getElementById('txtmessaggio').style.visibilty='hidden';" background="NuoveImm/sfondocopertina.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Label ID="Label3" runat="server" Font-Bold="False" Font-Names="ARIAL" Font-Size="8pt"
                ...
                Text="Label" Width="382px"></asp:Label>
            &nbsp; &nbsp;
            <asp:Label ID="label33" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ...
                top: 431px" Visible="False" Width="379px"></asp:Label>
            <asp:Label ID="lblComunicazioni" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="12pt"
                ForeColor="#721C1F" Style="z-index: 106; left: 153px; cursor: pointer; position: absolute;
                top: 405px" Visible="False" Width="379px">COMUNICAZIONI</asp:Label>
            &nbsp;
