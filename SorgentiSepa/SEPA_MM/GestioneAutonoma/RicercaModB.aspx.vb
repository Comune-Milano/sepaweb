...
Partial Class GestioneAutonoma_RicercaModB
    ...
    Protected Sub btnCerca_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCerca.Click
        Response.Redirect("RisModB.aspx?E=" & Me.cmbEdificio.SelectedValue.ToString & "&C=" & Me.DrLComplesso.SelectedValue.ToString & "&CODPROV=" & par.VaroleDaPassare(Me.txtCodProv.Text))
