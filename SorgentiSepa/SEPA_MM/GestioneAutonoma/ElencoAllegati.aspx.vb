...
Partial Class Contratti_ElencoAllegati
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Label1.Text = "Autogestione cod. " & Format(CDbl(Request.QueryString("cod")), "00000")

            

            par.cmd.CommandText = "SELECT AUTOGESTIONI.ID,AUTOGESTIONI.DENOMINAZIONE FROM SISCOM_MI.AUTOGESTIONI WHERE ID =" & Request.QueryString("cod")
            Dim myReader3 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
            If myReader3.Read Then
                Label1.Text = Label1.Text & "<br/>AUTOGESTIONE " & par.IfNull(myReader3("DENOMINAZIONE"), "")
            End If
                myReader3.Close()
            ...
            MiaSHTML_Stampa = "AUTOGESTIONE CODICE " & Format(CDbl(Request.QueryString("cod")), "00000") & " - Data Stampa:" & Format(Now, "dd/MM/yyyy") & "<br/>" & Label1.Text & "<br/><br/>Elenco Allegati<br/><br/>"
            ...
            MiaSHTML_Stampa = MiaSHTML_Stampa & "</tr>" & vbCrLf
                ...
                i = 0
                MIOCOLORE = "#CCFFFF"
            For Each foundFile As String In My.Computer.FileSystem.GetFiles(Server.MapPath("../ALLEGATI/AUTOGESTIONI/"), FileIO.SearchOption.SearchTopLevelOnly, "*_" & Request.QueryString("cod") & ".zip")
            ...
            Next
                ...
                If i > 0 Then
                    ...
                    MiaSHTML = MiaSHTML & "<td width='100px' bgcolor='" & MIOCOLORE & "'><font face='Arial' size='1'><a  alt='Download' href='../ALLEGATI/AUTOGESTIONI/" & RicavaFile(ElencoFile(j)) & "' target='_blank'><img src='../ImmMaschere/MenuTopDownload.gif' border='0'></a></font></td>" & vbCrLf
                        If Request.QueryString("LT") <> "1" Then
