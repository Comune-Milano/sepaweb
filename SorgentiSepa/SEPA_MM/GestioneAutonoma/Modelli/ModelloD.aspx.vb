...
Partial Class GestioneAutonoma_Modelli_ModelloD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If lettoreblob.Read Then
                ...
                srlet.Close()
                Response.Redirect("..\EDITOR_HTML\Editor.aspx?F=" & par.Cripta(NomeFile & ".htm") & "&ID_AUTO=" & Request.QueryString("IdGestAutonoma") & "&IDPROV=" & Request.QueryString("IdProv") & "&TIPO=D")
                Exit Sub
            End If

            '****************************SE NON ESISTE SUL DATABASE CARICO E COMPLETO IL TESTO STANDARD
            Dim sr1 As StreamReader = New StreamReader(Server.MapPath("..\TestoModelli\ModD.htm"), System.Text.Encoding.GetEncoding("iso-8859-1"))
            ...
            ElseIf Not String.IsNullOrEmpty(idComplesso) Then
