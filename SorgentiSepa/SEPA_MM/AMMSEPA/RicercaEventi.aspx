<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaEventi.aspx.vb" Inherits="AMMSEPA_RicercaEventi" %>
    ...
    <div style="position: relative; left: -12px">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 99%">
                    <asp:Label ID="Label1" runat="server" Text="Ricerca Eventi" Style="font-size: 24pt;
