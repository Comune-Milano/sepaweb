...
Partial Class AMMSEPA_MavErrori
    ...
    Protected Sub btnCerca_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCerca.Click
        ...
        Response.Write("<script>location.replace('RisultatoMavErrori.aspx?DAL=" & par.IfEmpty(par.AggiustaData(Me.txtdatadal.Text), "") & "&AL=" & par.IfEmpty(par.AggiustaData(Me.txtdataal.Text), "") & "&FI=" & par.VaroleDaPassare(Me.txtfile.Text.Trim) & "');</script>")
