<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoRicercaOp.aspx.vb" Inherits="AMMSEPA_RisultatoRicercaOp" %>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                            ...
                            GridLines="None" AllowPaging="True" ShowFooter="True" BorderColor="Navy" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="COGNOME" HeaderText="Cognome" ReadOnly="True" Visible="False">
                                </asp:BoundColumn>
                                ...
                                <asp:TemplateColumn HeaderText="ENTE">
                                    <ItemTemplate>
                                        <asp:Label ID="Label11" runat="server" 
                                            Text='<%# DataBinder.Eval(Container, "DataItem.ENTE") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
