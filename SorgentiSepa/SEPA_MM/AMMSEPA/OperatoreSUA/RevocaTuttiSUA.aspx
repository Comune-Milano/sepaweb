<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RevocaTuttiSUA.aspx.vb"
    Inherits="AMMSEPA_OperatoreSUA_RevocaTuttiSUA" %>
    ...
    <div style="position: relative; left: -12px">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 99%">
                    <asp:Label ID="Label1" runat="server" Text="Revoca Operatori" Style="font-size: 24pt;
                                        ...
                                        <td colspan="2">
                                            <center>
                                                <asp:Label ID="Label2" runat="server" Style="font-family: Arial; font-size: medium;
                                                    ...
                                                    Text="Desideri revocare tutti gli operatori attivi in questo momento (solo operatori MM)?"></asp:Label></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
