...
Partial Class AMMSEPA_OperatoreSUA_AnnullaRevocaSUA
    ...
    Protected Sub ImgSalva_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgSalva.Click
        Try
            ...
            PAR.cmd.CommandText = "UPDATE SEPA.OPERATORI SET APPOGGIO='',REVOCA='0',MOTIVO_REVOCA='' WHERE LIVELLO_WEB<>1 AND ID_CAF='2' AND REVOCA='1' AND FL_ELIMINATO='0' and APPOGGIO='3'"
            PAR.cmd.ExecuteNonQuery()

            Try
                Dim operatore As String = Session.Item("ID_OPERATORE")
                Eventi_Gestione(operatore, "F02", "RIPRISTINO OPERATORI REVOCATI CON LA FUNZIONE REVOCA TUTTI ENTE ALERMI")
