<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Quartieri.aspx.vb" Inherits="AMMSEPA_Commissariati" %>
    ...
    <div style="position: relative; left: -12px">
        <table style="width: 100%;" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="width: 99%">
                    <asp:Label ID="Label1" runat="server" Text="Quartieri" Style="font-size: 24pt;
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <asp:DataGrid ID="DataGridIntLegali" runat="server" AutoGenerateColumns="False" BackColor="#F2F5F1"
                            ...
                            meta:resourcekey="DataGrid1Resource1" PageSize="100" Width="100%" BorderColor="Navy" 
                                                    BorderStyle="Solid">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="NOME" HeaderText="QUARTIERE" ReadOnly="True"
            ...
            <table border="0" cellpadding="1" cellspacing="1" 
                ...
                <tr style="width: 435px; height: 208px; position: relative; top: 50px; left: 40px">
                    ...
                    <td style="width: 274px; height: 19px; text-align: left">
                        <strong><span style="font-family: Arial">Quartiere</span></strong></td>
                </tr>
                <tr style="font-size: 12pt; font-family: Times New Roman">
                    ...
                    <td style="width: 274px; height: 19px; text-align: left">
                        <asp:TextBox ID="txtQuartiere" runat="server" Font-Names="Arial" 
                            Font-Size="9pt" Width="293px" MaxLength="50" TabIndex="1"></asp:TextBox>
                        </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="text-align: right">
                                    <asp:ImageButton ID="img_InserisciSchema" runat="server" 
                                        ImageUrl="~/NuoveImm/Img_InserisciVal.png" TabIndex="2" 
