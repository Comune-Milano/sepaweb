<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoMavErrori.aspx.vb"
    Inherits="AMMSEPA_RisultatoMavErrori" %>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                            AllowPaging="True" Font-Size="8pt" PageSize="100" BackColor="White" Font-Bold="False"
                            Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"
                            GridLines="None" Width="100%" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px">
