<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RevocaTutti.aspx.vb" Inherits="AMMSEPA_RevocaTutti" %>
                                        ...
                                        <td colspan="2">
                                            <center>
                                                <asp:Label ID="Label2" runat="server" Style="font-family: Arial; font-size: medium;
                                                    ...
                                                    Text="Desideri revocare tutti gli operatori attivi in questo momento? (Gli operatori MM non sono inclusi)"></asp:Label></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
