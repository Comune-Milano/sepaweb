<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MavErrori.aspx.vb" Inherits="AMMSEPA_MavErrori" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Errori Rendicontazione</title>
    ...
    <div style="position: relative; left: -12px">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 99%">
                    <asp:Label ID="Label1" runat="server" Text="Errori Rendicontazione " Style="font-size: 24pt;
