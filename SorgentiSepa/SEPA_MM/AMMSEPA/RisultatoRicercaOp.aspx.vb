...
Partial Class AMMSEPA_RisultatoRicercaOp
    ...
    Private Sub Cerca()
        ...
        sStringaSQL1 = "SELECT OPERATORI.ID,REPLACE(OPERATORI.COGNOME,'''','-') as COGNOME,REPLACE(OPERATORI.NOME,'''','-') AS NOME,REPLACE(OPERATORI.OPERATORE,'''','-') AS OPERATORE,DECODE(OPERATORI.SEPA,'1','SI') AS ""CLIENT"",DECODE(OPERATORI.SEPA_WEB,'1','SI') AS ""WEB"",CAF_WEB.COD_CAF AS ""ENTE"",DECODE(OPERATORI.REVOCA,'1','SI','2','SI') AS ""FL_REVOCATO"" " _
    ...
    Protected Sub btnRicerca_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnRicerca.Click
        Response.Write("<script>document.location.href=""RicercaOP.aspx""</script>")
    End Sub
    ...
    Protected Sub btnVisualizza_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnVisualizza.Click
        ...
        Else
            ...
            & "location.replace('Operatore.aspx?RG=" & Request.QueryString("RG") & "&CN=" & Request.QueryString("CN") & "&NM=" & Request.QueryString("NM") & "&CF=" & Request.QueryString("CF") & "&OP=" & par.VaroleDaPassare(Request.QueryString("OP")) & "&EN=" & Request.QueryString("EN") & "&ID=" & LBLID.Value & "');" _
            & "</script>"
