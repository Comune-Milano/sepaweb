<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AnnullaRevoca.aspx.vb" Inherits="AMMSEPA_AnnullaRevoca" %>
                                        ...
                                        <td colspan="2">
                                            <center>
                                                <asp:Label ID="Label2" runat="server" Style="font-family: Arial; font-size: medium;
                                                    font-weight: 700; text-align: center" Text="Desideri Ripristinare tutti gli operatori revocati con la funzione 'Revoca Tutti'?"></asp:Label></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
