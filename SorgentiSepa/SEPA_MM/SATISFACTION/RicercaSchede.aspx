<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaSchede.aspx.vb" Inherits="SATISFACTION_RicercaSchede" %>
...
<head>
    <title>Ricerca Questionari</title>
</head>
        ...
        <tr>
            <td>
                <asp:Label ID="lblTitoloPagina" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="12pt" ForeColor="Maroon" Text="Ricerca Questionari"></asp:Label>
            </td>
        </tr><tr>
            ...
            <td>
                <table width="100%">
                    <tbody>
                        <tr>
                            <td style="width: 20%">
                                <asp:Label ID="Label11" runat="server" Font-Size="9pt" Font-Names="Arial" Font-Bold="False"
                                    Text="Servizi">
                                </asp:Label>
                            </td>
                            <td style="width: 80%">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label8" runat="server" Font-Size="9pt" Font-Names="Arial" Font-Bold="False"
                                    Text="Giudizio complessivo">
                                </asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlGiudizio" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                    Font-Names="Arial" Font-Size="9pt" Width="180px">
                                    <asp:ListItem Selected="True">---</asp:ListItem>
                                    <asp:ListItem Value="1"> 1 - Non soddisfacente</asp:ListItem>
                                    <asp:ListItem Value="2"> 2 - Poco soddisfacente</asp:ListItem>
                                    <asp:ListItem Value="3"> 3 - Soddisfacente</asp:ListItem>
                                    <asp:ListItem Value="4"> 4 - Molto soddisfacente</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txt_codUI" runat="server" Width="174px" Font-Names="Arial" Font-Size="9pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCivico" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                    Font-Names="Arial" Font-Size="9pt" Width="180px" AutoPostBack="True">
                                    <asp:ListItem Selected="True">---</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtData1" runat="server" Font-Names="Arial" Font-Size="9pt" Width="70px"></asp:TextBox>
                                <asp:Label ID="Label10" runat="server" Font-Size="8pt" Font-Names="Arial" Font-Bold="False"
                                    Style="width: 16px" Text="a"></asp:Label>
                                <asp:TextBox ID="txtData2" runat="server" Font-Names="Arial" Font-Size="9pt" Width="70px"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="erroreDate" runat="server" Font-Names="Arial" Font-Size="9pt" 
                                    Text="Inserire le date correttamente nel formato gg/mm/aaaa" 
