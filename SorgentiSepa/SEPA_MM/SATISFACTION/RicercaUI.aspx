...
<head id="Head1" runat="server">
    <title>Ricerca Codice U.I.</title>
</head>
<body bgcolor="white">
    ...
    defaultfocus="btnCerca">
        ...
        <asp:DropDownList ID="cmbEdificio" runat="server" AutoPostBack="True" BackColor="White"
            ...
            Style="border: 1px solid black; z-index: 111; left: 96px; position: absolute; top: 161px" TabIndex="2"
            Width="488px">
        </asp:DropDownList>
    ...
    <div>
        ...
        <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="../NuoveImm/Img_EsciCorto.png"
            Style="z-index: 106; left: 538px; position: absolute; top: 304px" 
            ToolTip="Home" TabIndex="5" />
        ...
        <asp:DropDownList ID="cmbCivico" runat="server" AutoPostBack="True" BackColor="White"
            Font-Names="arial" Font-Size="10pt" Height="20px" 
                        Style="border: 1px solid black; z-index: 111; left: 373px; position: absolute; top: 195px; width: 84px; right: 217px;" 
                        TabIndex="6">
        </asp:DropDownList>
                    <br />
                    <br />
        ...
        <div id="AiutoRicerca" style="z-index: 200; left: 289px; width: 302px; position: absolute; top: 236px; height: 225px; background-color: transparent;
            ">
            <br />
