...
//-->
	...
	<body bgColor="#f2f5f1" 
        ...
        background="../NuoveImm/sfondocopertinaContratti.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                Style="z-index: 100; left: 143px; position: absolute; top: 72px" 
                Text="VERSIONE 1.20" Font-Italic="False"></asp:Label>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:HiddenField ID="txtmessaggio" runat="server" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:Label ID="Label3" runat="server" Font-Bold="False" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="#404040" Style="z-index: 102; left: 144px; position: absolute; top: 92px"
                Text="Label" Width="314px"></asp:Label>
            &nbsp; &nbsp;
            &nbsp;
            <p>
            <asp:Label ID="lblComunicazioni" runat="server" Font-Bold="True" Font-Names="ARIAL"
                Font-Size="12pt" ForeColor="#721C1F" Style="z-index: 106; left: 263px; cursor: pointer;
                position: absolute; top: 419px" Visible="False" Width="379px">COMUNICAZIONI</asp:Label>
		    </p>
            <asp:Label ID="label33" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="#404040" Style="z-index: 106; left: 265px; cursor: pointer; position: absolute;
                top: 443px" Visible="False" Width="377px"></asp:Label>
		</form>
	</body>
