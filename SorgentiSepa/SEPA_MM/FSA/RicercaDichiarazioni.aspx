<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaDichiarazioni.aspx.vb" Inherits="FSA_RicercaDichiarazioni" %>
...
//document.onkeydown=$onkeydown;
        ...
        defaultfocus="txtCognome">
            ...
            <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                Style="z-index: 104; left: 539px; position: absolute; top: 311px" TabIndex="8" ToolTip="Home" />
            <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
                Style="z-index: 105; left: 407px; position: absolute; top: 311px" TabIndex="7" ToolTip="Avvi Ricerca" />
									...
									<asp:DropDownList id="cmbStato" tabIndex="5" runat="server" Width="187px" AutoPostBack="True" style="border-right: black 1px solid; border-top: black 1px solid; z-index: 111; left: 170px; border-left: black 1px solid; border-bottom: black 1px solid; position: absolute; top: 203px"></asp:DropDownList>
                                    <asp:Label ID="Label8" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                        Style="z-index: 112; left: 93px; position: absolute; top: 236px" Width="70px">Bando FSA</asp:Label><asp:DropDownList id="cmbBando" tabIndex="6" runat="server" Width="187px" AutoPostBack="True" style="z-index: 116; left: 170px; position: absolute; top: 233px; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                                </asp:DropDownList>
		</form>
	</body>
</html>
