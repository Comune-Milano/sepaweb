...
Partial Class FSA_ElencoNonIdonei
        ...
        If Not IsPostBack Then
            Try
                ...
                par.cmd.CommandText = "SELECT (CASE WHEN DOMANDE_BANDO_FSA.ID_STATO = '4' THEN 'NO' ELSE 'SI' END) AS IDONEA,comuni_nazioni.nome as ""comunedi"", " _
                                    ...
                                    & "AND domande_bando_fsa.provv_negativo='1' and domande_bando_fsa.id_bando= " & lIdBando
                ...
                imgExcel.Attributes.Add("onclick", "javascript:window.open('DownLoad.aspx?CHIAMA=2','export','');")
