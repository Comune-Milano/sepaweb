...
if (tab=='1') {
    ...
    document.getElementById('i3').src='../p_menu/CON_0.gif'
    document.getElementById('i4').src='../p_menu/ALL_0.gif'
    document.getElementById('i5').src='../p_menu/ABIT2_0.gif'
    document.getElementById('i6').src='../p_menu/REC_0.gif'
    document.getElementById('i7').src='../p_menu/NOTE_FSA_0.gif'
    }
if (tab=='2') {  
...
if (tab=='3') {  
    ...
    document.getElementById('i1').src='../p_menu/RICH_0.gif'
    document.getElementById('i2').src='../p_menu/DICH_0.gif'
    document.getElementById('i3').src='../p_menu/CON_1.gif'
    document.getElementById('i4').src='../p_menu/ALL_0.gif'
    document.getElementById('i5').src='../p_menu/ABIT2_0.gif'
    document.getElementById('i6').src='../p_menu/REC_0.gif'
    document.getElementById('i7').src='../p_menu/NOTE_FSA_0.gif'
...
if (tab=='4') {  
    ...
    document.getElementById('i2').src='../p_menu/DICH_0.gif'
    document.getElementById('i3').src='../p_menu/CON_0.gif'
    document.getElementById('i4').src='../p_menu/ALL_1.gif'
    document.getElementById('i5').src='../p_menu/ABIT2_0.gif'
    document.getElementById('i6').src='../p_menu/REC_0.gif'
    document.getElementById('i7').src='../p_menu/NOTE_FSA_0.gif'
    } 
...
if (tab=='7') {  
    ...
    document.getElementById('i5').src='../p_menu/ABIT2_0.gif'
    document.getElementById('i6').src='../p_menu/REC_0.gif'
    document.getElementById('i7').src='../p_menu/NOTE_FSA_1.gif'
...
if (tab=='1') {
    ...
    document.getElementById('i7').src='../p_menu/D70_0.gif'
    document.getElementById('txtTab').value=tab;
    }
if (tab=='2') {  
    if (Valorizza()==0) {
...
if (tab=='7') {  
    ...
    document.getElementById('i5').src='../p_menu/D5_0.gif'
    document.getElementById('i6').src='../p_menu/D6_0.gif'
    document.getElementById('i7').src='../p_menu/D70_1.gif'
    document.getElementById('txtTab').value=tab;
    }
    else
    {
