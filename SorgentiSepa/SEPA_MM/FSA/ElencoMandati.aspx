<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElencoMandati.aspx.vb" Inherits="FSA_ElencoMandati" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Mandati da liquidare</title>
</head>
<body>
    ...
    <table >
        <tr>
            <td align="center" 
                ...
                ELENCO MANDATI DA LIQUIDARE</td>
        </tr>
        <tr>
            <td>
            ...
            <asp:TemplateColumn HeaderText="DETRAZIONI">
                ...
                <EditItemTemplate>
                    <asp:TextBox runat="server" 
                        Text='<%# DataBinder.Eval(Container, "DataItem.IMPORTODETRAZIONI") %>'></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateColumn>
