<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Indici.aspx.vb" Inherits="FSA_Indici" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="z-index: 102; left: 10px;
        ...
        <tr>
            <td style="width: 616px; height: 24px; color: #660000;">
                <img id="STAMPA" onclick="javascript:window.print();" src="../IMG/print.jpg" style="z-index: 100; left: 428px; position: absolute;
        ...
        <tr>
            <td style="border-right: dimgray 1px solid; border-left: dimgray 1px solid;
                ...
                <asp:Label ID="Label1" runat="server" Style="z-index: 123; left: 20px; position: absolute;
                    top: 231px; text-align: left" Text="Contr. Comunale" Width="114px"></asp:Label>
                <asp:Label ID="Label6" runat="server" Style="z-index: 123; left: 20px; position: absolute;
                    top: 257px; text-align: left" Text="Contr. Regionale" Width="114px"></asp:Label>
                <asp:Label ID="LBLPSE" runat="server" CssClass="CssValori" Font-Bold="True" Font-Names="arial"
                    ...
                    Text="Label"></asp:Label>
                <asp:Label ID="lblComunale" runat="server" CssClass="CssValori" Font-Bold="True"
                    Font-Names="arial" Font-Size="12pt" Style="z-index: 124; left: 154px; position: absolute;
                    top: 231px; text-align: left;" Width="99px"></asp:Label>
                <asp:Label ID="lblRegionale" runat="server" CssClass="CssValori" Font-Bold="True" Font-Names="arial"
                    Font-Size="12pt" Style="z-index: 124; left: 154px; position: absolute; top: 257px; text-align: left;" Width="99px"></asp:Label>
                ...
                <asp:Label ID="Label7" runat="server" Style="z-index: 123; left: 20px; position: absolute;
                    top: 284px; text-align: left" Text="Contr. Totale" Width="114px"></asp:Label>
                <asp:Label ID="lblTotale" runat="server" CssClass="CssValori" Font-Bold="True" Font-Names="arial"
                    Font-Size="12pt" Style="z-index: 124; left: 154px; position: absolute; top: 284px; text-align: left;"
