...
Partial Class FSA_Riassunto
    ...
    Private Function Riassunto(ByVal id As Long, ByVal cf As String)
        ...
        'Dim bStringaHTML_6 As Boolean
        'Dim bStringaHTML_5 As Boolean
        'Dim bStringaHTML_4 As Boolean
        'Dim bStringaHTML_3 As Boolean
        'Dim bStringaHTML_2 As Boolean
        'Dim bStringaHTML_1 As Boolean
        'Dim bStringaHTML112 As Boolean
        ...
        Dim bStringaHTML1100 As Boolean
        Dim bStringaHTML1001 As Boolean
        'Dim bStringaHTML171 As Boolean
        'Dim bStringaHTML172 As Boolean
        'Dim bStringaHTML173 As Boolean
        ...
        Try
            ...
            par.cmd.CommandText = "SELECT DOMANDE_BANDO_FSA.*,bandi_FSA.descrizione as ""Db"" FROM bandi_FSA,DOMANDE_BANDO_FSA WHERE DOMANDE_BANDO_FSA.id_bando=bandi_FSA.id and DOMANDE_BANDO_fsa.ID=" & id
            ...
            If myReader.Read Then
                ...
                par.cmd.CommandText = "SELECT T_TIPO_VIA.DESCRIZIONE AS ""DVIA"",COMUNI_NAZIONI.NOME AS ""NN"",COMUNI_NAZIONI.SIGLA AS ""SS"",COMUNI_NAZIONI.CAP AS ""CC"",IND_RES_DNTE,CIVICO_RES_DNTE FROM DICHIARAZIONI_FSA,COMUNI_NAZIONI,T_TIPO_VIA WHERE ID_TIPO_IND_RES_DNTE=T_TIPO_VIA.COD AND ID_LUOGO_RES_DNTE=COMUNI_NAZIONI.ID AND DICHIARAZIONI_FSA.ID=" & ID_DICHIARAIONE
                ...
                par.cmd.CommandText = "select * from comp_nucleo_fsa where id_dichiarazione=" & myReader("id_dichiarazione") & " AND progr=0"
                ...
                StringaHTML = StringaHTML & "<tr>"
                'StringaHTML = StringaHTML & "<td width='35%'><font face='Arial' size='2'>Esclusione</font></td>"
                ...
                StringaHTML = StringaHTML & "<tr>"
                If par.Tronca(par.IfNull(myReader("reddito_isee"), "0")) = "0,000" Then
                    ...
                    If par.IfNull(myReader("requisito9"), "1") = "0" Then
                        Motivo = "9"
                    End If
                    If par.IfNull(myReader("requisito10"), "1") = "0" Then
                        Motivo = "10"
                    End If
                    If par.IfNull(myReader("requisito11"), "1") = "0" Then
                        Motivo = "11"
                    End If
                    If par.IfNull(myReader("requisito12"), "1") = "0" Then
                        Motivo = "12"
                    End If
                    If par.IfNull(myReader("requisito13"), "1") = "0" Then
                        Motivo = "13"
                    End If
                    If par.IfNull(myReader("requisito14"), "1") = "0" Then
                        Motivo = "14"
                    End If
                    If par.IfNull(myReader("requisito15"), "1") = "0" Then
                        Motivo = "15"
                    End If
                End If
                If Motivo <> "" Then Motivo = " - " & Motivo
                ' StringaHTML = StringaHTML & "<td width='35%'><font face='Arial' size='1'>" & Motivo & "</font></td>"
                StringaHTML = StringaHTML & "<td width='50%'><font face='Arial' size='1'>" & par.IfNull(myReader("ISE_ERP"), "Non calcolato") & "</font></td>"
                StringaHTML = StringaHTML & "<td width='50%'><font face='Arial' size='1'>" & par.IfNull(myReader("REDDITO_ISEE"), "Non calcolato") & "</font></td>"
                ...
                'CORRELAZIONI CON bando

                bStringaHTML1001 = False

                StringaHTML1100 = StringaHTML1100 & "<p><b><font face='Arial' size='3'>CORRELAZIONI BANDO ERP</font></b></p>"
                StringaHTML1100 = StringaHTML1100 & "<table border='1' cellpadding='0' cellspacing='0' width='100%'>"
                StringaHTML1100 = StringaHTML1100 & "<tr>"
                StringaHTML1100 = StringaHTML1100 & "<td width='15%'><font face='Arial' size='2'>NOMINATIVO</font></td>"
                StringaHTML1100 = StringaHTML1100 & "<td width='10%'><font face='Arial' size='2'>COD.FISCALE</font></td>"
                StringaHTML1100 = StringaHTML1100 & "<td width='8%'><font face='Arial' size='2'>INTESTATARIO</font></td>"
                StringaHTML1100 = StringaHTML1100 & "<td width='16%'><font face='Arial' size='2'>INDIRIZZO</font></td>"
                'StringaHTML1100 = StringaHTML1100 & "<td width='12%'><font face='Arial' size='2'>TIPO C.</font></td>"
                StringaHTML1100 = StringaHTML1100 & "<td width='13%'><font face='Arial' size='2'>ANNO REDD.</font></td>"
                StringaHTML1100 = StringaHTML1100 & "<td width='16%'><font face='Arial' size='2'>REDDITI DICHIARATI</font></td>"
                'StringaHTML1100 = StringaHTML1100 & "<td width='10%'><font face='Arial' size='2'>CODICE U.I.</font></td>"
                ...
                par.cmd.CommandText = "SELECT * FROM COMP_NUCLEO_fsa WHERE ID_DICHIARAZIONE=" & myReader("ID_DICHIARAZIONE") & " ORDER BY PROGR ASC"
                myReader1 = par.cmd.ExecuteReader()
                While myReader1.Read
                    par.cmd.CommandText = "select * from comp_nucleo where cod_fiscale='" & myReader1("COD_FISCALE") & "'"
                    Dim myReader2 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
                    While myReader2.Read
                        MiaTab = "<table cellpadding='0' cellspacing='0' width='100%'>"
                        bStringaHTML1100 = True

                        par.cmd.CommandText = "select * from dichiarazioni where id=" & myReader2("id_dichiarazione")
                        Dim myReader123 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
                        If myReader123.Read Then
                            StringaHTML1100 = StringaHTML1100 & "<tr>"
                            StringaHTML1100 = StringaHTML1100 & "<td width='15%'><font face='Arial' size='1'>" & par.IfNull(myReader2("COGNOME"), "") & " " & par.IfNull(myReader1("NOME"), "") & "</font></td>"
                            StringaHTML1100 = StringaHTML1100 & "<td width='10%'><font face='Arial' size='1'>" & par.IfNull(myReader2("COD_FISCALE"), "") & "</font></td>"

                            If myReader2("PROGR") = 0 Then
                                StringaHTML1100 = StringaHTML1100 & "<td width='8%'><font face='Arial' size='1'>SI</font></td>"
                            Else
                                StringaHTML1100 = StringaHTML1100 & "<td width='8%'><font face='Arial' size='1'>NO</font></td>"
                            End If

                            StringaHTML1100 = StringaHTML1100 & "<td width='16%'><font face='Arial' size='1'>" & par.IfNull(myReader123("ind_res_dnte"), "") & ", " & par.IfNull(myReader123("CIVICO_res_dnte"), "") & "</font></td>"
                            'If par.IfNull(myReader123("ind_res_dnte"), "0") = "0" Then
                            '    StringaHTML1100 = StringaHTML1100 & "<td width='12%'><font face='Arial' size='1'>EC</font></td>"
                            'Else
                            '    StringaHTML1100 = StringaHTML1100 & "<td width='12%'><font face='Arial' size='1'>ERP</font></td>"
                            'End If
                            StringaHTML1100 = StringaHTML1100 & "<td width='13%'><font face='Arial' size='1'>" & par.IfNull(myReader123("anno_sit_economica"), "") & "</font></td>"

                            par.cmd.CommandText = "SELECT * FROM COMP_ELENCO_SPESE WHERE ID_COMPONENTE=" & myReader2("ID")
                            ...
                            End While
                            myReader33.Close()
                            par.cmd.CommandText = "SELECT * FROM COMP_PATR_MOB WHERE ID_COMPONENTE=" & myReader2("ID")
                            ...
                            par.cmd.CommandText = "SELECT * FROM COMP_PATR_IMMOB WHERE ID_COMPONENTE=" & myReader2("ID")
                            myReader33 = par.cmd.ExecuteReader()
                            While myReader33.Read
                                MiaTab = MiaTab & vbCrLf
                            ...
                            par.cmd.CommandText = "SELECT * FROM COMP_REDDITO WHERE ID_COMPONENTE=" & myReader2("ID")
                            myReader33 = par.cmd.ExecuteReader()
                            While myReader33.Read
                                MiaTab = MiaTab & vbCrLf
                            ...
                            par.cmd.CommandText = "SELECT * FROM COMP_ALTRI_REDDITI WHERE ID_COMPONENTE=" & myReader2("ID")
                            myReader33 = par.cmd.ExecuteReader()
                            While myReader33.Read
                                MiaTab = MiaTab & vbCrLf
                            ...
                            par.cmd.CommandText = "SELECT * FROM COMP_DETRAZIONI WHERE ID_COMPONENTE=" & myReader2("ID")
                            myReader33 = par.cmd.ExecuteReader()
                            While myReader33.Read
                                MiaTab = MiaTab & vbCrLf
                            ...
                            If MiaTab <> "<table cellpadding='0' cellspacing='0' width='100%'>" Then
                                StringaHTML1100 = StringaHTML1100 & "<td width='16%'><font face='Arial' size='1'>" & MiaTab & "</table></font></td>"
                            Else
                                StringaHTML1100 = StringaHTML1100 & "<td width='16%'><font face='Arial' size='1'>---</font></td>"
                            End If
                            ' StringaHTML1100 = StringaHTML1100 & "<td width='10%'><font face='Arial' size='1'>" & par.IfNull(myReader123("posizione"), "") & "</font></td>"
                ...
                StringaHTML1100 = StringaHTML1100 & "</table>"
                ...
                If bStringaHTML1100 = False Then StringaHTML1100 = ""
