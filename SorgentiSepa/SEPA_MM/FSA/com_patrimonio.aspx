<%@ Page Language="VB" AutoEventWireup="false" CodeFile="com_patrimonio.aspx.vb" Inherits="FSA_com_patrimonio" %>
...
<body bgcolor="lightsteelblue">
    ...
    <div>
        ...
        <asp:Label ID="L1" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
            ForeColor="Red" Style="z-index: 108; left: 338px; position: absolute; top: 96px"
        ...
        <asp:Button ID="btnSalva" runat="server" Style="z-index: 118; left: 208px; position: absolute;
            top: 196px" TabIndex="7" Text="SALVA e Chiudi" />
