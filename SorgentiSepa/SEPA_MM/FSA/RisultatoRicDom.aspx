<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoRicDom.aspx.vb" Inherits="FSA_RisultatoRicDom" %>
	...
	<body bgColor="#f2f5f1">
		<form id="Form1" method="post" runat="server">
                ...
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="TextBox7" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="12pt"
                            Style="border-right: white 1px solid; border-top: white 1px solid; left: -1px;
                            border-left: white 1px solid; border-bottom: white 1px solid; top: 45px" Width="643px">Nessuna Selezione</asp:TextBox><br />
                        <br />
            ...
            &nbsp;<asp:ImageButton ID="btnVisualizza" runat="server" ImageUrl="~/NuoveImm/Img_Visualizza.png"
                Style="z-index: 102; left: 218px; position: absolute; top: 483px" ToolTip="Visualizza" />
            <asp:ImageButton ID="btnRicerca" runat="server" ImageUrl="~/NuoveImm/Img_NuovaRicerca.png"
                Style="z-index: 103; left: 406px; position: absolute; top: 483px" ToolTip="Nuova Ricerca" />
            &nbsp;
            <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                Style="z-index: 104; left: 539px; position: absolute; top: 483px" ToolTip="Home" />
            &nbsp;
