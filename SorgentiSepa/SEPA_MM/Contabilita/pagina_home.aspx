	...
	<body bgColor="#f2f5f1" 
		...
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                Style="z-index: 100; left: 26px; position: absolute; top: 69px" 
            ...
            <asp:Label ID="Label3" runat="server" Font-Bold="False" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="#404040" Style="z-index: 102; left: 28px; position: absolute; top: 89px"
                Text="Label" Width="314px"></asp:Label>
            &nbsp; &nbsp;&nbsp;
            <img src="../immagini/sistemiesoluzionisrl.gif" style="z-index: 111; left: 16px; position: absolute;
                top: 497px" />
            &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
		</form>
	</body>
