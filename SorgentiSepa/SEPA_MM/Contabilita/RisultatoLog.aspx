<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoLog.aspx.vb" Inherits="Contabilita_RisultatoLog" %>
...
<body style="background-image: url(../NuoveImm/SfondoMascheraContratti.jpg); width: 770px;">
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr>
            <td style="width: 100%">
                <asp:Label ID="Label1" runat="server" Text="Elenco Log" Font-Bold="True" Font-Names="Arial"
                                    ...
                                    <td style="width: 99%">
                                        <div style="width: 100%; overflow: auto; height: 400px;">
                                            <asp:DataGrid ID="DataGrid1" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                                                Font-Size="8pt" Width="100%" PageSize="100" BackColor="White" Font-Bold="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateColumn HeaderText="DATA">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label11" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="LOG">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox4" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.LOG") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                    </asp:TemplateColumn>
                                                </Columns>
