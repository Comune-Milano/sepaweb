<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DatePagamenti.aspx.vb" Inherits="Contabilita_DatePagEffett" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Date Pagamenti</title>
    <style type="text/css">
        .style1
        {
            ...
            <tr>
                <td style="left: 0px;">
                    <div style="height: 32px">
                        ...
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><asp:Label ID="LblTitolo"
                            runat="server">Date Pagamenti Pervenuti</asp:Label>
                        </span>
                        <br />
                        <br />
                        <span style="color: #801f1c; font-family: Arial; text-align: center;" 
                            class="style8">
                        Inserire il range di date per l&#39;elaborazione dei Pagamenti </span>
        ...
        <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Esci_Grande.png"
            ToolTip="Chiude la finestra" style="vertical-align: bottom" TabIndex="4" />
                    ...
                    <asp:Label ID="LblSuggeriemnto" runat="server" Font-Bold="True" 
                        ...
                        Text="Se entrambe le date non sono avvalorate, il sistema ricercherà tutti i pagamenti pervenuti."></asp:Label>
                    <br />
                    <br />
                    <br />
                    <br />
