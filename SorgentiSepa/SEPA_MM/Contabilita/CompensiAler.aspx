<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CompensiAler.aspx.vb" Inherits="Contabilita_CompensiAler" %>
...
<body>
    ...
    <div style="width: 150%; overflow: auto;">
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                <asp:Label ID="TBL_COMPENSO_RIEPILOGO" runat="server" Font-Names="ARIAL" 
                                                    Font-Size="8pt" TabIndex="24" Width="100%"></asp:Label>
                                            </td>
            </tr>
            <tr>
                <td>
                <asp:Label ID="TBL_COMPENSO_BIMESTRALE" runat="server" Font-Names="ARIAL" 
                                                    Font-Size="8pt" TabIndex="24" Width="100%"></asp:Label>
                                            </td>
            </tr>
            <tr>
