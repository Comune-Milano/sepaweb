...
Partial Class Contratti_Report_StampaOneri
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                Dim totAlloggi As Double = 0
                Dim totMqAlloggi As Double = 0

                Dim totDiverse As Double = 0
                Dim totMqDiverse As Double = 0

                Dim totPostiCop As Double = 0
                Dim totMqPostiCop As Double = 0

                Dim totPostiScop As Double = 0
                Dim totMqPostiScop As Double = 0

                Dim totBox As Double = 0
                Dim totMqBox As Double = 0
                ...
                Me.Label6.Text = "ONERI A CARICO DELLA PROPRIETA' PER ALLOGGI E UNITA' DIVERSE SFITTE DAL " & par.IfEmpty(Request.QueryString("INIZIO"), "--") & " AL " & par.IfEmpty(Request.QueryString("FINE"), "--")
                'Immagine Caricamento In corso con progressBar
                ...
                Do While myReader.Read
                    ...
                    totPostiScop = totPostiScop + par.IfNull(myReader2("N"), 0)
                    totMqPostiScop = totMqPostiScop + par.IfNull(myReader2("MQ"), 0)
                ...
                & "<span style='font-size: 8pt; font-family: Arial'><strong>" _
                        ...
                        & "<tr>" _
                        & "<td style='height: 19px;text-align:right'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & totAlloggi & "</span></td>" _
                        & "<td style='height: 19px;text-align:right'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & Format(par.IfNull(totMqAlloggi, 0), "##,##0.00") & "</span></td></tr></table>" _
                & "</strong></span></td>" _
                & "<td style='height: 19px'>" _
                & "<span style='font-size: 8pt; font-family: Arial'><strong>" _
                        & "<table cellpadding='1' cellspacing='2' width='100%'>" _
                        ...
                        & "<span style='font-size: 8pt; font-family: Arial'>" & totDiverse & "</span></td>" _
                        & "<td style='height: 19px;text-align:right'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & Format(par.IfNull(totMqDiverse, 0), "##,##0.00") & "</span></td></tr></table>" _
                & "</strong></span></td>" _
                & "<td style='height: 19px'>" _
                & "<span style='font-size: 8pt; font-family: Arial'><strong>" _
                        & "<table cellpadding='1' cellspacing='2' width='100%'>" _
                        & "<tr>" _
                        & "<td style='height: 19px;text-align:right'width='60%'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & totBox & "</span></td>" _
                        & "<td style='height: 19px;text-align:right'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & Format(par.IfNull(totMqBox, 0), "##,##0.00") & "</span></td></tr></table>" _
                & "</strong></span></td>" _
                & "<td style='height: 19px'>" _
                & "<span style='font-size: 8pt; font-family: Arial'><strong>" _
                        & "<table cellpadding='1' cellspacing='2' width='100%'>" _
                        & "<tr>" _
                        & "<td style='height: 19px;text-align:right'width='60%'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & totPostiCop & "</span></td>" _
                        & "<td style='height: 19px;text-align:right'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & Format(par.IfNull(totMqPostiCop, 0), "##,##0.00") & "</span></td></tr></table>" _
                & "</strong></span></td>" _
                & "<td style='height: 19px'>" _
                & "<span style='font-size: 8pt; font-family: Arial'><strong>" _
                        & "<table cellpadding='1' cellspacing='2' width='100%'>" _
                        & "<tr>" _
                        & "<td style='height: 19px;text-align:right'width='60%'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & totPostiScop & "</span></td>" _
                        & "<td style='height: 19px;text-align:right'>" _
                        & "<span style='font-size: 8pt; font-family: Arial'>" & Format(par.IfNull(totMqPostiScop, 0), "##,##0.00") & "</span></td></tr></table>" _
                & "</strong></span></td>"
                ...
                Me.TBL_ESTRATTO_ONERI.Text = testoTabella & "</table>"
    ...
    Protected Sub ImgBtnExport_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtnExport.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Oneri.xls")
