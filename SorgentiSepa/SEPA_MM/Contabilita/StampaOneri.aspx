<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StampaOneri.aspx.vb" Inherits="Contratti_Report_StampaOneri" %>
...
<body>
    ...
    <div style="height: 396px">
        ...
        <asp:Label ID="lblErrore" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
            ...
            top: 514px" Visible="False" Width="525px"></asp:Label>
        &nbsp;&nbsp;
        <table width="100%">
            <tr>
                <td style="text-align: center">
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="14pt"
            Style="z-index: 100; left: 337px; top: 11px" Width="763px">ONERI A CARICO DELLA PROPRIETA&#39; PER ALLOGGI E UNITA&#39; DIVERSE SFITTE</asp:Label></td>
            </tr>
        </table>
        <asp:ImageButton ID="ImgBtnExport" runat="server" ImageUrl="~/Contabilita/IMMCONTABILITA/Img_Export_XLS.png" /><br />
        <br />
        <asp:Label ID="TBL_ESTRATTO_ONERI" runat="server" Font-Names="ARIAL" 
