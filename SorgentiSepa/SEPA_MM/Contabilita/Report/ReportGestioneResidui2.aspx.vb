...
Partial Class Contabilita_Report_ReportGestioneResidui2
    ...
    Protected Sub ImageButtonAvviaRicerca_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonAvviaRicerca.Click
        ...
        ScriptManager.RegisterClientScriptBlock(Me, Me.GetType(), "msg", "window.open('RisultatiGestioneResidui2.aspx" & parametriDaPassare & "','_blank','');", True)
    End Sub
