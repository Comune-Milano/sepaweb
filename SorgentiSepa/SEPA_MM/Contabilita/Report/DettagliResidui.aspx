<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DettagliResidui.aspx.vb"
    Inherits="Contabilita_Report_DettagliResidui" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Situazione Residui</title>
</head>
<body>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%">
                            <asp:ImageButton ID="ImageButtonStampa" runat="server" ImageUrl="../../NuoveImm/Img_Stampa.png"
                                ToolTip="Stampa in PDF" style="height: 12px" />
                        </td>
                        <td style="width: 70%">
                            &nbsp;
                        </td>
        ...
        <tr>
            <td style="width: 100%">
                <asp:DataGrid runat="server" ID="DataGridResidui" AutoGenerateColumns="False" CellPadding="0"
                    ...
                    <AlternatingItemStyle BackColor="#EEEEEE" ForeColor="#000000" Font-Bold="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="TIPOLOGIA_UI" HeaderText="TIPOLOGIA UI" ItemStyle-Width="8%"
                            HeaderStyle-Width="8%">
                    ...
                    <ItemStyle BackColor="#FFFFFF" ForeColor="#000000" Font-Bold="False" 
                        Font-Italic="False" Font-Overline="False" Font-Strikeout="False" 
                        Font-Underline="False" Wrap="False" />
