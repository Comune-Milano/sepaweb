<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NuovoCapitolo.aspx.vb" Inherits="Contabilita_Report_NuovoCapitolo" %>
    ...
    <div>
        ...
        <div style="height: 450px; vertical-align: top">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="width: 20%">
                        <asp:Label ID="Label2" Text="Descrizione capitolo*" runat="server" Font-Names="Arial"
                            Font-Size="10pt" />
                    </td>
                    <td style="width: 80%">
