<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReportSituazioneEmissioni2.aspx.vb" Inherits="Contabilita_Report_ReportSituazioneEmissioni2" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
            <table cellpadding="1" cellspacing="0" width="98%">
                ...
                <tr>
                    <td style="width: 100%">
                        <asp:Label ID="Label1" Text="Ricerca Situazione Emissioni" runat="server" Font-Bold="True"
                ...
                <tr>
                    <td style="width: 100%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="width: 22%">
                                    <asp:Label ID="Label7" runat="server" Text="Aggiornamento al" Font-Names="Arial"
                                ...
                                <td style="width: 5%">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="!"
                                        ControlToValidate="TextBoxAggiornamentoAl" Font-Bold="True" Font-Names="Arial"
                                        Font-Size="9pt" ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([/])(0[13578]|10|12)([/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([/])(0[469]|11)([/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([/])(02)([/])(\d{4}))|((29)(\.|-|\/)(02)([/])([02468][048]00))|((29)([/])(02)([/])([13579][26]00))|((29)([/])(02)([/])([0-9][0-9][0][48]))|((29)([/])(02)([/])([0-9][0-9][2468][048]))|((29)([/])(02)([/])([0-9][0-9][13579][26])))"></asp:RegularExpressionValidator>
                                </td>
                                <td style="width: 20%">
                                    <asp:Label ID="Label8" runat="server" Text="Accertato" Font-Names="Arial" Font-Size="9pt"></asp:Label>
                                </td>
                                <td style="width: 43%">
                                    <asp:DropDownList ID="DropDownListAccertato" runat="server" Font-Names="Arial" Font-Size="9pt"
                                        ...
                                        <asp:ListItem Value="1">Accertato</asp:ListItem>
                                                ...
                                                <td style="background-color: #507CD1; text-align: center; width: 100%">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 90%">
                                                                <asp:Label ID="Label13" runat="server" Text="Capitoli" Font-Names="Arial"
                                                                    Font-Size="9pt" ForeColor="White" Width="100%"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="height: 100px; overflow: auto">
                                                        <asp:CheckBoxList ID="CheckBoxListCapitoli" runat="server" Font-Names="Arial"
                                                            Font-Size="9pt">
                                                        </asp:CheckBoxList>
                                                    </div>
                                                </td>
