<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiReportSituazioneEmissioniAcc.aspx.vb"
    Inherits="Contabilita_Report_RisultatiReportSituazioneEmissioniAcc" %>
            ...
            <td style="width: 100%">
                <asp:DataGrid runat="server" ID="DataGridEmissioni" AutoGenerateColumns="False" CellPadding="0"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="ACCERTATO" HeaderText="ACCERTATO" ItemStyle-Width="6%"
                            HeaderStyle-Width="6%">
                            <HeaderStyle Width="6%"></HeaderStyle>
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
