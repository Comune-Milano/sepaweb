...
Partial Class Contabilita_Report_RisultatiReportSituazioneIncassiCapDett
    ...
    Private Sub caricaDati()
        ...
        If numeroAssegno <> "" Then
            condizioneNumeroAssegno = " AND ID_VOCE_BOLLETTA IN (SELECT ID_VOCE_BOLLETTA FROM SISCOM_MI.EVENTI_PAGAMENTI_PARZ_DETT WHERE ID_EVENTO_PRINCIPALE IN (SELECT ID FROM SISCOM_MI.EVENTI_PAGAMENTI_PARZIALI WHERE ID_INCASSO_EXTRAMAV IN " _
                                    & " (SELECT ID FROM SISCOM_MI.INCASSI_EXTRAMAV WHERE NUMERO_ASSEGNO='" & numeroAssegno & "'"
        ...
        ElseIf Not String.IsNullOrEmpty(DataAssDal) Or Not String.IsNullOrEmpty(DataAssAl) Then
            ...
            condizioneNumeroAssegno = " AND ID_VOCE_BOLLETTA IN (SELECT ID_VOCE_BOLLETTA FROM SISCOM_MI.EVENTI_PAGAMENTI_PARZ_DETT WHERE ID_EVENTO_PRINCIPALE IN (SELECT ID FROM SISCOM_MI.EVENTI_PAGAMENTI_PARZIALI WHERE ID_INCASSO_EXTRAMAV IN " _
                        & " (SELECT ID FROM SISCOM_MI.INCASSI_EXTRAMAV WHERE "
