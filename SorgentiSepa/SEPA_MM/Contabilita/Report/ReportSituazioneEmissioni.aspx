<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReportSituazioneEmissioni.aspx.vb"
    Inherits="Contabilita_Report_ReportSituazioneEmissioni" %>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right" width="15%">
                                    <asp:ImageButton ID="ImageButtonAvviaDettaglio" runat="server" AlternateText="Avvia Ricerca Dettaglio"
                                        ImageUrl="../../NuoveImm/Img_Dettaglio.png" ToolTip="Avvia Ricerc Dettaglioa" 
                                        style="height: 20px" />
                                </td>
                                <td style="text-align: right" width="10%">
