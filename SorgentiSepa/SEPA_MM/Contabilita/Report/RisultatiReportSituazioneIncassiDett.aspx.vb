...
Partial Class Contabilita_Report_RisultatiReportSituazioneIncassiDett
    ...
    Private Sub caricaDati(Optional Export As Boolean = False)
        ...
        Try
            ...
            If Export = False Then
                hfCaricaDati.Value = par.cmd.CommandText
                ...
                If dTable.Rows.Count > 0 Then
                    ...
                    DataGridIncassi.DataSource = dTable
                    DataGridIncassi.DataBind()
                    exportExtra.Visible = False
                    exportnonAttrib.Visible = False
            ...
            Else
                ...
                ''nomefile1 = par.EsportaExcelDaDT(dTable, "ExportIncassi", False, False)
                'nomefile1 = xls.EsportaExcelDaDT(ExcelSiSol.Estensione.Office2007_xlsx, "ExportIncassi", "ExportIncassi", dTable, True, )

                ''nomefile1 = xls.EsportaExcelDaDT(ExcelSiSol.Estensione.Office2007_xlsx, "ExportIncassi", "ExportIncassi", dTable, True, , )
                'If File.Exists(Server.MapPath("~\FileTemp\") & nomefile1) Then
                '    Response.Redirect("../../FileTemp/" & nomefile1, False)
                'Else
                '    Response.Write("<script>alert('Si è verificato un errore durante l\'esportazione. Riprovare!')</script>")
                'End If
                par.cmd.CommandText = hfCaricaDati.Value

                Session.Add("query", hfCaricaDati.Value)
                Response.Write("<script>window.showModalDialog('RptXLS.aspx?NOMEFILE=ExportIncassi','DettGest', 'status:no;dialogWidth:400px;dialogHeight:400px;dialogHide:true;help:no;scroll:no');</script>")
            End If
    ...
    '        nomefile2 = xls.EsportaExcelDaDataGrid(ExcelSiSol.Estensione.Office2007_xlsx, "ExportIncassiNonAttribuibili", "ExportIncassiNonAttribuibili", DataGridIncassiNonAttribuibili, True, , )
    ...
    '        nomefile3 = xls.EsportaExcelDaDataGrid(ExcelSiSol.Estensione.Office2007_xlsx, "ExportIncassiExtraMAV", "ExportIncassiExtraMAV", DataGridIncassiExtraMAV, True, , )
