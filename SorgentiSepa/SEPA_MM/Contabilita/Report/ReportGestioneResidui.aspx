<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReportGestioneResidui.aspx.vb"
    Inherits="Contabilita_Report_ReportGestioneResidui" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                    ...
                    <td style="width: 100%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="width: 18%">
                                    <asp:Label ID="Label7" runat="server" Font-Names="Arial" Font-Size="9pt" Text="Data pagamento dal"></asp:Label>
                                </td>
                                <td style="width: 10%">
                                ...
                                <td style="width: 2%">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxDataPagamentoDal"
                                ...
                                <td style="width: 5%; text-align: center;">
                                    <asp:Label ID="Label13" runat="server" Font-Names="Arial" Font-Size="9pt" Text="al"></asp:Label>
                                </td>
                                <td style="width: 10%">
                                ...
                                <td style="width: 3%; text-align: center;">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBoxDataPagamentoAl"
                                        ErrorMessage="!" Font-Bold="True" Font-Names="Arial" Font-Size="9pt" ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([/])(0[13578]|10|12)([/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([/])(0[469]|11)([/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([/])(02)([/])(\d{4}))|((29)(\.|-|\/)(02)([/])([02468][048]00))|((29)([/])(02)([/])([13579][26]00))|((29)([/])(02)([/])([0-9][0-9][0][48]))|((29)([/])(02)([/])([0-9][0-9][2468][048]))|((29)([/])(02)([/])([0-9][0-9][13579][26])))"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td style="width: 100%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="width: 5%; text-align: center;">
                                    <asp:Label ID="Label55" runat="server" Text="al" Font-Names="Arial" Font-Size="9pt"
                                    ...
                                    <asp:Panel ID="Panel7" runat="server" Style="border: 1px solid #507CD1" Width="100%">
                                        <table id="table5" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <div>
                                                        <asp:Panel ID="PanelCompetenza" runat="server" Style="height: 112px; overflow: auto"
                                    ...
                                    <asp:Panel ID="Panel4" runat="server" Style="border: 1px solid #507CD1" Width="100%">
                                        <table id="table3" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <div>
                                                        <asp:Panel ID="PanelMacrocategorie" runat="server" Style="height: 112px; overflow: auto"
                                    ...
                                    <asp:Panel ID="Panel5" runat="server" Style="border: 1px solid #507CD1" Width="100%">
                                        <table id="table2" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <div>
                                                        <asp:Panel ID="PanelCategorie" runat="server" Style="height: 112px; overflow: auto"
        ...
        <asp:View ID="View2" runat="server">
            <table cellpadding="1" cellspacing="0" width="98%">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label21" Text="Ordinamento " runat="server" Font-Names="Arial" Font-Size="9pt" />
