<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiReportSituazioneEmissioniCapAcc.aspx.vb" Inherits="Contabilita_Report_RisultatiReportSituazioneEmissioniCapAcc" %>
            ...
            <td style="width: 100%">
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 70%">
                            &nbsp;
                            <asp:ImageButton ID="ImageButtonRimuoviAccertamento" runat="server" ImageUrl="../IMMCONTABILITA/imgAnnullAccert.png"
                                ToolTip="Rimuovi accertamento" Style="height: 12px" />
                        </td>
