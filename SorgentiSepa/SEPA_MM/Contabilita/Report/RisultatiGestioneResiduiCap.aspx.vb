...
Partial Class Contabilita_Report_RisultatiGestioneResiduiCap
    ...
    Private Sub avviaProcedura()
        ...
        Dim DataAssegno As String = ""
        If Not IsNothing(Request.QueryString("DataAssegn")) Then
            DataAssegno = Request.QueryString("DataAssegn")
        End If
        ...
        If numeroAssegno <> "" Then
            ...
            If DataAssegno <> "" Then
                condizioneNumeroAssegno += " AND DATA_ASSEGNO = '" & DataAssegno & "'))) "
            Else
                condizioneNumeroAssegno += " ))) "
            End If

        ElseIf DataAssegno <> "" Then

            condizioneNumeroAssegno = " AND ID_VOCE_BOLLETTA IN (SELECT ID_VOCE_BOLLETTA FROM SISCOM_MI.EVENTI_PAGAMENTI_PARZ_DETT WHERE ID_EVENTO_PRINCIPALE IN (SELECT ID FROM SISCOM_MI.EVENTI_PAGAMENTI_PARZIALI WHERE ID_INCASSO_EXTRAMAV IN " _
                        & " (SELECT ID FROM SISCOM_MI.INCASSI_EXTRAMAV WHERE DATA_ASSEGNO ='" & DataAssegno & "'))) "
