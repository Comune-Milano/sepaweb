...
Partial Class Contabilita_Report_ReportSituazioneEmissioniAcc
    ...
    Private Sub ImpostaJavaScriptFunction()
        ...
        TextBoxAccertamento.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
    End Sub
    Protected Sub ImageButtonAvviaRicerca_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonAvviaRicerca.Click
        ...
        parametriDaPassare &= "&Accertamento=" & par.FormatoDataDB(TextBoxAccertamento.Text)
        ...
        If TextBoxAccertamento.Text <> "" Then
            parametriRicercaAggiornamento = "Accertamento il " & TextBoxAccertamento.Text
        End If
        ...
        If Ordinamento.SelectedValue = 1 Then
            ScriptManager.RegisterClientScriptBlock(Me, Me.GetType(), "msg", "window.open('RisultatiReportSituazioneEmissioniAcc.aspx" & parametriDaPassare & "','_blank','');", True)
        Else
            ScriptManager.RegisterClientScriptBlock(Me, Me.GetType(), "msg", "window.open('RisultatiReportSituazioneEmissioniCapACC.aspx" & parametriDaPassare & "','_blank','');", True)
        End If
    End Sub
    ...
    Protected Sub ImageButtonAvanti_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonAvanti.Click
        If Len(Trim(TextBoxAccertamento.Text)) = 10 AndAlso IsDate(TextBoxAccertamento.Text) Then
            MultiView1.ActiveViewIndex = 1
        Else
            Dim Script As String = "alert('La data di accertamento è obbligatoria');"
            ScriptManager.RegisterStartupScript(Page, GetType(Page), Page.ClientID, Script, True)
        End If
    End Sub
