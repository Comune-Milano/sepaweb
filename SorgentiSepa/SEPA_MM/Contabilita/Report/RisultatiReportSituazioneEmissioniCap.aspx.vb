...
Partial Class Contabilita_Report_RisultatiReportSituazioneEmissioniCap
    ...
    Protected Sub ImageButtonStampaEAccerta_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonStampaAccerta.Click
        ...
        Try
            ...
            'par.cmd.ExecuteNonQuery()
            par.cmd.CommandText = "UPDATE (" & queryBolBolletteVoci & ") A SET A.FL_ACCERTATO_BOL_BOLLETTE_VOCI=1,A.ACCERTATO='Sì',A.DATA_ACCERTAMENTO='" & Format(Now, "yyyyMMdd") & "',a.data_rimozione_accertamento=null "
            par.cmd.ExecuteNonQuery()
