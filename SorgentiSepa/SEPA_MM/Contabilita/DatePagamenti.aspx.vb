...
Partial Class Contabilita_DatePagEffett
    ...
    Protected Sub btnVisualizza_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnVisualizza.Click
        ...
        Response.Write("<script>window.open('PagamentiPervenuti.aspx?DAL=" & par.AggiustaData(Me.TxtDal.Text) & "&AL=" & par.AggiustaData(Me.TxtAl.Text) & "&IDANA=" & Request.QueryString("IDANA") & "&IDCONT=" & Request.QueryString("IDCONT") & "&NONPERV=" & Request.QueryString("NONPERV") & "','Pagamenti', '');</script>")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Request.QueryString("NONPERV") = 1 Then
                LblTitolo.Text = "Date Pagamenti NON Pervenuti"
            End If
        End If
