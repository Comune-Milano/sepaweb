...
Partial Class Dic_Patrimonio
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Not Session.Item("GLista") Is Nothing Then
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Button1.Attributes.Add("OnClick", "javascript:AggiungiPatrimonio();")
            btnModifica.Attributes.Add("OnClick", "javascript:ModificaPatrimonio();")
            btnAggiungi.Attributes.Add("OnClick", "javascript:AggiungiPatrimonioI();")
            btnMod.Attributes.Add("OnClick", "javascript:ModificaPatrimonioI();")
            'V1.Text = ListBox2.Items(0).Text
        End If
        ListBox2.Attributes.Add("OnClick", "javascript:obj2=document.getElementById('Dic_Patrimonio1_ListBox2');if (obj2.selectedIndex!=-1) {document.getElementById('Dic_Patrimonio1_V1').value=obj2.options[obj2.selectedIndex].text;}")
    ...
    Protected Sub btnAggiungi_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAggiungi.Click
        If Not Cache(Session.Item("GLista")) Is Nothing Then
            ...
            If par.RicavaTesto(Cache.Get(Session.Item("GLista")).ToString(), 79, 2) = "SI" Then
                cmbTipoImm.Enabled = True
                'cmbUI.Enabled = True
                'chUbicazione.Enabled = True
            Else
                cmbTipoImm.Enabled = False
                'cmbUI.Enabled = False
                'chUbicazione.Enabled = False
            End If

            If par.RicavaTesto(Cache.Get(Session.Item("GLista")).ToString(), 27, 11) = "FABBRICATI" Then
                cmbUI.Enabled = True
                chUbicazione.Enabled = True
            Else
                'cmbUI.Enabled = False
