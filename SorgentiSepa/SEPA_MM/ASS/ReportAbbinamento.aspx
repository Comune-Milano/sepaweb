<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReportAbbinamento.aspx.vb" Inherits="ASS_ReportAbbinamento" %>
                ...
                <td style="text-align: left" width="100%">
                    <strong><span>
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="arial" Font-Size="10pt"
                            Style="z-index: 100; left: 0px; position: static; top: 0px; text-align: center;" Width="98%"></asp:Label></span></strong></td>
            </tr>
            <tr>
                <td style="text-align: left" width="100%">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="arial" Font-Size="12pt"
                        Style="z-index: 100; left: 0px; position: static; top: 0px; text-align: center"
