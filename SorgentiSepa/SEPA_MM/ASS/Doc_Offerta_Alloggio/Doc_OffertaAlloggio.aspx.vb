...
Partial Class ASS_Doc_Offerta_Alloggio_Doc_OffertaAlloggio
    ...
    Private Sub caricaDati()
        ...
        Try
            ...
            Dim sr1 As StreamReader = New StreamReader(Server.MapPath("Doc_OffertaAlloggio.htm"), System.Text.Encoding.GetEncoding("iso-8859-1"))
            ...
            Dim PercorsoBarCode As String = par.RicavaBarCode(33, idDomanda.Value)
            ...
            Dim nomefile As String = "A6_" & idDomanda.Value & "-" & Format(Now, "yyyyMMddHHmmss") & ".pdf"
