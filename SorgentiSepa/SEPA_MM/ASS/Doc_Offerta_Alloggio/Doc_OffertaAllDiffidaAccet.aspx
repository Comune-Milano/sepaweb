<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Doc_OffertaAllDiffidaAccet.aspx.vb" Inherits="ASS_Doc_Offerta_Alloggio_Doc_OffertaAllDiffidaAccet" %>
   ...
   <div id="caric" style="margin: 0px; background-color: #C0C0C0; width: 100%; height: 100%; position: fixed;
    ...
    <div>
     <asp:HiddenField ID="tipo" runat="server" />
        ...
        <asp:HiddenField ID="txt_proprieta" runat="server" Value="0" />
    </div>
