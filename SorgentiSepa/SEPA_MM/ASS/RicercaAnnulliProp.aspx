<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaAnnulliProp.aspx.vb" Inherits="ASS_RicercaAnnulliProp" %>
...
//document.onkeydown=$onkeydown;
    ...
    <div>
        ...
        Style="z-index: 101; left: 404px; position: absolute; top: 252px; right: 567px; height: 20px;" 
            ...
            <tr>
                <td>
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Ricerca
                        Offerta per Annullo Proposta</strong></span><br />
                    <br />
                    <br />
                    <br />
                    <br />
