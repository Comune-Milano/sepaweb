<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoRicOfferta.aspx.vb" Inherits="ASS_RisultatoRicOfferta" %>
    ...
    <div>
        <div>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Label ID="Label8" runat="server" 
                            ...
                            style="position:absolute; top: 311px; left: 6px;" Font-Bold="True" 
                            Font-Names="ARIAL" Font-Size="9pt"></asp:Label>
                        <asp:Label ID="Label7" runat="server" Text="BANDO CAMBI" 
                            style="position:absolute; top: 188px; left: 6px;" Font-Bold="True" 
                            Font-Names="ARIAL" Font-Size="9pt"></asp:Label>
                        <asp:Label ID="Label6" runat="server" Text="BANDO ERP" 
                            style="position:absolute; top: 53px; left: 6px;" Font-Bold="True" 
                            Font-Names="ARIAL" Font-Size="9pt"></asp:Label>
                        <br />
                        <br />
                        <br />
            ...
            <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                ...
                Font-Names="Arial" 
                style="z-index: 107; left: 5px; position: absolute; top: 446px; text-align: left; width: 662px;" 
                ...
                style="z-index: 108; left: 3px; position: absolute; top: 328px" 
                ...
                PageSize="4">
                        ...
                        <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            Font-Names="Arial" Font-Size="8pt" Width="666px" 
                style="z-index: 108; left: 3px; position: absolute; top: 205px" 
                BackColor="White" Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                Font-Strikeout="False" Font-Underline="False" GridLines="None" 
                PageSize="4">
                            <PagerStyle Mode="NumericPages" />
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            Font-Names="Arial" Font-Size="8pt" Width="666px" 
                style="z-index: 108; left: 3px; position: absolute; top: 71px" 
                BackColor="White" Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                Font-Strikeout="False" Font-Underline="False" GridLines="None" 
                PageSize="5">
                            <PagerStyle Mode="NumericPages" />
        ...
        <script  language="javascript" type="text/javascript">
            ...
            function Open() {
                ...
                var child = window.open("ProcessoDecisionale.aspx?TIPO=" + document.getElementById('HiddenField1').value + "&ID=" + document.getElementById('LBLID').value + "&OF=" + document.getElementById('LBLPROGR').value + "&SC=" + document.getElementById('lblScad').value + "");
                child.focus();
                return false;
            }
    </script>
