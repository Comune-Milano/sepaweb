...
Partial Class ASS_GestionePreferenze
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If Request.QueryString("PROV") = "0" Then
                    FrmSolaLettura(Me)
                    btnSalva1.Visible = False
                    btnSalva2.Visible = False
                    btnSalva3.Visible = False
                End If
    ...
    Protected Sub btnSalva1_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnSalva1.Click
        SalvaDati()
    End Sub

    Protected Sub btnSalva2_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnSalva2.Click
        SalvaDati()
    End Sub

    Protected Sub btnSalva3_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnSalva3.Click
        SalvaDati()
    End Sub
End Class
