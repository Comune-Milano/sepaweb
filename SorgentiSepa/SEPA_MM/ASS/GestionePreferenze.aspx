                        ...
                        <table style="width: 100%;" cellpadding="0" cellspacing="0">
                            <tr valign="bottom">
                                ...
                                <td style="width: 40%;text-align:center;">
                                    <asp:ImageButton ID="btnSalva1" runat="server" ImageUrl="~/NuoveImm/Img_SalvaGrande.png"
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr valign="bottom">
                                ...
                                <td style="width: 50%;">
                                    <asp:ImageButton ID="btnSalva2" runat="server" ImageUrl="~/NuoveImm/Img_SalvaGrande.png"
                                        ToolTip="Salva" TabIndex="18" OnClientClick="document.getElementById('H1').value = 0;" />
                                </td>
                                <td>
                    ...
                    <td>
                        <table style="width: 100%;" cellpadding="0" cellspacing="0">
                            <tr valign="bottom">
                                ...
                                <td style="width: 50%;">
                                    <asp:ImageButton ID="btnSalva3" runat="server" ImageUrl="~/NuoveImm/Img_SalvaGrande.png"
                                        ToolTip="Salva" TabIndex="18" OnClientClick="document.getElementById('H1').value = 0;" />
                                </td>
                                <td>
