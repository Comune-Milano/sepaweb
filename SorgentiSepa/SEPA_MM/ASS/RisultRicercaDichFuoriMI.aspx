<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultRicercaDichFuoriMI.aspx.vb"
    Inherits="ASS_RisultRicercaDichFuoriMI" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Risultati Dichiarazioni Fuori Milano</title>
</head>
            ...
            <td>
                <table style="width: 100%">
                    <tr>
                        ...
                        <td>
                            <asp:ImageButton ID="btnProcedi" runat="server" ImageUrl="~/NuoveImm/Img_Visualizza.png"
                                OnClientClick="caricamentoincorso();" ToolTip="Visualizza" />
                        </td>
                         <td>
                            <asp:ImageButton ID="btnExcel" runat="server" ImageUrl="~/NuoveImm/Img_Export_XLS.png"
                                OnClientClick="caricamentoincorso();" ToolTip="Esporta in Excel" />
                        </td>
                        <td>
                            <asp:ImageButton ID="btnNewRicerca" runat="server" ImageUrl="~/NuoveImm/Img_NuovaRicerca.png"
                                OnClientClick="caricamentoincorso();location.href='RicercaDichFuoriMI.aspx';return false;"
