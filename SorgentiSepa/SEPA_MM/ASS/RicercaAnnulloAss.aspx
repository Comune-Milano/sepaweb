<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaAnnulloAss.aspx.vb" Inherits="ASS_RicercaAnnulloAss" %>
...
<head id="Head1" runat="server">
    <title>Annullo Assegnazioni</title>
</head>
<script type="text/javascript">
function Attendi() {
    var win=null;
...
//document.onkeydown=$onkeydown;
    ...
    <div>
        ...
        <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
            Style="z-index: 101; left: 400px; position: absolute; top: 247px; height: 20px;" 
            ...
            <tr>
                <td>
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Ricerca
                        Assegnazioni per Annullo</strong></span><br />
                    <br />
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                                ...
                                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Small"
                                    Style="z-index: 102; left: 106px; position: absolute; top: 93px" Width="50px">N. Offerta</asp:Label>
