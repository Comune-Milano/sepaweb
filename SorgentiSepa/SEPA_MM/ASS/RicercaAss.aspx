<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaAss.aspx.vb" Inherits="ASS_RicercaOfferta" %>
...
//document.onkeydown=$onkeydown;
    ...
    <div>
        ...
        Style="z-index: 101; left: 404px; position: absolute; top: 252px; right: 544px;" 
            ...
            <tr>
                <td>
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Ricerca
                        per Provv. di Assegnazione</strong></span><br />
                    <br />
                    <br />
                    <br />
                    <br />
        ...
        style="z-index: 102; left: 111px; position: absolute; top: 142px">Cognome/Rag.Sociale</asp:Label>
                                ...
                                <asp:TextBox ID="txtCoRs" runat="server" 
        TabIndex="2" 
        style="z-index: 103; left: 227px; position: absolute; top: 138px; width: 326px;" 
        BorderStyle="Solid" BorderWidth="1px" Wrap="False"></asp:TextBox>
                                <asp:TextBox ID="txtOfferta" runat="server" 
        TabIndex="1" style="z-index: 103; left: 227px; position: absolute; top: 106px" 
        BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
        <asp:Label ID="Label1" runat="server" Font-Names="ARIAL" Font-Size="10pt" ForeColor="#C00000"
            Height="23px" Style="left: 165px; position: absolute; top: 186px" Visible="False"
