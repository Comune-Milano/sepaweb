<%@ Page Title="" Language="VB" MasterPageFile="~/SPESE_REVERSIBILI/HomePage.master" AutoEventWireup="false" CodeFile="ImportTotale.aspx.vb" Inherits="SPESE_REVERSIBILI_ImportTotale" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2">
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            <asp:Label ID="LabelJolly" runat="server" class="TitoloH1"><i>L'operazione di importazione cancella preventivamente le precedenti spese importate nel prospetto</i></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
