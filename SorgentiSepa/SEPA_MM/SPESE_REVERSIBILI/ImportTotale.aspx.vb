...
Partial Class SPESE_REVERSIBILI_ImportTotale
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If controlloProfilo() Then
            CType(Master.FindControl("TitoloMaster"), Label).Text = "Consuntivi e Conguagli - Gestione - Import totale"
    ...
    Private Sub btnImporta_Click(sender As Object, e As EventArgs) Handles btnImporta.Click
        Try
            ...
            End If
            par.cmd.CommandText = "SISCOM_MI.CONGUAGLIO"
            ...
            RadWindowManager1.RadAlert("Operazione effettuata!", 300, 150, "Attenzione", "function f(sender,args){loading(0);location.href='ProspettoConsuntivi.aspx?';}", "null")
