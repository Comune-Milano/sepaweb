...
Partial Class SPESE_REVERSIBILI_ImportNoleggio
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If controlloProfilo() Then
            CType(Master.FindControl("TitoloMaster"), Label).Text = "Consuntivi e Conguagli - Gestione - Noleggio"
    ...
    Private Sub btnImporta_Click(sender As Object, e As EventArgs) Handles btnImporta.Click
        Try
            ...
            End If
            par.cmd.CommandText = "SISCOM_MI.CONSUNTIVO_NOLEGGIO"
            ...
            RadWindowManager1.RadAlert("Operazione effettuata: importati " & risOp & " noleggio cassonetti.", 300, 150, "Attenzione", "function f(sender,args){location.href='ProspettoConsuntivi.aspx?';}", "null")
            'RadNotificationNote.Text = "Operazione effettuata: importate " & ris & " noleggio cassonetti"
