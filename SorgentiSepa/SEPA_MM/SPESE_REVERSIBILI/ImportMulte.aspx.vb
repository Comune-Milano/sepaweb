...
Partial Class SPESE_REVERSIBILI_ImportMulte
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If controlloProfilo() Then
            CType(Master.FindControl("TitoloMaster"), Label).Text = "Consuntivi e Conguagli - Gestione - Multe"
    ...
    Private Sub btnImporta_Click(sender As Object, e As EventArgs) Handles btnImporta.Click
        Try
            ...
            End If
            par.cmd.CommandText = "SISCOM_MI.CONSUNTIVO_MULTE"
            ...
            RadWindowManager1.RadAlert("Operazione effettuata: importate " & risOp & " multe.", 300, 150, "Attenzione", "function f(sender,args){location.href='ProspettoConsuntivi.aspx?';}", "null")
            'RadNotificationNote.Text = "Operazione effettuata: importate " & ris & " multe!"
