<%@ Page Title="" Language="VB" MasterPageFile="~/SPESE_REVERSIBILI/HomePage.master"
    AutoEventWireup="false" CodeFile="ImportODL.aspx.vb" Inherits="SPESE_REVERSIBILI_ImportODL" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2">
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            <asp:Label ID="LabelJolly" runat="server" class="TitoloH1"><i>L'operazione di importazione cancella preventivamente le precedenti manutenzioni importate nel prospetto</i></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <asp:Button ID="btnImportaDaODL" runat="server" Text="Importa" ToolTip="Importa ODL"
        />
