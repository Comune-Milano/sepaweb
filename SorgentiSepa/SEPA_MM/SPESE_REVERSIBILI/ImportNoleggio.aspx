<%@ Page Title="" Language="VB" MasterPageFile="~/SPESE_REVERSIBILI/HomePage.master"
    AutoEventWireup="false" CodeFile="ImportNoleggio.aspx.vb" Inherits="SPESE_REVERSIBILI_ImportNoleggio" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2">
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            <asp:Label ID="LabelJolly" runat="server" class="TitoloH1"><i>L'operazione di importazione cancella preventivamente le precedenti spese di noleggio importate nel prospetto</i></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
