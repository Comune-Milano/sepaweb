...
Partial Class SPESE_REVERSIBILI_ImportFattureIdriche
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If controlloProfilo() Then
            CType(Master.FindControl("TitoloMaster"), Label).Text = "Consuntivi e Conguagli - Gestione - Fatture idriche"
    ...
    Private Sub btnImporta_Click(sender As Object, e As EventArgs) Handles btnImporta.Click
        Try
            ...
            End If
            par.cmd.CommandText = "SISCOM_MI.CONSUNTIVO_IDRICO"
            ...
            RadWindowManager1.RadAlert("Operazione effettuata: importate " & risOp & " fatture idriche.", 300, 150, "Attenzione", "function f(sender,args){location.href='ProspettoConsuntivi.aspx?';}", "null")
            'RadNotificationNote.Text = "Operazione effettuata: importate " & ris & " fatture idriche"
