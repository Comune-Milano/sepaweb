...
Partial Class SPESE_REVERSIBILI_ImportODL
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If controlloProfilo() Then
            CType(Master.FindControl("TitoloMaster"), Label).Text = "Consuntivi e Conguagli - Gestione - Manutenzioni"
    ...
    Private Sub solaLettura()
        btnImportaDaODL.Enabled = False
    End Sub
    Private Sub btnImportaDaODL_Click(sender As Object, e As EventArgs) Handles btnImportaDaODL.Click
        Try
            connData.apri(True)
            ...
            End If
            par.cmd.CommandText = "SISCOM_MI.CONSUNTIVO_ODL"
            ...
            RadWindowManager1.RadAlert("Operazione effettuata: importati " & risOp & " ODL.", 300, 150, "Attenzione", "function f(sender,args){location.href='ProspettoConsuntivi.aspx?';}", "null")
            'RadNotificationNote.Text = "Operazione effettuata: importate " & RIS & " manutenzioni"
            'RadNotificationNote.Show()
        Catch ex As Exception
            If par.OracleConn.State = Data.ConnectionState.Open Then
                connData.chiudi(False)
            End If
            Session.Add("ERRORE", "Provenienza: " & Me.Page.Title & " - btnImportaDaODL_Click - " & ex.Message)
    ...
    '    controlloDate = True
    '    Try
    '        Dim dataInizio As String = txtInizio.SelectedDate.ToString
    '        Dim dataFine As String = txtFine.SelectedDate.ToString
    '        If dataInizio = "" And dataFine = "" Then
    '            controlloDate = False
    '        End If
    '    Catch ex As Exception
    '        If par.OracleConn.State = Data.ConnectionState.Open Then
    '            connData.chiudi(False)
    '        End If
    '        Session.Add("ERRORE", "Provenienza: " & Me.Page.Title & " - controlloDate - " & ex.Message)
    '        Response.Redirect("../Errore.aspx", False)
    '    End Try
    'End Function
End Class
