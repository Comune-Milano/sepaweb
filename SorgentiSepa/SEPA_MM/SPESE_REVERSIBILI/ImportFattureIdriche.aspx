<%@ Page Title="" Language="VB" MasterPageFile="~/SPESE_REVERSIBILI/HomePage.master" AutoEventWireup="false" CodeFile="ImportFattureIdriche.aspx.vb" Inherits="SPESE_REVERSIBILI_ImportFattureIdriche" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2">
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            <asp:Label ID="LabelJolly" runat="server" class="TitoloH1"><i>L'operazione di importazione cancella preventivamente le precedenti fatture idriche importate nel prospetto</i></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 10%">
                                        <telerik:RadDatePicker ID="txtDataInizio" runat="server" WrapperTableCaption="" MaxDate="01/01/9999" ClientIDMode="Static"
                                    ...
                                    <td style="width: 6%">Data Fine</td>
                                    <td>
                                        <telerik:RadDatePicker ID="txtDataFine" runat="server" WrapperTableCaption="" MaxDate="01/01/9999" ClientIDMode="Static"
                                            DatePopupButton-Visible="true" DataFormatString="{0:dd/MM/yyyy}" Width="110">
