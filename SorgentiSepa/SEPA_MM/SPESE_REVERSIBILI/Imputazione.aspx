<%@ Page Title="" Language="VB" MasterPageFile="~/SPESE_REVERSIBILI/HomePage.master"
    AutoEventWireup="false" CodeFile="Imputazione.aspx.vb" Inherits="SPESE_REVERSIBILI_Imputazione" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="decorationZone">
        <telerik:RadTabStrip runat="server" ID="RadTabStrip" Orientation="HorizontalTop" OnClientTabSelecting="setIndicePulsanti"
            ...
            <Tabs>
                <telerik:RadTab runat="server" PageViewID="RadPageView2" Text="Edifici" Value="Edifici" Selected="true">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" CssClass="multiPage" Width="100%"
            ...
            ScrollChildren="true">
            <telerik:RadPageView runat="server" ID="RadPageView2" CssClass="panelTabsStrip" Selected="true">
                <div>
                    <table>
                        <tr>
                    ...
                    <telerik:RadGrid ID="dgvComplessi" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic"
                        ...
                        <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="NUM_UNITA" HeaderText="N° UNITA" AutoPostBackOnFilter="true" ItemStyle-HorizontalAlign="Right"
                    ...
                    <telerik:RadGrid ID="dgvEdifici" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic"
                        ...
                        <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="N_PIANI" HeaderText="N° PIANI" AutoPostBackOnFilter="true"
                                    FilterControlWidth="84%" CurrentFilterFunction="Contains" ItemStyle-HorizontalAlign="Right">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="SCALA" HeaderText="SCALA" AutoPostBackOnFilter="true"
                                    FilterControlWidth="84%" CurrentFilterFunction="Contains" DataFormatString="{0:@}">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataField="PULIZIA_SCALE" HeaderText="PULIZIA SCALE" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    ...
                                    <FilterTemplate>
                                        <table style="text-align: center">
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="headerChkScale" runat="server" AutoPostBack="true" OnCheckedChanged="headerChkScale_CheckedChanged" onClick="caricamento(2);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </FilterTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn DataField="ROTAZIONE_SACCHI" HeaderText="ROTAZIONE SACCHI" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    ...
                                    <FilterTemplate>
                                        <table style="text-align: center">
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="headerChkRotSacchi" runat="server" AutoPostBack="true" OnCheckedChanged="headerChkRotSacchi_CheckedChanged" onClick="caricamento(2);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </FilterTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn DataField="RESA_SACCHI" HeaderText="RESA SACCHI" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    ...
                                    <FilterTemplate>
                                        <table style="text-align: center">
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="headerChkResaSacchi" runat="server" AutoPostBack="true" OnCheckedChanged="headerChkResaSacchi_CheckedChanged" onClick="caricamento(2);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </FilterTemplate>
                    ...
                    <telerik:RadGrid ID="dgvTotale05" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic"
                        ...
                        <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="TOT_ANNUO_SCONTATO" HeaderText="TOTALE SCONTATO" AutoPostBackOnFilter="true" Aggregate="Sum" ItemStyle-HorizontalAlign="Right"
                                    FilterControlWidth="84%" CurrentFilterFunction="Contains" DataFormatString="{0:C2}">
                                </telerik:GridBoundColumn>
                            </Columns>
                            <HeaderStyle HorizontalAlign="Center" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div id="divEdifici" runat="server" clientidmode="Static" style="display: none; float: left;">
        <asp:Button ID="btnSalvaComplessi" runat="server" Text="Salva" ToolTip="Salva" />
        &nbsp;
    </div>
    <div id="divScale" runat="server" clientidmode="Static" style="display: none; float: left;">
        <asp:Button ID="btnSalvaEdifici" runat="server" Text="Salva" ToolTip="Salva" />
        &nbsp;
    </div>

    <div style="float: left;">
        <asp:Button ID="ButtonAggiorna" runat="server" Text="Aggiorna canoni" ToolTip="Aggiorna i canoni delle voci dell' appalto" OnClientClick="chiudi('btnAggiorna');return false;" />
