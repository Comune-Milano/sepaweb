...
var Messaggio = {
    ...
    NoGo: "Chiudere la pagina in cui si sta lavorando prima di Procedere!"
};
    ...
    if (document.getElementById('optMenu').value == 0) {
        switch (valore) {
            ...
            case 'CDP_Tracciati':
                ...
                break;
            case 'Gest_Crediti':
                if (document.getElementById('HFParamCP').value == 0) { alert('Non disponibile o Utente non abilitato!'); } else { Apri('CicloPassivo/Plan/Prospetto.aspx'); }
                break;
            //Building Manager                            
            case 'B_Manager':
...
//            for (i = 0; i < griglia.length; i++) {
//                document.getElementById(griglia[i]).style.height = altezzaPagina - 220 + 'px';
//            }
//        };
//    };

//    if (document.getElementById('RadTabStripAppalti')) {
