...
Partial Class Contratti_RptAzLegali_2
    ...
    Private Sub RadGridAzLegali_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles RadGridAzLegali.NeedDataSource
        Try
            par.cmd.CommandText = " SELECT RAPPORTI_UTENZA.ID," _
                ...
                & " (case when controllo_anagra_esito = 1 then 'Titolare mononucleo deced.' when controllo_anagra_esito= 0 then 'Vuoto' when controllo_anagra_esito is null then '' end) as ESITO_CTRL_ANAGRAF " _
                & " FROM SISCOM_MI.RAPPORTI_UTENZA, siscom_mi.rapporti_utenza_controllo " _
                & " WHERE rapporti_utenza.id = rapporti_utenza_controllo.id_contratto "
    ...
    Private Sub Esporta(ByVal dt As Data.DataTable)
        ...
        Dim nomeFile = xls.EsportaExcelDaDT(ExcelSiSol.Estensione.Office2007_xlsx, "ExportMononucleoDeceduto", "ControlloAnagrafico", dt)
