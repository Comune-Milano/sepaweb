<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptPgRuoliDett.aspx.vb"
    Inherits="Contratti_Pagamenti_RptPgRuoliDett" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Report bollette ruolo</title>
</head>
            ...
            <td>
                <asp:DataGrid ID="dgvRptPagExtraMav" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="NUM_RUOLO" HeaderText="NUM. RUOLO"></asp:BoundColumn>
                        <asp:BoundColumn DataField="NUM_BOLLETTA" HeaderText="NUM. BOLLETTA"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="IMPORTO_RUOLO" HeaderText="IMPORTO RUOLO"></asp:BoundColumn>
                        <asp:BoundColumn DataField="IMP_RUOLO_PAGATO" HeaderText="IMP. RUOLO PAGATO"></asp:BoundColumn>
                        <asp:BoundColumn DataField="RESIDUO" HeaderText="RESIDUO"></asp:BoundColumn>
                        <asp:BoundColumn DataField="SGRAVIO" HeaderText="IMP.SGRAVATO"></asp:BoundColumn>
                    </Columns>
