<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipologiaAnno.aspx.vb" Inherits="Contratti_Pagamenti_TipologiaAnno" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Gestione Anno Competenza Aggiornamento</title>
    <script type="text/javascript">
        function modifica(id) {
            location.replace('NuovaTipologiaAnno.aspx?id=' + id);
        }
        function elimina(id) {
            var chiediConferma = window.confirm('Questa operazione eliminerà definitivamente questo anno. Vuoi continuare?');
            if (chiediConferma) {
...
<body style="background-image: url(../../NuoveImm/SfondoMascheraContratti.jpg);">
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:Label ID="Label1" Text="Gestione anno competenza aggiornamento" runat="server"
        ...
        <div style="height: 450px">
            <asp:DataGrid ID="DataGridAnno" runat="server" CellPadding="2" Font-Bold="False"
                ...
                <Columns>
                    <asp:BoundColumn DataField="validita_da" HeaderText="VALIDITA DA">
                        <ItemStyle Wrap="false" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                            Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="validita_a" HeaderText="VALIDITA A">
                        <ItemStyle Wrap="false" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                            Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                    </asp:BoundColumn>
