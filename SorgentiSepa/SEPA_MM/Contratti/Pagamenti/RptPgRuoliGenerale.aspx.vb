...
Partial Class Contratti_Pagamenti_RptPgRuoliGenerale
    ...
    Private Sub Cerca()
        Try
            ...
            If par.IfEmpty(Request.QueryString("S"), "-1") <> "1" Then
                ...
                End If
            End If
            If par.IfEmpty(Request.QueryString("NR"), "Null") <> "Null" Then
                sValore = Request.QueryString("NR")
                sWhere = sWhere & " AND NUM_RUOLO like '%" & sValore & "%'"
            End If
            ...
            par.cmd.CommandText = "SELECT  RAPPORTI_UTENZA.ID, " _
                ...
                & "      END)" _
                & "        AS sgravio, " _
                                 & "TRIM (TO_CHAR(importo_RUOLO,'9G999G999G990D99')) AS IMPORTO_RUOLO," _
                                 & "TRIM (TO_CHAR(nvl(IMP_RUOLO_PAGATO,0),'9G999G999G990D99')) AS IMP_RUOLO_PAGATO," _
