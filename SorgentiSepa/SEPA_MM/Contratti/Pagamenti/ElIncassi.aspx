<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElIncassi.aspx.vb" Inherits="Contratti_Pagamenti_ElIncassi" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Elenco Incassi Manuali</title>
    <style type="text/css">
        .style2
        {
            font-family: Arial;
                ...
                <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">
                    <asp:DataGrid ID="dgvIncassi" runat="server" AutoGenerateColumns="False" Font-Bold="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="FL_ANNULLATA" HeaderText="FL_ANNULLATA" Visible="False">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="EDITDELABLE" HeaderText="EDITDELABLE" Visible="False">
                            </asp:BoundColumn>
                        </Columns>
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        <asp:ImageButton ID="btnVisualizza" runat="server" ImageUrl="~/Contratti/Pagamenti/image/View-icon.png"
                                            OnClientClick="VisualIncasso();" Style="text-align: center" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style2">
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/Contratti/Pagamenti/image/EditIcon.png"
                                            OnClientClick="if (document.getElementById('idBollettaRic').value == '0') {ModIncasso();return false;} else { alert('Impossibile modificare, trattasi di un incasso che include bollette messe in mora!') }" />
                                    </td>
                                    <td align="center">
