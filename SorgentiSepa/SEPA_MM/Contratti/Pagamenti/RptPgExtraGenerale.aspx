<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptPgExtraGenerale.aspx.vb"
    Inherits="Contratti_Pagamenti_RptPgExtraGenerale" %>
            ...
            <td>
                <asp:DataGrid ID="dgvRptPagExtraMav" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="RIFERIMENTO_DA_A" HeaderText="RIFERIMENTO DA - A"></asp:BoundColumn>
