...
Partial Class Contratti_Pagamenti_RicercaBolletteIng
    ...
    Protected Sub btnCerca_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnCerca.Click
        ...
        If Me.chkDettaglio.Checked = False Then
            ...
            Response.Write("<script>window.open('RptPgIngGenerale.aspx?CodContratto=" & par.VaroleDaPassare(Me.txtCodContratto.Text) & "&RIFDAL=" & par.VaroleDaPassare(par.AggiustaData(Me.txtRiferimentoDal.Text)) _
        ...
        ElseIf Me.chkDettaglio.Checked = True Then
            ...
            Response.Write("<script>window.open('RptPgIngDett.aspx?CodContratto=" & par.VaroleDaPassare(Me.txtCodContratto.Text) & "&RIFDAL=" & par.VaroleDaPassare(par.AggiustaData(Me.txtRiferimentoDal.Text)) _
                    & "&RIFAL=" & par.VaroleDaPassare(par.AggiustaData(Me.txtRiferiemntoAl.Text)) _
                    & "&DPAG=" & par.VaroleDaPassare(par.AggiustaData(Me.txtDataPagamento.Text)) & "&DPAGAL=" & par.VaroleDaPassare(par.AggiustaData(Me.txtDataPagamentoAl.Text)) & "','RptPgExtraMavI','');</script>")
