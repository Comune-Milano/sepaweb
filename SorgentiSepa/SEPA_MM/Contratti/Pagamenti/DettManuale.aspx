<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DettManuale.aspx.vb" Inherits="Contratti_Pagamenti_DettManuale" %>
...
<head runat="server">
            ...
            if (document.getElementById("cmbTipoPagamento").value != '-1') {
                if (document.getElementById('txtImpPagamento')) {
                    if (parseFloat(document.getElementById('txtImpPagamento').value.replace(/\./g, '').replace(',', '.')) > parseFloat(document.getElementById('totResiduo').value.replace(/\./g, '').replace(',', '.'))) {
                        ...
                        if (window.confirm('Si sta inserendo un importo superiore al totale della bolletta.\nQuesta operazione genererà un CREDITO!\n\nContinuare?')) {
                            document.getElementById("confCredito").value = 1;
                        }
                        else {
    ...
    <title>Dettaglio Bolletta</title>
</head>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkEcludeQS" runat="server" AutoPostBack="True" BackColor="#FFFF99"
                                            Font-Bold="True" Font-Names="Arial" Font-Size="8pt" ForeColor="#FF3300" 
                                            Text="Escludi Quote Sind." Enabled="False" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="width: 52%">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:Button ID="ButtonIncassoNonAttribuito" Text="Pagamenti non attribuiti" runat="server"
                                            OnClientClick="javascript:ApriIncassiNonAttribuiti();" BackColor="Transparent"
                                            BorderColor="Transparent" BorderWidth="0px" Font-Bold="True" Font-Names="Arial"
                                            Style="cursor: pointer;" Font-Size="8pt" Width="130px" ForeColor="#0000C0" Font-Underline="True" />
                                    </td>
                                    <td>
