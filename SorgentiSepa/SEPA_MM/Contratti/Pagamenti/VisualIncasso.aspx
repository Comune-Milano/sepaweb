<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VisualIncasso.aspx.vb" Inherits="Contratti_Pagamenti_VisualIncasso" %>
...
<body>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="style2">
                <asp:RadioButtonList ID="rdbDettaglio" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="10pt" RepeatDirection="Horizontal" AutoPostBack="True">
                    <asp:ListItem Value="0">TUTTE (escluse le RICLA.)</asp:ListItem>
                    <asp:ListItem Value="1">SOLO RICLA.</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
