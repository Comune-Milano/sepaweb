<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElIncassiRuoli.aspx.vb"
    Inherits="Contratti_Pagamenti_ElIncassiRuoli" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Elenco Incassi Manuali Ruoli</title>
    <style type="text/css">
        .style2
        {
            font-family: Arial;
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        <asp:ImageButton ID="btnVisualizza" runat="server" ImageUrl="~/Contratti/Pagamenti/image/View-icon.png"
                                            OnClientClick="VisualIncassoRuoli();return false;" Style="text-align: center" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style2">
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/Contratti/Pagamenti/image/EditIcon.png"
                                            OnClientClick="ModIncassoRuoli();return false;" />
                                    </td>
                                    <td align="center">
