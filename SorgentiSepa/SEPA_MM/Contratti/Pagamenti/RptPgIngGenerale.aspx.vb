...
Partial Class Contratti_Pagamenti_RptPgIngGenerale
    ...
    Private Sub Cerca()
        Try
            ...
            par.cmd.CommandText = "SELECT  RAPPORTI_UTENZA.ID, " _
                                 ...
                                 & "TIPO_BOLL_INGIUNZIONE.DESCRIZIONE AS INGIUNZIONE,TRIM (TO_CHAR(importo_ingiunzione,'9G999G999G990D99')) AS importo_ingiunzione," _
                                 & "TRIM (TO_CHAR(nvl(imp_ingiunzione_pag,0),'9G999G999G990D99')) AS imp_ingiunzione_pag," _
     ...
     & "    AND bol_bollette.id_contratto = rapporti_utenza.id AND TIPO_BOLL_INGIUNZIONE.ID(+)=ID_TIPO_INGIUNZIONE " _
                                 ...
                                 & swhereOperatori & " " & swhereIdTipoPag & " " & condizioneCodContr & " " & sWhere
            ...
            Next
            row = dt.NewRow()
            row.Item("ingiunzione") = "T O T A L E"
