<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NuovaTipologiaPagamento.aspx.vb"
    Inherits="Contratti_Pagamenti_NuovaTipologiaPagamento" %>
...
<body style="background-image: url(../../NuoveImm/SfondoMascheraContratti.jpg);">
    ...
    <div>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:Label ID="Label1" Text="Gestione Tipologie Pagamenti" runat="server" Font-Bold="True"
