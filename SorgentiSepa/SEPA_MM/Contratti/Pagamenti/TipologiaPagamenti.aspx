<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipologiaPagamenti.aspx.vb"
    Inherits="Contratti_Pagamenti_TipologiaPagamenti" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gestione Tipologie Pagamenti</title>
    <script type="text/javascript">
        function modifica(id) {
            location.replace('NuovaTipologiaPagamento.aspx?id=' + id);
        }
        function elimina(id) {
            var chiediConferma = window.confirm('Questa operazione eliminerà definitivamente questa tipologia. Vuoi continuare?');
            if (chiediConferma) {
...
<body style="background-image: url(../../NuoveImm/SfondoMascheraContratti.jpg);">
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:Label Text="Gestione Tipologie Pagamenti" runat="server" Font-Bold="True" Font-Names="Arial"
        ...
        <div style="height: 450px">
            <asp:DataGrid ID="DataGridTipoPagamenti" runat="server" CellPadding="2" Font-Bold="False"
                ...
                Width="100%" CellSpacing="2" AutoGenerateColumns="False">
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="UTILIZZABILE" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplatE>
                            <asp:CheckBox ID="CheckBox1" runat="server"/>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:BoundColumn DataField="FL_ELIMINABILE" HeaderText="FL_ELIMINABILE" Visible="false">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="ELIMINA" HeaderText="" Visible="true" HeaderStyle-Width="5%">
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="ID" HeaderText="ID" Visible="false"></asp:BoundColumn>
                    <asp:BoundColumn DataField="UTILIZZABILE" HeaderText="UTILIZZABILE" Visible="false"></asp:BoundColumn>
                </Columns>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td style="width: 10%">
                    <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Imposta utilizzabili" 
                        ImageUrl="../../NuoveImm/newImposta.png" />
                </td>
                <td style="width: 10%">
                    <asp:ImageButton ID="ImageButtonAggiungiSpesa" runat="server" ToolTip="Aggiungi" 
