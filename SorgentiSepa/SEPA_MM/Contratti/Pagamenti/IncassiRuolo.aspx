<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IncassiRuolo.aspx.vb" Inherits="Contratti_Pagamenti_IncassiRuolo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Pagamento Ruoli</title>
                        ...
                        <td width="20%">
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td align="center">
                                        <asp:Button ID="btnEventi" runat="server" CssClass="bottone3" Text="Eventi" OnClientClick="ApriEventiIncassiRuoli();return false;" />
                                    </td>
                                    <td align="center">
            ...
            <td>
                <table cellpadding="2" cellspacing="0" style="width: 100%;">
                    <tr>
                        ...
                        <td class="style1">
                            <asp:Label ID="lblTotRuolo0" runat="server" Style="font-weight: 600; color: black;
                                font-size: 10pt; text-decoration: underline">Totale a ruolo:</asp:Label>
                            <asp:Label ID="lblTotRuolo" runat="server" Style="font-weight: 600; color: black;
                                font-size: 10pt;"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblPagatoRuolo0" runat="server" Style="font-weight: 600; color: black;
                                font-size: 10pt; text-decoration: underline">Pagato a ruolo:</asp:Label>
                            <asp:Label ID="lblPagatoRuolo" runat="server" Style="font-weight: 600; color: Blue;
                                font-size: 10pt;"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblRuoloDaPag0" runat="server" Style="font-weight: 600; color: black;
                                font-size: 10pt; text-decoration: underline">Da pagare:</asp:Label>
                            <asp:Label ID="lblRuoloDaPag" runat="server" Style="font-weight: 600; color: red;
                                font-size: 10pt;"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center" width="60%">
                            <span id="txtqs" runat="server" clientidmode="Static" visible="false"><b><span style="color: #ec483e;
                                font-family: Arial; font-size: 12pt;"></span></b></span>
                        </td>
