...
Partial Class Contratti_Prorogati_Documenti_NotaXUffFiscaleProrog
    ...
    Private Sub caricaDT()
        ...
        Try
            ...
            Dim sr1 As StreamReader = New StreamReader(Server.MapPath("NotaXUffFiscaleProrog.htm"), System.Text.Encoding.GetEncoding("iso-8859-1"))
