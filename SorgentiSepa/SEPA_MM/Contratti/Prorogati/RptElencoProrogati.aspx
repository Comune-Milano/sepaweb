<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptElencoProrogati.aspx.vb" Inherits="Contratti_Prorogati_RptElencoProrogati" %>
...
<head id="Head1" runat="server">
    ...
    <title>Report Contratti Prorogati</title>
    <style type="text/css">
        .style1
        {
            width: 993px;
...
<body>
                    ...
                    <asp:Menu ID="TStampe" runat="server" Font-Names="arial" Font-Size="8pt" ForeColor="Black"
                        ...
                        <Items>
                            <asp:MenuItem ImageUrl="~/NuoveImm/btnStampe.png" Selectable="False" Value="">
                                <asp:MenuItem Text="Report per Ufficio Fiscale" Value="1"></asp:MenuItem>
                                <asp:MenuItem Text="Report per Sede Territoriale" Value="2"></asp:MenuItem>
        ...
        <tr>
            <td style="vertical-align: middle; text-align: center" height="40px" align="center" 
                ...
                <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="14pt"
                    Style="font-size: small; text-align:center;"></asp:Label><br />
            ...
            <td style="vertical-align: top; text-align: left">
                <div style="border: 4px solid #ACC8F0; width: 99.5%; height: 600px; overflow: auto;">
                    <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">
                        <asp:DataGrid ID="dgvRptProrogati" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            <Columns>
                               ...
                               <asp:BoundColumn DataField="DATA_PROROGA" HeaderText="DATA PROROGA">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Left" />
                                </asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="PROV_COMUNE" HeaderText="COMUNE">
                                  ...
                                  <asp:BoundColumn DataField="NOME_FILIALE" HeaderText="SEDE T.">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Left" />
                                </asp:BoundColumn>
                            </Columns>
    ...
    <asp:HiddenField ID="dataDal" runat="server" />
    <asp:HiddenField ID="dataAl" runat="server" />
     <asp:HiddenField ID="idFiliale" runat="server" />
