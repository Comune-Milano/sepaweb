...
Partial Class Contratti_ElencoSimulazioni
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Request.QueryString("T") = "SIMULAZIONE" Then

            Else
                Label1.Text = "Elenco Emissioni"
            End If
            ...
            i = 0
            MIOCOLORE = "#CCFFFF"
            For Each foundFile As String In My.Computer.FileSystem.GetFiles(Server.MapPath("../ALLEGATI/CONTRATTI/ELABORAZIONI/"), FileIO.SearchOption.SearchTopLevelOnly, Request.QueryString("T") & "_*.zip")
            ...
            If i > 0 Then
                For j = 0 To i - 1
                    MiaSHTML = MiaSHTML & "<tr>" & vbCrLf
                    MiaSHTML = MiaSHTML & "<td width='500px' bgcolor='" & MIOCOLORE & "'><font face='Arial' size='1'>" & j + 1 & ")<a href='../ALLEGATI/CONTRATTI/ELABORAZIONI/" & RicavaFile(ElencoFile(j)) & "' target='_blank'>" & RicavaFile(ElencoFile(j)) & "</a></font></td>" & vbCrLf
