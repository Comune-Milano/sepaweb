...
Partial Class Contratti_Comunicazioni_LetteraFattura
    ...
    Protected Sub btnAnteprima_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnAnteprima.Click
        ...
        Try
            ...
            contenuto = Replace(contenuto, "$scadenza$", "01/01/2009")
            contenuto = Replace(contenuto, "$importo$", "100,00")
            contenuto = Replace(contenuto, "$causale$", "XXXXXXXXXXXXXXX")

            contenuto = Replace(contenuto, "$dettaglio$", PAR.MiaFormat("AFFITTO", 40) & vbTab & vbTab & vbTab & "50,00" & "<br />" & PAR.MiaFormat("SPESE", 40) & vbTab & vbTab & vbTab & "50,00")
            ...
            Response.Write("<script>window.open('../../ALLEGATI/CONTRATTI/StampeLettere/" & NomeFile & ".pdf" & "','Fattura','');</script>")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                ...
                PAR.cmd.CommandText = "select valore from siscom_MI.parametri_BOLLETTA where ID=14"
                ...
                PAR.cmd.CommandText = "select valore from siscom_MI.parametri_BOLLETTA where ID=15"
    ...
    Protected Sub btnSalva_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSalva.Click
        Try
            ...
            PAR.cmd.CommandText = "UPDATE siscom_MI.parametri_BOLLETTA SET VALORE='" & PAR.PulisciStrSql(Replace(txtTesto.Text, vbCrLf, "<br />")) & "' WHERE ID=14"
            PAR.cmd.ExecuteNonQuery()

            PAR.cmd.CommandText = "UPDATE siscom_MI.parametri_BOLLETTA SET VALORE='" & PAR.PulisciStrSql(Replace(txtNote.Text, vbCrLf, "<br />")) & "' WHERE ID=15"
            PAR.cmd.ExecuteNonQuery()
