<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipologieGestionale.aspx.vb"
    Inherits="Contratti_TipologieGestionale" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Documenti Gestionali</title>
        ...
        <tr>
            <td style="height: 10px">
                <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp Elenco
                    Tipologie Gestionali</strong></span>
            </td>
        </tr>
    </table>
    <div>
                    ...
                    <div style="overflow: auto; height: 400px; z-index: 100;">
                        <asp:DataGrid ID="DataGrDocGest" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="DESCRIZIONE" HeaderText="DOCUMENTO GESTIONALE">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Width="20%" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="UTILIZZABILE" HeaderText="UTILIZZABILE">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Width="20%" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="FL_RIPARTIBILE" HeaderText="RIPARTIBILE">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Width="20%" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; text-align: left;">
                        <asp:TextBox ID="txtAcronimo" runat="server" Font-Names="Arial" Font-Size="10pt"
                            Width="309px" MaxLength="400" TabIndex="1" Height="20px" Font-Bold="True" CssClass="CSSmaiuscolo"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top;">
                        <span style="font-size: 10pt; font-family: Arial">Utilizzabile</span>
                    </td>
                    <td style="vertical-align: top; text-align: left;">
                        <asp:CheckBox ID="chkUtilizzabile" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top;">
                        <span style="font-size: 10pt; font-family: Arial">Ripartibile</span>
                    </td>
                    <td style="vertical-align: top; text-align: left;">
                        <asp:CheckBox ID="chkRipartibile" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
