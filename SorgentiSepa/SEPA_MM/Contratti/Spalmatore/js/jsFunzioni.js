...
// Funzione pagina Nuovo Intervento

function CreaSegnalazDaIntervento() {

    confirm('Attenzione', 'Sei sicuro di voler procedere?', 'SI', 2, 'btnSegnalazione', 'NO', 3, '');
};
...
function Procedure() {
    CenterPage('Procedure.aspx', 'ProcedureSpalmatore', 900, 700);
};