<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Canone_Usi_Diversi.aspx.vb" Inherits="Contratti_Canone_Usi_Diversi" %>
...
<head runat="server">
    <title>Canone Usi Diversi</title>
</head>
<body>
    ...
    <p>
            ...
            Style="z-index: 104; left: 48px; position: absolute; top: 248px" 
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Canone
                        per stipula contratto USI DIVERSI </strong>
...
<br />
        ...
        <asp:FileUpload ID="FileUpload1" runat="server" Font-Names="arial" Font-Size="8pt"
                    ...
                    <asp:ImageButton ID="ImgProcedi" runat="server" ImageUrl="~/NuoveImm/img_SalvaModelli.png"
                        Style="left: 623px; position: absolute; top: 515px; right: 97px; height: 20px;" 
                        TabIndex="4" />
                    <br />
