<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DichiarazioneCS.aspx.vb" Inherits="Contratti_DichiarazioneFO" %>
...
<head runat="server">
    <title>Dichiarazione Cambi Consensuali</title>
</head>
<body>
                ...
                <td style="width: 800px">
                    ...
                    &nbsp;
                        <asp:TextBox ID="TextBox7" runat="server" Font-Bold="True"
                            ...
                            Width="632px"
                            Height="24px">Nessuna Selezione</asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <br />
                    ...
                    <asp:ImageButton ID="ImgIndietro" runat="server" ImageUrl="~/NuoveImm/Img_Indietro2.png"
                        Style="left: 474px; position: absolute; top: 516px;" TabIndex="21" />
