<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelezionaUnitaOA.aspx.vb" Inherits="Contratti_SelezionaUnitaOA" %>
...
<body>
    ...
    <div>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Seleziona
                        Unità per rapporto O.A.</strong></span><br />
                    <br />
                    <br />
                    <div id="contenitore" 
                    ...
                    <asp:ImageButton ID="ImgProcedi" runat="server" ImageUrl="~/NuoveImm/Img_Procedi.png"
                        Style="left: 616px; position: absolute; top: 530px" />
                    <br />
        ...
        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="arial" Font-Size="12pt"
            Style="z-index: 124; left: 11px; position: absolute; top: 497px; text-align: left"
    ...
    <p>
                    <asp:ImageButton ID="btnAnnulla0" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                        Style="z-index: 101; left: 516px; position: absolute; top: 530px; height: 20px;" 
