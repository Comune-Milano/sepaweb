...
Partial Class Contratti_VisualizzazioneCompNucleo
        ...
        Try
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                If Request.QueryString("T") = 1 Then
                    ...
                    par.cmd.CommandText = "SELECT * FROM SISCOM_MI.SOGGETTI_CONTRATTUALI,SISCOM_MI.ANAGRAFICA WHERE SOGGETTI_CONTRATTUALI.ID_ANAGRAFICA = ANAGRAFICA.ID AND COD_FISCALE ='" & dt.Rows(i).Item("COD_FISCALE") & "' AND SOGGETTI_CONTRATTUALI.ID_CONTRATTO=" & Request.QueryString("IDRU")
            ...
            If compCancell = True Then
                For j As Integer = 0 To dt2.Rows.Count - 1
                    ...
                    par.cmd.CommandText = "SELECT TIPOLOGIA_PARENTELA.DESCRIZIONE AS PARENTE,ANAGRAFICA.* FROM SISCOM_MI.SOGGETTI_CONTRATTUALI,SISCOM_MI.TIPOLOGIA_PARENTELA,SISCOM_MI.ANAGRAFICA WHERE TIPOLOGIA_PARENTELA.COD = SOGGETTI_CONTRATTUALI.COD_TIPOLOGIA_PARENTELA AND SOGGETTI_CONTRATTUALI.ID_ANAGRAFICA = ANAGRAFICA.ID AND COD_FISCALE ='" & dt2.Rows(j).Item("COD_FISCALE") & "' AND SOGGETTI_CONTRATTUALI.ID_CONTRATTO=" & Request.QueryString("IDRU")
                    ...
                    End If
                    lettParente.Close()
                    par.cmd.CommandText = "SELECT * FROM SISCOM_MI.SOGGETTI_CONTRATTUALI,SISCOM_MI.ANAGRAFICA WHERE SOGGETTI_CONTRATTUALI.ID_ANAGRAFICA = ANAGRAFICA.ID AND COD_FISCALE ='" & dt2.Rows(j).Item("COD_FISCALE") & "' AND SOGGETTI_CONTRATTUALI.ID_CONTRATTO=" & Request.QueryString("IDRU")
