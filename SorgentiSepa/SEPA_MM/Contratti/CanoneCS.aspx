<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CanoneCS.aspx.vb" Inherits="Contratti_CanoneFO" %>
...
<body>
    ...
    <p>
            ...
            Style="z-index: 104; left: 65px; position: absolute; top: 432px" 
        ...
        <table style="left: 0px; background-image: url(../NuoveImm/SfondoMascheraContratti.jpg);
            ...
            <tr>
                <td style="width: 800px">
                    <br />
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Stipula contratto ERP da Cambio Consensuale</strong></span><br />
                    <br />
                    <br />
                    <br />
                    &nbsp;<br />
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server"
                        ControlToValidate="txtDataProvvedimento" 
                        ErrorMessage="Non Valido (gg/mm/aaaa)" Font-Bold="True"
                        Font-Names="arial" Font-Size="9pt" Height="15px" Style="z-index: 105; left: 138px;
                        position: absolute; top: 174px" ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([/])(0[13578]|10|12)([/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([/])(0[469]|11)([/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([/])(02)([/])(\d{4}))|((29)(\.|-|\/)(02)([/])([02468][048]00))|((29)([/])(02)([/])([13579][26]00))|((29)([/])(02)([/])([0-9][0-9][0][48]))|((29)([/])(02)([/])([0-9][0-9][2468][048]))|((29)([/])(02)([/])([0-9][0-9][13579][26])))"
...
<br />
                    <br />
                    <br />
                    <asp:Label ID="Label5" runat="server" Visible="False" Font-Bold="True" 
                        Font-Names="arial" Font-Size="9pt" ForeColor="#CC0000"></asp:Label>
                    <br />
        ...
        <asp:FileUpload ID="FileUpload1" runat="server" Font-Names="arial" Font-Size="8pt"
                    ...
                    <asp:ImageButton ID="ImgIndietro" runat="server" ImageUrl="~/NuoveImm/Img_Indietro2.png"
                        Style="left: 510px; position: absolute; top: 515px;" TabIndex="21" />
                    ...
                    &nbsp;
                        ...
                        Style="z-index: 104; left: 46px; position: absolute; top: 97px">N.Provvedimento</asp:Label>
                                            <asp:TextBox ID="txtNumProvvedimento" runat="server" 
                        BorderStyle="Solid" BorderWidth="1px" MaxLength="50"
                        
                        
                        Style="z-index: 105; left: 46px; position: absolute; top: 115px; right: 672px;" TabIndex="1"
                        Width="82px"></asp:TextBox>
                        <asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        Style="z-index: 104; left: 46px; position: absolute; top: 155px">Data Provvedimento</asp:Label>
                        <asp:TextBox ID="txtDataProvvedimento" runat="server" 
                        BorderStyle="Solid" BorderWidth="1px" MaxLength="50"
                        
                        
                        
                        
                        Style="z-index: 105; left: 46px; position: absolute; top: 172px; right: 672px;" TabIndex="2"
                        Width="82px"></asp:TextBox>
                    <br />
                    <br />
                </td>
