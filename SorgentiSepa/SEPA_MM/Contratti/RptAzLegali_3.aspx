<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptAzLegali_3.aspx.vb" Inherits="Contratti_RptAzLegali_3" %>
...
<head runat="server">
    ...
    <title>Rpt Accesso Ufficiale Giudiziario</title>
</head>
<body>
        ...
        <table>
            <tr>
                ...
                <td style="text-align: center; width: 100%; font-size: 10pt; font-family: Arial; color: #416094; font-weight: bold;">
                    <asp:Label ID="lblTitolo" runat="server" Text="Elenco Contratti Accesso Ufficiale Giudiziario" Font-Size="20px"></asp:Label>
                </td>
                <td>&nbsp</td>
            </tr>
        </table>
                    ...
                    <asp:Panel runat="server" ID="PanelRadGrid">
                        <telerik:RadGrid ID="RadGridAzLegali" runat="server" GroupPanelPosition="Top" resolvedrendermode="Classic"
                            ...
                            <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                CommandItemDisplay="Top" FilterExpression="([ESITO_CTRL_ANAGRAF] = 'Titolare mononucleo deced.')">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridDateTimeColumn DataField="MOROSITA_ANNI_PREC_DATA_DECORR" HeaderText="DATA DECORR. ACC.UFF.GIUD." CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn DataField="MOROSITA_ANNI_PREC_NUM_ID" HeaderText="NUM.IDENT. ACC.UFF.GIUD." CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn DataField="MOROSITA_ANNI_NOTE" HeaderText="NOTE ACC.UFF.GIUD." CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
