<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelezionaUnitaArt15.aspx.vb" Inherits="Contratti_SelezionaUnitaArt15" %>
...
<body>
    ...
    <div>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Seleziona
                        Unità per stipula rapporto Art.15 R.R. 1/2004</strong></span><br />
                    <br />
                    <br />
                    <div id="contenitore" 
        ...
        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="arial" Font-Size="12pt"
            Style="z-index: 124; left: 11px; position: absolute; top: 483px; text-align: left"
