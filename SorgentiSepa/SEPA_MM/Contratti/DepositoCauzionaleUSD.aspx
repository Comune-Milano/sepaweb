<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DepositoCauzionaleUSD.aspx.vb"
    Inherits="Contratti_DepositoCauzionaleUSD" %>
...
<body style="background-attachment: fixed; background-image: url('../NuoveImm/SfondoMascheraContratti.jpg');
    background-repeat: no-repeat; width: 792px; position: absolute; let: 5px;">
        ...
        <tr>
            <td colspan="5" style="text-align: left">
                <table style="width: 100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 90%;">
                            <asp:Button ID="Button2" runat="server" CssClass="bottone" Text="Esci" OnClientClick="self.close();" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="7" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #000000">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            <asp:Label Text="Ragione sociale" runat="server" ID="Label8" Font-Bold="True" Font-Names="Arial"
                                Font-Size="12pt" ForeColor="#3366CC" />
                        </td>
                        <td>
                            <asp:Label Text="Cognome" runat="server" ID="Label9" Font-Bold="True" Font-Names="Arial"
                                Font-Size="12pt" ForeColor="#3366CC" />
                        </td>
                        <td>
                            <asp:Label Text="Nome" runat="server" ID="Label10" Font-Bold="True" Font-Names="Arial"
                                Font-Size="12pt" ForeColor="#3366CC" />
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label runat="server" ID="RagioneSociale" Width="100%" Font-Names="Arial" Font-Size="9pt" />
                        </td>
                        <td>
                            <asp:Label runat="server" ID="Cognome" Width="100%" Font-Names="Arial" Font-Size="9pt" />
                        </td>
                        <td>
                            <asp:Label runat="server" ID="Nome" Width="100%" Font-Names="Arial" Font-Size="9pt" />
                        </td>
                        <td>
