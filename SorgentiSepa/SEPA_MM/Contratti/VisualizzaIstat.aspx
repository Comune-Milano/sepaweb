<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VisualizzaIstat.aspx.vb" Inherits="Contratti_VisualizzaIstat" %>
...
<body>
    ...
    <div>
        ...
        <asp:ImageButton ID="imgVisualizza" runat="server" ImageUrl="~/NuoveImm/Img_Visualizza.png"
            ...
            Style="z-index: 101; left: 535px; position: absolute; top: 493px; right: 475px;" 
