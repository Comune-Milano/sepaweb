<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Eventi_1.aspx.vb" Inherits="Contratti_CONTRATTI_LIGHT_Eventi_1" %>
    ...
    <asp:datagrid id="DataGrid1" runat="server" Font-Names="Arial" 
                ...
                Font-Strikeout="False" Font-Underline="False" GridLines="None" CellPadding="4" 
                    ForeColor="#333333">
							...
							<Columns>
								<asp:BoundColumn DataField="DATA_ORA" HeaderText="DATA">
                                </asp:BoundColumn>
