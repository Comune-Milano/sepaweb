        ...
        <tr>
            <td width="900px">
                ...
                <asp:ListBox ID="lstIntestatari" runat="server" Font-Names="Courier New" Font-Size="8pt"
                    Width="1010px" Height="95px" TabIndex="26" Enabled="False"></asp:ListBox>
            </td>
        ...
        <tr>
            <td width="700px">
                ...
                <asp:ListBox ID="lstComponenti" runat="server" Font-Names="Courier New" Font-Size="8pt"
                    Width="1010px" Height="105px" TabIndex="30" Enabled="False"></asp:ListBox>
            </td>
        ...
        <tr>
            <td width="700px">
                &nbsp;<asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                    ForeColor="#8080FF" Text="ELENCO OSPITI" Width="104px"></asp:Label>
            </td>
            <td width="150px">
            </td>
        </tr>
        <tr>
            <td width="700px">
                &nbsp;<asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Names="Courier New"
                    Font-Size="8pt" ForeColor="Black" Text="Nominativo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.Fiscale&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data Inizio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data Fine"
