<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InteressiVisualizza.aspx.vb" Inherits="Contratti_Interessi" %>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;
                        <asp:Label ID="Label7" runat="server" Text="Visualizza Interessi su Deposito"></asp:Label><br />
                    </strong></span>
                    <br />
                    <br />
                    &nbsp;&nbsp;
                    <asp:Label ID="Label4" runat="server" Font-Names="arial" Font-Size="10pt" Width="83px">Interessi dal:</asp:Label>&nbsp;
                    ...
                    &nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" Font-Names="arial" Font-Size="10pt" Width="83px">Interessi al:</asp:Label>&nbsp;
                    <asp:TextBox ID="txtDataAl" runat="server" BorderColor="Silver" BorderStyle="Solid"
                        BorderWidth="1px" MaxLength="10" TabIndex="2" Width="77px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="cmbComplesso" runat="server" AutoPostBack="True" BackColor="White"
                                    ...
                                    border-bottom: black 1px solid; position: static; top: 185px" TabIndex="3" 
                                    Width="283px">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="cmbEdificio" runat="server" AutoPostBack="True" BackColor="White"
                                    ...
                                    border-bottom: black 1px solid; position: static; top: 402px" TabIndex="4" 
                                    Width="283px">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="cmbUnita" runat="server" BackColor="White" Font-Names="arial"
                                    ...
                                    position: static; top: 427px" TabIndex="5" Width="283px">
                                </asp:DropDownList></td>
                        </tr>
                    </table>
                    <br />
