                    ...
                    If dtCodUfficio.Rows.Count > 0 Then
                        For Each rowCodUff As Data.DataRow In dtCodUfficio.Rows
                            ...
                            par.cmd.CommandText = "select (SELECT SUM(IMPORTO) FROM SISCOM_MI.RAPPORTI_UTENZA_AD_CANONE WHERE ID_MOTIVO=2 AND ID_CONTRATTO=RAPPORTI_UTENZA.ID) AS ISTAT," _
                                ...
                                & "RAPPORTI_UTENZA.IMP_CANONE_INIZIALE>0 AND UNITA_CONTRATTUALE.ID_CONTRATTO=RAPPORTI_UTENZA.ID AND UNITA_CONTRATTUALE.ID_UNITA_PRINCIPALE IS NULL AND UNITA_IMMOBILIARI.ID=UNITA_CONTRATTUALE.ID_UNITA AND  data_stipula<'20091001' AND nvl(cod_ufficio_reg,'A01')='" & varUfficioTerritoriale _
    ...
    Private Function CreaElencoXLSAnteAler(ByVal elencoContr As String, ByRef kk As Integer, ByVal NomeFilexls As String) As String
        ...
        With myExcelFile
            If kk = 2 Then
                ...
                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 12, "GIORNI SANZIONE", 12)
                ...
                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 17, "QUOTA INQUILINO", 12)
                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 18, "QUOTA COMUNE", 12)
                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 19, "NOTE", 12)
            End If
            ...
            If dtIdContratti.Rows.Count > 0 Then
                For Each rowIdContr As Data.DataRow In dtIdContratti.Rows
                    ...
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 9, par.IfNull(rowIdContr.Item("SERIE_REGISTRAZIONE"), "3t"), 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 10, par.IfNull(rowIdContr.Item("NUM_REGISTRAZIONE"), "999999"), 12)
                    ...
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsRightAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 12, par.IfNull(rowIdContr.Item("giorni_Sanzione"), 0), 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsRightAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 13, (par.IfNull(rowIdContr.Item("imp_canone_iniziale"), 0)), 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsRightAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 14, par.IfNull(rowIdContr.Item("importo_tributo"), 0), 12)
                    ...
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsRightAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 17, Format(par.IfNull(rowIdContr.Item("importo_tributo"), 0) / 2, "0.00"), 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsRightAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 18, Format((par.IfNull(rowIdContr.Item("importo_tributo"), 0) / 2) + par.IfNull(rowIdContr.Item("importo_Sanzione"), 0) + par.IfNull(rowIdContr.Item("importo_interessi"), 0), "0.00"), 12)

                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsRightAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, kk, 19, par.IfNull(rowIdContr.Item("NOTE_IMPOSTE"), ""), 12)
                    kk = kk + 1
                Next
            End If
