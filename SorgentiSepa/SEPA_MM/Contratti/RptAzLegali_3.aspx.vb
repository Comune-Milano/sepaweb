...
Partial Class Contratti_RptAzLegali_3
    ...
    Private Sub RadGridAzLegali_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles RadGridAzLegali.NeedDataSource
        Try
            par.cmd.CommandText = " SELECT RAPPORTI_UTENZA.ID," _
                ...
                & " getdata (MOROSITA_ANNI_PREC_DATA_DECORR) AS MOROSITA_ANNI_PREC_DATA_DECORR, " _
                & " MOROSITA_ANNI_PREC_NUM_ID,MOROSITA_ANNI_NOTE " _
                ...
                & " AND (MOROSITA_ANNI_PREC_DATA_DECORR  is not null OR MOROSITA_ANNI_PREC_NUM_ID  is not null OR MOROSITA_ANNI_NOTE is not null) "
    ...
    Private Sub Esporta(ByVal dt As Data.DataTable)
        ...
        Dim nomeFile = xls.EsportaExcelDaDT(ExcelSiSol.Estensione.Office2007_xlsx, "ExportAccUfficialeGiudiz", "AccUfficialeGiudiz", dt)
