<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CancellazioneMassivaSchema.aspx.vb"
    Inherits="Contratti_CancellazioneMassivaSchema" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Eliminazione massiva voci</title>
...
<body style="background-repeat: no-repeat; background-image: url('../NuoveImm/SfondoMascheraContratti.jpg');">
    ...
    <div id="caricamento" style="margin: 0px; background-color: #C0C0C0; width: 100%;
        height: 100%; position: fixed; top: 0px; left: 1500px; filter: alpha(opacity='75');
        ...
        <div>
            <table>
                <tr>
                    <td>
                        <br />
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>Eliminazione
                            massiva voci schema bollette</strong></span>
                    </td>
                </tr>
            </table>
        </div>
