<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CanoneArt15.aspx.vb" Inherits="Contratti_CanoneArt15" %>
...
<head id="Head1" runat="server">
    <title>Canone 431/98 art.15 RR 1/2004</title>
</head>
<body>
<script type="text/javascript">
        ...
        <table style="left: 0px; background-image: url(../NuoveImm/SfondoMascheraContratti.jpg);
            ...
            <tr>
                <td style="width: 800px">
                    <br />
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Canone per stipula contratto 431/98 
                    art. 15 R.R. 1/2004</strong></span><br />
                    <br />
                    <br />
                    <br />
                    &nbsp;<br />
                    ...
                    <asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        Style="z-index: 104; left: 50px; position: absolute; top: 342px; width: 700px;" 
