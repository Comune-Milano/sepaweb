<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ContraenteOA.aspx.vb" Inherits="Contratti_ContraenteOA" %>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Seleziona/Inserisci
                        Nominativo per abbinamento O.A.</strong></span><br />
                    <br />
                    ...
                    <asp:Label ID="Label23" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        Style="z-index: 108; left: 616px; position: absolute; top: 113px; width: 181px; height: 132px;">Il Cod.Fiscale è obbligatorio per indentificare l&#39;utente nella banca dati. Se non si conosce, inserire un codice fiscale partendo dal Cognome e Nome e inserendo come data di nascita 01/01/2000 nato a MILANO. Successivamente questo dato potrà essere corretto.</asp:Label>
                    <br />
                    <br />
                    <br />
                    ...
                    <asp:ImageButton ID="ImgSeleziona" runat="server" ImageUrl="~/NuoveImm/Img_RicercaDaAnagrafica.png"
                        Style="left: 33px; position: absolute; top: 516px; height: 20px;" 
                    ...
                    <asp:ImageButton ID="ImgProcedi" runat="server" ImageUrl="~/NuoveImm/Img_Procedi.png"
                        ...
                        Style="left: 574px; position: absolute; top: 516px; right: 136px; height: 20px;" 
                    ...
                    <asp:TextBox ID="txtTel" runat="server" BorderStyle="Solid" BorderWidth="1px" MaxLength="50"
                        ...
                        Style="z-index: 107; left: 388px; position: absolute; top: 198px; width: 117px;" 
                    ...
                    <asp:Label ID="lblErrore" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        top: 418px" Visible="False" Width="506px"></asp:Label>
