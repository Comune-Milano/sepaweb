<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptRateizzStraordinaria1.aspx.vb" Inherits="Contratti_RptRateizzStraordinaria1" %>
        ...
        <table>
            <tr>
                ...
                <td style="text-align: center; width: 100%; font-size: 10pt; font-family: Arial; color: #416094; font-weight: bold;">
                    <asp:Label ID="lblTitolo" runat="server" Text="Elenco Contratti Rateizz. Straordinaria" Font-Size="20px"></asp:Label>
                </td>
                <td>&nbsp</td>
            </tr>
        </table>
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" GroupPanelPosition="Top" resolvedrendermode="Classic"
                            ...
                            <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridDateTimeColumn DataField="NUM_BOLL_PAGATE" HeaderText="NUM. BOLL. PAGATE" CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn DataField="NUM_RATE_PAGATE" HeaderText="NUM. RATE PAGATE" CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
