...
<body bgcolor="#f2f5f1">
    ...
    <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="../NuoveImm/Img_Esci_AMM.png"
        Style="z-index: 101; left: 533px; position: absolute; top: 400px; height: 20px;"
    ...
    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
        Font-Size="8pt" Width="650px" Style="z-index: 105; left: 10px; position: absolute;
        top: 70px" Font-Bold="False" Font-Italic="False" Font-Overline="False"
        Font-Strikeout="False" Font-Underline="False" GridLines="None" BorderWidth="0px"
        Font-Names="arial" CellPadding="2">
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="PG_DOMANDA" HeaderText="NUM. DOMANDA">
                <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" Wrap="False" />
                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" Wrap="False"/>
            ...
            <asp:BoundColumn DataField="STATO_DOM" HeaderText="STATO DOMANDA">
                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="PG_DICHIARAZIONE" HeaderText="NUM. DICHIARAZ.">
                <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" Wrap="False" />
                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" Wrap="False"/>
            ...
            <asp:BoundColumn DataField="STATO_DICH" HeaderText="STATO DICHIARAZ.">
                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="CAMBIO">
            </asp:BoundColumn>
        </Columns>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ControlloCambio() {

            if (document.getElementById('IDmotivo').value != '2' || document.getElementById('IDmotivo').value != '3')
            {
