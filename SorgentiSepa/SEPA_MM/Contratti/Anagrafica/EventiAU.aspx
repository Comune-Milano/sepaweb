<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EventiAU.aspx.vb" Inherits="Contratti_Anagrafica_EventiAU" %>
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DataGrid1" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                        Font-Size="8pt" PageSize="8" Style="z-index: 105; width: 100%;" Font-Bold="False"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="DATA_ORA" HeaderText="DATA"></asp:BoundColumn>
