...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="color: #660000">
		<form id="Form1" method="post" runat="server">
            <span style="font-size: 16pt; font-family: Arial"><strong>&nbsp; Rubrica</strong></span>&nbsp;
            <asp:Image ID="Image2" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                Style="left: 427px; position: absolute; top: 29px" Width="4px" />
            &nbsp;
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" Style="left: 443px; position: absolute; top: 29px">Chiudi</asp:LinkButton>
        </form>
		<script type="text/javascript">
		function spegni()
		{
