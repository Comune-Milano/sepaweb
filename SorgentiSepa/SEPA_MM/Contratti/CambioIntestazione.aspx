<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CambioIntestazione.aspx.vb" Inherits="Contratti_CambioIntestazione" %>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Seleziona/Inserisci
                        Nominativo per Cambio Intestazione USI DIVERSI</strong></span><br />
                    <br />
                    <br />
                    ...
                    <asp:Label ID="Label14" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        Style="z-index: 106; left: 47px; position: absolute; top: 271px; width: 118px;">Documento Rilasciato da</asp:Label>
                    <asp:TextBox ID="txtDocRilasciato" runat="server" BorderStyle="Solid" BorderWidth="1px"
                        ...
                        position: absolute; top: 289px" TabIndex="14" Width="497px"></asp:TextBox>
                    ...
                    <br />
                    <asp:ImageButton ID="ImgSeleziona" runat="server" ImageUrl="~/NuoveImm/Img_RicercaDaAnagrafica.png"
                        Style="left: 154px; position: absolute; top: 498px" 
                    ...
                    <asp:ImageButton ID="ImgProcedi" runat="server" ImageUrl="~/NuoveImm/Img_Procedi.png"
                        ...
                        TabIndex="22" onclientclick="VerPIVA();VerificaIns();" />
                    <br />
                    ...
                    <asp:Label ID="Label23" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        Style="z-index: 104; left: 46px; position: absolute; top: 376px">ESTREMI DOC. DI SOGGIORNO</asp:Label>
                    <asp:Label ID="Label17" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        Style="z-index: 104; left: 46px; position: absolute; top: 318px">RESIDENZA</asp:Label>
                    ...
                    <asp:Label ID="lblErrore" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        top: 428px; height: 30px; width: 728px;" Visible="False"></asp:Label>
