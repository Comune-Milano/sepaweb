...
Partial Class Contratti_SelezionaUnita392
    ...
    Protected Sub ImgProcedi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgProcedi.Click
        If LBLID.Text <> "" Then
            Try
                ...
                'Response.Redirect("Contraente392.aspx?U=" & Codice & "&CODICE=" & LBLID.Text)
                Response.Redirect("SceltaContraenteUD.aspx?T=1&U=" & Codice & "&CODICE=" & LBLID.Text)
