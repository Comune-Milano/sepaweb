<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelezionaUnitaFO.aspx.vb" Inherits="Contratti_SelezionaUnitaFO" %>
...
<body>
    ...
    <div>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Seleziona
                        Unità per stipula rapporto FORZE DELL&#39;ORDINE</strong></span><br />
                    <br />
                    <br />
                    <div id="contenitore" 
        ...
        <asp:TextBox ID="Label9" runat="server" Font-Bold="True" Font-Names="arial" Font-Size="12pt"
            Style="border-right: white 1px solid; border-top: white 1px solid; border-left: white 1px solid; border-bottom: white 1px solid;left: 11px; position: absolute; top: 482px; text-align: left"
            Width="767px">Nessuna Selezione</asp:TextBox>
