...
Partial Class Contratti_Scadenza_Documenti_AssegnTemp_letteraTempComune
    ...
    Private Sub caricaDT()
        ...
        Try
            ...
            Dim sr1 As StreamReader = New StreamReader(Server.MapPath("letteraTempComune.htm"), System.Text.Encoding.GetEncoding("iso-8859-1"))
            ...
            tabella1 = tabella1 & "<td  align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>DATA DELIBERA </td>"
            tabella1 = tabella1 & "<td  align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>DATA DECORR. </td>"
            ...
            tabella1 = tabella1 & " <td  align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>INDIRIZZO </td>"
            tabella1 = tabella1 & " <td  align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>SCALA </td>"
            tabella1 = tabella1 & " <td align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>INTERNO </td>"
            tabella1 = tabella1 & " <td  align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>CAP &nbsp&nbsp</td>"
            tabella1 = tabella1 & " <td align='center' style='border-bottom-style: solid; border-bottom-width: thin;border-bottom-color: #000000; font-size:9px;'>COMUNE </td>"
            ...
            contenuto = Replace(contenuto, "$dataInserita$", par.FormattaData(dataRif.Value))
            ...
            For Each riga As Data.DataRow In dt.Rows
                ...
                tabella1 = tabella1 & "<td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("DATA_DELIBERA"), "") & "</td><td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("DATA_DECORRENZA"), "") & "</td><td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("DATA_SCADENZA_RINNOVO"), "") & "</td>"
                tabella1 = tabella1 & "<td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("INDIRIZZO"), "") & "</td><td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("SCALA"), "") & "</td><td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("INTERNO"), "") & "</td><td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("CAP"), "") & "</td>"
                tabella1 = tabella1 & "<td  align='left' style='border-width: thin; border-color: #000000; border-style: none solid solid solid;font-size:8px;'>" & par.IfNull(riga.Item("COMUNE"), "") & "</td></tr>"
            ...
            'Dim PercorsoBarCode As String = par.RicavaBarCode(8, idContr.Value)
