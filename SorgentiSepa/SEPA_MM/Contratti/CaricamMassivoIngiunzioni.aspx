<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CaricamMassivoIngiunzioni.aspx.vb"
    Inherits="Contratti_CaricamMassivoIngiunzioni" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Caricamento massivo ingiunzioni</title>
...
<body style="background-repeat: no-repeat; background-image: url('../NuoveImm/SfondoMascheraContratti.jpg');">
    <form id="form1" runat="server">
        ...
        <asp:Panel runat="server" ID="Panel2" Style="position: absolute; top: 0px; left: 0px; width: 800px; height: 550px; display: none; background-color: #eeeeee">
            <br />
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                massivo ingiunzioni</strong></span>
                            </td>
                        </tr>
                    </table>
                </div>
