	...
	<body background="../NuoveImm/SfondoUpContratti.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image2" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                Style="left: 742px; position: absolute; top: 33px" Width="4px" 
                Visible="False" />
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_CONTRATTI.png" Style="left: 26px;
                position: absolute; top: 3px" />
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" Style="left: 751px; position: absolute; top: 33px" 
