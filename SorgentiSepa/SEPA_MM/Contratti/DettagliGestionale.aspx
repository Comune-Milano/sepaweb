<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DettagliGestionale.aspx.vb"
    Inherits="Contratti_DettagliGestionale" %>
        ...
        <tr>
            <td>
                <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp Dettagli
                    documento gestionale DEBITO</strong></span>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                        <td colspan="3" style="padding-left: 10px; padding-top: 15px;">
                            <asp:DataGrid ID="DataGrDettaglio" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                                ...
                                ForeColor="#333333" BorderStyle="Solid" BorderWidth="1px" CellSpacing="1" BackColor="#708ECB"
                                BorderColor="#3399FF">
