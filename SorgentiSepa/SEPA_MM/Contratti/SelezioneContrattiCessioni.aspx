<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelezioneContrattiCessioni.aspx.vb"
    Inherits="Contratti_SelezioneContrattiCessioni" %>
                    ...
                    <asp:DataGrid ID="datagridContr" runat="server" AutoGenerateColumns="False" Font-Names="Arial"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="ChSelezionato" runat="server" OnCheckedChanged="chkSelected_click" />
                            ...
                            <asp:BoundColumn DataField="EX_INTESTATARIO" HeaderText="EX INTEST.">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="NUOVO_INTEST" HeaderText="NUOVO INTEST.">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="DATA_CESSIONE" HeaderText="DATA CESSIONE">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>
                        </Columns>
...
<script type="text/javascript">
    ...
    function ConfermaProcedi() {
        chiediConferma = window.confirm("Attenzione...procedendo verrà creato un file XML valido per il versamento delle imposte. Continuare?");
