<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipologieBollette.aspx.vb"
    Inherits="Contratti_TipologieBollette" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Documenti Contabili</title>
...
<body style="width: 800px; left: 0px; background-repeat: no-repeat; background-image: url('../NuoveImm/SfondoMascheraContratti.jpg');">
    ...
    <table>
        <tr>
            <td style="height: 10px">
                <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp Elenco
                    Tipologie Bollette</strong></span>
            </td>
        </tr>
    </table>
    <div>
        <table style="width: 96%; margin-left: 10px;">
            ...
            <tr>
                <td style="width: 90%" valign="top">
                    <div style="overflow: auto; z-index: 100; height: 300px; width: 100%">
                        <asp:DataGrid ID="DataGrTipBol" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="DESCRIZIONE" HeaderText="DESCRIZIONE">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Width="80%" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="ACRONIMO" HeaderText="ACRONIMO">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                ...
                <td style="width: 20%; height: 20%;" valign="top">
                    ...
                    <asp:ImageButton ID="btnElimina" runat="server" ImageUrl="../NuoveImm/Img_Elimina.png"
                        ToolTip="Elimina Tipologia" OnClientClick="DeleteConfirm();" Visible="false" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td style="width: 90%; height: 60px;" valign="bottom" align="right">
    ...
    <div id="InseriMotivazione" style="margin: 0px; width: 100%; background-image: url('../NuoveImm/sfondo_grigio.png');
        height: 100%; position: fixed; top: 5px; left: 5px; z-index: 200; visibility: visible;">
        <div style="position: fixed; top: 50%; left: 50%; width: 492px; height: 320px; margin-left: -246px;
            ...
            <table width="460px" style="height: 250px; text-align: center; margin-left: 10px;
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <span style="font-size: 10pt; font-family: Arial">Acronimo</span>
                    </td>
                    <td style="vertical-align: top; text-align: left;">
                        <asp:TextBox ID="txtAcronimo" runat="server" Font-Names="Arial" Font-Size="10pt"
                            Width="309px" MaxLength="3" TabIndex="1" Height="20px" Font-Bold="True" CssClass="CSSmaiuscolo"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        ...
                        <asp:ImageButton ID="btn_chiudi" runat="server" ImageUrl="../NuoveImm/Img_AnnullaVal.png"
                            OnClientClick="document.getElementById('InseriMotivazione').style.visibility='hidden'; document.getElementById('txtAcronimo').value='';" />
                    </td>
                </tr>
            </table>
        </div>
