...
Partial Class Contratti_Canone392
            ...
            If txtpg.Text <> "" And txtCanoneCorrente.Text <> "" And txtData.Text <> "" And par.AggiustaData(txtData.Text) <= Format(Now, "yyyyMMdd") Then
                ...
                If myReader.Read = True Then
                    ...
                    par.cmd.CommandText = "Insert into siscom_mi.UNITA_ASSEGNATE (ID_DOMANDA, ID_UNITA, DATA_ASSEGNAZIONE, " _
                                        ...
                                        & "', '" & par.PulisciStrSql(cf) & "', 'Q', 0," & par.VirgoleInPunti(txtCanoneCorrente.Text) & "," & Indice & ",'" & par.PulisciStrSql(txtpg.Text) & "','" & par.AggiustaData(txtData.Text) & "')"
                    ...
                    Dim SriptJSContratto As String = "var chiediConferma;" _
                                              ...
                                              & "a = window.open('Contratto.aspx?ID=-1&IdDichiarazione=" & Indice & "&IdDomanda=-1&IdUnita=" & Unita & "&TIPO=5&Lett=Q','Contratto" & Format(Now, "hhss") & "','height=780,width=1160');" _
                                              & "window.close();}" _
                                              & "else {" _
                                              & "window.close();" _
                                              & "}"
