<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElencoErrDepCauz.aspx.vb"
    Inherits="Contratti_ElencoErrDepCauz" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Elenco Errori Su Elaborazione Interessi Depositi Cauzionali</title>
</head>
<body bgcolor="#f2f5f1">
        ...
        <tr>
            <td>
                ...
                <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Elenco
                    anomalie elaborazione interessi depositi cauzionali </strong>
                </span>
                <br />
                <br />
                <br />
    ...
    <div style="overflow: auto; position: absolute; width: 776px; height: 433px; top: 57px;
        ...
        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                <asp:BoundColumn DataField="DATA_REST_INTERESSI" HeaderText="DATA CALCOLO">
                    <HeaderStyle Width="150px" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="INIZIO" HeaderText="DATA/ORA INIZIO ELAB.">
                    <HeaderStyle Width="150px" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="ERRORE" HeaderText="DESCRIZIONE ANOMALIA">
                    <HeaderStyle Width="300px" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="OPERATORE" HeaderText="VISTO DA OPERATORE">
                </asp:BoundColumn>
            </Columns>
