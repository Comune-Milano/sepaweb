<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElencoDomScad.aspx.vb" Inherits="Contratti_ElencoDomScad" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Elenco Domande in Scadenza</title>
</head>
<body bgcolor="#f2f5f1">
    ...
    <table style="left: 0px; background-image: url(../Condomini/Immagini/SfondoMascheraContratti.jpg);
        ...
        <tr>
            <td>
                ...
                <br />
                <br />
                <asp:DropDownList ID="cmbOperatore" runat="server" 
                    style="position:absolute; top: 77px; left: 78px; height: 20px;" Font-Names="arial" 
                    Font-Size="8pt" AutoPostBack="True">
                </asp:DropDownList>
                <asp:Label ID="Label10" runat="server" Text="Operatore" 
                    style="position:absolute; top: 80px; left: 13px;" Font-Bold="True" 
                    Font-Names="arial" Font-Size="8pt"></asp:Label>
                    <asp:Label ID="Label1" runat="server" Text="Tipo Domanda" 
                    style="position:absolute; top: 80px; left: 372px;" Font-Bold="True" 
                    Font-Names="arial" Font-Size="8pt"></asp:Label>
                    <asp:DropDownList ID="cmbTipodomanda" runat="server" 
                    style="position:absolute; top: 77px; left: 460px;" Font-Names="arial" 
                    Font-Size="8pt" AutoPostBack="True">
                </asp:DropDownList>
                <br />
                <br />
    ...
    <div style="overflow: auto; position: absolute; width: 776px; height: 363px; top: 116px;
        left: 14px;">
        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="DATAPRES" HeaderText="DATA PRESENTAZIONE">
                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Wrap="False" HorizontalAlign="Center" />
                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Wrap="False" HorizontalAlign="Center" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="DATASCAD" HeaderText="DATA SCADENZA">
                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Wrap="False" HorizontalAlign="Center" />
                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Wrap="False" HorizontalAlign="Center" />
