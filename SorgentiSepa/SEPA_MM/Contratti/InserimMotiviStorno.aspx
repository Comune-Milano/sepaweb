<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InserimMotiviStorno.aspx.vb"
    Inherits="Contratti_InserimMotiviStorno" %>
        ...
        <tr>
            <td style="height: 10px">
                <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp Elenco
                    Motivazioni Storno</strong></span>
            </td>
        </tr>
    </table>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; text-align: left;">
                        <asp:TextBox ID="txtMotivazione" runat="server" Font-Names="Arial" Font-Size="10pt"
                            Width="309px" MaxLength="400" TabIndex="1" Height="61px" Font-Bold="True" CssClass="CSSmaiuscolo"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <tr>
                <td style="width: 80%" valign="top">
                    <div style="overflow: auto; z-index: 100;">
                        <asp:DataGrid ID="DataGrMotivStorno" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
