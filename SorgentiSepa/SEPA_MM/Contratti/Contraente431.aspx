<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Contraente431.aspx.vb" Inherits="Contratti_Contraente431" %>
            ...
            <tr>
                <td style="width: 800px">
                    ...
                    <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp;Seleziona/Inserisci
                        Nominativo per abbinamento 431/98</strong></span><br />
                    <br />
                    <br />
                    <br />
                    &nbsp;<br />
                    ...
                    <asp:ImageButton ID="ImgSeleziona" runat="server" ImageUrl="~/NuoveImm/Img_RicercaDaAnagrafica.png"
                        Style="left: 33px; position: absolute; top: 516px; right: 677px;" 
                    ...
                    <asp:ImageButton ID="ImgProcedi" runat="server" ImageUrl="~/NuoveImm/Img_Procedi.png"
                        Style="left: 574px; position: absolute; top: 516px; right: 136px;" TabIndex="22" 
                        onclientclick="VerPIVA()" />
                    <br />
                    ...
                    <asp:Label ID="Label17" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        <asp:TextBox ID="txtComuneResidenza" runat="server" BorderStyle="Solid" BorderWidth="1px"
                            ...
                            MaxLength="6" Style="z-index: 107; left: 497px; position: absolute; top: 350px; width: 47px; height: 20px;"
                    ...
                    <asp:Label ID="lblErrore" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                        ...
                        top: 419px" Visible="False" Width="506px"></asp:Label>
