...
Partial Class Contratti_Contraente392
        ...
        Try
            ...
            If (lblErrore.Visible = False AndAlso par.IfEmpty(Me.txtDocRilasciato.Text, "Null") <> "Null" AndAlso par.IfEmpty(Me.txtDataDoc.Text, "Null") <> "Null" AndAlso par.IfEmpty(Me.txtNumDoc.Text, "Null") <> "Null" AndAlso par.IfEmpty(Me.txtNome.Text, "Null") <> "Null" AndAlso par.IfEmpty(Me.txtCognome.Text, "Null") <> "Null" AndAlso par.IfEmpty(Me.txtCF.Text, "Null") <> "Null") Or (par.IfEmpty(Me.txtRagione.Text, "Null") <> "Null" AndAlso par.IfEmpty(Me.txtPIva.Text, "Null") <> "Null") Then
                ...
                If myReader.HasRows = True Then
                    ...
                    End If
                Else
                    'par.cmd.CommandText = "INSERT INTO SISCOM_MI.ANAGRAFICA (ID, NOME, COGNOME, COD_FISCALE, PARTITA_IVA, RAGIONE_SOCIALE, CITTADINANZA, RESIDENZA, DATA_NASCITA, COD_COMUNE_NASCITA, SESSO, TELEFONO,TIPO_DOC,NUM_DOC,DATA_DOC,RILASCIO_DOC)" _
                    '& "VALUES(SISCOM_MI.SEQ_ANAGRAFICA.NEXTVAL,'" & par.PulisciStrSql(Me.txtNome.Text) & "','" & par.PulisciStrSql(Me.txtCognome.Text) & "', '" & par.PulisciStrSql(Me.txtCF.Text) & "', '" & par.PulisciStrSql(Me.txtPIva.Text) & "'" _
                    '& ", '" & par.PulisciStrSql(Me.txtRagione.Text) & "','" & par.PulisciStrSql(cmbCittadinanza.SelectedItem.Text) & "', '" & par.PulisciStrSql(Me.txtResidenza.Text) & "', '" & par.AggiustaData(Me.txtDataNascita.Text) & "', '" & CmbComune.SelectedItem.Value & "' " _
                    '& ",'" & Me.cmbSesso.SelectedItem.Text & "','" & par.PulisciStrSql(Me.txtTel.Text) & "'," & cmbTipoDoc.SelectedItem.Value & ",'" & par.PulisciStrSql(txtNumDoc.Text) & "','" & par.AggiustaData(txtDataDoc.Text) & "','" & par.PulisciStrSql(txtDocRilasciato.Text) & "')"
                    ...
                    & ", '" & par.PulisciStrSql(LTrim(RTrim(Me.txtRagione.Text))) & "','" & par.PulisciStrSql(Me.cmbCittadinanza.SelectedItem.Text) & "', '" & par.PulisciStrSql(txtComuneResidenza.Text & " (" & txtProvinciaResidenza.Text & ") " & LTrim(RTrim(txtIndirizzoResidenza.Text)) & ", " & txtCivicoResidenza.Text) & "', '" & par.AggiustaData(Me.txtDataNascita.Text) & "', '" & COMUNE_NASCITA & "'" _
                    ...
                    & "','" & par.PulisciStrSql(txtComuneResidenza.Text) & "','" & par.PulisciStrSql(txtProvinciaResidenza.Text) & "','" & par.PulisciStrSql(LTrim(RTrim(txtIndirizzoResidenza.Text))) & "','" & par.PulisciStrSql(txtCivicoResidenza.Text) & "','" & par.PulisciStrSql(LTrim(RTrim(txtSoggiorno.Text))) & "','" & par.PulisciStrSql(txtCAP.Text) & "')"
                    par.cmd.ExecuteNonQuery()
