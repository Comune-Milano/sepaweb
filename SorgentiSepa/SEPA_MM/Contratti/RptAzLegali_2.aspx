<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptAzLegali_2.aspx.vb" Inherits="Contratti_RptAzLegali_2" %>
...
<head runat="server">
    ...
    <title>Rpt Controllo Anagrafico Deceduti Mononucleo</title>
</head>
<body>
        ...
        <table>
            <tr>
                ...
                <td style="text-align: center; width: 100%; font-size: 10pt; font-family: Arial; color: #416094; font-weight: bold;">
                    <asp:Label ID="lblTitolo" runat="server" Text="Elenco Contratti Titolare Mononucleo Deceduto" Font-Size="20px"></asp:Label>
                </td>
                <td>&nbsp</td>
            </tr>
        </table>
                        ...
                        <telerik:RadGrid ID="RadGridAzLegali" runat="server" GroupPanelPosition="Top" resolvedrendermode="Classic"
                            ...
                            <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="ESITO_CTRL_ANAGRAF" HeaderText="ESITO CONTROLLO ANAG." CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True" CurrentFilterValue="Titolare mononucleo deced.">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridBoundColumn>
                                </Columns>
