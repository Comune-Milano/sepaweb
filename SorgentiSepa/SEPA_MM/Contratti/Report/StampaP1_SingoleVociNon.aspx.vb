...
Partial Class Contratti_Report_StampaP1_SingoleVociNon
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                ...
                Me.Label6.Text = "PAGAMENTI NON PERVENUTI PER SINGOLE VOCI BOLLETTA </br>"
                ...
                'par.cmd.CommandText = "select sum(importo) from siscom_mi.bol_bollette_voci where id_bolletta in (" & Session.Item("REPORT_ANNULLATE") & ")"
                ...
                '        lblTotDeiTot0.Text = lblTotDeiTot0.Text & " " & Format(myReader5(0), "##,##0.00") & "<br/>Le bollette annullate ma incassate devono essere ripristinate!"
