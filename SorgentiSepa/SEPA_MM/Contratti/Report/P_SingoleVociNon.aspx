<%@ Page Language="VB" AutoEventWireup="false" CodeFile="P_SingoleVociNon.aspx.vb" Inherits="Contratti_Report_P_SingoleVociNon" %>
...
document.onkeydown=$onkeydown;
                ...
                <tr>
                    <td style="width: 800px">
                        ...
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Pagamenti
                            NON Pervenuti per Singole Voci 
                        </strong></span>
                        <br />
                        <br />
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtRifAl"
                            ErrorMessage="!" Font-Bold="True" Style="left: 517px; position: absolute;
                            top: 148px" 
            ...
            <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
                Style="z-index: 101; left: 533px; position: absolute; top: 486px; width: 130px;" 
