<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StampaD_SingoleVoci.aspx.vb" Inherits="Contratti_Report_StampaP_SingoleVoci" %>
...
<body>
    ...
    <div style="text-align: left">
        ...
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="14pt"
            Style="z-index: 100; left: 215px; top: 11px" Width="388px">DISTINTA PER SINGOLE VOCI BOLLETTA</asp:Label></td>
            </tr>
        </table>
        &nbsp;
        <br />
    ...
    <p>
                                <asp:Label ID="lblTotDeiTot" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                                    ForeColor="RoyalBlue" Style="z-index: 100; left: 215px; top: 11px" Width="100%">TOTALE GENERALE  PARI A €</asp:Label></p>
        <p>
                                <asp:Label ID="lblTotDeiTot0" runat="server" Font-Bold="True" 
                                    Font-Names="Arial" Font-Size="12pt"
                                    ForeColor="RoyalBlue" Style="z-index: 100; left: 215px; top: 11px" 
