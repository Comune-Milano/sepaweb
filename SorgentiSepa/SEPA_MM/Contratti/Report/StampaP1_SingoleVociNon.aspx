<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StampaP1_SingoleVociNon.aspx.vb" Inherits="Contratti_Report_StampaP1_SingoleVociNon" %>
...
<body>
    ...
    <p>
                                <asp:Label ID="lblTotDeiTot" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                                    ForeColor="RoyalBlue" Style="z-index: 100; left: 215px; top: 11px" Width="100%">TOTALE NON INCASSATO  PARI A €</asp:Label></p>
        <p>
                                &nbsp;</p>
    <p>
