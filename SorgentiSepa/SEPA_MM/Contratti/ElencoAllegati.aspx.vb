    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Request.QueryString("LT") <> "1" Then
                ...
                MiaSHTML = MiaSHTML & "<td width='10%'><font size='2' face='Arial'>Elimina</font></td>" & vbCrLf
            Else
            ...
            If i > 0 Then
                For j = 0 To i - 1
                    ...
                    If Request.QueryString("LT") <> "1" Then
                        ...
                        MiaSHTML = MiaSHTML & "<td width='10%' bgcolor='" & MIOCOLORE & "'><a href='CancellaAllegato.aspx?X=" & par.Cripta(Indicecontratto) & "&D=" & par.Cripta(Mid(DESCRIZIONE_ALLEGATO, 1, 50)) & "&NOME=" & par.Cripta(RicavaFile(ElencoFile(j))) & "&EXT=ZIP' target='_blank'><img border='0' src='../NuoveImm/Elimina.png'></a></td>" & vbCrLf
                    Else
