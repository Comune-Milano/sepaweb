...
<body bgcolor="White">
    ...
    <div style="width: 776px;overflow:scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent" >
     ...
     <asp:DataGrid ID="Datagrid2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            PageSize="200" Style="z-index: 101; left: 9px; width: 1800px;" TabIndex="1" BorderWidth="0px">
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="TIPO CONTR. SPEC.">
                 ...
                 <asp:TemplateColumn HeaderText="ORIGINE">
                    <ItemTemplate>
                        <asp:Label ID="Label8" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ORIGINE") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Wrap="False" />
                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                ...
                <asp:TemplateColumn HeaderText="CAP">
                    <ItemTemplate>
                        <asp:Label ID="Label15" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CAP") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Wrap="False" />
                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                ...
                <asp:TemplateColumn HeaderText="PIANO RECAPITO">
                    <ItemTemplate>
                        <asp:Label ID="Label16" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.PIANO_RECAPITO") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.PIANO_RECAPITO") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="INTERNO RECAPITO">
                    <ItemTemplate>
                        <asp:Label ID="Label17" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.INTERNO_RECAPITO") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox4" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.INTERNO_RECAPITO") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="SCALA RECAPITO">
                    <ItemTemplate>
                        <asp:Label ID="Label18" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.SCALA_RECAPITO") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox5" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.SCALA_RECAPITO") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="DECRETO DECAD.">
                    <ItemTemplate>
                        <asp:Label ID="Label18" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.decreto_decadenza") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox5" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.decreto_decadenza") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="ESITO CONTROLLO ANAG.">
                    <ItemTemplate>
                        <asp:Label ID="Label18" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.esito_ctrl_anagraf") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox5" runat="server" 
                            Text='<%# DataBinder.Eval(Container, "DataItem.esito_ctrl_anagraf") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateColumn>
    ...
    <div id="DivFooterRow" style="overflow:hidden">
                ...
                <asp:Label ID="Label5" runat="server" Font-Names="ARIAL" Font-Size="8pt" 
                    Text="Attenzione: i codici rapporto che iniziano con le cifre 000000, 41, 42 e 43 identificano i rapporti 'virtuali' resisi recessari ai fini della bollettazione 'in fotocopia.'"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
