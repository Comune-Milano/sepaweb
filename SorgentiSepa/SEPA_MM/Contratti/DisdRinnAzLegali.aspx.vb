...
Partial Class Contratti_DisdRinnAzLegali
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.TxtDataContGiudiziari.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataContAnag.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            'Me.TxtDataMesseInMora.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataMorosita.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataReqGenerali.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataStatoAbitativo.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtRinnovoData.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            'Me.TxtDataMesseInMora.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")

            Me.TxtDataDecorrReqGen.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataDecorrMorosita.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataDecorrStatoAbit.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataDecorrContGiudiz.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataDecorrMesseInMora.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataDecorrContGiudiz.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtRinnovoDataDecorr.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.TxtDataDecorrContAnag.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")

            If vIdContratto <> "" Then
                '*********************APERTURA CONNESSIONE**********************
                If par.OracleConn.State = Data.ConnectionState.Closed Then
                    par.OracleConn.Open()
                    par.SettaCommand(par)
                End If
                par.cmd.CommandText = "SELECT * FROM SISCOM_MI.RAPPORTI_UTENZA_CONTROLLO WHERE ID_CONTRATTO = '" & vIdContratto & "'"
                ...
                If myReader.Read Then
                    Try
                        ...
                        If Me.cmbReqGenerali.SelectedValue >= 1 Then
    ...
    Private Sub CtrInterventoVerificaSEC()
        Try
            ...
            par.cmd.CommandText = "select id_unita from siscom_mi.unita_contrattuale where id_Contratto=" & vIdContratto & " and id_unita_principale is null"
        ...
        Try
            ...
            If Me.CmbRinnovoAmmissibile.SelectedValue <> "0" And Me.CmbRinnovoAmmissibile.SelectedValue <> "" Then
                ...
                par.cmd.CommandText = "UPDATE SISCOM_MI.RAPPORTI_UTENZA_CONTROLLO SET REQ_GENERALI =" & Me.cmbReqGenerali.SelectedValue & ", REQ_GENERALI_ESITO = " & Me.cmbReqGenEsito.SelectedValue & ", REQ_GENERALI_DATA='" & par.AggiustaData(Me.TxtDataReqGenerali.Text) & "', " _
                                        ...
                                        & " WHERE ID_CONTRATTO= " & vIdContratto
    ...
    Protected Sub cmbReqGenerali_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbReqGenerali.SelectedIndexChanged
        If par.IfEmpty(cmbReqGenerali.SelectedValue, 0) >= 1 Then
            Me.cmbReqGenEsito.Enabled = True
    ...
    Private Sub ControllaAzLegali()
        ...
        Try
            ...
            If decretoDecadenza = 1 Then
                par.cmd.CommandText = "UPDATE UTENZA_LISTE_CDETT SET MOTIVAZIONE='EMISSIONE DECRETO DECADENZA',ID_LISTA_CONV=NULL WHERE ID_CONTRATTO=" & vIdContratto & " AND ID_LISTA = (SELECT MAX(ID_LISTA) FROM UTENZA_LISTE_CDETT ULCD WHERE UTENZA_LISTE_CDETT.ID_CONTRATTO=ULCD.ID_CONTRATTO )"
                par.cmd.ExecuteNonQuery()
            End If
            If intestMononucleoDeceduto = 1 Then
                par.cmd.CommandText = "UPDATE UTENZA_LISTE_CDETT SET MOTIVAZIONE='TITOLARE MONONUCLEO DECEDUTO',ID_LISTA_CONV=NULL WHERE ID_CONTRATTO=" & vIdContratto & " AND ID_LISTA = (SELECT MAX(ID_LISTA) FROM UTENZA_LISTE_CDETT ULCD WHERE UTENZA_LISTE_CDETT.ID_CONTRATTO=ULCD.ID_CONTRATTO )"
                par.cmd.ExecuteNonQuery()
            End If
