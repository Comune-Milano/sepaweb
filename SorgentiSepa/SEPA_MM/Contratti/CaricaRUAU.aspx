<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CaricaRUAU.aspx.vb" Inherits="Contratti_CaricaRUAU" %>
        ...
        <tr>
            <td>
                ...
                <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; </strong>
                    <asp:Label ID="Label26" runat="server" Text="Report RU-AU" 
                ...
                <br />
                <br />
                <img style="position: absolute; top: 298px; left: 15px;" alt="" src="EsempioRUAU.jpg" />
                <br />
                <br />
                <asp:HiddenField ID="LBLID" runat="server" Value="0" />
                <asp:HiddenField ID="npg" runat="server" Value="" />
                <asp:Label ID="Label25" runat="server" Text="ATTENZIONE...Il file deve essere IN FORMATO TXT e strutturato come mostrato in figura, con il carattere ; (punto e virgola) finale, senza righe vuote. Massimo 1000 contratti per file."
