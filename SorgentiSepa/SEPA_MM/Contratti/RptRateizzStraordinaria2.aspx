<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptRateizzStraordinaria2.aspx.vb" Inherits="Contratti_RptRateizzStraordinaria2" %>
...
<head runat="server">
    ...
    <title>Rpt capienza rateizzazione straordinaria</title>
</head>
<body>
        ...
        <table>
            <tr>
                ...
                <td style="text-align: center; width: 100%; font-size: 10pt; font-family: Arial; color: #416094; font-weight: bold;">
                    <asp:Label ID="lblTitolo" runat="server" Text="Elenco Utenti Capienti" Font-Size="20px"></asp:Label>
                </td>
                <td>&nbsp</td>
            </tr>
        </table>
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" GroupPanelPosition="Top" resolvedrendermode="Classic"
                            ...
                            <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridDateTimeColumn DataField="STATO_CONTRATTO" HeaderText="STATO CONTR." CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn DataField="DATA_PRESENTAZIONE" HeaderText="DATA PRESENTAZIONE" CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn DataField="PG_DOMANDA" HeaderText="PG DOMANDA" CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True">
                                        <HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" />
                                    </telerik:GridDateTimeColumn>
