<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoGestionali.aspx.vb"
    Inherits="Contratti_RisultatoGestionali" %>
...
<body>
            ...
            <tr>
                <td>
                    <table style="width: 100%;">
                        <tr>
                            <td class="style3">
                                <asp:DropDownList ID="cmbElementi" runat="server" AutoPostBack="True" 
                                    CausesValidation="True" Font-Names="arial" Font-Size="8pt">
                                    <asp:ListItem Selected="True">150</asp:ListItem>
                            ...
                            <td class="style2">
                                <asp:Label ID="Label13" runat="server" Font-Names="arial" Font-Size="8pt" 
                                    Text="elementi per pagina"></asp:Label>
                            </td>
                            <td class="style1">
                                &nbsp;</td>
                            <td width="2%">
                                <hr align="left" style="vertical-align: middle; color: #008400;" width="20px" />
                            </td>
                            <td width="10%">
                                <asp:Label ID="Label2" runat="server" Text="Importo a credito" ForeColor="#008400"
                                    Font-Names="Arial" Font-Size="8pt" Font-Bold="True" Width="100%"></asp:Label>
                            </td>
                            <td width="2%">
                                <hr align="left" style="vertical-align: middle; color: red;" width="20px" />
                            </td>
                            <td width="80%">
                                <asp:Label ID="Label3" runat="server" Text="Importo a debito" ForeColor="Red" Font-Names="Arial"
                            ...
                            <td>
                                <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="../NuoveImm/Img_EsciCorto.png"
                                    Style="" ToolTip="Esci" CausesValidation="False" TabIndex="2" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Font-Bold="False"
                        ...
                        Font-Strikeout="False" Font-Underline="False" CellPadding="4" ForeColor="#333333"
                        Width="100%" AllowPaging="True" PageSize="150">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="ChParziale" runat="server" OnClick="ScegliPercentuale(this);" />
                            ...
                            <asp:BoundColumn DataField="DETTAGLI" HeaderText="">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function controllaSelezioneCheck() {
            ...
            if (errore == '1') {
                alert('Selezionare almeno un contratto da elaborare!');
                document.getElementById('errore').value = errore;
                document.getElementById('errore').value = errore;
            }
            //          else {
            //                if (errore2 == '1') {
            //                    alert('Tipo di applicazione non selezionata. Impossibile procedere!');
            //                    document.getElementById('errore').value = errore2;
            //                }
            //          }
            if (errore == '0') {
        ...
        function ScegliPercentuale(checkParz) {
            if (checkParz.checked) {
