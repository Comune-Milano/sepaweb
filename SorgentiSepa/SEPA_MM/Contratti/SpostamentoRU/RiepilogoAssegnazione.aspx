<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RiepilogoAssegnazione.aspx.vb"
    Inherits="Contratti_SpostamentoRU_RiepilogoAssegnazione" %>
...
<body>
            ...
            <tr>
                <td style="padding-left: 580px;">
                    <asp:ImageButton ID="btnProcedi" runat="server" ImageUrl="../../NuoveImm/Img_Procedi.png"
                        TabIndex="30" ToolTip="Procedi" Enabled="True" OnClientClick="Conferma();" />
    ...
    <script type="text/javascript">
        ...
        function Conferma() {
            var avviso = false;
            if (document.getElementById('HiddenScelta').value == '3' && (document.getElementById('txtDataNuova').value == '' || document.getElementById('txtDataConsegna').value == '' || document.getElementById('cmbMotivazioni').value == '-1')) {
