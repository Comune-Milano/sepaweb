<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BManager.aspx.vb" Inherits="Condomini_Delegati" %>
...
<body style="background-attachment: fixed; background-image: url(Immagini/SfondoMascheraContratti.jpg); background-repeat: no-repeat">
 <script type="text/javascript"  >
    ...
    <div>
        <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">Gestione Building
            Manager
            <div style="left: 11px; overflow: auto; width: 703px; position: absolute; top: 56px;
            height: 347px">
            <asp:DataGrid ID="DataGridBManager" runat="server" AutoGenerateColumns="False"
            ...
            <asp:Label ID="LblErrore" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="Red" Style="left: 269px; position: absolute; top: 19px" Text="Label"
                Visible="False" Width="514px"></asp:Label>
            ...
            <img id="IMG1" alt="Aggiungi Building Manager" onclick="document.getElementById('TextBox1').value='0';myOpacity.toggle();"
                src="../NuoveImm/Img_Aggiungi.png" style="left: 718px; width: 60px; cursor: pointer;
                position: absolute; top: 57px" />
            <div 
            style="border-color: #3366ff; border-width: thin; z-index: 201; left: 0px; visibility: visible; vertical-align: top; width: 803px; position: absolute;
                top: 01px; height: 582px; background-color: #dedede; text-align: left; background-image: url('../NuoveImm/SfondoMascheraContratti.jpg');" 
            id="DivDelegato">
