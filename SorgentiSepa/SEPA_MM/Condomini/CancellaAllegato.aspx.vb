    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                If Not String.IsNullOrEmpty(Request.QueryString("CALL")) Then
                    My.Computer.FileSystem.DeleteFile(Server.MapPath("../ALLEGATI/MOROSITA_CONDOMINI/") & Request.QueryString("NOME"))

                Else
                    My.Computer.FileSystem.DeleteFile(Server.MapPath("../ALLEGATI/CONDOMINI/") & Request.QueryString("NOME"))
