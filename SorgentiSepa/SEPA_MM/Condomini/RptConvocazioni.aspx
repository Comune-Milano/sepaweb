<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptConvocazioni.aspx.vb"
    Inherits="Condomini_RptConvocazioni" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Report Convocazioni</title>
</head>
<body>
        ...
        <tr>
            <td style="vertical-align: top; text-align: center">
                <asp:ImageButton ID="btnStampa" runat="server" ImageUrl="~/NuoveImm/Img_Stampa.png"
                    Style="z-index: 102; right: 817px; left: 121px; position: absolute; top: 16px"
                    TabIndex="2" ToolTip="Stampa il file in formato PDF" />
                <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="14pt"
                    Style="font-size: small; z-index: 100; left: 215px; top: 11px" Width="558px">REPORT CONVOCAZIONI CONDOMINIALI</asp:Label><br />
                <br />
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top; text-align: left">
                <asp:DataGrid ID="DataGridRPTConv" runat="server" AutoGenerateColumns="False" CellPadding="2"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="ORA" HeaderText="ORA"></asp:BoundColumn>
                        ...
                        <asp:TemplateColumn HeaderText="MILL." Visible="False">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MILL") %>'></asp:Label>
                            </ItemTemplate>
    ...
    <p>
        <asp:ImageButton ID="btnExport" runat="server" ImageUrl="~/NuoveImm/Img_ExportExcel.png"
            Style="z-index: 102; right: 921px; left: 17px; position: absolute; top: 16px; height: 12px;"
