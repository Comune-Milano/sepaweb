...
Partial Class Condomini_Delegati
    ...
    Private Sub Cerca()
        Try
            ...
            End If
            par.cmd.CommandText = "SELECT * FROM SISCOM_MI.COND_DELEGATI ORDER BY COGNOME ASC"
        ...
        If Not String.IsNullOrEmpty(Me.txtCognome.Text) Then
            Try
                ...
                Else
                    ...
                    End If
                    Try
                        par.cmd.CommandText = "INSERT INTO SISCOM_MI.COND_DELEGATI(ID,COGNOME,NOME) VALUES(SISCOM_MI.SEQ_COND_DELEGATI.NEXTVAL,' " & par.PulisciStrSql(Me.txtCognome.Text.ToUpper) & "', '" & par.PulisciStrSql(Me.TxtNome.Text.ToUpper) & "')"
                    ...
                    Catch ex1 As Oracle.DataAccess.Client.OracleException
                        If EX1.Number = 1 Then
                            Response.Write("<script>alert('ATTENZIONE...Il delegato che si cerca di inserire è già presente nell\'archivio!')</script>")
                            '*********************CHIUSURA CONNESSIONE**********************
                            par.OracleConn.Close()
                            Oracle.DataAccess.Client.OracleConnection.ClearAllPools()
                            Me.txtCognome.Text = ""
        ...
        If Not String.IsNullOrEmpty(Me.txtCognome.Text) Then
            Try
                ...
                If par.OracleConn.State = Data.ConnectionState.Closed Then
                    ...
                    par.SettaCommand(par)
                End If
                par.cmd.CommandText = "UPDATE SISCOM_MI.COND_DELEGATI SET COGNOME = ' " & par.PulisciStrSql(Me.txtCognome.Text.ToUpper) & "', NOME = '" & par.PulisciStrSql(Me.TxtNome.Text.ToUpper) & "' WHERE ID = " & Me.txtid.Value
                par.cmd.ExecuteNonQuery()
                Me.txtid.Value = ""
        ...
        Try
            ...
            If txtid.Value.ToString <> "" Then
                ...
                If par.OracleConn.State = Data.ConnectionState.Closed Then
                    ...
                    par.SettaCommand(par)
                End If
                par.cmd.CommandText = "SELECT  * FROM SISCOM_MI.COND_DELEGATI WHERE ID = " & Me.txtid.Value
    ...
    Protected Sub ImgBtnAggiungi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtnAggiungi.Click
        Try
            ...
            If txtConfElimina.Value = 1 Then
                ...
                If par.IfEmpty(Me.txtid.Value, "") <> "" Then
                    ...
                    par.cmd.CommandText = "DELETE FROM SISCOM_MI.COND_DELEGATI WHERE ID = " & Me.txtid.Value
                    par.cmd.ExecuteNonQuery()
                    par.OracleConn.Close()
                    Oracle.DataAccess.Client.OracleConnection.ClearAllPools()
                    Cerca()
        ...
        Catch EX1 As Oracle.DataAccess.Client.OracleException
            ...
            If EX1.Number = 2292 Then
                LblErrore.Text = "Building Manager in uso. Non è possibile eliminare il delegato selezionato!"
                par.OracleConn.Close()
                Oracle.DataAccess.Client.OracleConnection.ClearAllPools()
            Else
