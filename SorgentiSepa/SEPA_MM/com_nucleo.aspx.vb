...
Partial Class prova
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If txtOperazione.Text = "0" Then
            Cache(Session.Item("GLista")) = par.MiaFormat(UCase(txtCognome.Text), 25) & " " & par.MiaFormat(UCase(txtNome.Text), 25) & " " & par.MiaFormat(txtData.Text, 10) & " " & par.MiaFormat(UCase(txtCF.Text), 16) & " " & par.MiaFormat(cmbParenti.SelectedItem.Text, 25) & " " & par.MiaFormat(txtInv.Text, 6) & " " & par.MiaFormat(txtASL.Text, 5) & " " & par.MiaFormat(cmbAcc.SelectedItem.Text, 2)

            If Val(txtInv.Text) = 100 And cmbAcc.SelectedItem.Text = "SI" Then
                Cache(Session.Item("GSpese")) = par.MiaFormat(UCase(txtCognome.Text) & "," & UCase(txtNome.Text), 52) & " "
            Else
