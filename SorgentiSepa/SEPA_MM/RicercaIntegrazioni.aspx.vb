...
Partial Class RicercaIntegrazioni
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            RiempiOperatori()
            NumOperatori = CheckOperatori.Items.Count
        End If

    End Sub

    Public Property NumOperatori() As Integer
        Get
            If Not (ViewState("par_NumOperatori") Is Nothing) Then
                Return CInt(ViewState("par_NumOperatori"))
            Else
                Return 0
            End If
        End Get
        ...
        Set(ByVal value As Integer)
            ViewState("par_NumOperatori") = value
        End Set
    ...
    Protected Sub btnCerca_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCerca.Click
        ...
        If Val(INTERVALLO_A) < Val(INTERVALLO_DA) Then
            ...
            Exit Sub
        End If
        Response.Write("<script>window.open('StampaIntegrazioni.aspx?PDA=" & INTERVALLO_DA & "&PA=" & INTERVALLO_A & "&OP=" & Operatore & "','Domande','');</script>")
    End Sub
