...
Partial Class SEGNALAZIONI_Agenda_DettagliAppuntamenti
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Session.Item("ID_sTRUTTURA") <> "-1" Then
            If Session.Item("MOD_SEGNALAZIONI") = "0" Then
                Response.Write("<script>top.location.href=""../../AccessoNegato.htm""</script>")
                Exit Sub
            End If
        End If
        ...
        If Not IsPostBack Then
            ...
            par.caricaComboBox("SELECT ID,DESCRIZIONE FROM SISCOM_MI.APPUNTAMENTI_STATI ORDER BY ID", cmbStato, "ID", "DESCRIZIONE", False)
            Try
            ...
            CaricaAppuntamenti()
        End If
        If Session.Item("MOD_SEGNALAZIONI_SL") = "1" Or Session.Item("ID_STRUTTURA") = "-1" Then
            soloLettura()
        End If
    End Sub
        ...
        Try
            ...
            For Each elemento As Data.DataRow In dtOrari.Rows
                par.cmd.CommandText = "SELECT APPUNTAMENTI_CALL_CENTER.ID, " _
                    ...
                    & " TELEFONO," _
                    & " CELLULARE," _
                    & " EMAIL,(SELECT DESCRIZIONE FROM SISCOM_MI.APPUNTAMENTI_STATI WHERE APPUNTAMENTI_STATI.ID=APPUNTAMENTI_CALL_cENTER.ID_sTATO_APPUNTAMENTO) AS STATO," _
