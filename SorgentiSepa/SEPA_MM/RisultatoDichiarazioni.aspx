<%@ Page Language="vb" AutoEventWireup="false" Inherits="CM.RisultatoDichiarazioni" CodeFile="RisultatoDichiarazioni.aspx.vb" EnableSessionState="ReadOnly" %>
            ...
            <table style="left: 0px; background-image: url(NuoveImm/SfondoMaschere.jpg); width: 674px;
                ...
                <tr>
                    <td>
						...
						</asp:datagrid><asp:label id="lbl1" runat="server" Font-Names="Arial" Font-Size="XX-Small" Font-Bold="True" BorderStyle="None" BorderColor="Black" ForeColor="Blue" style="z-index: 106; left: 98px; position: absolute; top: 283px">Selezionare il componente al quale verrà intestata la domanda e premere il pulsante "VISUALIZZA"</asp:label>
						<asp:Label id="Label2" runat="server" Font-Names="Arial" 
                Font-Bold="True" 
                style="z-index: 107; left: 9px; position: absolute; top: 310px" 
                Font-Size="12pt">Nessuna selezione</asp:Label>
            <asp:ImageButton ID="Button3" runat="server" ImageUrl="~/NuoveImm/Img_Visualizza.png"
                Style="z-index: 108; left: 394px; position: absolute; top: 350px" ToolTip="Visualizza" />
            <asp:ImageButton ID="Button2" runat="server" ImageUrl="~/NuoveImm/Img_Home.png" Style="z-index: 111;
                left: 527px; position: absolute; top: 350px" ToolTip="Home" />
        </form>
	</body>
</html>
