<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VariazioneFondi.aspx.vb"
    Inherits="VariazioneFondi" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ApriEventi() {
            window.open('EventiVariazioni.aspx', 'Eventi', '');
        }
                    ...
                    <tr>
                        <td width="80%">
                            <asp:Label ID="lblTitolo" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                                ForeColor="Maroon" Width="100%">Trasferimento fondi tra voci</asp:Label>
                        </td>
                        <td width="20%">
        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td style="width: 20%">
                            <asp:Label ID="Label3" runat="server" Text="Esercizio Finanziario*" Font-Names="Arial" Font-Size="9pt"></asp:Label>
                        </td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td style="width: 20%">
                            <asp:Label ID="Label1" runat="server" Text="Struttura*" Font-Names="Arial" 
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Voce di prelievo*" Font-Names="Arial"
                                Font-Size="9pt"></asp:Label>
                        </td>
                        <td colspan="2">
                            <asp:DropDownList ID="ddlPrelievo" runat="server" Font-Names="Arial" Font-Size="9pt"
                                Width="590px" AutoPostBack="True" Font-Overline="False">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblDestinazione" runat="server" Text="Voce di destinazione*" Font-Names="Arial"
                                Font-Size="9pt"></asp:Label>
                        </td>
                        <td colspan="2">
                            <asp:DropDownList ID="ddlDestinazione" runat="server" Font-Names="Arial" Font-Size="9pt"
                                Width="590px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="txtImporto" runat="server" Font-Names="Arial" Font-Size="9pt"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 15%">
                            <asp:ImageButton ID="btnHome" runat="server" ImageUrl="../../../NuoveImm/Img_HomeModelli.png"
                                ToolTip="Torna alla Home" style="text-align: right" />
                        </td>
                    </tr>
                </table>
            </td>
