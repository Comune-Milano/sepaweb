<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RiepilogoPerStrutture.aspx.vb"
    Inherits="RiepilogoPerStrutture" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Riepilogo Variazioni per Strutture</title>
</head>
<body>
    ...
    <table style="width: 100%;">
                    ...
                    <tr>
                        <td align="center">
                            <span style="font-family: Arial"><strong style="text-align: center">
                                <asp:Label ID="lbltitolo" runat="server" Font-Names="Arial" Font-Size="13pt">
                                Riepilogo Variazioni tra Voci e tra Strutture - Dettaglio per Strutture (Esercizio Finanziario <%=Titolo %>)
                                </asp:Label>
                            </strong></span>
                        </td>
                    </tr>
        ...
        <tr>
            <td style="text-align: center">
                <asp:Label ID="lblErrore" runat="server" Text="Errore caricamento dati" Font-Names="Arial"
