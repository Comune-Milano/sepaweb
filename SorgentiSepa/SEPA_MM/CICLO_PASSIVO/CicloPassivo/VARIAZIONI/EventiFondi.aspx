<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EventiFondi.aspx.vb"
    Inherits="EventiFondi" %>
...
<body>
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                <div>
                    <asp:Label ID="lblTitolo" runat="server" BorderStyle="None" BorderWidth="1px" Style="font-size: 11pt;
                        z-index: 100; left: 0px; font-family: Arial; position: static; top: 0px" Text="EVENTI VARIAZIONI"
                        Width="100%" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"></asp:Label>
                    <br />
                    <br />
                    ...
                    <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="VOCE" HeaderText="VOCE DI PRELIEVO"></asp:BoundColumn>
                            <asp:BoundColumn DataField="STRUTTURA_DA" HeaderText="STRUTTURA DI PRELIEVO"></asp:BoundColumn>
                            <asp:BoundColumn DataField="STRUTTURA_A" HeaderText="STRUTTURA DI DESTINAZIONE"></asp:BoundColumn>
                    ...
                    <asp:Label ID="lblTotale" runat="server" BorderStyle="None" BorderWidth="1px" Style="font-size: 11pt;
                        ...
                        text-align: left" Width="100%" Font-Bold="True" Font-Names="Arial" 
