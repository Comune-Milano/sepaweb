<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RiepilogoVariazioni.aspx.vb"
    Inherits="RiepilogoVariazioni" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Riepilogo Generale Variazioni</title>
</head>
<body>
                    ...
                    <tr>
                        <td align="center">
                            <span style="font-family: Arial"><strong style="text-align: center">
                                ...
                                Riepilogo Variazioni tra Voci - Raggruppamento per Capitoli (Esercizio Finanziario <%=Titolo %>)
                                </asp:Label>
                            </strong></span>
                        </td>
                    </tr>
