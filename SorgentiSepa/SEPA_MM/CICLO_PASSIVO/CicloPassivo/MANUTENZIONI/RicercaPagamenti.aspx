<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaPagamenti.aspx.vb"
    Inherits="MANUTENZIONI_RicercaPagamenti" %>
        ...
        <table style="width: 100%">
            <tr>
                <td class="TitoloModulo">
                   Ordini - Manutenzioni e servizi - SAL - Stampa pagamenti
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <br />
                    <div style="overflow: auto; width: 784px; height: 320px">
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        <div>
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="height: 21px">
                                        <telerik:RadComboBox ID="cmbStruttura" Width="60%" AppendDataBoundItems="true" Filter="Contains"
                                ...
                                <tr>
                                    <td style="height: 21px" width="10%">
                                        <asp:Label ID="Label1" runat="server" Width="150px">Esercizio Finanziario</asp:Label>
                                    </td>
                                    <td style="height: 21px">
                                        <telerik:RadComboBox ID="cmbEsercizio" Width="60%" AppendDataBoundItems="true" Filter="Contains"
                                            runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                            LoadingMessage="Caricamento...">
                                        </telerik:RadComboBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="height: 21px">
                                        <telerik:RadComboBox ID="cmbFornitore" Width="60%" AppendDataBoundItems="true" Filter="Contains"
                                            runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                            LoadingMessage="Caricamento...">
                                        </telerik:RadComboBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="cmbAppalto" Width="60%" AppendDataBoundItems="true" Filter="Contains"
                                            runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                            LoadingMessage="Caricamento...">
                                        </telerik:RadComboBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="cmbServizioVoce" Width="60%" AppendDataBoundItems="true"
                                ...
                                <tr>
                                    <td style="vertical-align: top; text-align: left" width="10%">
                                        <asp:Label ID="Label2" runat="server">Stato della firma</asp:Label>
                                    </td>
                                    <td>
                                        <telerik:RadComboBox ID="cmbStato" Width="60%" AppendDataBoundItems="true" Filter="Contains"
                                            runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                            LoadingMessage="Caricamento...">
                                            <Items>
