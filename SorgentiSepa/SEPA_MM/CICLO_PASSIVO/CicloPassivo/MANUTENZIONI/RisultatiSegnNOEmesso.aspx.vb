...
Partial Class CICLO_PASSIVO_CicloPassivo_MANUTENZIONI_RisultatiSegnNOEmesso
    ...
    '                            & " AND NOT EXISTS (SELECT ID FROM SISCOM_MI.MANUTENZIONI WHERE ID_SEGNALAZIONI=SEGNALAZIONI.ID AND MANUTENZIONI.STATO<5) " _
    ...
    Protected Sub brnRicerca_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles brnRicerca.Click
        Response.Write("<script>document.location.href=""RicercaSegnalazioniNOEmesso.aspx""</script>")
    End Sub
    ...
    Private Sub DataGridSegnalaz_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles DataGridSegnalaz.NeedDataSource
        Try
            Dim s As String = ""
    ...
    '        e.Item.Attributes.Add("onclick", "if (selezionato) {selezionato.style.backgroundColor='';}selezionato=this;this.style.backgroundColor='red';document.getElementById('identificativo').value='" & e.Item.Cells(3).Text & "';document.getElementById('tipo').value='" & e.Item.Cells(2).Text & "';document.getElementById('TextBox3').value='Hai selezionato la segnalazione N°" & e.Item.Cells(1).Text & "';document.getElementById('LBLID').value='" & e.Item.Cells(0).Text & "';document.getElementById('IDSTATO').value='" & e.Item.Cells(par.IndDGC(DataGridSegnalaz, "ID_STATO")).Text & "';")
    '        e.Item.Attributes.Add("onDblclick", "Apri();")
    '    End If
    ...
    Protected Sub imgApri_Click(sender As Object, e As System.EventArgs) Handles imgApri.Click
        ...
        Else
            ...
            Response.Write("<script>location.replace('Segnalazioni.aspx?TIPO=NE&IDS=" & LBLID.Value & "&ST=" & IDSTATO.Value & "&ORD=PER');</script>")
        End If
    End Sub
    ...
    Protected Sub brnRicerca_Click(sender As Object, e As System.EventArgs) Handles brnRicerca.Click
        Response.Redirect("RicercaSegnalazioniNOEmesso.aspx", True)
    End Sub
    ...
    Private Sub CICLO_PASSIVO_CicloPassivo_MANUTENZIONI_RisultatiSegnNOEmesso_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ScriptManager.RegisterStartupScript(Me, Me.GetType, "", "setDimensioni();", True)
    End Sub
End Class
