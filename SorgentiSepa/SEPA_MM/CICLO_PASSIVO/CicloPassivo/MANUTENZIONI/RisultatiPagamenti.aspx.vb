'*** LISTA RISULTATO PAGAMENTI da STAMPARE
Imports System.IO
...
Partial Class MANUTENAZIONI_RisultatiPagamenti
  ...
  TipoAllegato.Value = par.getIdOggettoAllegatiWs("SAL")
    ...
    Private Sub stampaP(Optional ByVal dataEmiss As String = Nothing)
        ...
        Try
            ...
            Else
                ...
                par.cmd.CommandText = "INSERT INTO SISCOM_MI.EVENTI_PAGAMENTI (ID_PAGAMENTO,ID_OPERATORE,DATA_ORA,COD_EVENTO,MOTIVAZIONE) VALUES ( " & Me.txtid.Text & "," & Session.Item("ID_OPERATORE") & ",'" & Format(Now, "yyyyMMddHHmmss") & "', 'F98','Stampa Attestato di Pagamento con data emissione del pagamento " & dataEmiss & "')"
                ...
                If myReader1.Read Then
                    ...
                    Dim anticipo As Decimal = CDec(par.IfEmpty(par.cmd.ExecuteScalar.ToString, "0"))
                    ...
                    par.cmd.CommandText = "select distinct(ID_VOCE)," _
                                        ...
                                        & " from SISCOM_MI.PF_VOCI_IMPORTO " _
                                          & " where ID in (select ID_PF_VOCE_IMPORTO from SISCOM_MI.MANUTENZIONI where ID_PAGAMENTO=" & Me.txtid.Text & ")"
                    ...
                    par.cmd.CommandText = "SELECT INITCAP(GESTORI_ORDINI.DESCRIZIONE) FROM SISCOM_MI.GESTORI_ORDINI,SISCOM_MI.APPALTI,SISCOM_MI.PAGAMENTI " _
                        & " WHERE APPALTI.ID_gESTORE_ORDINI=GESTORI_ORDINI.ID AND APPALTI.ID=PAGAMENTI.ID_APPALTO AND PAGAMENTI.ID=" & Me.txtid.Text
                ...
                nomefile = par.NomeFileManut("CDP", Me.txtid.Text) & ".pdf"
    ...
    Sub CalcolaImporti(ByVal importo As Decimal, ByVal IVA_CONSUMO As Decimal, ByVal rimborso As Decimal, ByVal penale As Decimal, ByVal Id_Voce As Decimal, ByVal Id_Appalto As Decimal, ByVal Oneri_Inseriti As Decimal)
        Dim sStr1 As String
        Dim perc_oneri As Decimal, perc_sconto As Decimal, perc_iva As Decimal
        Dim oneri As Decimal, asta As Decimal, iva As Decimal, risultato1 As Decimal, risultato2 As Decimal, risultato3 As Decimal, risultato4 As Decimal, ritenuta As Decimal, ritenutaIVATA As Decimal, risultato5 As Decimal
        Dim FlagConnessione As Boolean
    ...
    '                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 1, "PROG/ANNO", 0)
    '                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 2, "SAL/ANNO", 0)
    '                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 3, "EMISSIONE", 0)
    ...
    '                .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 6, "NUM. REPERTORIO", 0)
    ...
    '                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 1, oDataGridItem.Cells(1).Text, 0)
    ...
    '                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 3, oDataGridItem.Cells(4).Text, 0)
...
Protected Sub btnStampaPagamento_Click(sender As Object, e As System.EventArgs) Handles btnStampaPagamento.Click
        ...
        Try
            ...
            Else
                ...
                par.cmd.CommandText = "SELECT NOME FROM SISCOM_MI.ALLEGATI_WS WHERE TIPO = " & idTipoOggetto & " AND OGGETTO = " & TipoAllegato.Value & " AND ID_OGGETTO = " & txtid.Text
