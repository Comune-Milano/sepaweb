<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiManutenzioni.aspx.vb"
    Inherits="MANUTENZIONI_RisultatiManutenzioni" %>
    ...
    <form id="form1" runat="server" onsubmit="caricamento();return true;">
        ...
        <asp:Panel ID="panelContenuto" runat="server" Style="width: 100%">
            <table style="width: 100%">
                <tr>
                    <td class="TitoloModulo">Ordini - Manutenzioni e servizi - Ricerca - Selettiva
                    </td>
                </tr>
                <tr>
                    <td>
                            ...
                            <telerik:RadGrid ID="DataGrid1" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic"
                                ...
                                <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                    ...
                                    <CommandItemTemplate>
                                        <div style="display: inline-block; width: 100%;">
                                            <div style="float: right; padding: 4px;">
                                                ...
                                                <asp:Button ID="ButtonExportExcel" Text="text" runat="server" OnClick="Esporta_Click" Visible="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="NUM_REPERTORIO" HeaderText="NUM. REPERTORIO" Exportable="true" SortExpression="REP_ORD"
                                            HeaderStyle-Width="9%" FilterControlWidth="85%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                            DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <telerik:GridDateTimeColumn DataField="DATA_INIZIO_ORDINE" HeaderText="DATA" DataFormatString="{0:dd/MM/yyyy}" Exportable="true"
                                            HeaderStyle-Width="13%" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo">
                                        </telerik:GridDateTimeColumn>
                                        <telerik:GridBoundColumn DataField="UBICAZIONE" HeaderText="UBICAZIONE" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="15%" AutoPostBackOnFilter="true" FilterControlWidth="85%"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="IMPORTO_PRESUNTO" HeaderText="IMPORTO PRESUNTO" Exportable="true"
                                            HeaderStyle-Width="10%" AutoPostBackOnFilter="true" DataFormatString="{0:C2}"
                                            FilterControlWidth="85%" CurrentFilterFunction="EqualTo" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <telerik:GridBoundColumn DataField="SERVIZIO_VOCI" HeaderText="VOCE DGR" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="30%" AutoPostBackOnFilter="true" FilterControlWidth="85%"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="FORNITORE" HeaderText="FORNITORE" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="20%" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CODICE_BP" HeaderText="CODICE BP" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="10%" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="VOCE_BP" HeaderText="VOCE BP" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="25%" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="STRUTTURA_ALER" HeaderText="STRUTTURA" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                        ...
                                        <telerik:GridBoundColumn DataField="DESCRIZIONE" HeaderText="DESCRIZIONE" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="28%" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="AUTORIZZAZIONE" HeaderText="AUTORIZZAZIONE" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="12%" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" DataFormatString="{0:@}" HeaderStyle-HorizontalAlign="Center">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="NUM_SEGN" HeaderText="NUMERO SEGNALAZIONE" ItemStyle-HorizontalAlign="Left" Exportable="true"
                                            HeaderStyle-Width="10%" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" HeaderStyle-HorizontalAlign="Center">
                                        </telerik:GridBoundColumn>
