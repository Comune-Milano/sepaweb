...
Partial Class MANUTENZIONI_RicercaManutenzioni
    ...
    Private Sub CaricaVociBP()
        ...
        Try
            ...
            ' Me.cmbVoceBP.Items.Add(New ListItem(" ", -1))
            ...
            'Dim myReader1 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
            'While myReader1.Read
            '    Me.cmbVoceBP.Items.Add(New ListItem(par.IfNull(myReader1("CODICE"), " ") & " - " & par.IfNull(myReader1("DESCRIZIONE"), " "), par.IfNull(myReader1("ID"), -1)))
            'End While
            'myReader1.Close()
            '**************************
    ...
    Private Sub CaricaStati()
        ...
        Try
            ...
            par.cmd.CommandText = "select ID,TRIM(DESCRIZIONE) as DESCRIZIONE from SISCOM_MI.TAB_STATI_ODL where ID<6 order by ID"
    ...
    Private Sub FiltraLotti()
        ...
        Try
            ...
            If cmbEsercizio.SelectedValue <> "-1" Then
                ...
                par.caricaComboTelerik(par.cmd.CommandText, cmbLotto, "ID", "DESCRIZIONE", True)
            Else
                Me.cmbLotto.Items.Add(New RadComboBoxItem(" ", -1))
                cmbLotto.SelectedValue = "-1"
            End If
    ...
    Private Sub FiltraComplessi()
        ...
        Try
            ...
            If cmbComplesso.Items.Count = 2 Then
    ...
    Private Sub FiltraServizi()
        ...
        Try
            ...
            If cmbServizio.Items.Count = 2 Then
        ...
        Try
            ...
            If Me.cmbFornitore.SelectedValue <> "-1" Then
                ...
                If cmbEsercizio.SelectedValue <> "-1" Then
                    filtroPiano = "   AND ID_PIANO_FINANZIARIO=(SELECT ID FROM SISCOM_MI.PF_MAIN WHERE ID_ESERCIZIO_FINANZIARIO=" & Me.cmbEsercizio.SelectedValue & ") "
                End If
                par.cmd.CommandText = "SELECT DISTINCT APPALTI.ID_GRUPPO AS ID,TRIM(NUM_REPERTORIO) || ' - ' || FORNITORI.RAGIONE_SOCIALE AS RAGIONE_SOCIALE " _
                                    & "FROM  SISCOM_MI.APPALTI, SISCOM_MI.FORNITORI " _
    ...
    Private Sub CaricaEsercizio()
        ...
        Try
            ...
            While myReader1.Read
                ...
                Else
                    If Strings.Right(par.IfNull(myReader1("INIZIO"), 1000), 4) = Now.Year - 1 Then
                        ID_ANNO_EF_CORRENTE = par.IfNull(myReader1("ID"), -1)
                    End If
                End If
            ...
            End While
            myReader1.Close()
            par.cmd.CommandText &= " ORDER BY ID DESC"
