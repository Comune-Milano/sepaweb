    ...
    <tr>
        <td>&nbsp;&nbsp;
            ...
            <table style="font-weight: normal; text-decoration: none">
                <tr>
                    <td>
                        <asp:Label ID="lblLordoOneri" runat="server"
                            Style="z-index: 100; left: 8px; top: 88px" TabIndex="-1" Width="160px">A lordo compresi oneri</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtImporto" runat="server" Font-Bold="True" MaxLength="30" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" ReadOnly="True"
                            Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEuro1" runat="server"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                    <td style="width: 90px"></td>
                    <td>
                        <asp:Label ID="LabelRitenuta" runat="server"
                            Style="z-index: 100; left: 8px; top: 88px" TabIndex="-1" Width="160px">Ritenuta di legge 0,5%</asp:Label>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="LabelRitenutaEuro" runat="server"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblOneri" runat="server"
                            Style="z-index: 100; left: 8px; top: 88px" TabIndex="-1" Width="160px">Oneri di Sicurezza</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtOneri" runat="server" Font-Bold="True" MaxLength="30" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEuro2" runat="server"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                    <td style="width: 90px;"></td>
                    <td>
                        <asp:Label ID="lblNetto" runat="server" Font-Bold="False"
                            Style="z-index: 100; left: 8px; top: 88px" TabIndex="-1" Width="160px">A netto compresi oneri</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtNettoOneri" runat="server" Font-Bold="True" MaxLength="30" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" ReadOnly="True"
                            Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEuro6" runat="server"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtOneriImporto" runat="server" Font-Bold="True" MaxLength="30"
                            ...
                            Width="120px" ReadOnly="True" Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEuro3" runat="server"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                    <td style="width: 90px"></td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtIVA" runat="server" Font-Bold="True" MaxLength="30" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" ReadOnly="True"
                            Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="style1">
                        <asp:Label ID="lblRibasso" runat="server"
                            Style="z-index: 100; left: 8px; top: 88px" TabIndex="-1" Width="160px">Ribasso d'asta</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRibassoAsta" runat="server" Font-Bold="True" MaxLength="30" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" ReadOnly="True"
                            Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEuro4" runat="server"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                    <td class="style3" style="width: 90px;"></td>
                    <td class="style3">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblNettoOneri" runat="server"
                            Style="z-index: 100; left: 8px; top: 88px" TabIndex="-1" Width="160px">A netto esclusi oneri</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtNetto" runat="server" Font-Bold="True" MaxLength="30" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" ReadOnly="True"
                            Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEuro5" runat="server" Font-Bold="False"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px"></asp:Label>
                    </td>
                    <td style="width: 90px;"></td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblEuro8" runat="server" Font-Bold="False" Font-Names="Arial" ForeColor="Black"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtImportoTrattenuto" runat="server" MaxLength="30" Font-Bold="true"
                            Style="z-index: 10; left: 408px; top: 171px; text-align: right" TabIndex="-1"
                ...
                <tr>
                    ...
                    <td style="height: 10px">
                        <asp:TextBox ID="txtImportoIvaTrattenuto" runat="server" Font-Bold="True" MaxLength="30"
                            ReadOnly="true" Text="0" Style="z-index: 10; left: 408px; top: 171px; text-align: right"
                            TabIndex="-1" Width="120px" Font-Size="9pt"></asp:TextBox>
                    </td>
                    <td style="height: 10px">
                        <asp:Label ID="Label30" runat="server" Font-Bold="False" Font-Names="Arial" ForeColor="Black"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px" Font-Size="9pt"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height: 10px">
                        <asp:Label ID="Label32" runat="server" Font-Bold="False" Font-Names="Arial" ForeColor="Black"
                            Style="text-align: right" TabIndex="-1" Text="€" Width="16px" Font-Size="9pt"></asp:Label>
                    </td>
                </tr>
            </table>
