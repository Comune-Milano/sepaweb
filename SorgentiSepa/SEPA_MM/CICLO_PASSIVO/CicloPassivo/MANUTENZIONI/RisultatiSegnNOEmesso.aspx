<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiSegnNOEmesso.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_MANUTENZIONI_RisultatiSegnNOEmesso" %>
        ...
        <table style="width: 100%">
            <tr>
                <td class="TitoloModulo">
                    Ordini - Manutenzioni e servizi - Segnalazione - Senza ODL</td>
            </tr>
            <tr>
                <td>
                    <table>
            ...
            <tr>
                <td>
                            ...
                            <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="TIPO_INT" HeaderText="TIPO INT." ItemStyle-HorizontalAlign="Left"
                                     ...
                                     <telerik:GridBoundColumn DataField="TIPO_SEGNALANTE" HeaderText="TIPO SEGNALANTE" ItemStyle-HorizontalAlign="Left">
                                            <HeaderStyle Width="5%" />
                    ...
                    <telerik:GridBoundColumn DataField="COMPLESSO" HeaderText="COMPLESSO"><ItemStyle HorizontalAlign="Left"></ItemStyle></Telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="MUNICIPIO" HeaderText="ZONA"><ItemStyle HorizontalAlign="Left"></ItemStyle></Telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="FORNITORE" HeaderText="FORNITORE"><ItemStyle HorizontalAlign="Left"></ItemStyle></Telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
