<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaManutenzioni.aspx.vb"
    Inherits="MANUTENZIONI_RicercaManutenzioni" %>
        ...
        <table style="width: 100%" class="FontTelerik">
            <tr>
                <td class="TitoloModulo">
                      Ordini - Manutenzioni e servizi - Ricerca - Selettiva
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <div style="overflow: auto;">
                        <table>
                            <tr>
                                ...
                                <td style="height: 21px; width: 700px">
                            ...
                            <tr>
                                ...
                                <td style="height: 21px">
                                    <asp:Label ID="Label3" runat="server">Lotto</asp:Label>
                                </td>
                                <td style="height: 21px">
                                    <telerik:RadComboBox ID="cmbLotto" Width="70%" AppendDataBoundItems="true" Filter="Contains"
                                        runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                        LoadingMessage="Caricamento...">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="height: 21px">
                                    <telerik:RadComboBox ID="cmbComplesso" Width="70%" AppendDataBoundItems="true" Filter="Contains"
                                        runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                        LoadingMessage="Caricamento...">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="height: 21px">
                                    <telerik:RadComboBox ID="cmbEdificio" Width="70%" AppendDataBoundItems="true" Filter="Contains"
                                        runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                        LoadingMessage="Caricamento...">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="height: 21px">
                                    <telerik:RadComboBox ID="cmbServizio" Width="70%" AppendDataBoundItems="true" Filter="Contains"
                                        runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                        LoadingMessage="Caricamento...">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="cmbVoceBP" Width="70%" AppendDataBoundItems="true" Filter="Contains"
                                        runat="server" AutoPostBack="true" ResolvedRenderMode="Classic" HighlightTemplatedItems="true"
                                        LoadingMessage="Caricamento...">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="DropDownListAutorizzazione" Width="20%" AppendDataBoundItems="true"
