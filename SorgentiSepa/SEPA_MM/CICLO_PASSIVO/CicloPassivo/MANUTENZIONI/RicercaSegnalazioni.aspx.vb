...
Partial Class CICLO_PASSIVO_CicloPassivo_MANUTENZIONI_RicercaSegnalazioni
    ...
    Private Sub CaricaTipologieLivello1()
        Try
            ...
            Next
            If contaTip = 1 Then
                Dim query As String = "SELECT ID,REPLACE(DESCRIZIONE,'#','') AS DESCRIZIONE FROM SISCOM_MI.TIPO_SEGNALAZIONE_LIVELLO_1 WHERE ID_TIPO_SEGNALAZIONE=" & tipologiaSelezionata & " ORDER BY DESCRIZIONE"
                'connData.apri(False)
    ...
    Private Sub CaricaTipologieLivello2()
        Try
            Dim query As String = "SELECT ID,REPLACE(DESCRIZIONE,'#','') AS DESCRIZIONE FROM SISCOM_MI.TIPO_SEGNALAZIONE_LIVELLO_2 WHERE ID_TIPO_SEGNALAZIONE_LIVELLO_1=" & cmbTipoSegnalazioneLivello1.SelectedValue & " ORDER BY DESCRIZIONE"
            'connData.apri(False)
    ...
    Private Sub CaricaTipologieLivello3()
        Try
            Dim query As String = "SELECT ID,REPLACE(DESCRIZIONE,'#','') AS DESCRIZIONE FROM SISCOM_MI.TIPO_SEGNALAZIONE_LIVELLO_3 WHERE ID_TIPO_SEGNALAZIONE_LIVELLO_2=" & cmbTipoSegnalazioneLivello2.SelectedValue & " ORDER BY DESCRIZIONE"
            'connData.apri(False)
    ...
    Private Sub CaricaTipologieLivello4()
        Try
            Dim query As String = "SELECT ID,REPLACE(DESCRIZIONE,'#','') AS DESCRIZIONE FROM SISCOM_MI.TIPO_SEGNALAZIONE_LIVELLO_4 WHERE ID_TIPO_SEGNALAZIONE_LIVELLO_3=" & cmbTipoSegnalazioneLivello3.SelectedValue & " ORDER BY DESCRIZIONE"
            'connData.apri(False)
...
Protected Sub btnCerca_Click(sender As Object, e As System.EventArgs) Handles btnCerca.Click
        ...
        End If
        Response.Write("<script>document.location.href='RisultatiSegn.aspx?FOR=" _
