<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TabM_Manu_Consuntivo.aspx.vb"
    Inherits="TabM_Manu_Consuntivo" %>
...
<body  text="#ede0c0">
            ...
            <tr>
                <td style="width: 740px">
                    ...
                    <asp:Label ID="lblELENCO_INTERVENTI" runat="server" Font-Bold="True" Font-Names="Arial"
                        Font-Size="8pt" ForeColor="#8080FF" TabIndex="-1" Text="ELENCO CONSUNTIVI  e/o RIMBORSI"
                ...
                <td style="width: 60px">
                    <asp:ImageButton ID="imgUscita" runat="server" ImageUrl="~/NuoveImm/Img_Esci.png"
                        ...
                        ToolTip="Esce dalla gestione dei consuntivi" OnClientClick="document.getElementById('USCITA').value='1';ConfermaEsci();" />
                </td>
            </tr>
        </table>
                ...
                <td>
                    <div style="border-right: #0000cc thin solid; border-top: #0000cc thin solid; visibility: visible;
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            TabIndex="8" Width="710px" BorderColor="Blue">
                    ...
                    <asp:Label ID="lbl_Tot_Cons" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                        ForeColor="#0000C0" Style="text-align: right" TabIndex="-1" Text="0" Width="100px"></asp:Label>
                </td>
                <td>
                </td>
                <td>
                        ...
                        <tr>
                            <td style="height: 16px">
                                <asp:ImageButton ID="btnAgg1" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/Img_Aggiungi.png"
                                    TabIndex="9" ToolTip="Aggiunge un nuovo consuntivo" OnClientClick="document.getElementById('txtAppare2').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_C').style.visibility='visible';"
                                    Width="60px" />
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 16px">
                                <asp:ImageButton ID="btnAggRimborso" runat="server" CausesValidation="False" ImageUrl="~/CICLO_PASSIVO/CicloPassivo/MANUTENZIONI/Immagini/Img_Aggiungi_Rimborsi.png"
                                    TabIndex="9" ToolTip="Aggiunge un nuovo rimborso per opera specialistica" OnClientClick="document.getElementById('txtAppare2').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_C').style.visibility='visible';"
                                    Width="60px" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:ImageButton ID="btnElimina1" runat="server" Height="12px" ImageUrl="~/NuoveImm/Img_Elimina.png"
                                    TabIndex="11" ToolTip="Elimina il consuntivo selezionato" Width="60px" OnClientClick="document.getElementById('USCITA').value='1';ConfermaAnnulloConsuntivo();" />
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 14px">
                                <asp:ImageButton ID="btnApri1" runat="server" CausesValidation="False" Height="12px"
                                    ...
                                    Width="60px" OnClientClick="document.getElementById('txtAppare2').value='2';document.getElementById('USCITA').value='1'; document.getElementById('DIV_C').style.visibility='visible';" />
                            </td>
                        </tr>
                    </table>
                    <br />
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSel1" runat="server" BackColor="#F2F5F1" BorderColor="White"
                        ...
                        ReadOnly="True" Style="left: 40px; top: 200px" TabIndex="-1" Width="700px"></asp:TextBox>
                </td>
                <td>
                </td>
                <td>
    ...
    <div id="DIV_C" style="left: 0px; width: 800px; position: absolute; top: 0px; height: 544px;
                ...
                <td>
                    <strong><span style="color: #0000ff; font-family: Arial">
                        <asp:Label ID="lblTitolo1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                            ForeColor="Blue" Style="z-index: 100; left: 24px; top: 32px" Width="300px">Gestione Consuntivo</asp:Label></span></strong>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblCodArticolo" runat="server" Font-Bold="False" Font-Names="Arial"
                                    ...
                                    Width="100px">Cod. Articolo *</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCodArticolo" runat="server" Font-Names="Arial" Font-Size="9pt"
                                    MaxLength="30" TabIndex="1" ToolTip="Codice Articolo" Width="300px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                    ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="100px">Descrizione *</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblQuantita" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                    ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="100px">Quantità *</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblDettaglio" runat="server" Font-Bold="False" Font-Names="Arial"
                                    Font-Size="8pt" ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px"
                                    Width="100px">Unità di Misura *</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblPrezzoUNI" runat="server" Font-Bold="False" Font-Names="Arial"
                                    Font-Size="8pt" ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px"
                                    Width="100px">Prezzo Unitario *</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblTotale" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                    ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="100px">Prezzo Totale *</asp:Label>
                            </td>
                            <td>
                                ...
                                <table border="0" cellpadding="1" cellspacing="1" style="width: 90%">
                                    <tr>
                                        <td align="right" style="vertical-align: top; text-align: center">
                                            <asp:ImageButton ID="btn_Modifica1" runat="server" ImageUrl="~/CICLO_PASSIVO/CicloPassivo/MANUTENZIONI/Immagini/img_Modifica.png"
                                            ...
                                            <asp:ImageButton ID="btn_Inserisci1" runat="server" ImageUrl="~/NuoveImm/Img_SalvaContinua.png"
                                                ...
                                                TabIndex="7" ToolTip="Salva le modifiche apportate e pulisce la maschera per un inserimento nuovo" />
                                            &nbsp; &nbsp;<asp:ImageButton ID="btn_Chiudi1" runat="server" ImageUrl="~/NuoveImm/Img_Esci_AMM.png"
                                                ...
                                                Style="cursor: pointer" TabIndex="8" ToolTip="Esci senza inserire o modificare" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblTitolo2" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                                    ...
                                    Width="300px">Elenco Consuntivi Inseriti</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div style="border-right: #0000cc thin solid; border-top: #0000cc thin solid; visibility: visible;
                                    ...
                                    <asp:DataGrid ID="DataGrid2" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                        ...
                                        ForeColor="Black" PageSize="1" Style="table-layout: auto; z-index: 101; left: 8px;
                                        clip: rect(auto auto auto auto); direction: ltr; top: 40px; border-collapse: separate"
                                        TabIndex="8" Width="730px" BorderColor="Blue">
                                        <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <EditItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
    ...
    <asp:TextBox ID="USCITA" runat="server" Style="left: 800px; position: absolute; top: 320px"
    ...
    <asp:TextBox ID="txtannullo" runat="server" Style="left: 800px; position: absolute;
        top: 320px" TabIndex="-1" Width="0px" Height="0px"></asp:TextBox>
    <asp:TextBox ID="txtModificato" runat="server" Style="left: 800px; position: absolute;
        top: 320px" TabIndex="-1" Width="0px" Height="0px"></asp:TextBox>
    ...
    <asp:HiddenField ID="txtOneriC_MANO" runat="server" Value="0" />
