...
Partial Class MANUTENZIONI_RicercaConsuntiviD
  ...
  Protected Sub btnCerca_Click(sender As Object, e As System.EventArgs) Handles btnCerca.Click
        Try
            Response.Write("<script>location.replace('RisultatiConsuntiviD.aspx?REP=" & par.VaroleDaPassare(Me.txtNumRepertorio.Text) _
