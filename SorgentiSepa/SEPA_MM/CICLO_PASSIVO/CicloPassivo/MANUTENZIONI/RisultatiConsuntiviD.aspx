<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiConsuntiviD.aspx.vb"
    Inherits="MANUTENZIONI_RisultatiConsuntiviD" %>
    ...
    <table style="width: 100%">
        <tr>
            <td class="TitoloModulo">
                 Ordini - Manutenzioni e servizi - Consuntivazione - Diretta
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <telerik:RadGrid ID="DataGrid1" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic"
                        ...
                        <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="ODL_ANNO" HeaderText="ODL/ANNO" FilterControlWidth="85%"
                                ...
                                <telerik:GridDateTimeColumn DataField="DATA_INIZIO_ORDINE" HeaderText="DATA" DataFormatString="{0:dd/MM/yyyy}"
                                    HeaderStyle-Width="11%" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo">
                                </telerik:GridDateTimeColumn>
                                <telerik:GridBoundColumn DataField="UBICAZIONE" HeaderText="UBICAZIONE" FilterControlWidth="85%"
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" DataFormatString="{0:@}">
                                    <HeaderStyle Font-Bold="false" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                ...
                                <telerik:GridBoundColumn DataField="SERVIZIO_VOCI" HeaderText="VOCE DGR" FilterControlWidth="85%"
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" DataFormatString="{0:@}">
                                    <HeaderStyle Font-Bold="false" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
