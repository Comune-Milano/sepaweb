            ...
            If myReaderA.Read Then
                ...
                If lettore.Read Then
                    If IO.File.Exists(Server.MapPath("../../../ALLEGATI/FIRME/" & par.IfNull(lettore("FIRMA"), ""))) Then
                        firmaResponsabile = "<table><tr><td>" & par.IfNull(lettore("NOME"), "") & " " & par.IfNull(lettore("COGNOME"), "") & "</td></tr><tr><td><img alt="""" src=""" & par.IfNull(lettore("FIRMA"), "") & """ width=""300"" heigth=""120"" /></td></tr></table>"
                    End If
                End If
                lettore.Close()
                ...
                sModello = "Attenersi agli obblighi in materia di tutela della salute e della sicurezza nei luoghi di lavoro Titolo 4° DLgs 81/2008 E s.m.i. <br>" & vbCrLf _
