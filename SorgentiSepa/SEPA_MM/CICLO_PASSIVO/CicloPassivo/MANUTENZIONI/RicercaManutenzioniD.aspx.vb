...
Partial Class MANUTENZIONI_RicercaManutenzioniD
 ...
 Protected Sub btnCerca_Click(sender As Object, e As System.EventArgs) Handles btnCerca.Click
        Try
            Response.Write("<script>location.replace('RisultatiManutenzioniD.aspx?REP=" & par.VaroleDaPassare(Me.txtNumRepertorio.Text) _
