...
<div style="width: 100%; height: 350px">
    <table class="FontTelerik">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDescrizione" runat="server" Height="30px" MaxLength="300" Style="left: 80px;
                    top: 88px" TabIndex="8" TextMode="MultiLine" Width="670px" ReadOnly="True"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:TextBox ID="txtDanneggiante" runat="server" MaxLength="500" Style="z-index: 10;
                    left: 408px; top: 171px" TabIndex="9" Width="670px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:TextBox ID="txtDanneggiato" runat="server" MaxLength="500" Style="z-index: 10;
                    left: 408px; top: 171px" TabIndex="10" Width="670px"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table id="TABBLE_LISTA" style="width: 100%">
        <tr>
            <td class="TitoloH1" style="text-align: left">
                &nbsp;<asp:Label ID="lblELENCO_INTERVENTI" runat="server" TabIndex="-1" Text="Elenco interventi"
                        ...
                        <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="DETTAGLIO OGGETTO">
                                    ...
                                    <ItemTemplate>
                                        <asp:DropDownList ID="DropDownListTipologiaOggettoDettaglio" runat="server" Font-Names="Arial"
                                ...
                                <telerik:GridBoundColumn DataField="IMPORTO_RIMBORSO" HeaderText="IMPORTO RIMBORSO"
                                    Visible="false">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Width="10%" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                ...
                                <telerik:GridTemplateColumn HeaderText="IMPONIBILE RIMBORSO">
                                    <HeaderStyle Width="10%" />
                                    <ItemTemplate>
                                        <asp:TextBox runat="server" ID="TextBoxImportoRimborso" Text='<%# DataBinder.Eval(Container, "DataItem.IMPORTO_RIMBORSO") %>'
                                            Style="font-family: Arial; font-size: 8pt; text-align: right" Width="98%"></asp:TextBox>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn DataField="PERC_IVA_RIMBORSO" HeaderText="IVA RIMBORSO"
                                    Visible="false">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Width="10%" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
							...
							<ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="IVA RIMBORSO" HeaderStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="TextBoxIvaRimborso" runat="server" AutoPostBack="false" Font-Size="8pt"
                            ...
                            <CommandItemTemplate>
                                <a id="addServizio" style="cursor: pointer" onclick="document.getElementById('Tab_Manu_Dettagli_ImageButtonAggiorna').click();">
...
<div align='center' id="ATTESA" style="position: absolute; background-color: #ffffff;
    text-align: center; width: 200px; height: 100px; top: 200px; left: 300px; z-index: 10;
    border: 1px dashed #660000; font: verdana; font-size: 10px; color: blue;">
    <br />
    <img src='Immagini/load.gif' alt='caricamento in corso' /><br />
    caricamento in corso...
</div>
<div id="DIV_1" style="width: 800px; position: absolute; height: 550px; background-color: whitesmoke;
    left: 0px; top: 0px; display: block; background-image: url(../../../NuoveImm/SfondoMascheraContratti.jpg);
    visibility: hidden;">
    &nbsp;
    <table style="border-right: blue 2px; border-top: blue 2px; left: 32px; border-left: blue 2px;
        border-bottom: blue 2px; position: absolute; top: 96px; background-color: #ffffff;
        z-index: 102;" id="TABLE1">
        <tr>
            <td>
        ...
        <tr>
            <td style="height: 150px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList onchange="AttesaDIV()" ID="cmbTipologia" runat="server" AutoPostBack="True"
                                BackColor="White" Font-Names="arial" Font-Size="10pt" Style="border: 1px solid black;
                                z-index: 111; left: 88px; top: 56px; height: 20px;" TabIndex="13" Width="600px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:DropDownList ID="cmbDettaglio" runat="server" BackColor="White" Font-Names="arial"
                    ...
                    top: 56px" TabIndex="14" Width="720px">
                </asp:DropDownList>
                <br />
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtImporto" runat="server" MaxLength="10" Style="z-index: 10; left: 408px;
...
<script language="javascript" type="text/javascript">
    ...
    function controlla_div() {
        if (document.getElementById('Tab_Manu_Dettagli_txtIdComponente').value != "") {
            ...
            apriAlert('Nessuna riga selezionata!', 300, 150, 'Attenzione', null, null);
