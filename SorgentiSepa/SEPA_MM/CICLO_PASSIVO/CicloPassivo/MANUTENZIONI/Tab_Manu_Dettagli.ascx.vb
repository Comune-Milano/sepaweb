...
& "       AND SISCOM_MI.MANUTENZIONI_CONSUNTIVI.COD_ARTICOLO = 'RIMBORSO OPERE SPECIALISTICHE'), '9G999G999G999G999G990D99')) AS ""perc_iva_rimborso"", " _
                ...
                Case "UNITA COMUNE"
                    ...
                    Else
                        ...
                        sStr1 = "select SISCOM_MI.UNITA_COMUNI.ID," _
                             ...
                             & " or unita_comuni.id_edificio in (select id from siscom_mi.edifici where id_complesso=" & vIdComplesso & ")) " _
                             & " and   SISCOM_MI.UNITA_COMUNI.COD_TIPOLOGIA=SISCOM_MI.TIPO_UNITA_COMUNE.COD  (+) " _
                             & " order by SISCOM_MI.TIPO_UNITA_COMUNE.DESCRIZIONE,SISCOM_MI.UNITA_COMUNI.LOCALIZZAZIONE asc "
                    End If
                Case Else
                    ...
                    End If
            End Select
            PAR.caricaComboBox(sStr1, CType(elemento.FindControl("DropDownListTipologiaOggettoDettaglio"), DropDownList), "ID", "DENOMINAZIONE", False)
            'PAR.caricaComboBox("SELECT ID, VALORE FROM SISCOM_MI.IVA WHERE FL_DISPONIBILE = 1 ORDER BY VALORE ASC", CType(elemento.FindControl("TextBoxIvaRimborso"), DropDownList), "ID", "VALORE", False)
    ...
    'Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GriddataitemEventArgs) Handles DataGrid1.ItemDataBound
    ...
    Function ControlloCampiInterventi() As Boolean
        ...
        If PAR.IfEmpty(Me.cmbTipologia.Text, "Null") = "Null" Or Me.cmbTipologia.Text = "-1" Then
            RadWindowManager1.RadAlert("Inserire la tipologia oggetto!", 300, 150, "Attenzione", "", "null")
        ...
        If PAR.IfEmpty(Me.cmbDettaglio.Text, "Null") = "Null" Or Me.cmbDettaglio.Text = "-1" Then
            RadWindowManager1.RadAlert("Inserire il dettaglio tipologia oggetto!", 300, 150, "Attenzione", "", "null")
            ControlloCampiInterventi = False
            cmbDettaglio.Focus()
            Exit Function
        End If
                ...
                If vIdManutenzione = -1 Then
                    ...
                    For Each elemento As GridDataItem In DataGrid1.Items
                        If elemento.Cells(PAR.IndRDGC(DataGrid1, "id")).Text <> txtIdComponente.Text Then
                            ...
                            riga.Item("PERC_IVA_RIMBORSO") = CType(elemento.FindControl("TextBoxIvaRimborso"), DropDownList).SelectedItem
                    ...
                    For Each elemento As GridDataItem In DataGrid1.Items
                        ...
                        Select Case tipologia
                            ...
                            Case Else
                                ...
                                End If
                        End Select
                        PAR.caricaComboBox(query, CType(elemento.FindControl("DropDownListTipologiaOggettoDettaglio"), DropDownList), "ID", "DENOMINAZIONE", False)
                        ...
                        'PAR.caricaComboBox("SELECT ID, VALORE FROM SISCOM_MI.IVA WHERE FL_DISPONIBILE = 1 ORDER BY VALORE ASC", CType(elemento.FindControl("TextBoxIvaRimborso"), DropDownList), "ID", "VALORE", False)
                        'CType(elemento.FindControl("TextBoxIvaRimborso"), DropDownList).SelectedValue = elemento.Cells(PAR.IndDGC(DataGrid1, "PERC_IVA_RIMBORSO")).Text
                        ...
                        'CType(elemento.FindControl("TextBoxIvaRimborso"), TextBox).Attributes.Add("onBlur", "javascript:valid(this,'notnumbers');AutoDecimal2(this);")
                    ...
                    For i = 0 To Me.DataGrid1.Items.Count - 1
                        ...
                        CType(Me.DataGrid1.Items(i).FindControl("TextBoxIvaRimborso"), DropDownList).SelectedValue = DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "PERC_IVA_RIMBORSO")).Text
                        If stato = "0" Then
                            CType(Me.DataGrid1.Items(i).FindControl("DropDownListTipologiaOggetto"), DropDownList).Enabled = True
                            CType(Me.DataGrid1.Items(i).FindControl("DropDownListTipologiaOggettoDettaglio"), DropDownList).Enabled = True
                            CType(Me.DataGrid1.Items(i).FindControl("TextBoxImportoPresunto"), TextBox).Enabled = True
                    ...
                    Else
                        ...
                        ElseIf txtIdComponente.Text < 0 Then
                            ...
                            For i = 0 To Me.DataGrid1.Items.Count - 1
                                ...
                                CType(Me.DataGrid1.Items(i).FindControl("DropDownListTipologiaOggetto"), DropDownList).SelectedValue = DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "TIPOLOGIA")).Text
                                CType(Me.DataGrid1.Items(i).FindControl("DropDownListTipologiaOggettoDettaglio"), DropDownList).SelectedValue = DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "DETTAGLIO")).Text
                                CType(Me.DataGrid1.Items(i).FindControl("TextBoxIvaRimborso"), DropDownList).SelectedValue = Me.DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "PERC_IVA_RIMBORSO")).Text
                                If stato = "0" Then
                                    CType(Me.DataGrid1.Items(i).FindControl("DropDownListTipologiaOggetto"), DropDownList).Enabled = True
                                    CType(Me.DataGrid1.Items(i).FindControl("DropDownListTipologiaOggettoDettaglio"), DropDownList).Enabled = True
                                    CType(Me.DataGrid1.Items(i).FindControl("TextBoxImportoPresunto"), TextBox).Enabled = True
    ...
    '    If PAR.IfEmpty(CType(Me.Page.FindControl("txtTipoLotto"), HiddenField).Value, "E") = "I" Then

    '        If PAR.IfEmpty(CType(Me.Page.FindControl("txtMANU_INTERV_INSERITO"), HiddenField).Value, "1") = "1" Then
    '            Me.cmbTipologia.Enabled = False
    '            'Me.cmbDettaglio.Enabled = False
    '        Else
    '            'server per capire se mi trovo in BOZZA, APPALTO tipo IMPIANTI e non è stato inserito nessuna MANUTENZIONE_INTERVENTI
    '            Me.cmbTipologia.Enabled = True
    '        End If
    ...
    '        'If vIdManutenzione = -1 Then
    '        If PAR.IfEmpty(CType(Me.Page.FindControl("txtID_Segnalazioni"), HiddenField).Value, 0) > 0 Then
    '            PAR.cmd.CommandText = "SELECT * FROM SISCOM_MI.SEGNALAZIONI WHERE ID = " & PAR.IfEmpty(CType(Me.Page.FindControl("txtID_Segnalazioni"), HiddenField).Value, 0)
    '            Dim Lettore As Oracle.DataAccess.Client.OracleDataReader = PAR.cmd.ExecuteReader
    '            If Lettore.Read Then
    '                If PAR.IfNull(Lettore("id_unita"), 0) > 0 Then
    '                    Me.cmbTipologia.SelectedValue = "UNITA IMMOBILIARE"
    '                    Setta_Dettaglio()
    '                    Me.cmbDettaglio.SelectedValue = PAR.IfNull(Lettore("id_unita"), 0)
    '                ElseIf PAR.IfNull(Lettore("id_edificio"), 0) > 0 Then
    '                    Me.cmbTipologia.SelectedValue = "EDIFICIO"
    '                    Setta_Dettaglio()
    '                    Me.cmbDettaglio.SelectedValue = PAR.IfNull(Lettore("ID_EDIFICIO"), 0)
    ...
    Private Sub BindGrid_Consuntivi()
        ...
        For i = 0 To Me.DataGrid1.Items.Count - 1
            ...
            If IsNumeric(Me.DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "perc_iva_rimborso")).Text) Then
                percIVArim = CDec(Me.DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "perc_iva_rimborso")).Text)
            Else
                percIVArim = 0
            End If
            SommaTotC = SommaTotC + PAR.IfEmpty(Me.DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "IMPORTO_CONSUNTIVO")).Text, 0)
            SommaTotRimborsi = SommaTotRimborsi + PAR.IfEmpty(Me.DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "IMPORTO_RIMBORSO")).Text, 0) + Math.Round(PAR.IfEmpty(Me.DataGrid1.Items(i).Cells(PAR.IndRDGC(DataGrid1, "IMPORTO_RIMBORSO")).Text, 0) * percIVArim / 100, 2)
        Next i
        ...
        Select Case CType(Me.Page.FindControl("txtSTATO"), HiddenField).Value
            Case 0  'BOZZA
                ...
                Else
                    ...
                    CType(Me.Page.FindControl("cmbServizio"), RadComboBox).Enabled = True
                    ...
                    '    CType(Me.Page.FindControl("RBL1"), RadioButtonList).Enabled = False
                    '    CType(Me.Page.FindControl("cmbIndirizzo"), DropDownList).Enabled = False
                    '    CType(Me.Page.FindControl("cmbScala"), DropDownList).Enabled = False
                    '    CType(Me.Page.FindControl("cmbServizio"), DropDownList).Enabled = True
                    '    CType(Me.Page.FindControl("cmbServizioVoce"), DropDownList).Enabled = True

                    'Else
                    '    ' se ho cancellato tutti gli INTERVENTI inseriti, posso cambiare l'indirizzo o servizio
                    '    CType(Me.Page.FindControl("RBL1"), RadioButtonList).Enabled = True
                    '    CType(Me.Page.FindControl("cmbIndirizzo"), DropDownList).Enabled = True
                    '    CType(Me.Page.FindControl("cmbScala"), DropDownList).Enabled = True
                    '    CType(Me.Page.FindControl("cmbServizio"), DropDownList).Enabled = True
                    '    CType(Me.Page.FindControl("cmbServizioVoce"), DropDownList).Enabled = True
                    'End If
                ...
                If CType(Me.Page.FindControl("cmbServizioVoce"), RadComboBox).SelectedValue <> "-1" Then
                ...
                CType(Me.Page.FindControl("btnAnnulla"), RadButton).Visible = False
                CType(Me.Page.FindControl("btnOrdineIntegrativo"), RadButton).Visible = False
            ...
            Case 1  'EMESSO ORDINE
                ...
                CType(Me.Page.FindControl("btnElimina"), RadButton).Visible = False
                CType(Me.Page.FindControl("btnAnnulla"), RadButton).Visible = True
    ...
    & "       AND SISCOM_MI.MANUTENZIONI_CONSUNTIVI.COD_ARTICOLO = 'RIMBORSO OPERE SPECIALISTICHE'), '9G999G999G999G999G990D99')) AS ""perc_iva_rimborso"", " _
            ...
            Dim dt As Data.DataTable = PAR.getDataTableGrid(StringaSql)
