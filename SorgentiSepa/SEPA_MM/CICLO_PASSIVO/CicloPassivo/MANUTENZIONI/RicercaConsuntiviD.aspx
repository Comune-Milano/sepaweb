<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaConsuntiviD.aspx.vb"
    Inherits="MANUTENZIONI_RicercaConsuntiviD" %>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtODL" runat="server" Font-Names="arial" Font-Size="9pt" MaxLength="15"
                                            ...
                                            Width="100px"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator7"
                                                runat="server" ControlToValidate="txtODL" Display="Dynamic" ErrorMessage="RegularExpressionValidator"
                                                Font-Names="Arial" Font-Size="8pt" Style="left: 224px; top: 232px" TabIndex="-1"
                                                ValidationExpression="\d+(\.\d\d)?(,\d\d)?(\.\d)?(,\d)?" Width="80px">Valore Numerico</asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: top; text-align: left">
                                        <asp:Label ID="lblAnno" runat="server" Font-Bold="False" >Anno</asp:Label>
                                    </td>
                                    <td>
