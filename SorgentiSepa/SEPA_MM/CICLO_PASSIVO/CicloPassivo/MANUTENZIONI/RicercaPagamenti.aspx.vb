'*** RICERCA I Pagamenti da stampare

Partial Class MANUTENZIONI_RicercaPagamenti
    ...
    Private Sub FiltraAppalti()
        ...
        Try
            ...
            If par.IfEmpty(Me.cmbFornitore.SelectedValue.ToString, "-1") <> "-1" Then
                par.cmd.CommandText = par.cmd.CommandText & "   and ID_FORNITORE= " & Me.cmbFornitore.SelectedValue.ToString
            End If
    ...
    Private Sub FiltraServizioVoce()
        ...
        Try
            ...
            sStr1 = "select ID,trim(DESCRIZIONE) as DESCRIZIONE " _
                ...
                & " where ID in (select distinct(ID_VOCE_PF_IMPORTO) " _
 ...
 Protected Sub btnCerca_Click(sender As Object, e As System.EventArgs) Handles btnCerca.Click
        ...
        Try
            ...
            Response.Write("<script>location.replace('RisultatiPagamenti.aspx?FO=" & Me.cmbFornitore.SelectedValue.ToString _
