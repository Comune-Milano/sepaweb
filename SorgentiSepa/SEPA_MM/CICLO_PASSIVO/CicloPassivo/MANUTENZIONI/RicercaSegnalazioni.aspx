<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaSegnalazioni.aspx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_MANUTENZIONI_RicercaSegnalazioni" %>
    ...
    <table border="0" cellpadding="2" cellspacing="2" width="100%" class="FontTelerik">
        ...
        <tr>
            <td colspan="4" class="TitoloModulo">
                <asp:Label ID="Label2" Text="Ordini - Manutenzioni e servizi - Segnalazione - Con ODL" runat="server" />
            </td>
        </tr>
       <tr>
            <td colspan="4">
