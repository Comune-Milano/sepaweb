...
Partial Class FSA_Eventi
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                'lblTitolo.Text = "ELENCO EVENTI LOTTI"

                vIdLOTTO = Request.QueryString("ID_LOTTO")


                sStringaSql = "select TO_DATE(SISCOM_MI.EVENTI_LOTTI.DATA_ORA,'yyyyMMddHH24MISS') as ""DATA_ORA""," _
                                  & " SISCOM_MI.TAB_EVENTI.DESCRIZIONE,SISCOM_MI.EVENTI_LOTTI.COD_EVENTO,SISCOM_MI.EVENTI_LOTTI.MOTIVAZIONE," _
                                  & " SEPA.OPERATORI.OPERATORE,SISCOM_MI.EVENTI_LOTTI.ID_OPERATORE,SEPA.CAF_WEB.COD_CAF " _
                           & " from SEPA.CAF_WEB, SISCOM_MI.EVENTI_LOTTI, SISCOM_MI.TAB_EVENTI,SEPA.OPERATORI " _
                           & " where SISCOM_MI.EVENTI_LOTTI.ID_LOTTO= " & vIdLOTTO _
                             & " and SISCOM_MI.EVENTI_LOTTI.COD_EVENTO=SISCOM_MI.TAB_EVENTI.COD (+) " _
                             & " and SISCOM_MI.EVENTI_LOTTI.ID_OPERATORE=SEPA.OPERATORI.ID (+) " _
                             & " and SEPA.CAF_WEB.ID=SEPA.OPERATORI.ID_CAF " _
                          & " order by EVENTI_LOTTI.DATA_ORA desc, EVENTI_LOTTI.COD_EVENTO desc"
    ...
    Private Sub Esporta(ByVal dt As Data.DataTable)
        ...
        Dim nomeFile = xls.EsportaExcelDaDT(ExcelSiSol.Estensione.Office2007_xlsx, "EventiLotto", "EventiLotto", dt)
