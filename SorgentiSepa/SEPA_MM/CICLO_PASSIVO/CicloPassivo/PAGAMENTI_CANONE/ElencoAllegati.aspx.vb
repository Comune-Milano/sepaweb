...
Partial Class Contratti_ElencoAllegati
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            par.cmd.CommandText = "select * from SISCOM_MI.PRENOTAZIONI where ID = " & Request.QueryString("cod")

            Dim myReader1 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
            If myReader1.Read Then
                Label1.Text = "Prenotazione NUM/ANNO: " & par.IfNull(myReader1("PROGR_FORNITORE"), "") & "/" & par.IfNull(myReader1("ANNO"), "")
            End If
            myReader1.Close()
            ...
            i = 0
            MIOCOLORE = "#CCFFFF"
            For Each foundFile As String In My.Computer.FileSystem.GetFiles(Server.MapPath("../../../ALLEGATI/PAGAMENTI/"), FileIO.SearchOption.SearchTopLevelOnly, "*_" & Request.QueryString("cod") & ".zip")
            ...
            If i > 0 Then
                For j = 0 To i - 1
                    ...
                    If erroreTrasferimento = False Then
                        MiaSHTML = MiaSHTML & "<td width='100px' bgcolor='" & MIOCOLORE & "'><font face='Arial' size='1'><a  alt='Download' href='../../../ALLEGATI/PAGAMENTI/" & RicavaFile(ElencoFile(j)) & "' target='_blank'><img src='../../../ImmMaschere/MenuTopDownload.gif' border='0'></a></font></td>" & vbCrLf
                        If Request.QueryString("LT") <> "1" Then
