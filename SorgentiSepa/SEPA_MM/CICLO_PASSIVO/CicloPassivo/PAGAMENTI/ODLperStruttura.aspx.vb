...
Partial Class CICLO_PASSIVO_CicloPassivo_PAGAMENTI_ODLperStruttura
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session.Item("BP_GENERALE") <> 1 Then
            If Session.Item("ID_STRUTTURA") = "-1" Then
                Response.Write("<script>alert('Attenzione! Operatore non abilitato per questa funzione!');parent.main.location.href=""../../pagina_home.aspx""</script>")
                Exit Sub
            End If
        End If
        '#########################
    ...
    Protected Sub btnStampa_Click(sender As Object, e As System.EventArgs) Handles btnStampa.Click
        Dim script As String = "window.open('RisultatiODLperStruttura.aspx?IDS=" & ddlStrutture.SelectedValue & "&EF=" & ddlEsercizio.SelectedValue & "','Report');"
        ...
        Try
            ...
            While myReader1.Read
                ...
                Else
                    ...
                    Response.Write("<script>ocation.replace('../../pagina_home.aspx');</script>")
                End If
    ...
    Private Sub CaricaStrutture()
        ...
        Try
            ...
            If Session.Item("BP_GENERALE") = 1 Then
                ...
                par.caricaComboTelerik(par.cmd.CommandText, ddlStrutture, "ID", "NOME", True)
