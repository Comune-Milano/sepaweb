<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaResidui.aspx.vb"
    Inherits="RicercaResidui" %>
...
<head id="Head1" runat="server">
    ...
    <title>Ricerca Uscite Conto Capitale</title>
</head>
<body class="sfondo">
        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td style="width: 20%">
                            <asp:Label ID="Label4" runat="server" Font-Bold="False"
                                Width="110px" Text="Esercizio Finanziario"></asp:Label>
                        </td>
                        <td style="width: 80%">
                    ...
                    <tr>
                        <td style="width: 20%">
                            <asp:Label ID="lblStruttura" runat="server" 
                                 Width="110px" Text="Struttura"></asp:Label>
                        </td>
                        <td style="width: 80%">
