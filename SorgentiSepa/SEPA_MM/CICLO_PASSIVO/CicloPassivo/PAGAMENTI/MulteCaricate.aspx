<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MulteCaricate.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_MulteCaricate" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Apri() {
            window.showModalDialog('FatturePagaUt.aspx?TIPO=M', 'window', 'status:no;dialogWidth:800px;dialogHeight:500px;dialogHide:true;help:no;scroll:no');
        };
