...
Protected Sub btnAnnulla_Click(sender As Object, e As System.EventArgs) Handles btnAnnulla.Click
    ...
    Protected Sub btnStampa_Click(sender As Object, e As System.EventArgs) Handles btnStampa.Click
        Dim script As String = "window.open('StampaPFresidui.aspx?S=" & cmbStruttura.SelectedValue & "&EF_R=" & cmbEsercizio.SelectedValue.ToString _
                                                          & "','_blank','resizable=yes,height=800,width=1000,top=0,left=0,scrollbars=yes');"
