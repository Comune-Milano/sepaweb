<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StampaPFdisp.aspx.vb" Inherits="CicloPassivo_Pagamenti_StampaPFdisp" %>
    ...
    <table width="100%">
            ...
            <td style="text-align: left; height: 21px; width: 90%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <telerik:RadButton ID="btnStampaPDF" runat="server" Style="top: 0px; left: 0px" Text="Stampa PDF"
        ...
        <tr>
            <td style="width: 100%;" colspan="2">
                <asp:Label runat="server" ID="TabellaCompleta" Text=""></asp:Label>
            </td>
        </tr>
    </table>
