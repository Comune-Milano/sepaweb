<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiContabilitaDett.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_RisultatiContabilitaDett" %>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <telerik:RadButton ID="btnExport" runat="server" 
                    Style="top: 0px; left: 0px" Text="Export XLS"
                                ToolTip="Esporta in Excel" />
            </td>
            <td>
              <telerik:RadButton ID="btnStampaPDF" runat="server" 
                    Style="top: 0px; left: 0px" Text="Stampa"
                                ToolTip="Stampa" />
            ...
            <td style="text-align: right; height: 21px; width: 10%;">
                            <telerik:RadButton ID="btnEsci" runat="server" 
                    Style="top: 0px; left: 0px" Text="Esci"
