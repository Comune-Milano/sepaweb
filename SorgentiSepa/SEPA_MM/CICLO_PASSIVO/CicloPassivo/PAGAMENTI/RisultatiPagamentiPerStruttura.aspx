<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiPagamentiPerStruttura.aspx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_RisultatiPagamentiPerStruttura" %>
...
<body class="sfondo">
        ...
        <tr>
            <td style="text-align: left; height: 21px; width: 90%;">
                <table>
                    <tr>
                        <td>
                            <telerik:RadButton ID="indietro" runat="server" Text="Indietro" ToolTip="Indietro"
                                Visible="false" />
                        </td>
                        <td>
                        ...
                        <td>
                            <telerik:RadButton ID="btnStampaPDF" runat="server" Text="Stampa PDF" ToolTip="Stampa in PDF"
                                OnClientClicking="function(sender, args){Messaggio();}" />
                        </td>
                    </tr>
                </table>
            </td>
            <td style="text-align: right; height: 21px; width: 10%;">
                <telerik:RadButton ID="btnEsci" runat="server" Text="Esci" ToolTip="Esci" OnClientClicking="function(sender, args){self.close();}" />
            </td>
        </tr>
        <tr>
                ...
                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="FORNITORE" HeaderText="FORNITORE">
                            ...
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Left" Wrap="True" Width="9%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="NUM_REPERTORIO" HeaderText="REPERTORIO">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" Wrap="True" Width="6%" />
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Left" Wrap="True" Width="6%" />
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="MAE" HeaderText="PAGAMENTI">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
    ...
    <table width="100%">
        ...
        <tr>
            <td style="text-align: left; height: 21px; width: 90%;">
                <table>
                    <tr>
                        <td>
                            <telerik:RadButton ID="excelRit" runat="server" Text="Export XLS" ToolTip="Esporta in Excel" />
                        </td>
                        <td>
                            <telerik:RadButton ID="stampaRit" runat="server" Text="Stampa" ToolTip="Stampa in PDF"
                                OnClientClicking="function(sender, args){Messaggio();}" />
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td align="center" colspan="2" class="style1">
                <asp:Label ID="lblTitoloRit" runat="server" Font-Names="Arial" Font-Size="14pt" Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 7px;" colspan="2">
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:Label ID="lblErroreRit" runat="server" Font-Names="Arial" Font-Size="10pt"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="2">
                <asp:DataGrid ID="DataGridRit" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                    CellPadding="4" ForeColor="#333333" Width="99%" BorderColor="#507CD1" BorderStyle="Solid"
                    PageSize="500">
                    <AlternatingItemStyle BackColor="WHITE" />
                    <Columns>
    ...
    <asp:HiddenField ID="idPagamentoRitLeggePrec" runat="server" Value="-1" />
