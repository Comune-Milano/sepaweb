...
Partial Class Contratti_ElencoAllegati
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            par.cmd.CommandText = "select * from SISCOM_MI.ODL where SISCOM_MI.ODL.ID = " & Request.QueryString("cod")

            Dim myReader1 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
            If myReader1.Read Then
                Label1.Text = "Pagamento PROG/ANNO: " & par.IfNull(myReader1("PROGR"), "") & "/" & par.IfNull(myReader1("ANNO"), "")
            End If
            myReader1.Close()
