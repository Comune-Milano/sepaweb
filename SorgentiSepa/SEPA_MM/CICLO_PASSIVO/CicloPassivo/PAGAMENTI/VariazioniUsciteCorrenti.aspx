<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VariazioniUsciteCorrenti.aspx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_VariazioniUsciteCorrenti" %>
...
<head id="Head1" runat="server">
    ...
    <title>Variazioni Uscite Correnti</title>
</head>
<body class="sfondo">
            ...
            <td style="width: 100%">
                <asp:DataGrid runat="server" ID="DataGrid" AutoGenerateColumns="False" CellPadding="1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="STATOP" HeaderText="STATO PRECEDENTE">
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Left" />
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="IMPORTO" HeaderText="IMPORTO PRENOTATO">
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        ...
                        <asp:BoundColumn DataField="VARIAZIONE" HeaderText="VARIAZIONE">
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Right" />
                        </asp:BoundColumn>
        ...
        <tr>
            <td style="width: 100%">
                <table width="100%">
                    <tr>
                        <td style="width: 10%">
                            <telerik:RadButton ID="btnExportRitl" runat="server" Text="Export XLS" 
                                ToolTip="Esporta in Excel" />
                        </td>
                        <td style="width: 10%">
                            <telerik:RadButton ID="btnStampaRit" runat="server" Text="Stampa" 
                                ToolTip="Stampa" style="top: 0px; left: 0px" />
                        </td>
                        <td style="width: 70%">
                            &nbsp;
                        </td>
