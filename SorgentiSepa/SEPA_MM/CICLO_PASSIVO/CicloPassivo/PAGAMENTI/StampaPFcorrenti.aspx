<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StampaPFcorrenti.aspx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_StampaPFcorrenti" %>
...
<head id="Head1" runat="server">
    ...
    <title>Stampa Situazione Uscite Correnti</title>
</head>
<body class="sfondo">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 10%; text-align: right">
                            <telerik:RadButton ID="btnEsci" runat="server" OnClientClicking="function(sender, args){self.close();}"
            ...
            <td style="width: 100%">
                <asp:DataGrid runat="server" ID="DataGrid" AutoGenerateColumns="False" CellPadding="1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="DISPONIBILITA_RESIDUA" HeaderText="RESIDUI">
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        ...
                        <asp:BoundColumn DataField="RESIDUI_FINALI" HeaderText="RESIDUI FINALI">
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Right" />
                        </asp:BoundColumn>
                    </Columns>
