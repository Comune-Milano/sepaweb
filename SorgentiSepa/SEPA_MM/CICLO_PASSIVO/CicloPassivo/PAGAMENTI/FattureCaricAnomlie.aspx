<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FattureCaricAnomlie.aspx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_FattureCaricAnomlie" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Anomalie Caricamento Fatture Utenze</title>
    <style type="text/css">
        .bottone
        {
    ...
    <table style="width: 100%;">
        <tr>
            <td style="text-align: center">
                <asp:Label ID="lblTitolo" runat="server" Style="font-family: Arial; font-size: 12pt;
                    font-weight: 700; color: #990000"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="btnExport" runat="server" CssClass="bottone" Text="EXPORT XLS" ToolTip="Esporta le anomalie in formato excel" />
            </td>
        </tr>
        <tr>
            <td>
                <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">
                    <asp:DataGrid ID="dgvAnomalie" runat="server" AutoGenerateColumns="False" Font-Bold="False"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="TIPO_UTENZA" HeaderText="TIPO UTENZA"></asp:BoundColumn>
                            <asp:BoundColumn DataField="FORNITORE" HeaderText="FORNITORE"></asp:BoundColumn>
                            <asp:BoundColumn DataField="DATA_CARICAMENTO" HeaderText="DATA CARICAMENTO"></asp:BoundColumn>
                            <asp:BoundColumn DataField="NUMERO_FATTURA" HeaderText="NUMERO FATT."></asp:BoundColumn>
                            <asp:BoundColumn DataField="ANNO_FATTURA" HeaderText="ANNO"></asp:BoundColumn>
