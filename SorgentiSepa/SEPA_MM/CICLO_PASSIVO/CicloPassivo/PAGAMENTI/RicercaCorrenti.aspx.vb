...
Partial Class CICLO_PASSIVO_CicloPassivo_PAGAMENTI_RicercaCorrenti
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session.Item("BP_RESIDUI") <> "1" Then
    ...
    Private Sub CaricaStrutture()
        ...
        Try
            ...
            If Session.Item("BP_GENERALE") = 1 Then
                ...
                'End While
                'myReader.Close()
                par.caricaComboTelerik(par.cmd.CommandText, cmbStruttura, "ID", "NOME", False)
...
Protected Sub btnAnnulla_Click(sender As Object, e As System.EventArgs) Handles btnAnnulla.Click
    ...
    Protected Sub btnStampa_Click(sender As Object, e As System.EventArgs) Handles btnStampa.Click
        Dim script As String = "window.open('StampaPFcorrenti.aspx?S=" & cmbStruttura.SelectedValue & "&EF_R=" & cmbEsercizio.SelectedValue.ToString _
                                                          & "','_blank','resizable=yes,top=0,left=0,scrollbars=yes');"
        ...
        Try
            ...
            While myReader1.Read
                ...
                If Len(ANNOINIZIO) = 8 And Len(ANNOFINE) = 8 Then
                    ...
                    ' cmbEsercizio.Items.Add(New ListItem(ANNOINIZIO & " - " & ANNOFINE & "  (" & par.IfNull(myReader1("DESCRIZIONE"), "") & ")", par.IfNull(myReader1("ID"), 0)))
