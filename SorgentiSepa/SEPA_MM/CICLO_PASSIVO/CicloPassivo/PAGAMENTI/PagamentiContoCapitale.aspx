<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PagamentiContoCapitale.aspx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_PagamentiContoCapitale" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Pagamenti Conto Capitale</title>
            ...
            <td style="width: 100%">
                <asp:DataGrid runat="server" ID="DataGrid" AutoGenerateColumns="False" CellPadding="1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="TIPORIT" HeaderText="TIPORIT" Visible="False">
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Left" />
                        </asp:BoundColumn>
                    </Columns>
