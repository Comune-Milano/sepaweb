...
Partial Class CICLO_PASSIVO_CicloPassivo_PAGAMENTI_RicercaPerServizi
    ...
    Protected Sub btnStampa_Click(sender As Object, e As System.EventArgs) Handles btnStampa.Click
        Dim script As String = "window.open('StampaPFserv.aspx?EF_R=" & cmbEsercizio.SelectedValue.ToString _
