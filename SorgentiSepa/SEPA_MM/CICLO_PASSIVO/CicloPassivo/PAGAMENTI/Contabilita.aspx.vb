...
Partial Class CICLO_PASSIVO_CicloPassivo_PAGAMENTI_Contabilita
    ...
    Protected Sub btnStampa_Click(sender As Object, e As System.EventArgs) Handles btnStampa.Click
        ...
        Try
            ...
            If ControlloCampi = True Then
                Dim script As String = "window.open('RisultatiContabilita.aspx?&VOCI=" & ChkStampa.Checked & "&AL=" & par.IfEmpty(par.AggiustaData(dataal), "") & "&DAL=" & par.IfEmpty(par.AggiustaData(datadal), "") & "&EF_R=" & cmbEsercizio.SelectedValue.ToString & "','Contabilita','');"
