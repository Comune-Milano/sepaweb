<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiEstrazioniPagamentiNew.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_PAGAMENTI_RisultatiEstrazioniPagamentiNew" %>
...
<body>
    ...
    <div>
        <table width="100%">
            ...
            <tr>
                <td style="width: 100%">
                    <asp:DataGrid runat="server" ID="DataGridPagamenti" CellPadding="1" 
                        Font-Names="Arial" Font-Size="8pt" ForeColor="#000000" GridLines="None" 
                        CellSpacing="1" ShowFooter="false" AutoGenerateColumns="false" Width="99%" 
                        UseAccessibleHeader="True" PageSize="100">
                        <Columns>
                            ...
                            <%--<asp:BoundColumn DataField="ANNO_CDP" HeaderText="ANNO CDP" ItemStyle-HorizontalAlign="Right" Visible="true" HeaderStyle-CssClass="formatoTesto"></asp:BoundColumn>--%>
                            <asp:BoundColumn DataField="DATA_CDP" HeaderText="DATA CDP" ItemStyle-HorizontalAlign="Right" Visible="true" HeaderStyle-CssClass="formatoTesto"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="ANNO_PF" HeaderText="ANNO PF" ItemStyle-HorizontalAlign="Left" Visible="true" HeaderStyle-CssClass="formatoTesto"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="ID_FATTURA_MM" HeaderText="ID_FATTURA_MM" ItemStyle-HorizontalAlign="Left" Visible="false" HeaderStyle-CssClass="formatoTesto"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="DATA_REG" HeaderText="DATA REGISTRAZIONE" ItemStyle-HorizontalAlign="Center" Visible="true" HeaderStyle-CssClass="formatoData"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="ID_PAGAMENTO_MM" HeaderText="ID_PAGAMENTO_MM" ItemStyle-HorizontalAlign="Left" Visible="false" HeaderStyle-CssClass="formatoTesto"></asp:BoundColumn>
