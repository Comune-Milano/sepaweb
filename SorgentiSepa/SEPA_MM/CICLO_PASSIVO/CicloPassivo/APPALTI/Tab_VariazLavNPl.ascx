<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_VariazLavNPl.ascx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_APPALTI_Tab_VariazLavNPl" %>
            ...
            <div style="border: medium solid #ccccff; vertical-align: top;
                ...
                <asp:DataGrid ID="DataGridImportiVariaz" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="SERVIZIO" HeaderText="SERVIZIO" Visible="False">
                        </asp:BoundColumn>
                ...
                <asp:Image ID="Image1" runat="server" BackColor="White" 
                    ...
                    Style="z-index: 100; left: 15px; position: absolute; top: 52px; height: 480px; width: 770px;" />
            </div>
