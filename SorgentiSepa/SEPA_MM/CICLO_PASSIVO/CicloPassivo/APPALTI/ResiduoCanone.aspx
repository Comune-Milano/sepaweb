<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ResiduoCanone.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_APPALTI_ResiduoCanone" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../CicloPassivo.js" type="text/javascript"></script>
       <title>Residuo a canone appalto</title>
...
<body class="sfondo">
    <form id="form1" runat="server">
        ...
        <table style="width: 925px;">
            ...
            <tr>
                <td class="TitoloH1">Riepilogo residuo importo a canone
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                            ...
                            <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                               ...
                               <CommandItemTemplate>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="PROGR" HeaderText="PROGR">
                                        <HeaderStyle Width="80px" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="IMPORTO_CONSUNTIVATO" HeaderText="IMPORTO">
                                        <HeaderStyle Font-Italic="False" Font-Overline="False"
                                            Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center"
                                            Width="150px" />
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td class="style2">Totale Appalto a Canone</td>
                            <td class="style2">
                            ...
                            <td class="style2">Totale Pagamenti</td>
                            <td class="style2">
                                <asp:TextBox ID="txtTotPagamenti" runat="server" Font-Names="Arial"
                                    Font-Size="8pt" Style="text-align: right" Width="80px" ReadOnly="True"></asp:TextBox>
                            </td>
