<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PagamentoCertificatiExcel.aspx.vb"
    Inherits="PagamentoCertificatiExcel" %>
        ...
        <tr>
            <td style="width: 100%">
                <asp:Label ID="lblTitoloPagina" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="12pt" ForeColor="Maroon" Text="Elaborazione ritenute di legge"></asp:Label>
                <br />
                <br />
            </td>
        </tr>
