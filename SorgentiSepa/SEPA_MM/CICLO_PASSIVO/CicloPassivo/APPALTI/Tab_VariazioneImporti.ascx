<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_VariazioneImporti.ascx.vb"
    Inherits="CICLO_PASSIVO_CicloPassivo_APPALTI_Tab_VaImporti" %>
<style type="text/css">
    .style1
    {
        height: 19px;
                   ...
                   <td>
                       <table>
                           <tr>
                            ...
                            OnClientClick="document.getElementById('USCITA').value='1';closeWindow(null, null, 'Tab_VariazioneImporti1_RadWindowVarImporti');" Style="cursor: pointer"
                ...
                <tr>
                    <td class="style2" colspan="2">
                        <table>
                            <tr>
                                <td>
                                    <asp:RadioButton runat="server" ID="radioBtnCanone" GroupName="verificaRadio" Text="Variazione a canone"
                                        Checked="true" />
                                </td>
                                <td>
                                    <asp:RadioButton runat="server" ID="radioBtnConsumo" GroupName="verificaRadio" Text="Variazione a consumo" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <div style="overflow: auto; width: 100%; height: 100%;">
                <telerik:RadGrid ID="DataGridVCan" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic"
                    ...
                    <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                        ...
                        <telerik:GridBoundColumn DataField="ONERI_SICUREZZA_CANONE" HeaderText="ONERI DI SICUREZZA CANONE">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" />
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Right" />
                        ...
                        <CommandItemTemplate>
                            <a id="addServizio" style="cursor: pointer" onclick="openWindow(null, null, 'Tab_VariazioneImporti1_RadWindowVarImporti')">
