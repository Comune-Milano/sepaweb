<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_VariazioniNP.ascx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_APPALTI_Tab_VariazioniNP" %>
<table>
    <tr>
    ...
    style="border: thin none #3366ff; left: -14px; width: 802px; position: absolute; top: -8px; height: 560px; background-color: #dedede; visibility : hidden; vertical-align: top; text-align: left; z-index: 201; background-image: url('../../../NuoveImm/SfondoMascheraContratti.jpg'); margin-right: 10px;">
            ...
            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ...
                <asp:TextBox ID="txtPercVarCanone" runat="server" BorderStyle="Solid" BorderWidth="1px"
                    ...
                    top: 67px; text-align: right" TabIndex="21" Width="80px" ToolTip="dd/MM/yyyy"></asp:TextBox>
                        ...
                        <asp:TemplateColumn HeaderText="IMPORTO %">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtPercVarCanone" runat="server" Font-Names="Arial" 
                                    Font-Size="8pt" style="text-align: right;" Width="42px"></asp:TextBox>
...
<asp:HiddenField ID="txtAppareV" runat="server" />
...
<asp:HiddenField ID="ConfermaSp_Canone" runat="server" Value="0" />
<asp:HiddenField ID="ConfermaSp_Consumo" runat="server" Value="0" />
<asp:HiddenField ID="txtAppareVC" runat="server" />
    ...
    style="border: thin none #3366ff; left: -14px; width: 802px; position: absolute; top: -8px; height: 560px; background-color: #dedede; visibility : hidden; vertical-align: top; text-align: left; z-index: 201; background-image: url('../../../NuoveImm/SfondoMascheraContratti.jpg'); margin-right: 10px;">
            ...
            <div style="border: medium solid #ccccff; vertical-align: top;
                ...
                <asp:Image ID="Image2" runat="server" BackColor="White" 
                    ImageUrl="~/ImmDiv/DivMGrande.png"        
                    Style="z-index: 100; left: 16px; position: absolute; top: 52px; height: 478px; width: 770px;" />
            </div>
...
<script type="text/javascript">
    ...
    function controllaDivVariazioni() {
        if (document.getElementById('Tab_VariazioniNP1_id_selected').value != 0) {
            document.getElementById('Tab_VariazioniNP1_visibile').value = '1';
        }
        else {
    ...
    if (document.getElementById('Tab_VariazioniNP1_txtAppareV').value != '1') {
        document.getElementById('Variazioni').style.visibility = 'hidden';
    }
    if (document.getElementById('Tab_VariazioniNP1_txtAppareVC').value != '1') {
