<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EventiAppalti.aspx.vb" Inherits="MANUTENZIONI_EventiAppalti" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Eventi contratto</title>
                            ...
                            <CommandItemTemplate>
                                <div style="display: inline-block; width: 100%;">
                                    <div style="float: right; padding: 4px;">
                                        <asp:Button ID="ButtonRefresh" runat="server" OnClick="Refresh_Click" CommandName="Refresh" Style="display:none"
                                            CssClass="rgRefresh" />
