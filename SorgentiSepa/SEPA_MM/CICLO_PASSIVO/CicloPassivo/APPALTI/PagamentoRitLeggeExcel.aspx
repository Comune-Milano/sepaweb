<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PagamentoRitLeggeExcel.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_APPALTI_PagamentoRitLeggeExcel" %>
        ...
        <tr>
            <td style="width: 100%">
                <asp:Label ID="lblTitoloPagina" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="12pt" ForeColor="Maroon" Text="Elaborazione mandato pagamenti">
                </asp:Label>
                <br />
                <br />
            </td>
