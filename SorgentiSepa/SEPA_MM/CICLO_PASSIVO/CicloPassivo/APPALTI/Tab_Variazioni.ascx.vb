...
Partial Class CICLO_PASSIVO_CicloPassivo_APPALTI_Tab_Variazioni
    ...
    Private Sub ContSpalmabilità()
        Try
            ...
            If IsNothing(CType(HttpContext.Current.Session.Item("CONNESSIONE" & CType(Me.Page, Object).lIdConnessione), Oracle.DataAccess.Client.OracleConnection)) Then
                par.OracleConn.Open()
            ...
            par.cmd.CommandText = "SELECT DISTINCT IVA_CANONE FROM SISCOM_MI.APPALTI_LOTTI_SERVIZI WHERE ID_APPALTO = " & CType(Me.Page, Object).vIdAppalti
            ...
            par.cmd.CommandText = "SELECT DISTINCT IVA_CONSUMO FROM SISCOM_MI.APPALTI_LOTTI_SERVIZI WHERE ID_APPALTO = " & CType(Me.Page, Object).vIdAppalti
    ...
    Private Sub salvaServCanone()
        Try
            If par.IfEmpty(Me.txtData.Text, "") <> "" Then
                ...
                If par.IfEmpty(Me.ConfermaSp_Canone.Value, 0) = 1 Then
