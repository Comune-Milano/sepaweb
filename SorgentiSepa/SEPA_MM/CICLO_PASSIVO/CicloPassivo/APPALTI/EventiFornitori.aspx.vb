...
Partial Class MANUTENZIONI_EventiFornitori
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                lblTitolo.Text = "ELENCO EVENTI FORNITORI"

                vIdFornitore = Request.QueryString("ID_FORNITORE")



                sStringaSql = "select TO_DATE(SISCOM_MI.EVENTI_FORNITORI.DATA_ORA,'yyyyMMddHH24MISS') as ""DATA_ORA""," _
                                  & " SISCOM_MI.TAB_EVENTI.DESCRIZIONE,SISCOM_MI.EVENTI_FORNITORI.COD_EVENTO,SISCOM_MI.EVENTI_FORNITORI.MOTIVAZIONE," _
                                  & " SEPA.OPERATORI.OPERATORE,SISCOM_MI.EVENTI_FORNITORI.ID_OPERATORE,SEPA.CAF_WEB.COD_CAF " _
                           & " from SEPA.CAF_WEB, SISCOM_MI.EVENTI_FORNITORI, SISCOM_MI.TAB_EVENTI,SEPA.OPERATORI " _
                           & " where SISCOM_MI.EVENTI_FORNITORI.ID_FORNITORE= " & vIdFornitore _
                             & " and SISCOM_MI.EVENTI_FORNITORI.COD_EVENTO=SISCOM_MI.TAB_EVENTI.COD (+) " _
                             & " and SISCOM_MI.EVENTI_FORNITORI.ID_OPERATORE=SEPA.OPERATORI.ID (+) " _
                             & " and SEPA.CAF_WEB.ID=SEPA.OPERATORI.ID_CAF " _
                          & " order by EVENTI_FORNITORI.DATA_ORA desc, EVENTI_FORNITORI.COD_EVENTO desc"
    ...
    Private Sub Visualizza(ByVal IdFornitore As Long, ByVal Codice As String)
        Try
            ...
            Response.Write("Fornitori, CODICE: <strong>" & Codice & "</strong><br />")
            Response.Write("<br />")
            'End If
            'myReader.Close()
            ...
            par.cmd.CommandText = "select TO_CHAR(TO_DATE(EVENTI_FORNITORI.DATA_ORA,'YYYYmmdd'),'DD/MM/YYYY') AS ""DATA_ORA""," _
                                      & " TAB_EVENTI.DESCRIZIONE,EVENTI_FORNITORI.COD_EVENTO,EVENTI_FORNITORI.MOTIVAZIONE," _
                                      & " OPERATORI.OPERATORE,EVENTI_FORNITORI.ID_OPERATORE,CAF_WEB.COD_CAF " _
                               & " from CAF_WEB, siscom_mi.EVENTI_FORNITORI, siscom_mi.TAB_EVENTI,SEPA.OPERATORI " _
                               & " where EVENTI_FORNITORI.ID_FORNITORE= " & IdFornitore _
                                 & " and EVENTI_FORNITORI.COD_EVENTO=TAB_EVENTI.COD (+) " _
                                 & " and EVENTI_FORNITORI.ID_OPERATORE=OPERATORI.ID (+) " _
                                 & " and CAF_WEB.ID=OPERATORI.ID_CAF " _
                              & " order by EVENTI_FORNITORI.DATA_ORA desc"
