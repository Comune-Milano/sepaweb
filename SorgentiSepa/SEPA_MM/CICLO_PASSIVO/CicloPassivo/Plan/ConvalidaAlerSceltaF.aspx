<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConvalidaAlerSceltaF.aspx.vb" Inherits="CICLO_PASSIVO_CicloPassivo_Plan_ConvalidaAlerSceltaF" %>
                ...
                <td style="width: 706px">
                   <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; 
                    ...
                    <br />
                        ...
                        style="position: absolute; width: 747px; height: 402px; top: 100px; left: 26px; overflow: scroll;"><%=Tabella%>
                    </div>
                                        <br />
                    <br />
                    <br />
                    ...
                    <asp:Label ID="lblErrore" runat="server" Visible="False" 
                        ...
                        style="position:absolute; top: 62px; left: 18px;" Font-Bold="True" 
