<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NuovoLotto.aspx.vb" Inherits="Contabilita_CicloPassivo_Plan_NuovoLotto" %>
...
<body>
        ...
        <table style="left: 0px; BACKGROUND-IMAGE: url('../../../NuoveImm/SfondoMascheraContratti.jpg'); WIDTH: 798px;
            ...
            <tr>
                <td style="width: 706px">
                    ...
                    <asp:Label ID="lblLotto0" runat="server" 
                        style="position:absolute; top: 205px; left: 14px;" Font-Bold="True" 
                        Font-Names="arial" Font-Size="10pt" Visible="False">Tipo Lotto</asp:Label>
                    ...
                    <asp:DropDownList ID="cmbTipoLotto" runat="server" 
                        style="position:absolute; top: 204px; left: 88px;" Font-Names="arial" 
                        Font-Size="10pt" Width="620px" TabIndex="1" Visible="False">
                        <asp:ListItem Value="E">EDIFICIO</asp:ListItem>
                        <asp:ListItem Value="I">IMPIANTO</asp:ListItem>
                    </asp:DropDownList>
        ...
        <asp:DataGrid ID="tabcomplessi" runat="server" AutoGenerateColumns="False"
            ...
            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                ...
                ToolTip="Elimina Elemento Selezionato" onclientclick="Cancellare();" 
                        TabIndex="6" />
                        <asp:ImageButton ID="ImgInseriscitutti" runat="server" ImageUrl="Immagini/AggiungiTutti.png"
                            Style="z-index: 102; left: 736px; top: 247px; position:absolute; height: 18px;cursor:pointer; width: 18px;" 
                ToolTip="Inserisci Tutti gli edifici" 
                        TabIndex="6" />
            <asp:Image ID="Img2" 
                alt="Aiuto Ricerca per Edifici" onclick="VisualizzaComplesso();"
                runat="server" 
                ImageUrl="Immagini/home16.png" 
                        ToolTip="Visualizza dati del complesso" 
                        style="position:absolute; top: 335px; left: 689px;cursor:pointer; " 
                        TabIndex="7" />
            <asp:Image ID="Img1" 
                alt="Aiuto Ricerca per Edifici" onclick="document.getElementById('txtcomplessi').value='1';myOpacitycom.toggle();"
                runat="server" 
                ImageUrl="Immagini/40px-Crystal_Clear_action_edit_add.png" 
                        ToolTip="Aggiungi Edificio" 
            ...
            Style="z-index: 104; left: 16px; position: absolute; top: 230px">Lista Edifici</asp:Label>
                        ...
                        <tr>
                            <td style="vertical-align: top; text-align: left" class="style1">
                                <asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                                    ...
                                    Width="238px">Inserire edifici</asp:Label>
                            </td>
    ...
    <div id="RicercaComplessi" 
        ...
        style="z-index: 400; left: 0px; width: 800px; position: absolute; top: 0px; height: 600px; background-image: url('../../../../../../NuoveImm/SfondoMascheraContratti.jpg'); background-repeat: no-repeat; visibility: hidden;">
                        ...
                        <tr>
                            <td style="vertical-align: top; text-align: left" class="style1">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                                    ForeColor="Black" Style="z-index: 100; left: 14px; top: 32px" 
                                    Width="238px">ELENCO EDIFICI</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="vertical-align: top; width: 352px; height: 104px; text-align: left">
                    ...
                    <img alt="" src="../../../ImmDiv/SfondoDivLotto.png" 
                        style="position:absolute; top: 0px; left: 0px; z-index: 401;"/>
            </div>
    ...
    <script type="text/javascript">
        ...
        function VisualizzaComplesso() {
            if (document.getElementById('txtIdComponente').value > 0) {
                ...
                window.open('../../../CENSIMENTO/InserimentoEdifici.aspx?X=1&SLE=1&ID=' + document.getElementById('txtIdComponente').value, 'Dettagli', 'height=600,top=0,left=0,width=780');
    ...
    <script type="text/javascript">
        ...
        if (document.getElementById('lettura').value == '1') {
            ...
            document.getElementById('ImgInseriscitutti').style.visibility = 'hidden';
            document.getElementById('ImgInseriscitutti').style.position = 'absolute';
            document.getElementById('ImgInseriscitutti').style.left = '-100px';
            document.getElementById('ImgInseriscitutti').style.display = 'none';
