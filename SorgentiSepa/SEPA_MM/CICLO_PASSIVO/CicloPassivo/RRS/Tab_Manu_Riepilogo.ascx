...
<table id="TABBLE_PRINCIPALE">
            ...
            <table>
                <tr>
                    <td style="vertical-align: middle; text-align: left">
                        <asp:Label ID="lblFornitore" runat="server" ForeColor="Black" Style="z-index: 100; left: -46px; top: -302px"
                            TabIndex="-1" Width="50px">Fornitore</asp:Label>
                    </td>
                    <td style="vertical-align: middle; text-align: left">
                        <asp:HyperLink ID="HLink_Fornitore" runat="server" class="TitoloH1" 
                            Font-Size="8pt" Width="170px" Style="cursor: pointer; text-align:left" Font-Underline="True" >123456789 123456789 123456789  </asp:HyperLink>
                    </td>
                    <td style="width: 15px; vertical-align: top; text-align: left;">
                    </td>
                    <td style="vertical-align: middle; text-align: left">
                        <asp:Label ID="lblAppalto" runat="server"  Font-Size="8pt" 
                            ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px; text-align:left " TabIndex="-1" Width="85px">Num. Repertorio</asp:Label>
                    </td>
                    <td style="vertical-align: middle; text-align: left">
                        <asp:HyperLink ID="HLink_Appalto" runat="server" CssClass="TitoloH1" 
                            Font-Size="8pt" Font-Underline="True"  Width="130px" Style="cursor: pointer; text-align:left ">123456789 123456789  </asp:HyperLink>
                    </td>
                    <td style="width: 15px; vertical-align: middle; text-align: left;">
                        <asp:ImageButton ID="btnAggAppalto" runat="server" CausesValidation="False" ImageUrl="~/CICLO_PASSIVO/CicloPassivo/MANUTENZIONI/Immagini/40px-Crystal_Clear_action_edit_add.png"
                            ...
                            TabIndex="9" ToolTip="Seleziona l'appalto" Visible="false" />
                    </td>
                    <td style="vertical-align: middle; text-align: left">
                        <asp:Label ID="lblDittaGestione" runat="server" 
                            Font-Size="8pt" ForeColor="Black" Style="z-index: 100; left: 8px; top: 88px"
                            TabIndex="-1" Width="65px">Imp. Residuo</asp:Label>
                    </td>
                    <td style="vertical-align: top; text-align: left">
                        <asp:TextBox ID="txtImportoTotale" runat="server" Font-Bold="True" MaxLength="30"
                            ...
                            Width="90px" ReadOnly="True" Font-Size="8pt"></asp:TextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="Label21" runat="server" Font-Bold="False" Font-Italic="True" Font-Names="Arial"
                            Font-Size="7pt" ForeColor="Black" Style="z-index: 100; left: 8px; top: 88px"
                            TabIndex="-1" Width="80px">(a netto dell'ordine)</asp:Label>
                    </td>
                </tr>
            </table>
            &nbsp;&nbsp;
                    ...
                    <td style="vertical-align: top">
                        <fieldset style="border-width: 2px">
                            ...
                            <table style="font-weight: normal; text-decoration: none">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblIVAC" runat="server">IVA</asp:Label>&nbsp;<asp:DropDownList ID="cmbIVA_C" Font-Size="8pt"
                                            runat="server" SelectedValue='<%# DataBinder.Eval(Container, "DataItem.IVA") %>' Enabled="false"
                                            TabIndex="8" Width="60px">
                                        </asp:DropDownList>
 ...
 <asp:HiddenField ID="txtOneriP_MANO" runat="server" />
            ...
            <asp:TextBox ID="txtIdComponente" runat="server" Style="left: 800px; position: absolute;
                display: none; visibility: hidden; top: 320px" TabIndex="-1" Width="0px" Height="0px"></asp:TextBox>
