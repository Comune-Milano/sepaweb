<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReportRisultatoRRS_D.aspx.vb" Inherits="ReportRisultatoRRS_D" %>
...
<body>
    ...
    <div>
        ...
        <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            ...
            border-collapse: separate" Width="968px">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="NUM_REPERTORIO" HeaderText="NUM. REPER.">
                ...
                <asp:BoundColumn DataField="VOCE" HeaderText="VOCE P.F.">
                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                ...
                <asp:BoundColumn DataField="PROGR" HeaderText="ODL_NUM" Visible="False"></asp:BoundColumn>
                <asp:BoundColumn DataField="ANNO" HeaderText="ANNO" Visible="False"></asp:BoundColumn>
                <asp:BoundColumn DataField="DATA_ODL" HeaderText="DATA_ODL" Visible="False"></asp:BoundColumn>
