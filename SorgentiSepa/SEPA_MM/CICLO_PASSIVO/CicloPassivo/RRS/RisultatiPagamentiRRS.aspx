<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiPagamentiRRS.aspx.vb"
    Inherits="RRS_RisultatiPagamentiRRS" %>
...
<body>
    ...
    <telerik:RadWindow ID="RadWindowVociServizi" runat="server" CenterIfModal="true"
        VisibleTitlebar="true" Modal="true" Width="650px" Height="400px" VisibleStatusbar="false"
        Title="Aggiungi Voci Servizi" Behaviors="Pin, Maximize, Move, Resize">
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server">
                <table border="0" cellpadding="4" cellspacing="4" width="90%">
                    ...
                    <tr>
                        <td style="width: 20%">
                            <asp:Label ID="Label1" Text="Data di emissione*" runat="server" Font-Names="Arial"
                                Font-Size="9pt" />
                        </td>
                        <td style="width: 80%">
