<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiRRS.aspx.vb" Inherits="RRS_RisultatiRRS" %>
    ...
    <form id="form1" runat="server" onsubmit="caricamento();return true;">
        ...
        <div style="width: 100%">
            <table style="width: 100%">
                <tr>
                    <td class="TitoloModulo">Ordini - Gestione non patrimoniale - Ricerca - Selettiva
                    </td>
                </tr>
                <tr>
                    <td>
                                ...
                                <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="NUM_REPERTORIO" HeaderText="NUM. REPER." ItemStyle-HorizontalAlign="Left"
                                            ...
                                            DataFormatString="{0:@}" FilterControlWidth="85%" HeaderStyle-HorizontalAlign="Center">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="ODL_ANNO" HeaderText="ODL/ANNO" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="5%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                            DataFormatString="{0:@}" FilterControlWidth="85%" HeaderStyle-HorizontalAlign="Center">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="UBICAZIONE" HeaderText="UBICAZIONE" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            FilterControlWidth="85%" HeaderStyle-HorizontalAlign="Center">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="IMPORTO_PRE" HeaderText="IMPORTO PREVENTIVO"
                                            HeaderStyle-Width="5%" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right"
