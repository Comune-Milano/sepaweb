'*** RICERCA MANUTENZIONI RRS DIRETTA

Partial Class RRS_RicercaRRS_D
 ...
 Protected Sub btnCerca_Click(sender As Object, e As System.EventArgs) Handles btnCerca.Click
        Try
            Response.Write("<script>location.replace('RisultatiRRS_D.aspx?REP=" & par.VaroleDaPassare(Me.txtNumRepertorio.Text) _
