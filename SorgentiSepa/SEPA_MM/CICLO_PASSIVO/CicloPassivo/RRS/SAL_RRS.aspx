<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SAL_RRS.aspx.vb" Inherits="RRS_SAL_RRS" %>
    ...
    <form id="form1" runat="server" onsubmit="caricamento();return true;">
        ...
        <div class="FontTelerik">
            <table style="width: 100%">
                <tr>
                    <td class="TitoloModulo">SAL non patrimoniale</td>
                </tr>
                <tr>
                    <td>
                        <table>
                                ...
                                <td>
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadComboBox ID="cmbStato" Width="50%" AppendDataBoundItems="true" Filter="Contains"
