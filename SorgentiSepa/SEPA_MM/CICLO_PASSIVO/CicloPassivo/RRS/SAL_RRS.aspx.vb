'SCHEDA SAL RRS (PAGAMENTI + ELENCO MANUTENZIONI)
Imports System.Math
...
Partial Class RRS_SAL_RRS
    ...
    Public importo, penale, importoT, penaleT, oneriT, astaT, ivaT, ritenutaT, ritenutaNoIvaT, rimborsoT, risultato1T, risultato2T, risultato3T, risultato4T, risultatoImponibileT, ivaLiquidazioneT As Decimal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                Me.HLink_ElencoMandati.Attributes.Add("onClick", "javascript:window.open('../PAGAMENTI/Tab_ElencoMandati.aspx?ID_PAGAMENTO=" & vIdPagamento & "','Elenco','height=800,width=600');")
                ...
                & "AND PAGAMENTI.ID IN (" & vIdPagamento & ") AND PAGAMENTI.ID=PRENOTAZIONI.ID_PAGAMENTO AND PF_VOCI.FL_CC=0"
                    ...
                    If Lett.Read Then
                        ...
                        If par.IfNull(Lett(0), 0) = 6 And Session.Item("FL_ANNULLA_SAL") = 0 Then
    ...
    Private Sub Setta_StatoPagamento()
        ...
        'Me.cmbStato.Items.Add(New ListItem("NON FIRMATO", 0))
        'Me.cmbStato.Items.Add(New ListItem("FIRMATO CON RISERVA", 1))
        'Me.cmbStato.Items.Add(New ListItem("FIRMATO", 2))
    ...
    Private Sub RiempiCampi(ByVal myReader1 As Oracle.DataAccess.Client.OracleDataReader)
        ...
        Try
            ...
            If myReader2.Read Then
                ...
                Me.HLink_Appalto.Attributes.Add("onClick", "javascript:window.open('../APPALTI/AppaltiNP.aspx?IDA=" & par.IfNull(myReader2("ID"), "") & "&LE=1','Appalto','height=700,width=1300');")
            ...
            par.cmd.CommandText = "select MANUTENZIONI.DESCRIZIONE,MANUTENZIONI.IMPORTO_CONSUNTIVATO,MANUTENZIONI.IVA_CONSUMO," _
                                      & " MANUTENZIONI.RIMBORSI,MANUTENZIONI.ID_PF_VOCE, " _
            ...
            While myReader2.Read
                ...
                CalcolaImporti2(par.IfNull(myReader2("IMPORTO_CONSUNTIVATO"), 0), par.IfNull(myReader2("IVA_CONSUMO"), 0), par.IfNull(myReader2("RIMBORSI"), 0), par.IfNull(myReader2("PENALE2"), 0), par.IfNull(myReader2("ID_PF_VOCE"), 0), par.IfNull(myReader2("ID_APPALTO"), 0), par.IfNull(myReader2("IMPORTO_ONERI_CONS"), 0))
            ...
            par.cmd.CommandText = "select MANUTENZIONI.DESCRIZIONE,MANUTENZIONI.IMPORTO_CONSUNTIVATO,MANUTENZIONI.IVA_CONSUMO," _
                               ...
                               & " where MANUTENZIONI.ID_PAGAMENTO in (select ID from SISCOM_MI.PAGAMENTI " _
                                                                   & " where TIPO_PAGAMENTO=7  and id_stato<>-3  " _
            ...
            While myReader2.Read
                ...
                CalcolaImportiProgress2(Somma1, par.IfNull(myReader2("IVA_CONSUMO"), 0), par.IfNull(myReader2("RIMBORSI"), 0), par.IfNull(myReader2("PENALE2"), 0), par.IfNull(myReader2("ID_PF_VOCE"), 0), par.IfNull(myReader2("ID_APPALTO"), 0), par.IfNull(myReader2("IMPORTO_ONERI_CONS"), 0))
                'Else
                'Response.Write("<script>alert('Nessun importo stanziato per questo tipo di pagamento!');</script>")
                'myReader2.Close()
                'Exit Sub
    ...
    Sub SettaValRicerca()
        ...
        Try
            ...
            If myReader1.Read Then
                ...
                Me.HLink_Appalto.Attributes.Add("onClick", "javascript:window.open('../APPALTI/AppaltiNP.aspx?IDA=" & par.IfNull(myReader1("ID"), "") & "&LE=1','Appalto','height=700,width=1300');")
            ...
            par.cmd.CommandText = "select MANUTENZIONI.DESCRIZIONE,MANUTENZIONI.IMPORTO_CONSUNTIVATO,MANUTENZIONI.IVA_CONSUMO," _
                                      ...
                                      & ",(select anticipo_contrattuale from siscom_mi.prenotazioni where prenotazioni.id=manutenzioni.id_prenotazione_pagamento) as anticipo_contrattuale," _
                                      & "(select PERC_IVA FROM SISCOM_MI.APPALTI_ANTICIPI_CONTRATTUALI WHERE ID_APPALTO=(SELECT ID_GRUPPO FROM SISCOM_MI.APPALTI WHERE ID= manutenzioni.id_appalto )) as perc_iva, " _
                                      & " NVL((SELECT APPALTI_ANTICIPI_CONTRATTUALI.TIPO FROM SISCOM_MI.APPALTI_ANTICIPI_CONTRATTUALI WHERE APPALTI_ANTICIPI_CONTRATTUALI.ID_APPALTO=MANUTENZIONI.ID_APPALTO AND APPALTI_ANTICIPI_CONTRATTUALI.ID_PF_VOCE " _
                                      & " in  " _
                                      & "(SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID=ID_OLD START WITH ID IN (MANUTENZIONI.ID_PF_VOCE) " _
                                      & "      UNION " _
                                      & "      SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID_OLD=ID START WITH ID IN (MANUTENZIONI.ID_PF_VOCE) " _
                                      & "     ) " _
                                      & " ),0) AS TIPO " _
                                      & " from   SISCOM_MI.MANUTENZIONI,SISCOM_MI.APPALTI_PENALI" _
            ...
            While myReader1.Read
                ...
                CalcolaImporti(par.IfNull(myReader1("IMPORTO_CONSUNTIVATO"), 0), par.IfNull(myReader1("IVA_CONSUMO"), 0), par.IfNull(myReader1("RIMBORSI"), 0), par.IfNull(myReader1("PENALE2"), 0), par.IfNull(myReader1("ID_PF_VOCE"), 0), par.IfNull(myReader1("ID_APPALTO"), 0), par.IfNull(myReader1("IMPORTO_ONERI_CONS"), 0))
                If par.IfNull(myReader1("TIPO"), 0) = "1" Then
                    par.cmd.CommandText = "SELECT id FROM SISCOM_MI.PF_VOCI WHERE ID in " _
                                        & " (SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID=ID_OLD START WITH ID IN (" & voce.Value & ") " _
                                        & " UNION " _
                                        & " SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID_OLD=ID START WITH ID IN (" & voce.Value & ")" _
                                        & ")"
                    ...
                    For Each riga As Data.DataRow In dtVociImporto.Rows
                        If par.IfNull(myReader1("ID_PF_VOCE"), 0) = riga.Item("ID") Then
                            anticipoCalcolato = risultato3T * 0.2D
                        End If
                    Next


                    'If par.IfNull(myReader1("ID_PF_VOCE"), 0) = voce.Value Then
                    '    anticipoCalcolato = risultato3T * 0.2D
                    'End If
                End If
                If sDescManutenzioni = "" Then
            ...
            Else
                If tipoAnticipo.Value = "1" Then
                    ...
                    CType(Tab_SAL_Riepilogo.FindControl("txtImportoTotaleTrattenuto"), TextBox).Attributes.Add("ReadOnly", "ReadOnly")
                Else
                    par.cmd.CommandText = "SELECT NVL(VOCE_ANTICIPO_NP,-1) FROM SISCOM_MI.APPALTI WHERE ID = " & sValoreAppalto
            ...
            While myReader1.Read
                ...
                CalcolaImportiProgress(Somma1, par.IfNull(myReader1("IVA_CONSUMO"), 0), par.IfNull(myReader1("RIMBORSI"), 0), par.IfNull(myReader1("PENALE2"), 0), par.IfNull(myReader1("ID_PF_VOCE"), 0), par.IfNull(myReader1("ID_APPALTO"), 0), par.IfNull(myReader1("IMPORTO_ONERI_CONS"), 0))
                'Else
                '    Response.Write("<script>alert('Nessun importo stanziato per questo tipo di pagamento!');</script>")
                '    myReader1.Close()
        ...
        Catch EX1 As Oracle.DataAccess.Client.OracleException
            If EX1.Number = 54 Then
                'par.OracleConn.Close()
                scriptblock = "<script language='javascript' type='text/javascript'>" _
                & "alert('Non è possibile effettuare il Sal perchè l\' ODL è aperto da un altro utente!');document.location.href='../../pagina_home_ncp.aspx'" _
                & "</script>"
                If (Not Page.ClientScript.IsClientScriptBlockRegistered("clientScript4")) Then
                    Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "clientScript4", scriptblock)
                End If
    ...
    Private Sub Salva()
        ...
        Try
            ...
            If CDec(CType(Tab_SAL_Riepilogo.FindControl("txtImportoTrattenuto"), TextBox).Text) >= CDec(Importo_ConsuntivatoTotale) Then
            ...
            par.cmd.CommandText = "SELECT APPALTI_ANTICIPI_CONTRATTUALI.TIPO AS TIPO, " _
                & " APPALTI_ANTICIPI_CONTRATTUALI.ID_PF_VOCE AS VOCE" _
            ...
            Else
                par.cmd.CommandText = "SELECT SUM(IMPORTO_aPPROVATO-NVL(RIT_LEGGE_IVATA,0)) " _
                    & " FROM SISCOM_MI.PRENOTAZIONI WHERE PRENOTAZIONI.ID_VOCE_PF in " _
                    & " (SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID=ID_OLD START WITH ID IN (" & voce & ") " _
                    & " UNION " _
                    & " SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID_OLD=ID START WITH ID IN (" & voce & ")" _
            ...
            par.cmd.CommandText = "insert into SISCOM_MI.PAGAMENTI  " _
                                        & " (ID, DATA_SAL,DATA_EMISSIONE,DATA_STAMPA,DESCRIZIONE,IMPORTO_CONSUNTIVATO,ID_FORNITORE,ID_APPALTO,ID_STATO,TIPO_PAGAMENTO,STATO_FIRMA,anticipo_contrattuale, importo_consuntivato_ant) " _
                                & "values (:id,:data_sal,:data,:data_stampa,:descrizione,:importo,:id_fornitore,:id_appalto,1,7,:stato_firma,:anticipo_contrattuale,:importo_consuntivato_ant) "
            ...
            par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("data_sal", par.AggiustaData(Me.txtDataSAL.SelectedDate)))
...
STAMPA:
    ...
    Private Sub Update()
        ...
        Try
            ...
            par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("data", par.AggiustaData(Me.txtDataDel.SelectedDate)))
            par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("data_sal", par.AggiustaData(Me.txtDataSAL.SelectedDate)))
            par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("conto_corrente", "12000X01"))
            par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("descrizione", Me.txtDescAttPagamento.Text)) 'sDescrizione))
    ...
    Protected Sub btnAnnulla_Click(sender As Object, e As System.EventArgs) Handles btnAnnulla.Click
        ...
        Try
            If txtElimina.Text = "1" Then
                ...
                par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("tipo_operazione", "ANNULLO SAL in PAGAMENTI MANUTENZIONE NON PATRIMONIALE"))

                par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("tipo_oggetto", "PAGAMENTI di MANUTENZIONI NON PATRIMONIALE"))
                ...
                sNote = "Annullamento SAL (Manutenzione NON PATRIMONIALE) con SAL: " & Me.lblProgAnnoPagamento.Text & " del:" & Me.txtDataDel.SelectedDate _
                ...
                Select Case sValoreProvenienza
                    ...
                    Case "RISULTATI_SAL_RRS"
                        'Response.Write("<script>location.replace('Blocca_SbloccaMenu(0);RisultatiSAL_RRS.aspx?FO=" & sValoreFornitore _
                        '                                                              & "&AP=" & sValoreAppalto _
                        ...
                        annullaSal = "1"
                        ScriptManager.RegisterStartupScript(Me, Me.GetType, "", "Blocca_SbloccaMenu(0);location.replace('RisultatiSAL_RRS.aspx?FO=" & sValoreFornitore _
                                                                                      & "&AP=" & sValoreAppalto _
                                                                                      & "&SV=" & sValoreServizio _
                                                                                      & "&DAL=" & sValoreData_Dal _
                                                                                      & "&AL=" & sValoreData_Al _
                    ...
                    Case "RISULTATI_SAL_RRS_FIRMA"
                        'Response.Write("<script>location.replace('Blocca_SbloccaMenu(0);RisultatiSAL_RRS_FIRMA.aspx?FO=" & sValoreFornitore _
                        '                                                              & "&AP=" & sValoreAppalto _
                        '                                                              & "&SV=" & sValoreServizio _
                        '                                                              & "&DAL=" & sValoreData_Dal _
                        '                                                              & "&AL=" & sValoreData_Al _
                        ...
                        '                                                              & "&PROVENIENZA=" & sValoreProvenienza & "');</script>")
                        annullaSal = "1"
                        ScriptManager.RegisterStartupScript(Me, Me.GetType, "", "Blocca_SbloccaMenu(0);location.replace('RisultatiSAL_RRS_FIRMA.aspx?FO=" & sValoreFornitore _
                                                                                      & "&AP=" & sValoreAppalto _
                                                                                      & "&SV=" & sValoreServizio _
                                                                                      & "&DAL=" & sValoreData_Dal _
                                                                                      & "&AL=" & sValoreData_Al _
                    ...
                    Case Else
                        If txtindietro.Text = 1 Then
                            ...
                            'Response.Write("<script>Blocca_SbloccaMenu(0);document.location.href=""../../pagina_home_ncp.aspx""</script>")
                        End If
                End Select
    ...
    Protected Sub btnINDIETRO_Click(sender As Object, e As System.EventArgs) Handles btnINDIETRO.Click
        If txtModificato.Text <> "111" Then
            ...
            Select Case sValoreProvenienza
                ...
                Case "RISULTATI_SAL_RRS"
                    Response.Write("<script>location.replace('RisultatiSAL_RRS.aspx?FO=" & sValoreFornitore _
                                                                                  & "&AP=" & sValoreAppalto _
                                                                                  & "&SV=" & sValoreServizio _
                                                                                  & "&DAL=" & sValoreData_Dal _
                                                                                  & "&AL=" & sValoreData_Al _
                ...
                Case "RISULTATI_SAL_RRS_FIRMA"
                    Response.Write("<script>location.replace('RisultatiSAL_RRS_FIRMA.aspx?FO=" & sValoreFornitore _
                                                                                  & "&AP=" & sValoreAppalto _
                                                                                  & "&SV=" & sValoreServizio _
                                                                                  & "&DAL=" & sValoreData_Dal _
                                                                                  & "&AL=" & sValoreData_Al _
    ...
    Private Sub caricaImportoResiduoDaTrattenere()
        ...
        Try
            ...
            par.cmd.CommandText = "SELECT TIPO,ID_PF_VOCE AS VOCE FROM SISCOM_MI.APPALTI_ANTICIPI_CONTRATTUALI WHERE ID_APPALTO=(Select ID_GRUPPO FROM SISCOM_MI.APPALTI WHERE ID=" & sValoreAppalto & ") " & condizioneVoce
            ...
            If tipo.Value = 1 Then
                condizioneVoce = " AND ID_PF_VOCE in " _
                    & " (SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID=ID_OLD START WITH ID IN (" & voce.Value & ") " _
                    & " UNION " _
                    & " SELECT ID FROM SISCOM_MI.PF_VOCI CONNECT BY PRIOR ID_OLD=ID START WITH ID IN (" & voce.Value & ")" _
                    & ")"
            ...
            par.cmd.CommandText = "SELECT SUM(IMPONIBILE) FROM SISCOM_MI.APPALTI_ANTICIPI_CONTRATTUALI WHERE ID_APPALTO=(SELECT ID_GRUPPO FROM SISCOM_MI.APPALTI WHERE ID=" & sValoreAppalto & ")"
            ...
            par.cmd.CommandText = "SELECT N_RATE_ANTICIPO FROM SISCOM_MI.APPALTI WHERE ID=" & sValoreAppalto
            numeroRate = par.IfNull(par.cmd.ExecuteScalar, 0)
    ...
    Sub CalcolaImporti(ByVal importo As Decimal, ByVal IVA_CONSUMO As Decimal, ByVal rimborso As Decimal, ByVal penale As Decimal, ByVal Id_Voce As Integer, ByVal Id_Appalto As Integer, ByVal Oneri_Inseriti As Decimal)
        Dim sStr1 As String
    ...
    Sub CalcolaImporti2(ByVal importo As Decimal, ByVal IVA_CONSUMO As Decimal, ByVal rimborso As Decimal, ByVal penale As Decimal, ByVal Id_Voce As Integer, ByVal Id_Appalto As Integer, ByVal Oneri_Inseriti As Decimal)
        Dim sStr1 As String
        Dim perc_oneri, perc_sconto, perc_iva As Decimal
    ...
    Sub CalcolaImportiProgress(ByVal importo As Decimal, ByVal IVA_CONSUMO As Decimal, ByVal rimborso As Decimal, ByVal penale As Decimal, ByVal Id_Voce As Integer, ByVal Id_Appalto As Integer, ByVal Oneri_Inseriti As Decimal)
        Dim sStr1 As String
        Dim perc_oneri, perc_sconto, perc_iva As Decimal
        Dim oneri, asta, iva, risultato1, risultato2, risultato3, risultato4, ritenuta, ritenutaIVATA, risultato5 As Decimal
        Dim FlagConnessione As Boolean
    ...
    Sub CalcolaImportiProgress2(ByVal importo As Decimal, ByVal IVA_CONSUMO As Decimal, ByVal rimborso As Decimal, ByVal penale As Decimal, ByVal Id_Voce As Integer, ByVal Id_Appalto As Integer, ByVal Oneri_Inseriti As Decimal)
        Dim sStr1 As String
        Dim perc_oneri, perc_sconto, perc_iva As Decimal
        Dim oneri, asta, iva, risultato1, risultato2, risultato3, risultato4, ritenuta, ritenutaIVATA, risultato5 As Decimal
        Dim FlagConnessione As Boolean
    ...
    Private Sub BindGridManutenzioni(ByVal sCondizione As String, ByVal ID_APPALTO As Long, ByVal PROGR_APPALTO As String)
        ...
        Try
            ...
            sStringaSql = " select  MANUTENZIONI.ID AS ""ID_MANUTENZIONE""," _
                                ...
                                & " MANUTENZIONI.PROGR,MANUTENZIONI.ANNO,MANUTENZIONI.ID_PRENOTAZIONE_PAGAMENTO,MANUTENZIONI.ID_PF_VOCE,MANUTENZIONI.IMPORTO_CONSUNTIVATO,MANUTENZIONI.IVA_CONSUMO,MANUTENZIONI.RIMBORSI,APPALTI_PENALI.IMPORTO as ""PENALE"",siscom_mi.GETOGGETTOMANUTENZIONE(MANUTENZIONI.ID) AS PATRIMONIO  " _
            ...
            While myReader2.Read()
                ...
                sStringaSql = "select APPALTI_VOCI_PF.*,APPALTI.FL_RIT_LEGGE " _
                                & "  from   SISCOM_MI.APPALTI_VOCI_PF,SISCOM_MI.APPALTI " _
                                & "  where APPALTI_VOCI_PF.ID_PF_VOCE=" & par.IfNull(myReader2("ID_PF_VOCE"), 0) _
                                & "  and   APPALTI_VOCI_PF.ID_APPALTO=" & ID_APPALTO _
                                & "  and   APPALTI.ID=" & ID_APPALTO
    ...
    Private Sub PdfPagamento(ByVal ID_Pagamento As Double)
        Dim sStr1 As String
        ...
        Try
            ...
            If myReader1.Read Then
                ...
                While myReaderT.Read
                    ...
                    CalcolaImportiProgress(Somma1, par.IfNull(myReaderT("IVA_CONSUMO"), 0), par.IfNull(myReaderT("RIMBORSI"), 0), par.IfNull(myReaderT("PENALE2"), 0), par.IfNull(myReaderT("ID_PF_VOCE"), 0), par.IfNull(myReaderT("ID_APPALTO"), 0), par.IfNull(myReaderT("IMPORTO_ONERI_CONS"), 0))
                    'Else
                    'Response.Write("<script>alert('Nessun importo stanziato per questo tipo di pagamento!');</script>")
                    'myReaderT.Close()
                ...
                While myReaderT.Read
                    ...
                    CalcolaImporti(par.IfNull(myReaderT("IMPORTO_CONSUNTIVATO"), 0), par.IfNull(myReaderT("IVA_CONSUMO"), 0), par.IfNull(myReaderT("RIMBORSI"), 0), par.IfNull(myReaderT("PENALE2"), 0), par.IfNull(myReaderT("ID_PF_VOCE"), 0), par.IfNull(myReaderT("ID_APPALTO"), 0), par.IfNull(myReaderT("IMPORTO_ONERI_CONS"), 0))
                    'Else
                    'Response.Write("<script>alert('Nessun importo stanziato per questo tipo di pagamento!');</script>")
                    'myReaderT.Close()
            ...
            ScriptManager.RegisterStartupScript(Me, Me.GetType, "", "window.open('../../../FileTemp/" & nomefile & "','SALPagamento');self.close();", True)
    ...
    Private Sub stampaP(ByVal dataEmiss As String)
        ...
        Try
            ...
            Else
                ...
                par.cmd.CommandText = "INSERT INTO SISCOM_MI.EVENTI_PAGAMENTI (ID_PAGAMENTO,ID_OPERATORE,DATA_ORA,COD_EVENTO,MOTIVAZIONE) VALUES ( " & Me.txtid.Value & "," & Session.Item("ID_OPERATORE") & ",'" & Format(Now, "yyyyMMddHHmmss") & "', 'F98','Stampa Attestato di Pagamento')"
                par.cmd.ExecuteNonQuery()
                ...
                If myReader1.Read Then
                    ...
                    ElseIf penaleT <> 0 Then
                        S2 = S2 & "</tr><tr>"
                        S2 = S2 & "<td style='text-align: left;  width:40%; font-size:14pt;font-family :Arial ;'>" & "   " & "</td>"
                        S2 = S2 & "</tr><tr><td style='text-align: right; width:40%; font-size:14pt;font-family :Arial ;'>Totale compreso IVA €</td>"
                    ...
                    While myReaderCapitolo.Read
                        TestoGrigliaBP = TestoGrigliaBP & "<tr style='border-bottom-style: dashed; border-bottom-width: 2px; border-bottom-color: #000000;border-width: 1px; border-color: #000000; height: 30px; border-bottom-style: solid;'>" _
                                                    ...
                                                    & "<td align='left' style='border-bottom-style: dashed; border-bottom-width: 1px; border-bottom-color: #000000;font-family: ARIAL; font-size: 9pt'>" & par.AnnoBPPag(Me.txtid.Value) & "</td>" _
                    ...
                    par.cmd.CommandText = "select sum(anticipo_contrattuale) " _
                        ...
                        & " WHERE APPALTI.ID_gESTORE_ORDINI=GESTORI_ORDINI.ID AND PAGAMENTI.ID_APPALTO=APPALTI.ID AND PAGAMENTI.ID=" & Me.txtid.Value
