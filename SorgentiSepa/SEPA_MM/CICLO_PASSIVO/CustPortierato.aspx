<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CustPortierato.aspx.vb"
    Inherits="CICLO_PASSIVO_CustPortierato" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gestione Portierato</title>
...
<body>
    ...
    <table style="width: 730px;">
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Label ID="lblTitolo" CssClass="testoGrassettoMaiuscoloBlu" runat="server">Gestione Portierato</asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                Matricola &nbsp;&nbsp;&nbsp;
                <telerik:RadTextBox ID="txtMatricola" runat="server" Width="150px" ReadOnly="True">
                </telerik:RadTextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <telerik:RadTextBox ID="txtCognome" runat="server" Width="300px" ReadOnly="True">
                </telerik:RadTextBox>
            </td>
            <td>
                <telerik:RadTextBox ID="txtNome" runat="server" Width="300px" ReadOnly="True">
                </telerik:RadTextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <table>
                    <tr>
                        <td>
                            <telerik:RadGrid ID="dgvPortierato" runat="server" AutoGenerateColumns="False" Culture="it-IT"
                    ...
                    <tr>
                        <td colspan="2" style="text-align: right">
                            <asp:Button ID="btnEsci" runat="server" Text="Esci" ToolTip="Esci" OnClientClick="CloseAndRebind();return false;" Width="100px" />
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <telerik:RadWindow ID="RadWindowComplesso" runat="server" CenterIfModal="true"
    ...
    <telerik:RadWindow ID="RadWindowEdificio" runat="server" CenterIfModal="true"
        Modal="True" VisibleStatusbar="False" AutoSize="True" Behavior="Pin, Move, Resize"
        Skin="Web20">
        <ContentTemplate>
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="Edificio">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="dgvPortierato" LoadingPanelID="RadAjaxLoadingPanel2" />
    ...
    <asp:Panel ID="hiddenpanel" runat="server">
        <asp:HiddenField ID="idCustode" runat="server" Value="0" ClientIDMode="Static" />
