<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GestCustodi.aspx.vb" Inherits="CICLO_PASSIVO_GestCustodi" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function NewCustode() {
            //window.showModalDialog('GestModCustodi.aspx', 'window', 'status:no;dialogWidth:800px;dialogHeight:500px;dialogHide:true;help:no;scroll:no');
            var oWnd = $find('RadWindow1');
            oWnd.setUrl('GestModCustodi.aspx');
            oWnd.show();
        };
        ...
        function ModCustode() {
            if (document.getElementById('idSel').value != '') {
                //window.showModalDialog('GestModCustodi.aspx?IDCUST=' + document.getElementById('idSel').value, 'window', 'status:no;dialogWidth:800px;dialogHeight:500px;dialogHide:true;help:no;scroll:no');
                var oWnd = $find('RadWindow1');
                oWnd.setUrl('GestModCustodi.aspx?IDCUST=' + document.getElementById('idSel').value);
                oWnd.show();
            } else {
                apriAlert(Messaggio.Elemento_No_Selezione, 300, 150, Messaggio.Titolo_Conferma, null, null);
            };
        };
        function ModPortierato() {
            if (document.getElementById('idSel').value != '') {
                if (document.getElementById('flAttivo').value == '0') {
                    apriAlert('Non è possibile gestire il portierato per custodi disattivati!', 300, 150, 'Attenzione', null, null);
                    return false;
                };
                //window.showModalDialog('CustPortierato.aspx?IDCUST=' + document.getElementById('idSel').value, 'window', 'status:no;dialogWidth:800px;dialogHeight:500px;dialogHide:true;help:no;scroll:no');
                var oWnd = $find('RadWindow1');
                oWnd.setUrl('CustPortierato.aspx?IDCUST=' + document.getElementById('idSel').value);
                oWnd.show();
            } else {
                apriAlert(Messaggio.Elemento_No_Selezione, 300, 150, Messaggio.Titolo_Conferma, null, null);
                return false;
...
//        function ResizeGrid() {
//            var scrollArea = document.getElementById("<%= RadGridCustodi.ClientID %>" + "_GridData");
//            scrollArea.style.height = window.screen.height - 570 + 'px';
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="Button1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGridCustodi" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="btnDelCustode">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGridCustodi" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <table border="0" cellpadding="2" cellspacing="2" width="100%">
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Label ID="lblTitolo" runat="server" Text="Elenco Custodi" CssClass="testoGrassettoMaiuscoloBlu"
        ...
        <tr>
            <td width="90%">
                <asp:Panel runat="server" ID="PanelRadGrid">
                    <telerik:RadGrid ID="RadGridCustodi" runat="server" GroupPanelPosition="Top" ResolvedRenderMode="Classic" HeaderStyle-Width="15%"
                        AutoGenerateColumns="False" Culture="it-IT" RegisterWithScriptManager="False"
                        AllowFilteringByColumn="True" EnableLinqExpressions="False" Width="100%" AllowSorting="True" PageSize="50"
                        ...
                        <MasterTableView NoMasterRecordsText="Nessun elemento da visualizzare." ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="MATRICOLA" HeaderText="MATRICOLA" AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridBoundColumn DataField="EMAIL_AZIENDALE" HeaderText="E-MAIL" AutoPostBackOnFilter="true"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="true">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="CELLULARE_AZIENDALE" HeaderText="CELL. AZIENDALE"
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="true">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="TELEFONO_AZIENDALE" HeaderText="TEL. AZIENDALE"
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="true">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="NOTE" HeaderText="NOTE" AutoPostBackOnFilter="true"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="true">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="SEDE" HeaderText="SEDE TERRITORIALE" AutoPostBackOnFilter="true"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="true">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="VIA" HeaderText="INDIRIZZO" AutoPostBackOnFilter="true"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="true">
                                </telerik:GridBoundColumn>
            ...
            <td style="vertical-align: top" width="10%">
                <table>
                    <tr>
                        <td>
                            <telerik:RadButton ID="btnCreaCdp" runat="server" Text="Aggiungi" Width="104px" ClientIDMode="Static"
                                OnClientClicking="NewCustode" AutoPostBack="false" ToolTip="Aggiungi un custode">
                            </telerik:RadButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <telerik:RadButton ID="btnModPod" runat="server" Text="Modifica" Width="104px" ClientIDMode="Static"
                                ToolTip="Modifica il custode selezionato" OnClientClicking="ModCustode" AutoPostBack="false">
                            </telerik:RadButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <telerik:RadButton ID="RadButtonDisattiva" runat="server" Text="Disattiva" Width="104px"
                                ...
                                ToolTip="Disattiva il custode selezionato">
                            </telerik:RadButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <telerik:RadButton ID="btnDelCustode" runat="server" Text="Elimina" Width="104px"
                                OnClientClicking="function(sender, args){deleteElementTelerik(sender, args, 'idSel');}"
                                ToolTip="Elimina il custode selezionato">
                            </telerik:RadButton>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <telerik:RadButton ID="btnPortierato" runat="server" Text="Portierato" ToolTip="Gestione del portierato"
                                AutoPostBack="false" Width="104px" OnClientClicking="ModPortierato">
                            </telerik:RadButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="btnEstraiTuttiAttuali" runat="server" Text="Estrai attuali" ToolTip="Estrazione custodi con portierato attuale"
                                Width="100px" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="btnEstraiTutti" runat="server" Text="Estrai tutti" ToolTip="Estrazione custodi con tutto il portierato"
                                Width="100px" />
                        </td>
                    </tr>
                    <tr>
    ...
    <asp:HiddenField ID="idSelAggr" runat="server" Value="" />
