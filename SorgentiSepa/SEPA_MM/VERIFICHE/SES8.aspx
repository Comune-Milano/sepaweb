<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SES8.aspx.vb" Inherits="AMMSEPA_Controllo_Select" %>
...
<body>
    ...
    <asp:TextBox ID="TextBox2" runat="server" Height="217px" TextMode="MultiLine" Visible="False"
    ...
    &nbsp;<asp:Button ID="ButtonEstrai" runat="server" Text="Estrai CSV" Visible="false" />
    <br />
