...
Partial Class ARCHIVIO_DatiEdificio
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                btnModifica.Visible = False
            End If
            IndiceEdificio = Request.QueryString("id")
            CaricaDati()
        End If
    End Sub
    ...
    Private Sub CaricaDati()
        Try
            ...
            par.cmd.CommandText = "select indirizzi.descrizione,indirizzi.civico,indirizzi.cap,indirizzi.localita,edifici.cod_edificio,edifici.denominazione from siscom_mi.indirizzi, siscom_mi.edifici where indirizzi.id (+)=edifici.id_indirizzo_principale and edifici.id=" & IndiceEdificio
            Dim myReader As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
            If myReader.Read Then
                lblCodEdificio.Text = par.IfNull(myReader("cod_edificio"), "---")
            ...
            sStringaSQL1 = "select EDIFICI_ARCHIVIO.ID,TAB_GESTORI_ARCHIVIO.DESCRIZIONE AS GESTORE,EDIFICI_ARCHIVIO.COD_EUSTORGIO,EDIFICI_ARCHIVIO.FALDONE,EDIFICI_ARCHIVIO.SCATOLA,EDIFICI_ARCHIVIO.ID_EDIFICIO,TAB_CAT_EUSTORGIO.DESCRIZIONE AS CATEGORIA,EDIFICI_ARCHIVIO.NOTE from SISCOM_MI.TAB_GESTORI_ARCHIVIO, SISCOM_MI.TAB_CAT_EUSTORGIO,siscom_mi.EDIFICI,siscom_mi.EDIFICI_archivio where TAB_GESTORI_ARCHIVIO.COD (+)=EDIFICI_ARCHIVIO.GESTORE AND TAB_CAT_EUSTORGIO.COD(+)=EDIFICI_ARCHIVIO.CATEGORIA AND EDIFICI_ARCHIVIO.id_EDIFICIO (+)=EDIFICI.id and EDIFICI.id=" & IndiceEdificio & " order by cod_eustorgio asc"
            BindGrid()
    ...
    Protected Sub btnModifica_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnModifica.Click
        'If LBLID.Value <> "" Then
        '    Response.Write("<script>window.open('SchedaEustorgio.aspx?SC=" & LBLID.Value & "&ID=" & IndiceEdificio & "&COD=" & lblCodEdificio.Text & "', '" & LBLID.Value & "', 'height=350,width=600');</script>")
        'Else
    ...
    Protected Sub ImgElimina_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImgElimina.Click
        ...
        '       & "VALUES (" & IndiceEdificio & "," & Session.Item("ID_OPERATORE") & ",'" & Format(Now, "yyyyMMddHHmmss") & "'," _
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                With myExcelFile
                    ...
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 4, "COD.EUSTORGIO", 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 5, "GESTORE", 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 6, "CATEGORIA", 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 7, "SCATOLA", 12)
                    .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont1, CM.ExcelFile.CellAlignment.xlsCentreAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, 1, 8, "FALDONE", 12)



                    K = 2
                    For Each row In dt.Rows
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 1, par.PulisciStrSql(lblCodEdificio.Text))
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 2, par.PulisciStrSql(lblDenominazione.Text))

                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 3, par.PulisciStrSql(lblIndirizzo.Text))
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 4, par.PulisciStrSql(par.IfNull(dt.Rows(i).Item("COD_EUSTORGIO"), "")))
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 5, par.PulisciStrSql(par.IfNull(dt.Rows(i).Item("GESTORE"), "")))
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 6, par.PulisciStrSql(par.IfNull(dt.Rows(i).Item("CATEGORIA"), "")))
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 7, par.PulisciStrSql(par.IfNull(dt.Rows(i).Item("SCATOLA"), "")))
                        .WriteValue(CM.ExcelFile.ValueTypes.xlsText, CM.ExcelFile.CellFont.xlsFont0, CM.ExcelFile.CellAlignment.xlsLeftAlign, CM.ExcelFile.CellHiddenLocked.xlsNormal, K, 8, par.PulisciStrSql(par.IfNull(dt.Rows(i).Item("FALDONE"), "")))
