<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni.aspx.vb" Inherits="VSA_menu_funzioni" %>
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            <asp:Label ID="lblOperatore" runat="server" Font-Bold="True" Font-Size="X-Small"
                Height="16px" 
                Style="z-index: 100; left: 220px; position: absolute; top: 38px; width: 200px;">Label</asp:Label>
            <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="arial" Font-Size="8pt"
                ForeColor="#721C1F" Height="16px" Style="z-index: 100; left: 183px; position: absolute;
                top: 38px" Width="35px">Utente</asp:Label>
            ...
            <asp:Image ID="Image2" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                ...
                Visible="False" />
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_vsa.png" Style="left: 26px;
