<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Correlazioni3.aspx.vb" Inherits="VSA_Correlazioni3" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="DATA NASCITA">
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DATA_NASCITA") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="GR. PARENTELA">
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="Label6" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PARENTELA") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
