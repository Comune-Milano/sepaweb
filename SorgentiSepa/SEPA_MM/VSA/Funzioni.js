...
//}
	...
	function AggTabDom(tab, tabv, tabinv1, tabinv5, tabinv6, tabinv7, tabinv8, tabinv9, tabinv10) {
...
//    tabinv4.visibility='hidden';
    ...
    tabinv8.visibility = 'hidden';
    tabinv9.visibility = 'hidden';
    tabinv10.visibility = 'hidden';
    ...
    document.getElementById('i7').src = '../p_menu/D_Man.gif';
    document.getElementById('i1_1').src='../p_menu/ALL_0.gif';
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('i9').src = '../p_menu/D_DEC.gif';
    document.getElementById('Img1').src = '../p_menu/D10_osp.gif';
...
//    tabinv4.visibility='hidden';
    ...
    //document.getElementById('i5').src='../p_menu/ABIT2_0.gif'
    document.getElementById('i6').src='../p_menu/REC_0.gif'
    document.getElementById('i7').src = '../p_menu/D_Man1.gif'
    document.getElementById('i1_1').src='../p_menu/ALL_0.gif'
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('i9').src = '../p_menu/D_DEC.gif';
    document.getElementById('Img1').src = '../p_menu/D10_osp.gif';
...
//    tabinv4.visibility = 'hidden';
    ...
    document.getElementById('i1_1').src = '../p_menu/ALL_0.gif'
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('i9').src = '../p_menu/D_DEC1.gif';
    document.getElementById('Img1').src = '../p_menu/D9_0.gif';
    document.getElementById('Img1').src = '../p_menu/D10_osp.gif';
...
//    tabinv4.visibility = 'hidden';
    ...
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('i9').src = '../p_menu/D_DEC.gif';
    document.getElementById('Img1').src = '../p_menu/D10_osp2.gif';
