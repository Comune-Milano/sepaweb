...
Partial Class Contratti_Anagrafica_Ricerca
    ...
    Protected Sub btnCerca_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCerca.Click
        Response.Redirect("RisultatiRicercaComp.aspx?NOME=" & par.VaroleDaPassare(Me.txtNome.Text.ToUpper) & "&COGNOME=" & par.VaroleDaPassare(Me.txtCognome.Text.ToUpper) & "&CF=" & par.VaroleDaPassare(Me.txtCF.Text.ToUpper) & "&RAGSOCIALE=" & par.VaroleDaPassare(Me.txtRagione.Text.ToUpper) & "&PIVA=" & par.VaroleDaPassare(Me.txtPiva.Text.ToUpper))
