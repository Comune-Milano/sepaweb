<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiRicercaComp.aspx.vb" Inherits="Contratti_Anagrafica_RisultatiRicerca" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
	...
	<body bgColor="#ffffff">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:ImageButton ID="btnSeleziona" runat="server" ImageUrl="../../NuoveImm/Img_Seleziona.png"
                ...
                ToolTip="Visualizza" meta:resourcekey="btnVisualizzaResource1" 
                TabIndex="1" />
                ...
                <tr>
                    <td style="width: 800px">
                        ...
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>
                            ...
                            &nbsp;&nbsp;</strong></span><br />
                        &nbsp;&nbsp;<br />
                        <img onclick="document.location.href='RicercaComp.aspx';" alt="" src="../../NuoveImm/Img_NuovaRicerca.png" 
