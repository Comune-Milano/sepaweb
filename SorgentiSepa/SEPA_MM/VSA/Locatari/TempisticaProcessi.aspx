<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TempisticaProcessi.aspx.vb"
    Inherits="VSA_Locatari_TempisticaProcessi" %>
    ...
    <div id="InserimentoLegali" style="left: -105px; width: 722px; background-repeat: no-repeat;
        ...
        <table border="0" cellpadding="1" cellspacing="1" style="left: 117px; width: 435px;
            ...
            <tr style="font-size: 12pt; font-family: Times New Roman">
                ...
                <td style="width: 274px; height: 19px; text-align: left">
                    &nbsp&nbsp
                    <asp:TextBox ID="txtDurata" runat="server" Font-Names="Arial" Font-Size="10pt" Width="293px"
                        MaxLength="400" TabIndex="1" Height="53px" TextMode="MultiLine" Font-Bold="True"></asp:TextBox>
                            ...
                            <td style="text-align: right">
                                <asp:ImageButton ID="img_InserisciSchema" runat="server" ImageUrl="~/NuoveImm/Img_InserisciVal.png"
                                    TabIndex="2" />&nbsp;<asp:ImageButton ID="img_ChiudiSchema" runat="server" ImageUrl="~/NuoveImm/Img_AnnullaVal.png"
                                        OnClientClick="document.getElementById('InserimentoLegali').style.visibility='hidden';document.getElementById('TextBox1').value='0';document.getElementById('txtDurata').value='';" />
                            </td>
                        </tr>
                    </table>
                </td>
