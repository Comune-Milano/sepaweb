<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElencoDomande.aspx.vb" Inherits="VSA_Locatari_ElencoDomande" %>
...
<body bgcolor="#f2f5f1">
    ...
    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="PG_DICHIARAZIONE" HeaderText="NUM. DICHIARAZIONE">
                <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" Wrap="False" />
                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" Wrap="False"/>
