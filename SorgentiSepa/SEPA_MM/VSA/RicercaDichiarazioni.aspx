<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaDichiarazioni.aspx.vb" Inherits="VSA_RicercaDichiarazioni" %>
...
//document.onkeydown=$onkeydown;
		...
		<form id="Form1" method="post" runat="server" defaultbutton="btnCerca">
            ...
            <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                Style="z-index: 104; left: 537px; position: absolute; top: 311px" TabIndex="8" ToolTip="Home" />
            <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
                Style="z-index: 105; left: 404px; position: absolute; top: 311px" TabIndex="7" ToolTip="Avvia Ricerca" />
									...
									<asp:label id="Label7" runat="server" Font-Size="8pt" Font-Names="Arial" 
                                        Font-Bold="False" 
                                        style="z-index: 110; left: 93px; position: absolute; top: 235px">Tipo</asp:label>
									...
									<asp:DropDownList id="cmbTipo" tabIndex="6" runat="server" Height="20px" 
                                        Width="187px" 
                                        
                                        style="border: 1px solid black; z-index: 111; left: 170px; position: absolute; top: 232px">
                                        <asp:ListItem Value="0">TUTTI</asp:ListItem>
                                        <asp:ListItem Value="1">FORZE DELL&#39;ORDINE</asp:ListItem>
                                    </asp:DropDownList>
									<asp:DropDownList id="cmbStato" tabIndex="5" runat="server" Height="20px" 
                                        Width="187px" 
                                        style="border-right: black 1px solid; border-top: black 1px solid; z-index: 111; left: 170px; border-left: black 1px solid; border-bottom: black 1px solid; position: absolute; top: 203px"></asp:DropDownList>

                                            <asp:Label ID="Label3" runat="server" Font-Bold="False" 
                                        Font-Names="Arial" Font-Size="8pt"
        
        Style="z-index: 113; left: 86px; position: absolute; top: 263px; right: 1258px; width: 65px;">Componenti in Carrozzina</asp:Label>

          <asp:DropDownList ID="ddl_invalid" TabIndex="6" runat="server" 
        Height="20px" Width="80px"
        AutoPostBack="True" Style="border: 1px solid black; z-index: 116; left: 170px; position: absolute; top: 268px;
        ">
