...
Partial Class VSA_com_uscita
    ...
    Private Sub ScriviCompDaCancell()
        Try
            ...
            par.cmd.CommandText = "DELETE FROM COMP_REDDITO_VSA WHERE ID_COMPONENTE=" & txtRiga.Text
            par.cmd.ExecuteNonQuery()

            par.cmd.CommandText = "DELETE FROM DOMANDE_REDDITI_VSA WHERE ID_COMPONENTE=" & txtRiga.Text
            par.cmd.ExecuteNonQuery()
