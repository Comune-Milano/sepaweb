...
Partial Class ANAUT_com_documenti
    ...
    Protected Sub btnSalva_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSalva.Click
        ...
        '    Cache(Session.Item("GLista")) = par.MiaFormat(cmbTipo.SelectedItem.Text & note, 2000)
        'Else
        '    Cache(Session.Item("GLista")) = par.MiaFormat(cmbTipo.SelectedItem.Text & " del Sig./Sig.ra " & cmbComponente.SelectedItem.Text & note, 2000)
        'End If
        ...
        Try
            ...
            par.cmd.CommandText = "SELECT * FROM VSA_DOC_MANCANTI WHERE ID_DICHIARAZIONE=" & Request.QueryString("IDDICH") & " AND ID_DOC= " & cmbTipo.SelectedValue
            ...
            If esistente = False Then
                par.cmd.CommandText = "INSERT INTO VSA_DOC_MANCANTI (ID_DICHIARAZIONE, ID_DOC, DESCRIZIONE) VALUES (" & Request.QueryString("IDDICH") & "," & cmbTipo.SelectedValue & ",'" & Replace(par.PulisciStrSql(cmbTipo.SelectedItem.Text & " del Sig./Sig.ra " & cmbComponente.SelectedItem.Text & " " & txtDescr.Text), vbCrLf, " ") & "')"
