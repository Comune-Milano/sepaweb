    ...
    Private Sub ScriviPatrMobiliare()
        Try
            ...
            If txtOperazione.Text = "0" Then
                par.cmd.CommandText = "INSERT INTO COMP_PATR_MOB_VSA (ID, ID_COMPONENTE, COD_INTERMEDIARIO, INTERMEDIARIO, IMPORTO, ID_TIPO,PERC_PROPRIETA) VALUES (SEQ_COMP_PATR_MOB_VSA.NEXTVAL," & cmbComponente.SelectedValue & ",'" & txtABI.Text & "','" & par.PulisciStrSql(txtInter.Text) & "'," & par.VirgoleInPunti(txtImporto.Text) & "," & tipoPatrMob & "," & txtPerc.Text & ")"
            ...
            Else
                ...
                If myReaderI.Read Then
                    par.cmd.CommandText = "UPDATE COMP_PATR_MOB_VSA SET PERC_PROPRIETA=" & txtPerc.Text & ",ID_COMPONENTE=" & cmbComponente.SelectedValue & ",ID_TIPO=" & tipoPatrMob & ",IMPORTO=" & par.VirgoleInPunti(txtImporto.Text) & ",COD_INTERMEDIARIO='" & txtABI.Text & "',INTERMEDIARIO='" & par.PulisciStrSql(txtInter.Text) & "' WHERE ID=" & txtRiga.Text
                    par.cmd.ExecuteNonQuery()
                End If
                myReaderI.Close()
            End If
