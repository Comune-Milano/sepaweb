...
<body bgcolor="lightsteelblue">
    ...
    <form id="form1" runat="server">
        <div>
            <input id="Button2" language="javascript" onclick="ConfermaEsci();" style="z-index: 121; left: 355px; position: absolute; top: 260px"
                type="button" value="Chiudi" />
            <asp:Label ID="Label1" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 100; left: 12px; position: absolute; top: 60px"
                Width="50px">Componente</asp:Label>
            <asp:DropDownList ID="cmbComponente" runat="server" CssClass="CssMaiuscolo" Style="z-index: 101; left: 88px; position: absolute; top: 59px"
                TabIndex="1" Width="316px">
            </asp:DropDownList>
        ...
        <asp:Label ID="Label3" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
            Font-Size="8pt" Height="18px" Style="z-index: 104; left: 13px; position: absolute; top: 91px"
            Width="69px">Codice</asp:Label>
        ...
        <asp:Label ID="L1" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
            ...
            <asp:Label ID="Label4" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 109; left: 13px; position: absolute; top: 125px"
                Width="71px">Intermediario</asp:Label>
        ...
        <asp:Label ID="Label5" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
            Font-Size="8pt" Height="18px" Style="z-index: 114; left: 155px; position: absolute; top: 188px"
            Width="24px">,00</asp:Label>
            <asp:TextBox ID="txtImporto" runat="server" Columns="8" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="8" Style="z-index: 115; left: 88px; position: absolute; top: 183px"
                TabIndex="7"></asp:TextBox>
            <asp:Label ID="Label8" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 116; left: 13px; position: absolute; top: 184px"
                Width="71px">Importo</asp:Label>
            <asp:Label ID="Label2" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 103; left: 13px; position: absolute; top: 156px"
                Width="83px">Tipo Patrim.</asp:Label>
            <asp:DropDownList ID="cmbTipoPatrim" runat="server" CssClass="CssMaiuscolo" Style="z-index: 104; left: 88px; position: absolute; top: 152px"
            ...
            <asp:Label ID="Label6" runat="server" CssClass="CssLabel" Font-Bold="True"
                Font-Size="8pt" Height="18px" Style="z-index: 108; left: 13px; position: absolute; top: 217px; width: 95px;">Num. Intest.</asp:Label>
            <asp:TextBox ID="txtPerc" runat="server" Columns="4" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Size="8pt" ForeColor="Blue" MaxLength="1" Style="z-index: 109; left: 88px; position: absolute; top: 213px; width: 31px;"
                TabIndex="3">1</asp:TextBox>
            <asp:Label ID="L4" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ...
                Text="(valorizzare)" Visible="False"></asp:Label>
            <asp:Button ID="btnSalva" runat="server" Style="z-index: 118; left: 208px; position: absolute; top: 260px"
                TabIndex="8" Text="SALVA e Chiudi" />
            ...
            <asp:TextBox ID="txtRiga" runat="server" Columns="5" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="6" Style="left: 689px; position: absolute; top: 260px"
                TabIndex="3" Width="5px" Height="13px"></asp:TextBox>
