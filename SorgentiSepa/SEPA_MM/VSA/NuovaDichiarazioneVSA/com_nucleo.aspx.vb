        ...
        If Not IsPostBack = True Then
            ...
            If txtOperazione.Text = "1" Then
                ...
                If Request.QueryString("NATURA_INVAL") <> "" Then
                    If Request.QueryString("NATURA_INVAL") = "NULL" Then
                        cmbNaturaInval.Items.FindByText("---").Selected = True
                    Else
    ...
    Private Sub ScriviComponente()
        Try
            ...
            If IsNothing(Request.QueryString("IDDICH")) = False Then
                par.cmd.CommandText = "SELECT DATA_FINE_VAL FROM DICHIARAZIONI_VSA WHERE ID=" & Request.QueryString("IDDICH")
            Else
                par.cmd.CommandText = "SELECT DATA_FINE_VAL FROM DICHIARAZIONI_VSA,COMP_NUCLEO_VSA WHERE DICHIARAZIONI_VSA.ID=COMP_NUCLEO_VSA.ID_DICHIARAZIONE AND COMP_NUCLEO_VSA.ID=" & txtRiga.Text
            End If
            ...
            If txtOperazione.Text = "0" Then
                ...
                If compOld = False Then
                    par.cmd.CommandText = "INSERT INTO COMP_NUCLEO_VSA (ID,ID_DICHIARAZIONE,PROGR,COGNOME,NOME,GRADO_PARENTELA,COD_FISCALE,PERC_INVAL,DATA_NASCITA,USL,INDENNITA_ACC,SESSO, TIPO_INVAL, NATURA_INVAL" _
                                & ") VALUES (SEQ_COMP_NUCLEO_VSA.NEXTVAL," & Request.QueryString("IDDICH") & "," & incrementaProgr & ",'" & par.PulisciStrSql(par.IfEmpty(txtCognome.Text, "")) & "','" & par.PulisciStrSql(par.IfEmpty(txtNome.Text, "")) _
