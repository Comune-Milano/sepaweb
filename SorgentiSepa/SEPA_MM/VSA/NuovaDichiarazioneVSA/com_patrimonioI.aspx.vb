...
Partial Class ANAUT_com_patrimonioI
    ...
    Protected Sub btnSalva_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSalva.Click
        ...
        If Mid(cmbTipoImm.SelectedItem.Text, 1, 1) <> "A" And txtNumVani.Text <> "0" Then
            L5.Visible = True
        ...
        If txtSupUtile.Text = "0" Then
            lblMQ.Visible = True
        End If

        If L1.Visible = True Or L2.Visible = True Or L3.Visible = True Or L5.Visible = True Or lblMQ.Visible = True Then
            Exit Sub
        End If
        ...
        Try
            ...
            If txtOperazione.Text = "0" Then
                par.cmd.CommandText = "INSERT INTO COMP_PATR_IMMOB_VSA (ID, ID_COMPONENTE, ID_TIPO, PERC_PATR_IMMOBILIARE, VALORE, MUTUO, F_RESIDENZA, CAT_CATASTALE, COMUNE, N_VANI, SUP_UTILE, FL_70KM, REND_CATAST_DOMINICALE, ID_TIPO_PROPRIETA,VALORE_MERCATO) " _
                    & " VALUES (SEQ_COMP_PATR_IMMOB_VSA.NEXTVAL," & cmbComponente.SelectedValue & "," & cmbTipo.SelectedValue & "," & par.VirgoleInPunti(txtPerc.Text) & "," & txtValore.Text & "," & TxtMutuo.Text & ",'0','" & cmbTipoImm.SelectedItem.Text & "','" & par.PulisciStrSql(cmbComune.SelectedItem.Text) & "','" & txtNumVani.Text & "','" & txtSupUtile.Text & "','" & FL_70KM & "'," & txtRendita.Text & "," & tipoPropr & "," & par.IfEmpty(txtValoreMercato.Text, "NULL") & ")"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                txtValoreMercato.Text = par.Elimina160(Request.QueryString("VALM"))
                ...
                txtValoreMercato.Attributes.Add("onkeyup", "javascript:valid(this,'notnumbers');")
