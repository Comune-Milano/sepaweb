    ...
    <div id="Div1" style="border: 2px solid lightsteelblue; z-index: 191; background-attachment: fixed;
        ...
        <p>
            ...
            <input id="Button2" style="z-index: 129; left: 363px; position: absolute; top: 509px"
                type="button" value="Chiudi" language="javascript" onclick="ConfermaEsci();" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <asp:DropDownList ID="cmbTipoVia" runat="server" CssClass="CssMaiuscolo" Style="z-index: 120;
                left: 101px; position: absolute; top: 306px" TabIndex="12" Width="90px" Visible="False">
            </asp:DropDownList>
            ...
            <asp:TextBox ID="txtDocIdent" runat="server" Columns="22" CssClass="CssMaiuscolo"
                ...
                width: 88px;" TabIndex="17" ToolTip="Inserire numero carta d'identità" Visible="False"></asp:TextBox>
            ...
            <asp:DropDownList ID="cmbParenti" runat="server" CssClass="CssMaiuscolo" Style="z-index: 114;
                left: 103px; position: absolute; top: 146px" TabIndex="5" Width="324px">
            </asp:DropDownList>
            ...
            <asp:Label ID="Label11" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 119; left: 212px; position: absolute;
                top: 176px; right: 168px;" Width="71px">Tipo Inval.</asp:Label>
            <asp:DropDownList ID="cmbTipoInval" runat="server" CssClass="CssMaiuscolo" Style="z-index: 120;
                left: 267px; position: absolute; top: 172px" TabIndex="8" Width="160px">
            ...
            <asp:Label ID="LTipoInval" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 123; left: 435px; position: absolute; top: 174px"
                Text="!!!" Visible="False"></asp:Label>
            <asp:Label ID="LNaturaInval" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 123; left: 435px; position: absolute; top: 202px"
                Text="!!!" Visible="False"></asp:Label>
            <asp:Label ID="Label12" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 119; left: 208px; position: absolute;
                top: 202px; right: 172px;" Width="71px">Natura Inval.</asp:Label>
            <asp:DropDownList ID="cmbNaturaInval" runat="server" CssClass="CssMaiuscolo" Style="z-index: 120;
                left: 278px; position: absolute; top: 197px" TabIndex="8" Width="150px">
                <asp:ListItem Value="-1">---</asp:ListItem>
                ...
                <asp:ListItem Value="SM" Text="Sordomutismo"></asp:ListItem>
                <asp:ListItem Value="CC" Text="Cecita"></asp:ListItem>
                <asp:ListItem Value="8" Text="Handicap grave ex art3 .L.104/1992"></asp:ListItem>
            </asp:DropDownList>
            ...
            <asp:Label ID="L5" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 123; left: 136px; position: absolute; top: 176px;
                height: 16px; width: 76px;" Text="(valorizzare)" Visible="False"></asp:Label>
            <asp:Label ID="L6" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 124; left: 136px; position: absolute; top: 201px;
                width: 80px;" Text="(valorizzare)" Visible="False"></asp:Label>
