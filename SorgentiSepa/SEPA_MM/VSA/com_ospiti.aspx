...
<body bgcolor="lightsteelblue">
    ...
    <div id="Div1" style="border: 2px solid lightsteelblue; z-index: 191; background-attachment: fixed;
        left: 2px; width: 437px; position: absolute; top: 2px; height: 460px; background-color: lightsteelblue">
        ...
        <p>
            ...
            <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="arial" Font-Size="12pt"
                ...
                Text="Ospiti" Width="209px"></asp:Label>
        ...
        <p>
            ...
            <input id="btnChiudi" style="z-index: 129; left: 335px; position: absolute; top: 411px"
                type="button" value="Chiudi" language="javascript" onclick="return Button2_onclick()" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:Button ID="btnSalva" runat="server" Style="z-index: 110; left: 188px; position: absolute;
                top: 411px" TabIndex="9" Text="SALVA e Chiudi" />
            ...
            <asp:Label ID="lblIndirizzo" runat="server" CssClass="CssLabel" Font-Bold="True"
                ...
                left: 23px; position: absolute; top: 149px" Width="71px">Indirizzo</asp:Label>
            <asp:Label ID="lblCivico" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 111; left: 23px; position: absolute;
                top: 176px; bottom: 376px;" Width="71px">Civico</asp:Label>
            <asp:Label ID="lblComune" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 111; left: 23px; position: absolute;
                top: 202px" Width="71px">Comune</asp:Label>
            ...
            <asp:TextBox ID="txtVia" runat="server" Columns="22" CssClass="CssMaiuscolo" Font-Bold="False"
                ...
                Style="z-index: 113; left: 204px; position: absolute; top: 147px; width: 214px;"
                TabIndex="6" ToolTip="Inserire l'indirizzo di residenza"></asp:TextBox>
            <asp:DropDownList ID="cmbTipoVia" runat="server" CssClass="CssMaiuscolo" Style="z-index: 120;
                left: 102px; position: absolute; top: 146px" TabIndex="5" Width="90px">
            </asp:DropDownList>
            <asp:TextBox ID="txtCivico" runat="server" Columns="22" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="16"
                Style="z-index: 113; left: 101px; position: absolute; top: 175px; width: 88px;
                bottom: 379px;" TabIndex="7"></asp:TextBox>
            <asp:TextBox ID="txtComune" runat="server" Columns="22" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="16"
                Style="z-index: 113; left: 100px; position: absolute; top: 199px; width: 88px;"
                TabIndex="8"></asp:TextBox>
            <asp:TextBox ID="txtCap" runat="server" Columns="22" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="16"
                Style="z-index: 113; left: 100px; position: absolute; top: 223px; width: 88px;
                right: 353px;" TabIndex="9"></asp:TextBox>
            <asp:TextBox ID="txtDocIdent" runat="server" Columns="22" CssClass="CssMaiuscolo"
                ...
                MaxLength="16" Style="z-index: 113; left: 100px; position: absolute; top: 246px;
                width: 88px;" TabIndex="10" ToolTip="Inserire numero carta d'identità"></asp:TextBox>
            <asp:TextBox ID="txtRilasciata" runat="server" Columns="22" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="16" Style="z-index: 113; left: 100px; position: absolute; top: 270px;
                width: 88px;" TabIndex="12"></asp:TextBox>
            <asp:TextBox ID="txtPermSogg" runat="server" Columns="22" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="16" Style="z-index: 113; left: 100px; position: absolute; top: 296px;
                width: 88px;" TabIndex="13"></asp:TextBox>
            <asp:TextBox ID="txtDataDocI" runat="server" Columns="10" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="10" Style="z-index: 105; left: 238px; position: absolute; top: 245px;
                width: 70px;" TabIndex="11" 
                ToolTip="Inserire la data di rilascio del doc. d'identità"></asp:TextBox>
            <asp:TextBox ID="txtDataPermSogg" runat="server" Columns="10" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="10" Style="z-index: 105; left: 238px; position: absolute; top: 295px;
                width: 70px;" TabIndex="14" 
                ToolTip="Inserire la data del permesso di soggiorno"></asp:TextBox>
            ...
            <asp:Label ID="lblDataIngr" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" Height="18px" Style="z-index: 119; left: 20px; position: absolute;
                top: 323px">Data inizio</asp:Label>
            <asp:TextBox ID="txtDataIngr" runat="server" Columns="22" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="10" Style="z-index: 113; left: 100px; position: absolute; top: 322px;
                width: 70px;" TabIndex="15"></asp:TextBox>
            <asp:Label ID="Label5" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
                ...
                top: 349px">Data fine</asp:Label>
            <asp:TextBox ID="txtDataFine" runat="server" Columns="22" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="10" Style="z-index: 113; left: 100px; position: absolute; top: 347px;
            ...
            <asp:Label ID="lblInizio" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 121; left: 197px; position: absolute; top: 324px"
                Text="(valorizzare)" Visible="False" Width="229px"></asp:Label>
            <asp:Label ID="lblFine" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 121; left: 196px; position: absolute; top: 350px"
                Text="(valorizzare)" Visible="False" Width="229px"></asp:Label>
            <asp:Label ID="LBLdataDoc" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 121; left: 329px; position: absolute; top: 246px"
            ...
            <asp:Label ID="LBLdataPerm" runat="server" Font-Bold="True" Font-Names="ARIAL" Font-Size="8pt"
                ForeColor="Red" Style="z-index: 121; left: 329px; position: absolute; top: 295px"
                Text="(valorizzare)" Visible="False"></asp:Label>
            ...
            <asp:TextBox ID="txtOperazione" runat="server" Columns="5" CssClass="CssMaiuscolo"
                Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue"
                MaxLength="6" Style="left: 257px; position: absolute; top: 420px" TabIndex="3"
                Width="17px" Height="12px"></asp:TextBox>
            <asp:TextBox ID="txtRiga" runat="server" Columns="5" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="6" Style="left: 274px;
                position: absolute; top: 416px; right: 157px;" TabIndex="3" Width="11px" Height="12px"></asp:TextBox>
            <asp:TextBox ID="txtProgr" runat="server" Columns="5" CssClass="CssMaiuscolo" Font-Bold="False"
                Font-Names="Times New Roman" Font-Size="8pt" ForeColor="Blue" MaxLength="6" Style="left: 200px;
                position: absolute; top: 419px" TabIndex="3" Width="11px" Height="11px"></asp:TextBox>
            <asp:CheckBox ID="chkReferente" runat="server" Style="z-index: 113; left: 100px;
                position: absolute; top: 16px;" Font-Bold="True" Font-Names="Times New Roman"
                Font-Size="8pt" TabIndex="20" Text="Referente" />
        </p>
    </div>
    </form>
</body>
