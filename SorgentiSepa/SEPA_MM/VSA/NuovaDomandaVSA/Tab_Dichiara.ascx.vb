...
Partial Class VSA_NuovaDomandaVSA_Tab_Dichiara
        ...
        Try
            ...
            Select Case item.Value
                Case "1" 'subentro
                    ...
                    imgCercaContratto.Visible = False
                ...
                Case "4" '"CAMBIO ART.22 C.10 RR 1/2004"
                    ...
                    CEM.NavigateUrl = "../MotivazioniEmergenzaNEW.aspx?ID=" & DOMANDA.Value & "&DI=" & DICHIARAZIONE.Value & "&IDE=" & cu.Value & "&CONN=" & CType(Me.Page, Object).lIdConnessDOMANDA
                    CEM.Target = "_blank"
                    lblCodContrattoScambio.Visible = False
                    txtCodContrattoScambio.Visible = False
                    txtCodContrattoScambio.Text = ""
