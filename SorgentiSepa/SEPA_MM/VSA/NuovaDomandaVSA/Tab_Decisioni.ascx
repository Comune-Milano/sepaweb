<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_Decisioni.ascx.vb"
    Inherits="VSA_NuovaDomandaVSA_Tab_Decisioni" %>
...
<div id="decisioni" style="border-right: lightsteelblue 1px solid; border-top: lightsteelblue 1px solid;
    ...
    <div id="divSospesa" style="background-color: #ffffff;">
        <table width="100%">
            <tr>
                <td align="center" style="width: 100%">
                    <asp:Label ID="lblMsgSosp" runat="server" Text="Impossibile applicare delle decisioni per questa domanda!<br/><br/>Il procedimento risulta SOSPESO per documentazione incompleta."
                        ...
                        Style="left: 105px; top: 143px;"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
    <table id="resto" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td>
                            <asp:CheckBox ID="ChkDecidi" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                Font-Underline="True" Text="SOTTOPONI A DECISIONE" Width="185px" />
                        </td>
                        <td class="style4">
                            DATA
                        </td>
                        <td>
                            <asp:TextBox ID="txtDataDecisione" runat="server" Font-Names="Arial" Font-Size="9pt"
                                ReadOnly="True" Width="80px" Enabled="False"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RadioButtonList ID="rdbListDecis0" runat="server" Font-Names="Arial" Font-Size="9pt"
                        ...
                        <td>
                            <div style="overflow: auto;" id="divNoteDecis0">
                                <asp:TextBox ID="txtNoteDec0" runat="server" TextMode="MultiLine" Font-Names="arial"
                                    Font-Size="9pt" Width="150px"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <table style="border: thin solid #0066CC; width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left; vertical-align: top">
                                <asp:TextBox ID="txtDataScelta" runat="server" Font-Names="Arial" Font-Size="9pt"
                                    ...
                                    <ContentTemplate>
                                        <div style="overflow: auto; width: 230px; height: 90px;" id="divCondNonAccolta">
                                            <asp:CheckBoxList ID="ChkMotivi" runat="server" Enabled="False" Font-Names="Arial"
                                                Font-Size="9pt" RepeatLayout="Flow" CellPadding="2" CellSpacing="2" Font-Overline="False"
                                                AutoPostBack="True">
                                            </asp:CheckBoxList>
                                        </div>
                                    </ContentTemplate>
                        ...
                        <tr>
                            <td style="text-align: left; vertical-align: top">
                                <asp:RadioButtonList ID="rdbListDecisione" runat="server" Font-Names="Arial" Font-Size="9pt"
                            ...
                            <td style="text-align: left; vertical-align: top">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtNoteDecisione" runat="server" Width="100%" Height="46px" TextMode="MultiLine"
                                            ReadOnly="True" Font-Names="arial" Font-Size="9pt"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td>
                            <asp:CheckBox ID="chkRiesame" runat="server" Font-Bold="True" Font-Names="Arial"
                                Font-Size="9pt" Font-Underline="True" Text="SOTTOPONI A RIESAME" Enabled="False"
                                Width="185px" />
                        </td>
                        <td class="style4">
                            DATA
                        ...
                        <td>
                            <asp:TextBox ID="txtDataRiesame" runat="server" Font-Names="Arial" Font-Size="9pt"
                                Width="80px" Enabled="False" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RadioButtonList ID="rdbListRies0" runat="server" Font-Names="Arial" Font-Size="9pt"
        ...
        <tr>
            <td class="style3">
                <div id="riesame" style="width: 100%">
                    <table style="border: thin solid #0066CC; width: 100%">
                        <tr>
                            <td class="style4">
                                DATA
                            ...
                            <td style="text-align: left; vertical-align: top">
                                <asp:TextBox ID="txtDatasceltaR" runat="server" Font-Names="Arial" Font-Size="9pt"
                                    Width="80px" Enabled="False" ReadOnly="True"></asp:TextBox>&nbsp&nbsp&nbsp
                                <asp:CheckBox ID="chkOsserv" runat="server" Font-Names="Arial" Font-Size="9pt" Text="Con Osservazioni"
                        ...
                        <tr>
                            <td style="text-align: left; vertical-align: top" class="style5">
                                <asp:RadioButtonList ID="rdbListRiesame" runat="server" Font-Names="Arial" Font-Size="9pt"
                                    Height="54px" Enabled="False" Width="100px">
                            ...
                            <td style="text-align: left; vertical-align: top" class="style5">
                                <div style="padding-left: 105px;" id="divOsservazioni">
                                    <asp:TextBox ID="txtDataOsserv" runat="server" Font-Names="Arial" Font-Size="9pt"
                                        Width="68px" Enabled="False" ToolTip="Inserire la data di present. delle osservazioni"></asp:TextBox>
                                    <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Size="9pt" Text="Data Osserv."></asp:Label>
                                </div>
                                <span class="style2">Note</span>
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtNoteRiesame" runat="server" Width="100%" Height="46px" TextMode="MultiLine"
                                            ReadOnly="True" Font-Names="arial" Font-Size="9pt"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                ...
                <div id="autorizzazione">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="text-align: left; vertical-align: top">
                                <asp:TextBox ID="txtdataAUTORIZ" runat="server" Font-Names="Arial" Font-Size="9pt"
