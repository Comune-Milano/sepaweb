<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Correlazioni2.aspx.vb" Inherits="CAMBI_Correlazioni2" %>
        ...
        <table id="Table1" align="center" border="1" cellpadding="1" cellspacing="1" style="z-index: 100;
            ...
            <tr>
                <td align="middle" bgcolor="aliceblue" style="text-align: center" valign="center">
                    <asp:Button ID="btnStampa" runat="server" Height="32px" Text="Stampa" Width="70px" />&nbsp; <asp:Button ID="Button1" runat="server" Height="32px" Text="Import Nucleo" Width="98px" OnClientClick="javascript:opener.parent.main.document.getElementById('txtModificato').value=1;opener.parent.main.document.getElementById('H1').value=0;"/>
