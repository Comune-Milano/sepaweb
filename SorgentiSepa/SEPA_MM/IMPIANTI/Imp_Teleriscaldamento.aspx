<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_Teleriscaldamento.aspx.vb" Inherits="IMPIANTI_Imp_Teleriscaldamento" %>

<%@ Register Src="Tab_Termico_GeneraleT.ascx"       TagName="TabGeneraleT"      TagPrefix="uc1" %>
<%@ Register Src="Tab_Termico_DettagliTELE.ascx"    TagName="TabDettagliTELE"   TagPrefix="uc2" %>
...
<title>IMPIANTO DI TELERISCALDAMENTO</title>
...
function ConfermaAnnulloScambiatore() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo componente?');
    if (sicuro == true) {
    document.getElementById('TabDettagliTELE_txtannullo').value='1';
    }
    else
    {
    document.getElementById('TabDettagliTELE_txtannullo').value='0'; 
    }
}
...
<body bgcolor="#f2f5f1" text="#ede0c0" style="text-align: left">
<script type="text/javascript">
	    if (navigator.appName == 'Microsoft Internet Explorer') 
	    {
    ...
    <div>
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportTeleriscaldamento.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                    ...
                    <table style="width: 760px">
                     ...
                     <div class="tabber" id="tab1">
                        <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                            <h2>Dettagli</h2>
                            <uc1:TabGeneraleT ID="TabGeneraleT" runat="server"  Visible=" true" />         
                        </div>
                        <div <%=Visibile %> class="tabbertab <%=Tabber2%>" style="BACKGROUND-COLOR: white;width:775px"> 
                            <h2>Scambiatori</h2>
                            <uc2:TabDettagliTELE ID="TabDettagliTELE" runat="server"  Visible="true"  />  &nbsp;
                        </div>     
        ...
        <asp:TextBox ID="USCITA"        runat="server" Style="left: 0px; position: absolute; top: 415px; z-index: -1;" TabIndex="-1">0</asp:TextBox>
        <asp:TextBox ID="txtModificato" runat="server" BackColor="White" BorderStyle="None" ForeColor="White" Style="left: 0px; position: absolute; top: 328px; z-index: -1;">0</asp:TextBox>
        ...
        <asp:TextBox ID="txtIdImpianto" runat="server" Style="left: 0px; position: absolute; top: 50px; z-index: -1; color: white;" TabIndex="-1" Visible="False" Width="5px"></asp:TextBox>
        <asp:TextBox ID="txttab"        runat="server" ForeColor="White" Style="left: 0px; position: absolute; top: 296px; z-index: -1;" TabIndex="-1">1</asp:TextBox>
        <asp:TextBox ID="txtindietro"   runat="server" BackColor="#F2F5F1" BorderColor="White" BorderStyle="None" MaxLength="100" Style="z-index: -1; left: 8px; position: absolute; top: 320px" TabIndex="-1" Width="48px">0</asp:TextBox>
