'*** TAB ANTINCENDIO (VERIFICHE)
Imports System.Collections

Partial Class Tab_Antincendio_Verifiche
    ...
    Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Antincendio_Verifiche_txtSel1').value='Hai selezionato: " & Replace(e.Item.Cells(1).Text, "'", "\'") & e.Item.Cells(2).Text & "';document.getElementById('Tab_Antincendio_Verifiche_txtIdComponente').value='" & e.Item.Cells(0).Text & "'")
    ...
    Protected Sub DataGrid2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid2.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onmouseover", "this.style.backgroundColor='yellow'")
            e.Item.Attributes.Add("onmouseout", "this.style.backgroundColor='white'")
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Antincendio_Verifiche_txtSel2').value='Hai selezionato: " & Replace(e.Item.Cells(1).Text, "'", "\'") & e.Item.Cells(2).Text & "';document.getElementById('Tab_Antincendio_Verifiche_txtIdComponente2').value='" & e.Item.Cells(0).Text & "'")
        ...
        Try
            ...
            If vIdImpianto > -1 Then
                ...
                If Strings.Len(Strings.Trim(txtIdComponente.Text)) > 0 Then
                    PAR.cmd.CommandText = "select max(ID) from SISCOM_MI.IMPIANTI_VERIFICHE where SISCOM_MI.IMPIANTI_VERIFICHE.ID_IMPIANTO = " & vIdImpianto & " and SISCOM_MI.IMPIANTI_VERIFICHE.TIPO='PR' and SISCOM_MI.IMPIANTI_VERIFICHE.ID<>" & txtIdComponente.Text
                Else
                    PAR.cmd.CommandText = "select max(ID) from SISCOM_MI.IMPIANTI_VERIFICHE where SISCOM_MI.IMPIANTI_VERIFICHE.ID_IMPIANTO = " & vIdImpianto & " and SISCOM_MI.IMPIANTI_VERIFICHE.TIPO='PR' "
                End If
    ...
    Private Sub Salva()
        ...
        Try
            If vIdImpianto = -1 Then
                ...
                gen = New Epifani.VerificheImpianti(lstVerifiche.Count, PAR.PulisciStrSql(PAR.PulisciStringaInvio(Me.txtDitta.Text, 100)), Me.txtData.Text, PAR.PulisciStrSql(Me.txtNote.Text), Me.cmbEsito.SelectedItem.Text, PAR.IfEmpty(Me.txtValidita.Text, 0), txtDataScadenza.Text, cmbEsito.SelectedItem.Value, Me.cmbPreAllarme.SelectedItem.Text, "PR", "")
            ...
            Else
                ...
                PAR.cmd.CommandText = "update SISCOM_MI.IMPIANTI_VERIFICHE set FL_STORICO='S' " _
                                   & " where TIPO='PR' and ID_IMPIANTO=" & vIdImpianto
    ...
    Private Sub Update()
        ...
        Try
            If vIdImpianto = -1 Then
                ...
                lstVerifiche(txtIdComponente.Text).DITTA = PAR.PulisciStrSql(PAR.PulisciStringaInvio(Me.txtDitta.Text, 100))
                lstVerifiche(txtIdComponente.Text).NOTE = PAR.PulisciStrSql(Me.txtNote.Text)
                lstVerifiche(txtIdComponente.Text).ESITO = Me.cmbEsito.SelectedItem.Value
                lstVerifiche(txtIdComponente.Text).ESITO_DETTAGLIO = Me.cmbEsito.SelectedItem.ToString
                ...
                lstVerifiche(txtIdComponente.Text).TIPO = "PR"
            ...
            Else
                ...
                '*** EVENTI_IMPIANTI
                PAR.InserisciEvento(PAR.cmd, vIdImpianto, Session.Item("ID_OPERATORE"), Epifani.TabEventi.MODIFICA_VERIFICA_IMPIANTO, "Verifica Dichiarazione Pressione Residua")
        ...
        Try
            ...
            Else
                If vIdImpianto = -1 Then
                    ...
                    Me.txtID.Text = lstVerifiche(txtIdComponente.Text).ID
                    ...
                    Me.cmbEsito.SelectedValue = PAR.IfNull(lstVerifiche(txtIdComponente.Text).ESITO, 0)
                    ...
                    Me.txtValidita.Text = PAR.IfNull(lstVerifiche(txtIdComponente.Text).MESI_VALIDITA, 12)
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            ...
                            '*** EVENTI_IMPIANTI
                            PAR.InserisciEvento(PAR.cmd, vIdImpianto, Session.Item("ID_OPERATORE"), Epifani.TabEventi.CANCELLAZIONE_VERIFICA_IMPIANTO, "Verifica Dichiarazione Pressione Residua")
