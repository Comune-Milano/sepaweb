<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_Antincendio_Verifiche.ascx.vb" Inherits="Tab_Antincendio_Verifiche" %>
<table id="TABBLE_LISTA">
    <tr>
        <td style="height: 21px">
            <asp:Label ID="lblTitoloGrid1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="#8080FF" Style="height: 15px" TabIndex="-1" Text="DICHIARAZIONE PRESSIONE RESIDUA"
            ...
            <tr>
                <td style="width: 88px; height: 14px">
                    <asp:ImageButton ID="btnAgg" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/btn_Aggiungi.jpg"
                            OnClientClick="document.getElementById('Tab_Antincendio_Verifiche_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_VERIFICHE').style.visibility='visible';"
                            TabIndex="87" ToolTip="Aggiunge un Nuova Verifica" /></td>
            </tr>
            <tr>
                <td style="width: 88px; height: 12px">
                    <asp:ImageButton ID="btnApri" runat="server" CausesValidation="False" Height="12px"
                            ImageUrl="~/NuoveImm/Img_Modifica.png" OnClientClick="document.getElementById('Tab_Antincendio_Verifiche_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_VERIFICHE').style.visibility='visible';"
                            TabIndex="34" ToolTip="Modifica la Verifica Selezionata" Width="60px" /></td>
            </tr>
        </table>
            <br />
        </td>
    ...
    <tr>
        <td>
            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="#8080FF" Style="height: 15px" TabIndex="-1" Text="ARCHIVIO STORICO DICHIARAZIONE PRESSIONE RESIDUA"
                Width="368px"></asp:Label></td>
        <td>
        </td>
        <td>
                ...
                <tr>
                    <td style="width: 88px; height: 14px">
                        <asp:ImageButton ID="btnVisualizza" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/Img_VisualizzaPiccolo.png"
                            OnClientClick="document.getElementById('Tab_Antincendio_Verifiche_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_VERIFICHE').style.visibility='visible';"
                            TabIndex="89" ToolTip="Visulizza la Verifica Selezionata" /></td>
                </tr>
            <tr>
                <td style="width: 88px">
                    <asp:ImageButton ID="btnElimina" runat="server" Height="12px" ImageUrl="~/NuoveImm/btn_Elimina.jpg"
                            ...
                            TabIndex="90" ToolTip="Elimina la Verifica Selezionata" Width="60px" /></td>
            </tr>
            </table>
            <br />
            <br />
...
<div id="DIV_VERIFICHE" style="width: 800px; height: 550px; display: block; left: 0px; position: absolute; top: 0px; background-color: #dedede; background-image: url(../NuoveImm/SfondoMascheraContratti.jpg);">
            ...
            <td>
                <strong><span style="color: #0000ff; font-family: Arial">
                    <p class="MsoNormal" style="margin: 0cm 0cm 10pt">
                        <strong><span style="color: blue; font-family: 'Arial','sans-serif'">Verifica Dichiarazione Pressione
                    Residua</span></strong></p>
                </span></strong></td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDitta" runat="server" Font-Names="Arial" Font-Size="9pt" MaxLength="100"
                                TextMode="MultiLine" Width="400px" TabIndex="91"></asp:TextBox></td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNote" runat="server" Font-Names="Arial" Font-Size="9pt" Height="64px"
                                MaxLength="4000" Style="left: 144px; top: 112px" TabIndex="92" TextMode="MultiLine"
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblEsito" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="110px">Pressione</asp:Label></td>
                        <td>
                            <asp:DropDownList ID="cmbEsito" runat="server" BackColor="White" Font-Names="arial"
                                ...
                                top: 184px" TabIndex="93" ToolTip="Pressione" Width="56px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtData" runat="server" Font-Names="Arial" Font-Size="9pt" MaxLength="10"
                                Style="left: 144px; top: 192px" TabIndex="94" ToolTip="gg/mm/aaaa" Width="70px" AutoPostBack="True"></asp:TextBox><asp:RegularExpressionValidator
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtValidita" runat="server" Font-Names="arial" Font-Size="9pt"
                                ...
                                TabIndex="95" Width="70px" AutoPostBack="True"></asp:TextBox>
                        ...
                        <td>
                            <asp:DropDownList ID="cmbPreAllarme" runat="server" BackColor="White" Font-Names="arial"
                                Font-Size="10pt" Style="border-right: black 1px solid; border-top: black 1px solid;
                                z-index: 111; left: 80px; border-left: black 1px solid; border-bottom: black 1px solid;
                                top: 184px" TabIndex="96" ToolTip="Mesi per il pre allarme" Width="56px" AutoPostBack="True">
                    ...
                    <tr>
                        <td align="right">
                            ...
                            &nbsp;<asp:ImageButton ID="btn_Inserisci" runat="server" ImageUrl="~/NuoveImm/Img_SalvaVal.png"
                                OnClientClick="document.getElementById('USCITA').value='1';document.getElementById('Tab_Antincendio_Verifiche_txtAppare').value='0';"
                                Style="cursor: pointer" TabIndex="97" ToolTip="Salva le modifiche apportate" />
                            <asp:ImageButton
                                    ID="btn_Chiudi" runat="server" ImageUrl="~/NuoveImm/Img_AnnullaVal.png" OnClientClick="document.getElementById('USCITA').value='1';document.getElementById('DIV_VERIFICHE').style.visibility='hidden';document.getElementById('Tab_Antincendio_Verifiche_txtAppare').value='0';"
                                    Style="cursor: pointer" TabIndex="98" ToolTip="Esce senza salvare le modifiche apportate" /></td>
                    </tr>
                </table>
            </td>
        </tr>
...
if (document.getElementById('Tab_Antincendio_Verifiche_txtAppare').value!='1') {
