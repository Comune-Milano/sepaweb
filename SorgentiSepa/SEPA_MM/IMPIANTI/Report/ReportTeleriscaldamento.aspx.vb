...
Partial Class ASS_ReportTeleriscaldamento
        ...
        If Not IsPostBack Then
            ...
            If IsNumeric(vIdImpianto) Then
                ...
                Try
                    ...
                    Label2.Text = "IMPIANTO DI TELERISCALDAMENTO"
                    ...
                    If myReader1.Read Then
                        ...
                        If myReader2.Read Then
                            ...
                            Me.lblDittaFornitrice.Text = par.IfNull(myReader2("DITTA_FORNITRICE"), "")
                            Me.lblTelF.Text = par.IfNull(myReader2("TELEFONO_DITTA_FORNITRICE"), "")
                        ...
                        StringaSql = "select distinct ID,(DENOMINAZIONE||' - -Cod.'||COD_EDIFICIO) as EDIFICIO, " _
                                         & "(select count(*) from SISCOM_MI.UNITA_IMMOBILIARI where ID_EDIFICIO=EDIFICI.ID and (COD_TIPOLOGIA <> 'K' AND COD_TIPOLOGIA <> 'B' AND COD_TIPOLOGIA <> 'C' AND COD_TIPOLOGIA <> 'H' AND COD_TIPOLOGIA <> 'I')) as UI,  " _
                    ...
                    StringaSql = "select SISCOM_MI.I_TER_GENERATORI_TELE.ID,SISCOM_MI.I_TER_GENERATORI_TELE.MODELLO," _
                                        & "SISCOM_MI.I_TER_GENERATORI_TELE.MATRICOLA,SISCOM_MI.I_TER_GENERATORI_TELE.NOTE," _
                                           & "SISCOM_MI.I_TER_GENERATORI_TELE.ANNO_COSTRUZIONE,SISCOM_MI.I_TER_GENERATORI_TELE.POTENZA,SISCOM_MI.I_TER_GENERATORI_TELE.MARC_EFF_ENERGETICA,SISCOM_MI.I_TER_GENERATORI_TELE.FLUIDO_TERMOVETTORE " _
                    ...
                    da2.Fill(ds2, "I_TER_GENERATORI_TELE")
