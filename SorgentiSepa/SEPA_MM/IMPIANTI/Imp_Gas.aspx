<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_Gas.aspx.vb" Inherits="IMPIANTI_Imp_Gas" %>

<%@ Register Src="Tab_Gas_Generale.ascx"         TagName="Tab_Gas_Generale"   TagPrefix="uc1" %>
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportGAS.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                    ...
                    <table style="width: 760px">
                        ...
                        <div class="tabber" id="tab1">
                            <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Dettagli</h2>
                                <uc1:Tab_Gas_Generale ID="Tab_Gas_Generale" runat="server"  Visible=" true" />         
                            </div>
