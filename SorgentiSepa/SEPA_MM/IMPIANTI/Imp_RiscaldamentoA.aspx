<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_RiscaldamentoA.aspx.vb" Inherits="IMPIANTI_Imp_RiscaldamentoA" %>

<%@ Register Src="Tab_Termico_GeneraleA.ascx" TagName="TabGeneraleA" TagPrefix="uc1" %>
<%@ Register Src="Tab_Termico_Dettagli1.ascx" TagName="TabDettagli1" TagPrefix="uc2" %>
<%@ Register Src="Tab_Termico_Cert.ascx" TagName="Tab_Termico_Certificazioni" TagPrefix="uc4" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"/>
    <title>IMPIANTO TERMICO AUTONOMO</title>
...
function ConfermaAnnulloPompe() {
    ...
    if (sicuro == true) {
    document.getElementById('Tab_Termico_PompeA_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Termico_PompA_txtannullo').value='0'; 
    }
}
...
function ConfermaAnnulloVerifiche() {
    ...
    if (sicuro == true) {
    document.getElementById('TabVerifiche_txtannullo').value='1';
    }
    else
    {
    document.getElementById('TabVerifiche_txtannullo').value='0'; 
    }
}
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportTermicoAutonomo.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                    ...
                    <table style="width: 760px">
                        <tr>
                            <td>
                                <asp:Label ID="lblUnita" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                    ForeColor="Black" Style="z-index: 100; left: -46px; top: -302px" TabIndex="-1"
                                    Width="72px">Unità Immobiliare</asp:Label></td>
                            <td>
                                <asp:DropDownList ID="cmbUnitaImmob" runat="server" BackColor="White"
                                    Font-Names="arial" Font-Size="10pt" Style="border-right: black 1px solid; border-top: black 1px solid;
                                    z-index: 111; left: 88px; border-left: black 1px solid; border-bottom: black 1px solid;
                                    top: 120px" TabIndex="3" Width="490px">
                                </asp:DropDownList></td>
                            <td>
                                &nbsp;&nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDenominazione" runat="server" Font-Names="Arial" Font-Size="9pt"
                                    MaxLength="500" Style="left: 136px; top: 112px; height: 30px" TabIndex="4" TextMode="MultiLine"
                            ...
                            <td>
                                <asp:Label ID="Lbl_TIPOLOGIA_USO" runat="server" Font-Bold="False" Font-Names="Arial"
                                    ...
                                    TabIndex="-1" Width="75px">Tipologia d'uso</asp:Label><asp:DropDownList ID="cmbTipoUso"
                                        ...
                                        border-bottom: black 1px solid; top: 144px" TabIndex="5" Width="168px">
                                    </asp:DropDownList></td>
                        </tr>
                    </table>
                     <div class="tabber" id="tab1">
                        <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                            <h2>Dettagli</h2>
                            <uc1:TabGeneraleA ID="TabGeneraleA" runat="server"  Visible=" true" />         
                        </div>
                        <div <%=Visibile %> class="tabbertab <%=Tabber2%>" style="BACKGROUND-COLOR: white;width:775px"> 
                            <h2>Componenti</h2>
                            <uc2:TabDettagli1 ID="TabDettagli1" runat="server"  Visible="true"  />  &nbsp;
                        </div>     
                        <div <%=Visibile %> class="tabbertab <%=Tabber4%>" style="BACKGROUND-COLOR: white;width:775px"> 
                            <h2>Certificazioni</h2>
                            <uc4:Tab_Termico_Certificazioni ID="Tab_Termico_Certificazioni" runat="server"  Visible="true"  />  &nbsp;
                        </div>     
