    ...
    <tr>
        <td>
            <div id="DIV1" style="border-right: #0000cc thin solid; border-top: #0000cc thin solid;
                visibility: visible; overflow: auto; border-left: #0000cc thin solid; width: 660px;
                ...
                <asp:DataGrid ID="DataGridEdifici" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    Font-Size="8pt" Font-Strikeout="False" Font-Underline="False" ForeColor="Black" PageSize="1" Style="z-index: 101; left: 9px; table-layout: auto; border-collapse: separate;" Width="100%" BorderColor="#000099">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblTotaleUI" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                            ForeColor="Black" Style="z-index: 100; left: 8px; top: 144px" TabIndex="-1" Width="85px">Totale U.I.</asp:Label></td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtTotUI" runat="server" Enabled="False" Font-Names="Arial" Font-Size="8pt"
                            ...
                            Width="85px" Font-Bold="True"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblMq" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                            ForeColor="Black" Style="z-index: 100; left: 8px; top: 144px" TabIndex="-1" Width="85px">Tot. mq riscaldato</asp:Label></td>
                </tr>
                <tr>
                    <td>
    ...
    <tr>
        ...
        <td>
            <table>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txtTotUI_Extra" runat="server" Enabled="False" Font-Names="Arial" Font-Size="8pt"
                            MaxLength="15" Style="left: 144px; top: 192px; text-align: right" TabIndex="-1"
                            Width="85px" Font-Bold="True"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txtTotMq_Extra" runat="server" Enabled="False" Font-Names="Arial" Font-Size="8pt"
                            MaxLength="15" Style="left: 144px; top: 192px; text-align: right" TabIndex="-1"
                            Width="85px" Font-Bold="True"></asp:TextBox></td>
                </tr>
            </table>
...
<div id="DIV_Edificio" style="left: 0px; width: 800px; position: absolute; top: 0px;
