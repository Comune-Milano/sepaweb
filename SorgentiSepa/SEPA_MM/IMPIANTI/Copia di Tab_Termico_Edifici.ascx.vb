...
Partial Class Tab_Termico_Edifici
    ...
    Protected Sub DataGridEdifici_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGridEdifici.ItemDataBound
