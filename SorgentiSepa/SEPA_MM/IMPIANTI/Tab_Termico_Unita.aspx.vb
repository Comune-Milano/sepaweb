    ...
    Private Sub BindGrid_UI()
        ...
        Try
            ...
            StringaSql = "select UNITA_IMMOBILIARI.ID," _
                ...
                & "   and (UNITA_IMMOBILIARI.COD_TIPOLOGIA <> 'K' AND UNITA_IMMOBILIARI.COD_TIPOLOGIA <> 'B' AND UNITA_IMMOBILIARI.COD_TIPOLOGIA <> 'C' AND UNITA_IMMOBILIARI.COD_TIPOLOGIA <> 'H' AND UNITA_IMMOBILIARI.COD_TIPOLOGIA <> 'I') " _
                ...
                If chkExport.Checked Then
                    ...
                    For i = 0 To lstEdificiCT_Extra.Count - 1
                        If lstEdificiCT_Extra.Item(i).ID = IdEdificio Then
                            ...
                            If oDataGridItem.Cells(4).Text <> "&nbsp;" Then
