<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_Tutela_Verifiche1.ascx.vb" Inherits="Tab_Tutela_Verifiche1" %>
<table id="TABBLE_LISTA">
    <tr>
        <td style="height: 21px">
            <asp:Label ID="lblTitoloGrid1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="#8080FF" Style="height: 15px" TabIndex="-1" Text="VERIFICHE PERIODICHE"
            ...
            <tr>
                <td style="width: 88px; height: 14px">
                    <asp:ImageButton ID="btnAgg" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/btn_Aggiungi.jpg"
                            OnClientClick="document.getElementById('Tab_Tutela_Verifiche1_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_VERIFICHE').style.visibility='visible';"
                            TabIndex="48" ToolTip="Aggiunge un Nuova Verifica" /></td>
            </tr>
            <tr>
                <td style="width: 88px; height: 12px">
                    <asp:ImageButton ID="btnApri" runat="server" CausesValidation="False" Height="12px"
                            ImageUrl="~/NuoveImm/Img_Modifica.png" OnClientClick="document.getElementById('Tab_Tutela_Verifiche1_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_VERIFICHE').style.visibility='visible';"
                            TabIndex="49" ToolTip="Modifica la Verifica Selezionata" Width="60px" /></td>
            </tr>
        </table>
            <br />
        </td>
    ...
    <tr>
        <td>
            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="#8080FF" Style="height: 15px" TabIndex="-1" Text="ARCHIVIO STORICO DELLE VERIFICHE PERIODICHE "
                Width="368px"></asp:Label></td>
        <td>
        </td>
        <td>
                ...
                <tr>
                    <td style="width: 88px; height: 14px">
                        <asp:ImageButton ID="btnVisualizza" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/Img_VisualizzaPiccolo.png"
                            OnClientClick="document.getElementById('Tab_Tutela_Verifiche1_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_VERIFICHE').style.visibility='visible';"
                            TabIndex="51" ToolTip="Visulizza la Verifica Selezionata" /></td>
                </tr>
            <tr>
                <td style="width: 88px">
                    <asp:ImageButton ID="btnElimina" runat="server" Height="12px" ImageUrl="~/NuoveImm/btn_Elimina.jpg"
                            ...
                            TabIndex="52" ToolTip="Elimina la Verifica Selezionata" Width="60px" /></td>
            </tr>
            </table>
            <br />
            <br />
...
<div id="DIV_VERIFICHE" style="width: 800px; height: 550px; display: block; left: 0px; position: absolute; top: 0px; background-color: #dedede; background-image: url(../NuoveImm/SfondoMascheraContratti.jpg);">
    <br /><table id="Table4" style="left: 130px; width: 50px;
        ...
        <tr>
            <td>
                <strong><span style="color: #0000ff; font-family: Arial">Verifica Periodica</span></strong></td>
        </tr>
        <tr>
            <td>
                &nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDitta" runat="server" Font-Names="Arial" Font-Size="9pt" MaxLength="100"
                                TextMode="MultiLine" Width="400px" TabIndex="53"></asp:TextBox></td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNote" runat="server" Font-Names="Arial" Font-Size="9pt" Height="64px"
                                MaxLength="4000" Style="left: 144px; top: 112px" TabIndex="54" TextMode="MultiLine"
                    ...
                    <tr>
                        ...
                        <td style="height: 24px">
                            <asp:DropDownList ID="cmbEsito" runat="server" BackColor="White" Font-Names="arial"
                                ...
                                top: 184px" TabIndex="55" ToolTip="Pressione" Width="56px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtData" runat="server" Font-Names="Arial" Font-Size="9pt" MaxLength="10"
                                Style="left: 144px; top: 192px" TabIndex="56" ToolTip="gg/mm/aaaa" Width="70px" AutoPostBack="True"></asp:TextBox><asp:RegularExpressionValidator
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtValidita" runat="server" Font-Names="arial" Font-Size="9pt"
                                ...
                                TabIndex="57" Width="70px" AutoPostBack="True"></asp:TextBox>
                        ...
                        <td>
                            <asp:DropDownList ID="cmbPreAllarme" runat="server" BackColor="White" Font-Names="arial"
                                Font-Size="10pt" Style="border-right: black 1px solid; border-top: black 1px solid;
                                z-index: 111; left: 80px; border-left: black 1px solid; border-bottom: black 1px solid;
                                top: 184px" TabIndex="58" ToolTip="Mesi per il pre allarme" Width="56px" AutoPostBack="True">
                    ...
                    <tr>
                        <td align="right">
                            &nbsp;<asp:ImageButton ID="btn_Inserisci" runat="server" ImageUrl="~/NuoveImm/Img_SalvaVal.png"
                                OnClientClick="document.getElementById('USCITA').value='1';document.getElementById('Tab_Tutela_Verifiche1_txtAppare').value='0';"
                                Style="cursor: pointer" TabIndex="59" ToolTip="Salva le modifiche apportate" />
                            <asp:ImageButton
                                    ID="btn_Chiudi" runat="server" ImageUrl="~/NuoveImm/Img_AnnullaVal.png" OnClientClick="document.getElementById('USCITA').value='1';document.getElementById('DIV_VERIFICHE').style.visibility='hidden';document.getElementById('Tab_Tutela_Verifiche1_txtAppare').value='0';"
                                    Style="cursor: pointer" TabIndex="60" ToolTip="Esci senza inserire" /></td>
                    </tr>
                </table>
            </td>
        </tr>
...
if (document.getElementById('Tab_Tutela_Verifiche1_txtAppare').value!='1') {
