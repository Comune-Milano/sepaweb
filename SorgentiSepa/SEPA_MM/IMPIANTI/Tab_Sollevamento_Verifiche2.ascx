<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_Sollevamento_Verifiche2.ascx.vb" Inherits="Tab_Sollevamento_Verifiche2" %>
<table id="TABBLE_LISTA">
    <tr>
        <td>
            <asp:Label ID="lblTitolo2" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="#8080FF" Style="height: 15px" TabIndex="-1" Text="VERIFICHE STRAORDINARIE"
                Width="248px" Height="15px"></asp:Label></td>
        <td>
        </td>
        <td>
        </td>
                ...
                <tr>
                    <td style="width: 88px; height: 14px">
                        <asp:ImageButton ID="btnAgg" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/btn_Aggiungi.jpg"
                            OnClientClick="document.getElementById('Tab_Sollevamento_Verifiche2_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_ST').style.visibility='visible';"
                            TabIndex="40" ToolTip="Aggiunge un nuova Verifica" /></td>
                </tr>
                <tr>
                    <td style="width: 88px; height: 12px">
                        <asp:ImageButton ID="btnApri" runat="server" CausesValidation="False" Height="12px"
                            ImageUrl="~/NuoveImm/Img_Modifica.png" OnClientClick="document.getElementById('Tab_Sollevamento_Verifiche2_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_ST').style.visibility='visible';"
                            TabIndex="41" ToolTip="Modifica la Verifica  selezionata"
                            Width="60px" /></td>
                </tr>
            </table>
            <br />
    ...
    <tr>
        <td>
            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                ForeColor="#8080FF" Style="height: 15px" TabIndex="-1" Text="STORICO VERIFICHE STRAORDINARIE"
                Width="248px" Height="15px"></asp:Label></td>
        <td>
        </td>
        <td>
            ...
            <div style="border-right: #0000cc thin solid; border-top: #0000cc thin solid; visibility: visible;
                ...
                <asp:DataGrid ID="DataGrid2" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MOTIVO">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox5" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ES_PRESCRIZIONE") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ES_PRESCRIZIONE") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" Width="30%" />
                        </asp:TemplateColumn>
                ...
                <tr>
                    <td style="width: 88px; height: 14px">
                        <asp:ImageButton ID="btnVisualizza" runat="server" CausesValidation="False" ImageUrl="~/NuoveImm/Img_VisualizzaPiccolo.png"
                            OnClientClick="document.getElementById('Tab_Sollevamento_Verifiche2_txtAppare').value='1';document.getElementById('USCITA').value='1'; document.getElementById('DIV_ST').style.visibility='visible';"
                            TabIndex="43" ToolTip="Visulizza la Verifica Selezionata" /></td>
                </tr>
                <tr>
                    <td style="width: 88px">
                        <asp:ImageButton ID="btnElimina" runat="server" Height="12px" ImageUrl="~/NuoveImm/btn_Elimina.jpg"
                            ...
                            TabIndex="44" ToolTip="Elimina la Verifica Selezionata" Width="60px" /></td>
                </tr>
            </table>
            <br />
            <br />
...
<div id="DIV_ST" style="width: 800px; height: 550px; display: block; left: 0px; position: absolute; top: 0px; background-color: whitesmoke; background-image: url(../NuoveImm/SfondoMascheraContratti.jpg);">
    <br /><table id="Table4" style="border-right: blue 2px; border-top: blue 2px;
        left: 128px; border-left: blue 2px; width: 50px; border-bottom: blue 2px;
        position: absolute; top: 104px; height: 248px; background-color: #ffffff; color: #0000ff; font-family: Arial; z-index: 102;" >
        <tr>
            <td style="height: 24px;">
                <strong><span style="color: #0000ff; font-family: Arial">Verifiche Straordinarie</span></strong></td>
        </tr>
        <tr>
            <td>
                &nbsp;
                <table id="Table2">
                    <tr>
                        ...
                        <td style="width: 156px;">
                            <asp:TextBox ID="txtDitta" runat="server" Font-Names="Arial" Font-Size="9pt" MaxLength="100"
                                TextMode="MultiLine" Width="400px" TabIndex="45"></asp:TextBox></td>
                        <td style="width: 3px;">
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 85px">
                            <asp:Label ID="lblMotivo" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="110px">Motivo</asp:Label></td>
                        <td style="width: 156px">
                            <asp:DropDownList ID="cmbMotivo" runat="server" BackColor="White" Font-Names="arial"
                                ...
                                top: 184px" TabIndex="46" ToolTip="Motivo" Width="400px">
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem Value="ESITO NEGATIVO">ESITO NEGATIVO (delle verifiche periodiche)</asp:ListItem>
                                <asp:ListItem Value="LAVORI STRAORDINARI">LAVORI STRAORDINARI</asp:ListItem>
                    ...
                    <tr>
                        <td style="width: 85px">
                            <asp:Label ID="lblNote" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="110px">Note</asp:Label></td>
                        <td style="width: 156px">
                            <asp:TextBox ID="txtNote" runat="server" Font-Names="Arial" Font-Size="9pt" Height="50px"
                                MaxLength="4000" Style="left: 144px; top: 112px" TabIndex="47" TextMode="MultiLine"
                    ...
                    <tr>
                        ...
                        <td style="width: 156px">
                            <asp:DropDownList ID="cmbEsitoST" runat="server" BackColor="White" Font-Names="arial"
                                Font-Size="10pt" Style="border-right: black 1px solid; border-top: black 1px solid;
                                z-index: 111; left: 80px; border-left: black 1px solid; border-bottom: black 1px solid;
                                top: 184px" TabIndex="48" ToolTip="Osservazioni" Width="200px">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtData" runat="server" Font-Names="Arial" Font-Size="9pt"
                                MaxLength="10" Style="left: 144px; top: 192px" TabIndex="49" ToolTip="gg/mm/aaaa"
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblValidita" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="110px" Visible="False">Validità (mesi)</asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtValidita" runat="server" AutoPostBack="True" Font-Names="arial"
                                ...
                                top: 192px; text-align: right" TabIndex="49" Width="70px" Visible="False"></asp:TextBox>
                            <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="40px" Visible="False">(mesi)</asp:Label><asp:RegularExpressionValidator
                                    ...
                                    TabIndex="303" ValidationExpression="\d+" Width="120px" Visible="False"></asp:RegularExpressionValidator></td>
                        <td style="width: 11px">
                        </td>
                        <td>
                            <asp:Label ID="lblPreAllarme" runat="server" Font-Bold="False" Font-Names="Arial"
                                ...
                                Width="80px" Visible="False">Pre-Allarme</asp:Label></td>
                        <td>
                            <asp:DropDownList ID="cmbPreAllarme" runat="server" AutoPostBack="True" BackColor="White"
                                ...
                                z-index: 111; left: 80px; border-left: black 1px solid; border-bottom: black 1px solid;
                                top: 184px" TabIndex="50" ToolTip="Mesi per il pre allarme" Width="56px" Visible="False">
                            ...
                            <asp:Label ID="Label7" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px" Width="40px" Visible="False">(mesi)</asp:Label></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblDataScadenza" runat="server" Font-Bold="False" Font-Names="Arial"
                                Font-Size="8pt" ForeColor="Black" Style="z-index: 100; left: 24px; top: 32px"
                                Width="110px" Visible="False">Data Prossima Verifica</asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtDataScadenza" runat="server" Enabled="False" Font-Names="Arial"
                                ...
                                TabIndex="-1" ToolTip="gg/mm/aaaa" Width="70px" Visible="False"></asp:TextBox>&nbsp;
                            <asp:Image ID="ImageAllarm" runat="server" BackColor="Silver" BorderColor="Silver"
                                ForeColor="LightGray" ImageUrl="~/IMPIANTI/Immagini/Semaforo_Rosso.png" Visible="False" />&nbsp;
                        </td>
                        <td style="width: 11px">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="txtIDST" runat="server" Height="16px" Style="left: 640px; top: 200px"
                    ...
                    <tr>
                        <td align="right">
                            &nbsp;<asp:ImageButton ID="btn_Inserisci" runat="server" ImageUrl="~/NuoveImm/Img_SalvaVal.png"
                                OnClientClick="document.getElementById('USCITA').value='1';document.getElementById('Tab_Sollevamento_Verifiche2_txtAppare').value='0';"
                                Style="cursor: pointer" TabIndex="51" ToolTip="Salva le modifiche apportate" />
                            <asp:ImageButton
                                    ID="btn_Chiudi" runat="server" ImageUrl="~/NuoveImm/Img_AnnullaVal.png" OnClientClick="document.getElementById('USCITA').value='1';document.getElementById('DIV_ST').style.visibility='hidden';document.getElementById('Tab_Sollevamento_Verifiche2_txtAppare').value='0';"
                                    Style="cursor: pointer" TabIndex="52" ToolTip="Esci senza inserire" /></td>
                    </tr>
                </table>
            </td>
        </tr>
...
if (document.getElementById('Tab_Sollevamento_Verifiche2_txtAppare').value!='1') {
document.getElementById('DIV_ST').style.visibility='hidden';
}
