'*** TAB SOLLEVAMENTO (VERIFICHE PERIODICHE BIENNALI E STRAORDINARIE)
Imports System.Collections

Partial Class Tab_Sollevamento_Verifiche2
        ...
        Try
            If Not IsPostBack Then
                ...
                If Not String.IsNullOrEmpty(Request.QueryString("ID")) Then
                    lstVerifiche2 = New System.Collections.Generic.List(Of Epifani.VerificheImpianti)
                End If
    ...
    'CARICAMENTO GRIGLIA VERIFICHE ST GRID1
    Private Sub BindGrid_VerificheST()
    ...
    'CARICAMENTO GRIGLIA STORICO VERIFICHE STRAORDINARIE GRID2
    ...
    Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Sollevamento_Verifiche2_txtSel1').value='Hai selezionato: " & Replace(e.Item.Cells(1).Text, "'", "\'") & "';document.getElementById('Tab_Sollevamento_Verifiche2_txtIdComponente').value='" & e.Item.Cells(0).Text & "'")
    ...
    Protected Sub DataGrid2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid2.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onmouseover", "this.style.backgroundColor='yellow'")
            e.Item.Attributes.Add("onmouseout", "this.style.backgroundColor='white'")
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Sollevamento_Verifiche2_txtSel2').value='Hai selezionato: " & Replace(e.Item.Cells(1).Text, "'", "\'") & "';document.getElementById('Tab_Sollevamento_Verifiche2_txtIdComponente2').value='" & e.Item.Cells(0).Text & "'")
    ...
    Function ControlloCampiST() As Boolean
        ...
        Try
            ...
            If vIdImpianto > -1 Then
                ...
                PAR.cmd.CommandText = "select max(ID) from SISCOM_MI.IMPIANTI_VERIFICHE where SISCOM_MI.IMPIANTI_VERIFICHE.ID_IMPIANTO = " & vIdImpianto & " and SISCOM_MI.IMPIANTI_VERIFICHE.TIPO='ST'"
    ...
    Protected Sub btn_Inserisci_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Inserisci.Click
        ...
        If ControlloCampiST() = False Then
            txtAppare.Text = "1"
            Exit Sub
        End If

        If Me.txtIDST.Text = "-1" Then
    ...
    Private Sub SalvaST()
        ...
        Try
            If vIdImpianto = -1 Then
                ...
                gen = New Epifani.VerificheImpianti(lstVerifiche2.Count, PAR.PulisciStringaInvio(Me.txtDitta.Text, 100), Me.txtData.Text, Me.txtNote.Text, Me.cmbEsitoST.SelectedItem.Text, PAR.IfEmpty(Me.txtValidita.Text, 0), txtDataScadenza.Text, cmbEsitoST.SelectedItem.Value, Me.cmbPreAllarme.SelectedItem.Text, "ST", Me.cmbMotivo.SelectedValue.ToString)

                DataGrid1.DataSource = Nothing
                lstVerifiche2.Add(gen)
                gen = Nothing

                DataGrid1.DataSource = lstVerifiche2
                DataGrid1.DataBind()
            ...
            Else
                ...
                PAR.cmd.CommandText = "update SISCOM_MI.IMPIANTI_VERIFICHE set FL_STORICO='S' " _
                                   & " where TIPO='ST' and ID_IMPIANTO=" & vIdImpianto
                ...
                PAR.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("esito", Convert.ToInt32(Me.cmbEsitoST.SelectedValue)))
                PAR.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("prescrizione", Me.cmbMotivo.SelectedValue.ToString))
                PAR.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("esitodettaglio", Me.cmbEsitoST.SelectedItem.ToString))
                PAR.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("validita", Convert.ToInt32(PAR.IfEmpty(txtValidita.Text, 0))))
    ...
    Private Sub UpdateST()
        ...
        Try
            If vIdImpianto = -1 Then
                ...
                lstVerifiche2(txtIdComponente.Text).DITTA = PAR.PulisciStringaInvio(Me.txtDitta.Text, 100)
                lstVerifiche2(txtIdComponente.Text).NOTE = Me.txtNote.Text
                lstVerifiche2(txtIdComponente.Text).ESITO = Me.cmbEsitoST.SelectedValue
                lstVerifiche2(txtIdComponente.Text).ESITO_DETTAGLIO = Me.cmbEsitoST.SelectedItem.ToString

                lstVerifiche2(txtIdComponente.Text).DATA = Me.txtData.Text
                lstVerifiche2(txtIdComponente.Text).MESI_VALIDITA = PAR.IfEmpty(Me.txtValidita.Text, 12)
                lstVerifiche2(txtIdComponente.Text).MESI_PREALLARME = Me.cmbPreAllarme.SelectedValue.ToString
                lstVerifiche2(txtIdComponente.Text).DATA_SCADENZA = Me.txtDataScadenza.Text

                lstVerifiche2(txtIdComponente.Text).TIPO = "ST"

                lstVerifiche2(txtIdComponente.Text).ES_PRESCRIZIONE = Me.cmbMotivo.SelectedValue.ToString
            ...
            Else
                ...
                '*** EVENTI_IMPIANTI
                PAR.InserisciEvento(PAR.cmd, vIdImpianto, Session.Item("ID_OPERATORE"), Epifani.TabEventi.MODIFICA_DETTAGLIO_IMPIANTO, "Verifiche Straordinarie")
        ...
        Try
            ...
            Else
                If vIdImpianto = -1 Then
                    ...
                    Me.txtIDST.Text = lstVerifiche2(txtIdComponente.Text).ID
                    Me.txtDitta.Text = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).DITTA, "")
                    Me.txtNote.Text = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).NOTE, "")
                    Me.cmbEsitoST.SelectedValue = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).ESITO, 0)

                    Me.txtData.Text = PAR.FormattaData(lstVerifiche2(txtIdComponente.Text).DATA)
                    'Me.txtDataScadenza.Text = PAR.FormattaData(lstVerifiche2(txtIdComponente.Text).DATA_SCADENZA)

                    'Me.txtValidita.Text = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).MESI_VALIDITA, 12)
                    'Me.cmbPreAllarme.SelectedValue = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).MESI_PREALLARME, 1)

                    Me.cmbMotivo.SelectedValue = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).ES_PRESCRIZIONE, "")
                ...
                Else
                    ...
                    If myReader1.Read Then
                        Me.txtIDST.Text = PAR.IfNull(myReader1("ID"), -1)

                        Me.txtDitta.Text = PAR.IfNull(myReader1("DITTA"), "")
                        Me.txtNote.Text = PAR.IfNull(myReader1("NOTE"), "")
                        Me.cmbEsitoST.SelectedValue = PAR.IfNull(myReader1("ESITO"), 0)
                        ...
                        Me.cmbMotivo.SelectedValue = PAR.IfNull(myReader1("ES_PRESCRIZIONE"), "")
            ...
            If txtannullo.Text = "1" Then
                ...
                Else
                    If vIdImpianto = -1 Then
                        ...
                        lstVerifiche2.RemoveAt(txtIdComponente2.Text)
                    ...
                    Else
                        ...
                        Else
                            ...
                            '*** EVENTI_IMPIANTI
                            PAR.InserisciEvento(PAR.cmd, vIdImpianto, Session.Item("ID_OPERATORE"), Epifani.TabEventi.CANCELLAZIONE_DETTAGLIO_IMPIANTO, "Verifiche Straordinarie")
