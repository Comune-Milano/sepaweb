<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_CannaFumaria.aspx.vb" Inherits="IMPIANTI_Imp_CannaFumaria" %>

<%@ Register Src="Tab_Canna_Generale.ascx"         TagName="Tab_Canna_Generale"   TagPrefix="uc1" %>
<%@ Register Src="Tab_Manutenzioni.ascx"           TagName="Tab_Manutenzioni"     TagPrefix="uc2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"/>
    <title>IMPIANTO CANNA FUMARIA</title>
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportCannaFumaria.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                    ...
                    <table style="width: 760px">
                        ...
                        <div class="tabber" id="tab1">
                            <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Dettagli</h2>
                                <uc1:Tab_Canna_Generale ID="Tab_Canna_Generale" runat="server"  Visible=" true" />         
                            </div>
                            <div  class="<%=TabberHide%> <%=Tabber2%>" style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Manutenzioni</h2>
                                <uc2:Tab_Manutenzioni ID="Tab_Manutenzioni" runat="server"   Visible="true"  />       
                            </div>                                                    
                        </div>                    
                </td>
            </tr>
