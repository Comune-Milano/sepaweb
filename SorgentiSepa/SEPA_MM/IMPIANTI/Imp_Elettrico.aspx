<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_Elettrico.aspx.vb" Inherits="IMPIANTI_Imp_Elettrico" %>

<%@ Register Src="Tab_Elettrico_Generale.ascx"      TagName="Tab_Elettrico_Generale"    TagPrefix="uc1" %>
<%@ Register Src="Tab_Elettrico_Dettagli.ascx"      TagName="TabElettricoDettagli"      TagPrefix="uc2" %>
<%@ Register Src="Tab_Elettrico_Portineria.ascx"    TagName="TabElettricoPortineria"    TagPrefix="uc3" %>
<%@ Register Src="Tab_Elettrico_Box.ascx"           TagName="TabElettricoBox"           TagPrefix="uc4" %>
<%@ Register Src="Tab_Manutenzioni.ascx"            TagName="Tab_Manutenzioni"          TagPrefix="uc5" %>
...
function ConfermaAnnulloSE() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo quadro?');
    if (sicuro == true) {
    document.getElementById('TabElettricoDettagli_txtannullo').value='1';
    }
    else
    {
    document.getElementById('TabElettricoDettagli_txtannullo').value='0'; 
    }
}

function ConfermaAnnulloSC() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo quadro?');
    if (sicuro == true) {
    document.getElementById('TabElettricoDettagli_txtannullo').value='1';
    }
...
function ConfermaAnnulloPortineria() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo quadro?');
    if (sicuro == true) {
    document.getElementById('TabElettricoPortineria_txtannullo').value='1';
    }
    else
    {
    document.getElementById('TabElettricoPortineria_txtannullo').value='0'; 
    }
}

function ConfermaAnnulloBox() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo quadro?');
    if (sicuro == true) {
    document.getElementById('TabElettricoBox_txtannullo').value='1';
    }
    else
    {
    document.getElementById('TabElettricoBox_txtannullo').value='0'; 
    }
}
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportElettrico.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDitta" runat="server" Font-Names="Arial" Font-Size="9pt" Height="30px"
                                    MaxLength="100" Style="left: 80px; top: 88px" TabIndex="4" TextMode="MultiLine"
                                ...
                                <asp:Label ID="LblAnnoRealizzazione" runat="server" Font-Bold="False" Font-Names="Arial"
                                    ...
                                    TabIndex="-1" Width="56px">Data Installazione</asp:Label>
                            ...
                            <td>
                                <asp:Label ID="Lbl_TIPOLOGIA_USO" runat="server" Font-Bold="False" Font-Names="Arial"
                                    ...
                                    TabIndex="-1" Width="75px" Visible="False">Tipologia d'uso</asp:Label><asp:DropDownList ID="cmbTipoUso"
                                        runat="server" BackColor="White" Font-Names="arial" Font-Size="9pt" Style="border-right: black 1px solid;
                                        border-top: black 1px solid; z-index: 111; left: 88px; border-left: black 1px solid;
                                        border-bottom: black 1px solid; top: 144px" TabIndex="6" Width="168px" Visible="False">
                                    </asp:DropDownList></td>
                        </tr>
                    </table>
                          <div class="tabber" id="tab1">
                            <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Dettagli</h2>
                                <uc1:Tab_Elettrico_Generale ID="Tab_Elettrico_Generale" runat="server"  Visible=" true" />         
                            </div>
                            <div class="tabbertab <%=Tabber2%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Quadro Servizi e Scala</h2>
                                <uc2:TabElettricoDettagli ID="TabElettricoDettagli" runat="server"  Visible=" true" />         
                            </div> 
                            <div class="tabbertab <%=Tabber3%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Portineria</h2>
                                <uc3:TabElettricoPortineria ID="TabElettricoPortineria" runat="server"  Visible=" true" />         
                            </div> 
                            <div class="tabbertab <%=Tabber4%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Box</h2>
                                <uc4:TabElettricoBox ID="TabElettricoBox" runat="server"  Visible=" true" />         
                            </div>    
                            <div  class="<%=TabberHide%> <%=Tabber5%>" style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Manutenzioni</h2>
                                <uc5:Tab_Manutenzioni ID="Tab_Manutenzioni" runat="server"   Visible="true"  />       
                            </div>                                                    
                        </div>                        
                </td>
            </tr>
