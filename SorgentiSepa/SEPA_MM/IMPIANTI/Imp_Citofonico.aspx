<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_Citofonico.aspx.vb" Inherits="IMPIANTI_Imp_Citofonico" %>

<%@ Register Src="Tab_Citofonico_Generale.ascx"  TagName="Tab_Citofonico_Generale"   TagPrefix="uc1" %>
<%@ Register Src="Tab_Citofonico_Dettagli.ascx"  TagName="Tab_Citofonico_Dettagli"   TagPrefix="uc2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"/>
    <title>IMPIANTO CITOFONICO</title>
...
function ConfermaAnnulloCI() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo dettaglio citofono?');
    if (sicuro == true) {
    document.getElementById('Tab_Citofonico_Dettagli_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Citofonico_Dettagli_txtannullo').value='0'; 
    }
}
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportCitofonico.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                    ...
                    <table style="width: 760px">
                        ...
                        <div class="tabber" id="tab1">
                            <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Generale</h2>
                                <uc1:Tab_Citofonico_Generale ID="Tab_Citofonico_Generale" runat="server"  Visible=" true" />         
                            </div>
                            <div class="tabbertab <%=Tabber2%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Dettagli</h2>
                                <uc2:Tab_Citofonico_Dettagli ID="Tab_Citofonico_Dettagli" runat="server"  Visible=" true" />         
                            </div>                            
