<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Imp_Tutela.aspx.vb" Inherits="IMPIANTI_Imp_Tutela" %>

<%@ Register Src="Tab_Tutela_Generale.ascx"         TagName="Tab_Tutela_Generale"   TagPrefix="uc1" %>
<%@ Register Src="Tab_Tutela_Dettagli.ascx"         TagName="Tab_Tutela_Dettagli"   TagPrefix="uc2" %>
<%@ Register Src="Tab_Tutela_Carraio.ascx"          TagName="Tab_Tutela_Carraio"    TagPrefix="uc3" %>
<%@ Register Src="Tab_Tutela_Alloggi.ascx"          TagName="Tab_Tutela_Alloggi"    TagPrefix="uc4" %>
<%@ Register Src="Tab_Tutela_Verifiche1.ascx"       TagName="Tab_Tutela_Verifiche1" TagPrefix="uc5" %>
<%@ Register Src="Tab_Tutela_Verifiche2.ascx"       TagName="Tab_Tutela_Verifiche2" TagPrefix="uc6" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"/>
    <title>IMPIANTO TUTELA IMMOBILI</title>
...
function ConfermaAnnulloCA() {
    var sicuro = confirm('Sei sicuro di voler cancellare questo cancello?');
    if (sicuro == true) {
    document.getElementById('Tab_Tutela_Dettagli_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Tutela_Dettagli_txtannullo').value='0'; 
    }
}

function ConfermaAnnulloPasso() {
    var sicuro = confirm('Sei sicuro di voler cancellare il passo carrabile?');
    if (sicuro == true) {
    document.getElementById('Tab_Tutela_Carraio_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Tutela_Carraio_txtannullo').value='0'; 
    }
}

function ConfermaAnnulloA() {
    var sicuro = confirm('Sei sicuro di voler cancellare il contenuto?');
    if (sicuro == true) {
    document.getElementById('Tab_Tutela_Alloggi_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Tutela_Alloggi_txtannullo').value='0'; 
    }
}
...
function ConfermaAnnulloVerifiche() {
    ...
    if (sicuro == true) {
    document.getElementById('Tab_Tutela_Verifiche1_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Tutela_Verifiche1_txtannullo').value='0'; 
    }
}
...
function ConfermaAnnulloVerifiche2() {
    var sicuro = confirm('Sei sicuro di voler cancellare questa verifica?');
    if (sicuro == true) {
    document.getElementById('Tab_Tutela_Verifiche2_txtannullo').value='1';
    }
    else
    {
    document.getElementById('Tab_Tutela_Verifiche2_txtannullo').value='0'; 
    }
}
                ...
                <td id="TD_Principale" style="width: 800px; height: 1px">
                    ...
                    <table style="width: 760px">
                        <tr>
                            ...
                            <td style="width: 60px">
                                <img id="imgStampa" alt="Stampa Scheda Impianto" border="0" onclick="window.open('Report/ReportTutela.aspx?ID_IMPIANTO=<%=vIdImpianto %> ','Report', '');"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DrLEdificio" runat="server" BackColor="White" Font-Names="arial"
                                    ...
                                    z-index: 111; left: 88px; border-left: black 1px solid; border-bottom: black 1px solid;
                                    top: 24px" TabIndex="2" Width="380px" AutoPostBack="True">
                                </asp:DropDownList></td>
                        </tr>
                    </table>
                    <table style="width: 760px">
                        ...
                        <tr>
                          ...
                          <div class="tabber" id="tab1">
                            <div class="tabbertab <%=Tabber1%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Dettagli</h2>
                                <uc1:Tab_Tutela_Generale ID="Tab_Tutela_Generale" runat="server"  Visible=" true" />         
                            </div>
                            <div class="tabbertab <%=Tabber2%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Cancelli</h2>
                                <uc2:Tab_Tutela_Dettagli ID="Tab_Tutela_Dettagli" runat="server"  Visible=" true" />         
                            </div>        
                            <div class="tabbertab <%=Tabber3%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Passi Carrabili</h2>
                                <uc3:Tab_Tutela_Carraio ID="Tab_Tutela_Carraio" runat="server"  Visible=" true" />         
                            </div>        
                            <div class="tabbertab <%=Tabber4%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Tutela Alloggi</h2>
                                <uc4:Tab_Tutela_Alloggi ID="Tab_Tutela_Alloggi" runat="server"  Visible=" true" />         
                            </div>      
                            <div class="tabbertab <%=Tabber5%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Verifiche Periodiche</h2>
                                <uc5:Tab_Tutela_Verifiche1 ID="Tab_Tutela_Verifiche1" runat="server"  Visible=" true" />         
                            </div>   
                            <div class="tabbertab <%=Tabber6%>"  style="BACKGROUND-COLOR: white;width:775px"> 
                                <h2>Verifiche Scale</h2>
                                <uc6:Tab_Tutela_Verifiche2 ID="Tab_Tutela_Verifiche2" runat="server"  Visible=" true" />         
                            </div>                                                                                
