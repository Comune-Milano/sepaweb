'*** TAB TUTELA (VERIFICHE ANNUALI SCALE)
Imports System.Collections

Partial Class Tab_Tutela_Verifiche2
    ...
    'CARICAMENTO GRIGLIA VERIFICHE PR GRID1
    ...
    'CARICAMENTO GRIGLIA STORICO VERIFICHE PR GRID2
    ...
    Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Tutela_Verifiche2_txtSel1').value='Hai selezionato: " & Replace(e.Item.Cells(1).Text, "'", "\'") & " " & e.Item.Cells(2).Text & "';document.getElementById('Tab_Tutela_Verifiche2_txtIdComponente').value='" & e.Item.Cells(0).Text & "'")
    ...
    Protected Sub DataGrid2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid2.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onmouseover", "this.style.backgroundColor='yellow'")
            e.Item.Attributes.Add("onmouseout", "this.style.backgroundColor='white'")
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Tutela_Verifiche2_txtSel2').value='Hai selezionato: " & Replace(e.Item.Cells(1).Text, "'", "\'") & " " & e.Item.Cells(2).Text & "';document.getElementById('Tab_Tutela_Verifiche2_txtIdComponente2').value='" & e.Item.Cells(0).Text & "'")
        ...
        Try
            ...
            If vIdImpianto > -1 Then
                ...
                If Strings.Len(Strings.Trim(txtIdComponente.Text)) > 0 Then
                    PAR.cmd.CommandText = "select max(ID) from SISCOM_MI.IMPIANTI_VERIFICHE where SISCOM_MI.IMPIANTI_VERIFICHE.ID_IMPIANTO = " & vIdImpianto & " and SISCOM_MI.IMPIANTI_VERIFICHE.TIPO='TS' and SISCOM_MI.IMPIANTI_VERIFICHE.ID<>" & txtIdComponente.Text
                Else
                    PAR.cmd.CommandText = "select max(ID) from SISCOM_MI.IMPIANTI_VERIFICHE where SISCOM_MI.IMPIANTI_VERIFICHE.ID_IMPIANTO = " & vIdImpianto & " and SISCOM_MI.IMPIANTI_VERIFICHE.TIPO='TS' "
                End If
    ...
    Private Sub Salva()
        ...
        Try
            If vIdImpianto = -1 Then
                ...
                gen = New Epifani.VerificheImpianti(lstVerifiche2.Count, PAR.PulisciStringaInvio(Me.txtDitta.Text, 100), Me.txtData.Text, Me.txtNote.Text, Me.cmbEsito.SelectedItem.Text, PAR.IfEmpty(Me.txtValidita.Text, 0), txtDataScadenza.Text, cmbEsito.SelectedItem.Value, Me.cmbPreAllarme.SelectedItem.Text, "TS", "")
            ...
            Else
                ...
                PAR.cmd.CommandText = "update SISCOM_MI.IMPIANTI_VERIFICHE set FL_STORICO='S' " _
                                   & " where TIPO='TS' and ID_IMPIANTO=" & vIdImpianto
    ...
    Private Sub Update()
        ...
        Try
            If vIdImpianto = -1 Then
                ...
                lstVerifiche2(txtIdComponente.Text).ESITO = Me.cmbEsito.SelectedValue
                lstVerifiche2(txtIdComponente.Text).ESITO_DETTAGLIO = Me.cmbEsito.SelectedItem.ToString
                ...
                lstVerifiche2(txtIdComponente.Text).TIPO = "TS"
            ...
            Else
                ...
                '*** EVENTI_IMPIANTI
                PAR.InserisciEvento(PAR.cmd, vIdImpianto, Session.Item("ID_OPERATORE"), Epifani.TabEventi.MODIFICA_DETTAGLIO_IMPIANTO, "Verifica Annuale CHIUSURA/INGRESSO Scale")
    ...
    Protected Sub btnAgg_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnAgg.Click
        Try
            ...
            Me.txtDitta.Text = ""
            Me.txtNote.Text = ""
            Me.cmbEsito.SelectedItem.Value = 1
        ...
        Try
            ...
            Else
                If vIdImpianto = -1 Then
                    ...
                    Me.txtID.Text = lstVerifiche2(txtIdComponente.Text).ID
                    ...
                    Me.cmbEsito.SelectedValue = PAR.IfNull(lstVerifiche2(txtIdComponente.Text).ESITO, 0)
                ...
                Else
                    ...
                    If myReader1.Read Then
                        ...
                        Me.cmbEsito.SelectedValue = PAR.IfNull(myReader1("ESITO"), 0)
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            ...
                            '*** EVENTI_IMPIANTI
                            PAR.InserisciEvento(PAR.cmd, vIdImpianto, Session.Item("ID_OPERATORE"), Epifani.TabEventi.CANCELLAZIONE_DETTAGLIO_IMPIANTO, "Verifica Annuale CHIUSURA/INGRESSO Scale")
