...
Partial Class VSA_com_patrimonio
    ...
    Protected Sub btnSalva_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSalva.Click
        ...
        Cache(Session.Item("GLista")) = par.MiaFormat(cmbComponente.SelectedItem.Text, 25) & " " & par.MiaFormat(txtABI.Text, 27) & " " & par.MiaFormat(Replace(txtInter.Text, "&", "e"), 16) & " " & par.MiaFormat(txtImporto.Text, 8) & ",00 "
