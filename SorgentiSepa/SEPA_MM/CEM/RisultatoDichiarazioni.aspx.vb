...
e.Item.ItemType = ListItemType.AlternatingItem Then
    ...
    Private Sub Cerca()
        ...
        If Session.Item("ID_CAF") <> "6" Then
            sStringaSQL = "SELECT DICHIARAZIONI_VSA.ID,COMP_NUCLEO_VSA.PROGR," _
                       ...
                       & "FROM DICHIARAZIONI_VSA,COMP_NUCLEO_VSA WHERE " & sStringaSQL & " COMP_NUCLEO_VSA.ID_DICHIARAZIONE=DICHIARAZIONI_VSA.ID " _
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles Button3.Click
        ...
        Else
            ...
            Response.Write("<script>document.location.href='domanda.aspx?ID=-1&ID1=" & LBLID.Text & "&PROGR=" & LBLPROGR.Text & "';</script>")
        End If
    End Sub
End Class
