                    ...
                    <td>
                        ...
                        <br />
                                    ...
                                    <asp:Label ID="Label8" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                        ...
                                        Style="z-index: 112; left: 42px; position: absolute; top: 220px; right: 1000px;" 
                                        Width="36px">Tipologia</asp:Label><asp:DropDownList id="cmbBando" tabIndex="6" runat="server" Width="175px" style="z-index: 113; left: 115px; position: absolute; top: 216px; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                                </asp:DropDownList>
