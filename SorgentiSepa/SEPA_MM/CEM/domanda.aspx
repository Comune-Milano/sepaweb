...
document.onkeydown=$onkeydown;
		...
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="imgAnagrafe" runat="server" ImageUrl="~/NuoveImm/Img_Anagrafe.png"
                Style="z-index: 127; left: 328px; cursor: pointer; position: absolute; top: 29px" ToolTip="Anagrafe della popolazione" />
           ...
           <br />
            ...
            <asp:Label ID="Label12" runat="server" BackColor="#C0FFC0" BorderStyle="Solid" BorderWidth="1px"
                ...
                ToolTip="Visualizza tutti gli eventi di questa domanda" Visible="False" Width="109px"></asp:Label>
                        ...
                        <asp:ImageButton ID="btnSalva" runat="server" ImageUrl="~/NuoveImm/Img_Salva.png" OnClientClick="document.getElementById('H2').value=document.getElementById('H1').value;document.getElementById('H1').value=0;" style="z-index: 126; left: 9px; position: absolute; top: 29px" ToolTip="Salva" />
            <asp:ImageButton ID="imgStampa" runat="server" 
                ...
                style="z-index: 127; left: 64px; position: absolute; top: 29px" 
                ToolTip="Elabora e Stampa" /><img src="../NuoveImm/Img_Indici.png" id="IMG1" onclick="Indici()" style="cursor: pointer; z-index: 136; left: 145px; position: absolute; top: 29px;" alt="Indici" />&nbsp;
