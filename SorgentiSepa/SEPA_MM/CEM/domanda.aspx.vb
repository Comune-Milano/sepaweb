...
Partial Class VSA_domanda
    ...
    Private Function VisualizzaDomanda()
        ...
        Try
            ...
            par.cmd.CommandText = "SELECT BANDI_VSA.STATO,DOMANDE_BANDO_VSA.FL_RINNOVO FROM BANDI_VSA,DOMANDE_BANDO_VSA WHERE DOMANDE_BANDO_VSA.ID=" & lIdDomanda & " AND DOMANDE_BANDO_VSA.ID_BANDO=BANDI_VSA.ID"
            ...
            par.cmd.CommandText = "SELECT DICHIARAZIONI_VSA.ID_STATO  FROM DICHIARAZIONI_VSA,DOMANDE_BANDO_VSA WHERE DOMANDE_BANDO_VSA.ID=" & lIdDomanda & " AND DOMANDE_BANDO_VSA.ID_DICHIARAZIONE=DICHIARAZIONI_VSA.ID"
            ...
            If myReader.Read() Then
                ...
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF1", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=0 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF2", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=1 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF3", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=2 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF4", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=3 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF5", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=4 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF6", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=5 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Familiari1, par.OracleConn, "cmbF7", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=6 order by id asc", "DESCRIZIONE", "ID")


                par.RiempiDListC(Dom_Abitative_1_1, par.OracleConn, "cmbA1", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=7 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_1_1, par.OracleConn, "cmbA2", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=8 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_1_1, par.OracleConn, "cmbA3", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=9 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_1_1, par.OracleConn, "cmbA4", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=10 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_1_1, par.OracleConn, "cmbA5", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=11 order by id asc", "DESCRIZIONE", "ID")

                par.RiempiDListC(Dom_Abitative_2_1, par.OracleConn, "cmbA6", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=12 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_2_1, par.OracleConn, "cmbA7", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=13 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_2_1, par.OracleConn, "cmbA8", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=14 order by id asc", "DESCRIZIONE", "ID")
                par.RiempiDListC(Dom_Abitative_2_1, par.OracleConn, "cmbA9", "select DESCRIZIONE,ID from parametri_bando_VSA where id_bando=" & lIndice_Bando & " and tipo_parametro=15 order by id asc", "DESCRIZIONE", "ID")
    ...
    Private Function NuovaDomanda()
        ...
        Try
            ...
            par.cmd.CommandText = "INSERT INTO DOMANDE_BANDO_VSA (ID,FL_PRATICA_CHIUSA,ID_STATO,N_DISTINTA,FL_CONFERMA_SCARICO,TIPO_PRATICA) VALUES (SEQ_DOMANDE_BANDO_VSA.NEXTVAL,'0','1',0,'0'," & lBando & ")"
            par.cmd.ExecuteNonQuery()
    ...
    Protected Sub btnSalva_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSalva.Click
        ...
        Try
            ...
            If CType(Dom_Alloggio_ERP1.FindControl("txtCognome"), TextBox).Text = "" Or CType(Dom_Alloggio_ERP1.FindControl("txtNome"), TextBox).Text = "" Or CType(Dom_Alloggio_ERP1.FindControl("txtCF"), TextBox).Text = "" Then
                Response.Write("<script>alert('Attenzione...Verificare i campi relativi l\'intestatario del contratto siano valorizzati! Risolvere il problema prima di salvare e stampare la domanda.')</script>")
                imgStampa.Enabled = False
                imgStampa.ImageUrl = "../NuoveImm/Img_No_Stampa.png"
                Exit Try
            End If
            ...
            If CType(Dom_Dichiara_Cambi1.FindControl("cmbPresentaD"), DropDownList).SelectedItem.Value = -1 Then
                Response.Write("<script>alert('Attenzione...Verificare il campo <Tipologia Domanda> sia valorizzato! Risolvere il problema prima di salvare e stampare la domanda.')</script>")
                imgStampa.Enabled = False
                imgStampa.ImageUrl = "../NuoveImm/Img_No_Stampa.png"
                Exit Try
            End If
            ...
            sStringaSql = "UPDATE DOMANDE_BANDO_VSA SET ID_BANDO=" & lIndice_Bando _
            ...
            If lProgr <> 0 Then
                If CType(Dom_Richiedente1.FindControl("cmbNazioneRes"), DropDownList).SelectedItem.Text = "ITALIA" Then
                    sStringaSql = "UPDATE COMP_NAS_RES_VSA SET CAP_RES='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtCAPRes"), TextBox).Text) & "',ID_LUOGO_RES_DNTE=" & CType(Dom_Richiedente1.FindControl("cmbComuneRes"), DropDownList).SelectedItem.Value & ",ID_TIPO_IND_RES_DNTE=" & CType(Dom_Richiedente1.FindControl("cmbTipoIRes"), DropDownList).SelectedItem.Value & ",IND_RES_DNTE='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtIndRes"), TextBox).Text) & "',CIVICO_RES_DNTE='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtCivicoRes"), TextBox).Text) & "',TELEFONO_DNTE='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtTelRes"), TextBox).Text) & "' WHERE ID_COMPONENTE=" & lIndice_Componente
                    par.cmd.CommandText = sStringaSql
                    par.cmd.ExecuteNonQuery()
                Else
                    sStringaSql = "UPDATE COMP_NAS_RES_VSA SET CAP_RES='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtCAPRes"), TextBox).Text) & "',ID_LUOGO_RES_DNTE=" & CType(Dom_Richiedente1.FindControl("cmbNazioneRes"), DropDownList).SelectedItem.Value & ",ID_TIPO_IND_RES_DNTE=" & CType(Dom_Richiedente1.FindControl("cmbTipoIRes"), DropDownList).SelectedItem.Value & ",IND_RES_DNTE='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtIndRes"), TextBox).Text) & "',CIVICO_RES_DNTE='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtCivicoRes"), TextBox).Text) & "',TELEFONO_DNTE='" & par.PulisciStrSql(CType(Dom_Richiedente1.FindControl("txtTelRes"), TextBox).Text) & "' WHERE ID_COMPONENTE=" & lIndice_Componente
                    par.cmd.CommandText = sStringaSql
                    par.cmd.ExecuteNonQuery()
                End If
            End If
    ...
    Private Function CalcolaStampa()
        ...
        Try
            ...
            'If Valore > 0 Then
            '    par.cmd.CommandText = "select comunale,regionale from  parametri_bando_VSA where id=" & Valore
            '    myReader = par.cmd.ExecuteReader()
            '    If myReader.Read() Then
            ...
            SstringaSql = SstringaSql & "" & vbCrLf
            SstringaSql = SstringaSql & "&nbsp;" & vbCrLf
            SstringaSql = SstringaSql & "<p>" & DATI_BANDO & "&nbsp;</P><P>" & protocollo & " / " & Session.Item("OPERATORE") & "</p>" & vbCrLf
            ...
            Select Case CType(Dom_Dichiara_Cambi1.FindControl("cmbPresentaD"), DropDownList).SelectedItem.Value
                Case 0
                    SstringaSql = SstringaSql & "ai sensi dell’Art. 22 RR 10 febbraio 2004 n.1, LA VOLTURA del contratto per l'alloggio Erp attualmente assegnato." & vbCrLf

                Case 1
                    SstringaSql = SstringaSql & "ai sensi dell’Art. 22 RR 10 febbraio 2004 n.1, il SUBENTRO dell’alloggio Erp attualmente assegnato." & vbCrLf

                Case 2
                    SstringaSql = SstringaSql & "ai sensi dell’Art. 22 RR 10 febbraio 2004 n.1, l'AMPLIAMENTO dell’alloggio Erp attualmente assegnato." & vbCrLf
            ...
            SstringaSql = SstringaSql & "<tr><td><table cellpadding='2' cellspacing='0' style=" & Chr(34) & "width: 117%" & Chr(34) & "><TBODY>"
            ...
            SstringaSql = SstringaSql & "DELL'ISEE-erp </font></b>" & sISEE_ERP & "</td>   </table><table border='0' cellpadding='0' cellspacing='5' width='90%' height='66'><tr><td width='75%' height='23'><b><font face='Arial' size='2'>Risultati intermedi" & vbCrLf
            SstringaSql = SstringaSql & "</font></b>" & RISULTATI_INTERMEDI & "</td>   </table><table border='0' cellpadding='0' cellspacing='5' width='90%' height='66'><tr><td width='75%' height='23'><b><font face='Arial' size='2'>" & vbCrLf
            SstringaSql = SstringaSql & "</font></b></td>      <P><P>" & Motivo & "<p><font face='Arial' size='2'>La presente domanda è stata valutata sulla base della dichiarazione sostitutiva unica con numero protocollo" & vbCrLf
            ...
            If Fl_DerogaInCorso = "" Then
                If ESCLUSIONE = "" Then
                    ...
                    If FL_VECCHIO_BANDO = "1" Then
                        par.cmd.CommandText = "update domande_bando_vsa set FL_COMPLETA='1',FL_RINNOVO='0'," _
                                            & "ID_VECCHIO_STATO='',ID_TIPO_CONTENZIOSO=NULL," _
                                            & "FL_ISTRUTTORIA_COMPLETA='1',ID_STATO='7a'," _
                                            & "FL_ESAMINATA='1',ISE_ERP=" & par.VirgoleInPunti(ISE_ERP) _
                                            & ",ISR_ERP=" & par.VirgoleInPunti(ISR_ERP) & ",ISP_ERP=" _
            ...
            lblISBAR.Text = par.Converti(ISEE_ERP)
