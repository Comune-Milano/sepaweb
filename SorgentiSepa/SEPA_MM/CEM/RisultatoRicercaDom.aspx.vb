...
Partial Class VSA_RisultatoRicercaDom
    ...
    Private Sub Cerca()
        ...
        Else
            ...
            bTrovato = True
            sStringaSql = sStringaSql & " (DOMANDE_BANDO_vsa.ID_STATO='1' or DOMANDE_BANDO_vsa.ID_STATO='2' or DOMANDE_BANDO_vsa.ID_STATO='4' or DOMANDE_BANDO_vsa.ID_STATO='7a') "
        ...
        If sValoreBA <> "" Then
            ...
            bTrovato = True
            sStringaSql = sStringaSql & " DOMANDE_BANDO_vsa.ID_CAUSALE_DOMANDA" & sCompara & "'" & par.PulisciStrSql(sValore) & "' "
        End If

        sStringaSQL1 = "SELECT DOMANDE_BANDO_VSA.ID,COMP_NUCLEO_VSA.COGNOME,COMP_NUCLEO_VSA.NOME,COMP_NUCLEO_VSA.COD_FISCALE," _
