<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoRicercaD.aspx.vb" Inherits="VSA_RisultatoRicercaD" %>
	...
	<body bgColor="#f2f5f1">
		<form id="Form1" method="post" runat="server">
			<asp:datagrid id="DataGrid1" runat="server" Font-Names="Arial" 
                ...
                PageSize="20" style="z-index: 101; left: 3px; position: absolute; top: 68px" 
            ...
            <table style="left: 0px; background-image: url(../NuoveImm/SfondoMaschere.jpg); width: 674px;
                ...
                <tr>
                    <td>
                        ...
                        <br />
                        <br />
                        <asp:TextBox ID="TextBox7" runat="server" BorderWidth="0px" Font-Bold="True" 
                            Font-Names="arial" Font-Size="12pt" ReadOnly="True" Width="657px">Nessuna Selezione</asp:TextBox>
                        <br />
                        <br />
            ...
            &nbsp;<asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                ...
                Style="z-index: 103; left: 539px; position: absolute; top: 492px; height: 20px;" 
                ToolTip="Home" />
            <asp:ImageButton ID="btnVisualizza" runat="server" ImageUrl="~/NuoveImm/Img_Visualizza.png"
                Style="z-index: 104; left: 225px; position: absolute; top: 492px" ToolTip="Visualizza" />
            <asp:ImageButton ID="btnRicerca" runat="server" ImageUrl="~/NuoveImm/Img_NuovaRicerca.png"
                Style="z-index: 105; left: 405px; position: absolute; top: 492px" ToolTip="Nuova Ricerca" />
                        </form>
	</body>
