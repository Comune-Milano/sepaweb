<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ServiziComuni_CE.aspx.vb" Inherits="MANUTENZIONI_ServiziComuni_CE" %>
...
<body bgcolor="#ffffff" text="#ede0c0">
    ...
    <div>
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
            ForeColor="Black" Style="z-index: 100; left: 24px; position: absolute; top: 32px">TIPOLOGIA SERVIZI </asp:Label>
        <asp:DropDownList ID="cmbTipoServizi" runat="server" AutoPostBack="True" BackColor="White"
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/NuoveImm/Img_Salva.png"
            Style="left: 184px; position: absolute; top: 147px" ToolTip="Salva" />
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/NuoveImm/Img_Esci.png"
            Style="left: 255px; position: absolute; top: 147px" ToolTip="Esci" />
