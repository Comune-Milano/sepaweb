<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Consistenza_CE.aspx.vb" Inherits="MANUTENZIONI_MiniConsEdifici" %>
...
<body bgcolor="white" text="#ede0c0">
    ...
    <div>
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
            ForeColor="Black" Style="z-index: 100; left: 24px; position: absolute; top: 32px">TIPOLOGIA CONSISTENZA</asp:Label>
        <asp:DropDownList ID="cmbTipocONS" runat="server" AutoPostBack="True" BackColor="White"
        ...
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/NuoveImm/Img_Esci.png"
            Style="left: 249px; position: absolute; top: 147px" ToolTip="Esci" />
