<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni_Interventi.aspx.vb" Inherits="MANUTENZIONI_menufunzioniInterventi" %>
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image2" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                Style="left: 642px; position: absolute; top: 33px" Width="4px" />
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_MANUTENZIONI.png" Style="left: 26px;
                position: absolute; top: 3px" />
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" Style="left: 649px; position: absolute; top: 33px" ToolTip="Chiudi Applicazione">X</asp:LinkButton><asp:Image ID="Image4" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                Style="left: 601px; position: absolute; top: 33px" Width="4px" />
            <asp:LinkButton ID="LinkButton2" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" Style="left: 608px; position: absolute; top: 33px">Menù</asp:LinkButton>
        </form>
		<script type="text/javascript">
		function spegni()
		{
