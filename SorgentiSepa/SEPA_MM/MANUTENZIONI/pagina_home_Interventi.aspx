<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pagina_home_Interventi.aspx.vb" Inherits="MANUTENZIONI_pagina_home_Interventi" %>
...
//-->
	...
	<body background="../NuoveImm/sfondocopertina.jpg" onload="document.getElementById('txtmessaggio').style.visibilty='hidden';">
		<form id="Form1" method="post" runat="server">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:TextBox ID="scorrevole" runat="server" Style="z-index: 102; left: 726px; position: absolute;
                top: 357px" Width="74px" BackColor="White" BorderColor="#E0E0E0" BorderStyle="None" Font-Names="ARIAL" Font-Size="8pt" ReadOnly="True" Font-Bold="True" Height="11px" ForeColor="#404040"></asp:TextBox>
            <asp:TextBox ID="txtmessaggio" runat="server" Style="left: 742px; position: absolute;
                top: 411px; z-index: 103;" Height="10px" Width="7px"></asp:TextBox>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp;
