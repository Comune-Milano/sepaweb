<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pagina_home.aspx.vb" Inherits="PED_pagina_home" %>
...
//-->
	...
	<body background="../NuoveImm/sfondocopertina.jpg" onload="document.getElementById('txtmessaggio').style.visibilty='hidden';">
		<form id="Form1" method="post" runat="server">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:TextBox ID="scorrevole" runat="server" Style="z-index: 102; left: 706px; position: absolute;
                top: 378px" Width="74px" BackColor="White" BorderColor="#E0E0E0" BorderStyle="None" Font-Names="ARIAL" Font-Size="8pt" ReadOnly="True" Font-Bold="True" Height="11px" ForeColor="#404040"></asp:TextBox>
            <asp:TextBox ID="txtmessaggio" runat="server" Style="left: 739px; position: absolute;
                top: 440px; z-index: 103;" Height="10px" Width="7px"></asp:TextBox>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp;
