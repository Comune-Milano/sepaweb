<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ImpComuni_CE.aspx.vb" Inherits="MANUTENZIONI_ImpComuni_CE" %>
...
<body bgcolor="#ffffff" text="#ede0c0">
    ...
    <div>
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
            ForeColor="Black" Style="z-index: 100; left: 24px; position: absolute; top: 32px">TIPOLOGIA IMPIANTI COMUNI</asp:Label>
        <asp:DropDownList ID="cmbTipoImpComu" runat="server" AutoPostBack="True" BackColor="White"
        ...
        <asp:TextBox ID="txtQuantita" runat="server" BorderStyle="Solid" BorderWidth="1px"
            Font-Names="arial" Font-Size="10pt" MaxLength="3" Style="z-index: 102; left: 80px;
            position: absolute; top: 88px" Width="56px" TabIndex="1"></asp:TextBox>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtQuantita"
            ...
            top: 88px" ValidationExpression="\d{0,3}" Width="1px">!</asp:RegularExpressionValidator>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp;
        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/NuoveImm/Img_Salva.png"
            Style="left: 184px; position: absolute; top: 147px" ToolTip="Salva" TabIndex="2" />
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/NuoveImm/Img_Esci.png"
            Style="left: 255px; position: absolute; top: 147px" ToolTip="Esci" TabIndex="3" />
