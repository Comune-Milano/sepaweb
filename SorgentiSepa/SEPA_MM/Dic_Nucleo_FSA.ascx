<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Dic_Nucleo_FSA.ascx.vb" Inherits="Dic_Nucleo_FSA" %>
...
window.showModalDialog("com_nucleo.aspx?OP=0&PR=" + a,window,'status:no;dialogWidth:433px;dialogHeight:340px;dialogHide:true;help:no;scroll:no');
}
...
else
{
    ...
    window.showModalDialog("com_nucleo.aspx?OP=1&RI=" + obj1.selectedIndex + "&COGNOME=" + cognome + "&NOME=" + nome + "&DATA=" + data + "&CF=" + cf + "&PARENTI=" + parenti + "&INV=" + inv + "&ASL=" + asl + "&ACC=" + acc + "&TESTO=" + obj1.options[obj1.selectedIndex].text + "&PR="  + a,'','status:no;dialogWidth:433px;dialogHeight:340px;dialogHide:true;help:no;scroll:no');
}
}
...
<div id="nuc" style="border-right: lightsteelblue 1px solid; border-top: lightsteelblue 1px solid;
    ...
    <p>
        ...
        &nbsp;</p>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <asp:Button ID="Button1" runat="server" Style="left: 591px; position: absolute;
        top: 141px; z-index: 101;" Text="+" Width="38px" TabIndex="19" ToolTip="Aggiungi Elemento" Visible="False" />
    <p>
        ...
        <asp:Button ID="Button3" runat="server" Style="left: 593px; position: absolute;
            top: 120px; z-index: 103;" Text="/" Width="38px" TabIndex="20" ToolTip="Modifica Elemento" Visible="False" /><asp:Button ID="Button2" runat="server" Style="left: 591px; position: absolute;
            top: 85px; z-index: 104;" Text="-" Width="38px" TabIndex="22" ToolTip="Elimina Elemento" />
        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
    </p>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <p style="z-index: 114; left: 0px; position: absolute; top: 0px">
        ...
        <asp:Label ID="Label2" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
            Font-Size="8pt" Height="18px" Style="left: 4px; position: absolute;
            top: 210px" Width="633px">SPESE DOCUMENTATE SUPERIORI A 10.000 Euro (solo componenti con indennità accompagnamento)</asp:Label>
        <asp:Label ID="Label14" runat="server" CssClass="CssLabel" Font-Bold="False" Font-Names="arial"
            Font-Size="8pt" Height="18px" Style="left: 4px; position: absolute; top: 164px"
            Width="255px">Num. di portatori di handicap psicofisico permanente</asp:Label>
        <asp:Label ID="Label15" runat="server" CssClass="CssLabel" Font-Bold="False" Font-Names="arial"
            Font-Size="8pt" Height="18px" Style="left: 5px; position: absolute; top: 185px"
            Width="90px">Singolo Genitore</asp:Label>
        <asp:Label ID="Label16" runat="server" CssClass="CssLabel" Font-Bold="False" Font-Names="arial"
            Font-Size="8pt" Height="18px" Style="left: 152px; position: absolute; top: 185px"
            Width="276px">Entrambi Genitori svolgono attività di  lavoro o di impresa</asp:Label>
        &nbsp; &nbsp; &nbsp;&nbsp;
        </p>
    <div style="border-right: 1px solid; border-top: 1px solid; left: 7px;
        overflow: auto; border-left: 1px solid; width: 573px; border-bottom: 1px solid;
        position: absolute; top: 32px; height: 126px; z-index: 113;">
        <asp:ListBox ID="ListBox1" runat="server" Font-Names="Courier New" Font-Size="8pt"
            Height="107px" Style="left: 0px; position: absolute; top: 18px; border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; z-index: 124;"
            Width="899px" Rows="7"></asp:ListBox>
    ...
    &nbsp;
    <asp:ListBox ID="ListBox2" runat="server" Height="62px" Style="left: 6px;
        position: absolute; top: 246px; z-index: 106;" Width="572px" Font-Names="Courier New" Font-Size="8pt"></asp:ListBox>
    <asp:Button ID="Button5" runat="server" Style="left: 590px; position: absolute;
            top: 246px; z-index: 107;" Text="/" Width="38px" ToolTip="Modifica Elemento" />
    <asp:Label ID="Label11" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
        Style="z-index: 108; left: 12px; position: absolute; top: 228px" Text="COMPONENTE"
        Width="51px"></asp:Label>
    <asp:Label ID="Label12" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
        Style="z-index: 109; left: 380px; position: absolute; top: 228px" Text="IMPORTO"
        Width="51px"></asp:Label>
    <asp:Label ID="Label13" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
        Style="z-index: 110; left: 455px; position: absolute; top: 228px" Text="DESCRIZIONE"
        Width="51px"></asp:Label>
    &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
    ...
    <asp:TextBox ID="txtPsico" runat="server" Columns="7" CssClass="CssMaiuscolo" Font-Bold="True"
        Font-Names="TIMES" Font-Size="8pt" ForeColor="Blue" Height="20px" MaxLength="10"
        Style="z-index: 118; left: 262px; position: absolute; top: 162px" TabIndex="1"
        Width="25px">0</asp:TextBox>
    &nbsp;&nbsp;
    <asp:DropDownList ID="cmbSingolo" runat="server" AutoPostBack="True" CssClass="CssProv"
        Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="#0000C0"
        Height="20px" Style="z-index: 121; left: 99px; position: absolute; top: 184px"
        TabIndex="9" Width="45px">
        <asp:ListItem Selected="True" Value="0">SI</asp:ListItem>
        <asp:ListItem Value="1">NO</asp:ListItem>
        <asp:ListItem Value="9">--</asp:ListItem>
    </asp:DropDownList>
    <asp:DropDownList ID="cmbEntrambi" runat="server" AutoPostBack="True" CssClass="CssProv"
        Font-Bold="False" Font-Names="Times New Roman" Font-Size="8pt" ForeColor="#0000C0"
        Height="20px" Style="z-index: 121; left: 430px; position: absolute; top: 184px"
        TabIndex="9" Width="45px">
