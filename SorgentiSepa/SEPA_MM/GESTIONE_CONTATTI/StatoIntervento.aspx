<%@ Page Title="" Language="VB" MasterPageFile="HomePage.master"
    AutoEventWireup="false" CodeFile="StatoIntervento.aspx.vb" Inherits="GESTIONE_CONTATTI_StatoIntervento" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="View2" runat="server">
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <asp:DataGrid runat="server" ID="DataGridRptTipo" AutoGenerateColumns="False" CellPadding="2"
        ...
        <asp:View ID="View4" runat="server">
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                ToolTip="Esporta in Excel" />
                    ...
                    <td>
                     <asp:Button ID="btnIndietro" runat="server" CssClass="bottone" Text="Indietro"
                ToolTip="Indietro" />
                    </td>
                </tr>
            </table>
