...
Partial Class GESTIONE_CONTATTI_AgendaGestioneContatti
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If provenienza.Value = "SEG" Then
                ...
                btnSettimana.Enabled = False
                btnGiorno.Enabled = False
            Else
                btnIndietroSegnalazione.Visible = False
                btnSettimana.Enabled = True
                btnGiorno.Enabled = True
            End If
    ...
    Private Function TrovaAppuntamentoGiornaliero(ByVal Giorno As Integer, ByVal Appuntamento As Integer) As Boolean
        Try
            ...
            Dim dat As String = Format(CInt(AnnoSelezionato.Value), "0000") & Format(CInt(MeseSelezionato.Value), "00") & Format(CInt(Giorno), "00")
    ...
    Protected Sub btnGiorno_Click(sender As Object, e As System.EventArgs) Handles btnGiorno.Click
        ...
        Catch ex As Exception
            Session.Add("ERRORE", "Provenienza: Agenda e Segnalazioni - Agenda - btnGiorno_Click - " & ex.Message)
            Response.Redirect("../Errore.aspx", False)
        End Try
    End Sub
