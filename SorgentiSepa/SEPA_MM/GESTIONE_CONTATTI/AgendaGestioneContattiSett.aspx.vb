...
Partial Class GESTIONE_CONTATTI_AgendaGestioneContattiSett
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                settaIndirizzi()
                GiornoSelezionato.Value = Format(Now, "dd")
                MeseSelezionato.Value = Format(Now, "MM")
                AnnoSelezionato.Value = Format(Now, "yyyy")
                Dim dataOdierna As Date = CDate(GiornoSelezionato.Value & "/" & MeseSelezionato.Value & "/" & AnnoSelezionato.Value)
                Select Case dataOdierna.DayOfWeek
                    Case 0
                        dataOdierna = dataOdierna.AddDays(-6)
                    Case 1
                        dataOdierna = dataOdierna.AddDays(0)
                    Case 2
                        dataOdierna = dataOdierna.AddDays(-1)
                    Case 3
                        dataOdierna = dataOdierna.AddDays(-2)
                    Case 4
                        dataOdierna = dataOdierna.AddDays(-3)
                    Case 5
                        dataOdierna = dataOdierna.AddDays(-4)
                    Case 6
                        dataOdierna = dataOdierna.AddDays(-5)
                End Select
                GiornoSelezionato.Value = dataOdierna.ToString("dd")
                MeseSelezionato.Value = dataOdierna.ToString("MM")
                AnnoSelezionato.Value = dataOdierna.ToString("yyyy")
    ...
    Private Sub SettaMese()
        Try
            ...
            'Dim PrimoGiorno As Integer = dataIniziale.DayOfWeek
            Dim dataInizio As Date = dataIniziale
            'Dim dataFine As Date = dataIniziale.AddDays(7)
            'Select Case PrimoGiorno
            '    Case 0
            '        dataInizio = dataIniziale.AddDays(-6)
            '        dataFine = dataIniziale.AddDays(0)
            '    Case 1
            '        dataInizio = dataIniziale.AddDays(0)
            '        dataFine = dataIniziale.AddDays(6)
            '    Case 2
            '        dataInizio = dataIniziale.AddDays(-1)
            '        dataFine = dataIniziale.AddDays(5)
            '    Case 3
            '        dataInizio = dataIniziale.AddDays(-2)
            '        dataFine = dataIniziale.AddDays(4)
            '    Case 4
            '        dataInizio = dataIniziale.AddDays(-3)
            '        dataFine = dataIniziale.AddDays(3)
            '    Case 5
            '        dataInizio = dataIniziale.AddDays(-4)
            '        dataFine = dataIniziale.AddDays(2)
            '    Case 6
            '        dataInizio = dataIniziale.AddDays(-5)
            '        dataFine = dataIniziale.AddDays(1)
            'End Select
            'If dataInizio.Month <> dataIniziale.Month Then
            '    dataInizio = dataIniziale.AddDays(-dataIniziale.Day + 1)
            'End If
            'GiornoSelezionato.Value = dataInizio.Day
            'MeseSelezionato.Value = dataInizio.Month
            'AnnoSelezionato.Value = dataInizio.Year
            'If dataFine.Month <> dataIniziale.Month Then
            '    dataFine = dataIniziale.AddDays(Date.DaysInMonth(dataIniziale.Year, dataIniziale.Month) - dataIniziale.Day)
            'End If

            'Dim dataCiclo As Date = dataInizio
            'For i As Integer = PrimoGiorno To PrimoGiorno - 1 + Math.Min(7, dataFine.Day - dataInizio.Day + 1) Step 1
            '    CType(mpContentPlaceHolder.FindControl("BloccoData" & i), Label).Text = "&nbsp;" & dataCiclo.Day
            '    dataCiclo = dataCiclo.AddDays(1)
            '    If TrovaAppuntamentoGiornaliero(dataCiclo.Day, i) = False Then
            '        Exit Sub
            '    End If
            'Next
            ...
            For i As Integer = 1 To 7 Step 1
                CType(mpContentPlaceHolder.FindControl("BloccoData" & i), Label).Text = "&nbsp;" & dataCiclo.Day
                If TrovaAppuntamentoGiornaliero(dataCiclo.Day, i, dataCiclo.Month, dataCiclo.Year) = False Then
                    Exit Sub
                End If
                dataCiclo = dataCiclo.AddDays(1)
            Next
            ...
            'Dim GiorniMese As Integer = 7
            'Dim PrimoInserimentoGiorno As Boolean = True
            'Dim PrimoNumeroGiornoIniz As Integer = 1
            'Dim PrimoNumeroGiorno As Integer = 1
            'connData.apri(False)

            'Dim data As Date = CDate(GiornoSelezionato.Value & "/" & MeseSelezionato.Value & "/" & AnnoSelezionato.Value)
            'Dim dataInizio As Date = data
            'Dim dataFine As Date = data
            ...
            '            Case "lunedì"
            '                PrimoNumeroGiorno = 1
            '                PrimoNumeroGiornoIniz = 1
            '                dataInizio = data
            '                dataFine = data.AddDays(6)
            '                BloccoData1.Text = "&nbsp;" & i
            '            Case "martedì"
            '                PrimoNumeroGiorno = 2
            '                PrimoNumeroGiornoIniz = 2
            '                dataInizio = data.AddDays(-1)
            '                dataFine = data.AddDays(5)
            '                BloccoData2.Text = "&nbsp;" & i
            '            Case "mercoledì"
            '                PrimoNumeroGiorno = 3
            '                PrimoNumeroGiornoIniz = 3
            '                dataInizio = data.AddDays(-2)
            '                dataFine = data.AddDays(4)
            '                BloccoData3.Text = "&nbsp;" & i
            '            Case "giovedì"
            '                PrimoNumeroGiorno = 4
            '                PrimoNumeroGiornoIniz = 4
            '                dataInizio = data.AddDays(-3)
            '                dataFine = data.AddDays(3)
            '                BloccoData4.Text = "&nbsp;" & i
            '            Case "venerdì"
            '                PrimoNumeroGiorno = 5
            '                PrimoNumeroGiornoIniz = 5
            '                dataInizio = data.AddDays(-4)
            '                dataFine = data.AddDays(2)
            '                BloccoData5.Text = "&nbsp;" & i
            '            Case "sabato"
            '                PrimoNumeroGiorno = 6
            '                PrimoNumeroGiornoIniz = 6
            '                dataInizio = data.AddDays(-5)
            '                dataFine = data.AddDays(1)
            '                BloccoData6.Text = "&nbsp;" & i
            '            Case "domenica"
            '                PrimoNumeroGiorno = 7
            '                PrimoNumeroGiornoIniz = 7

            '                BloccoData7.Text = "&nbsp;" & i
            '        End Select
            '        PrimoInserimentoGiorno = False
            '    Else
            '        CType(mpContentPlaceHolder.FindControl("BloccoData" & i), Label).Text = "&nbsp;" & PrimoNumeroGiorno
            '    End If
            '    'If i >= CInt(GiornoSelezionato.Value) And i <= Math.Min(CInt(GiornoSelezionato.Value) + 6, CInt(DateTime.DaysInMonth(AnnoSelezionato.Value, MeseSelezionato.Value))) Then
            ...
            'Next
            connData.chiudi()
            lblMese.Text = par.AggiustaTestoUcFirst(Format(CDate(dataInizio.Day & "/" & dataInizio.Month & "/" & dataInizio.Year), "dd MMMM yyyy")) & " - " & par.AggiustaTestoUcFirst(Format(CDate(dataInizio.AddDays(6).Day & "/" & dataInizio.AddDays(6).Month & "/" & dataInizio.AddDays(6).Year), "dd MMMM yyyy"))
            SettaBlocchiVuoti(dataInizio)
        Catch ex As Exception
            Session.Add("ERRORE", "Provenienza: Agenda e Segnalazioni - Agenda - SettaMese - " & ex.Message)
            Response.Redirect("../Errore.aspx", False)
        End Try
    End Sub
    Private Function TrovaAppuntamentoGiornaliero(ByVal Giorno As Integer, ByVal Appuntamento As Integer, Optional ByVal Mese As Integer = 0, Optional ByVal Anno As Integer = 0) As Boolean
        Try
            Dim mpContentPlaceHolder As ContentPlaceHolder
            mpContentPlaceHolder = CType(Master.FindControl("CPContenuto"), ContentPlaceHolder)
            ...
            Dim tabellaOrari As String = "<table cellpadding=""1"" cellspacing=""1"" style=""width:200px;font-size:7pt"">"
            par.cmd.CommandText = "SELECT DESCRIZIONE_BREVE FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI WHERE ID_FILIALE = " & cmbStruttura.SelectedValue & " ORDER BY INDICE ASC"
            ...
            If dtSP.Rows.Count > 0 Then
                ...
                For Each rigaSP As Data.DataRow In dtSP.Rows
                    array(i) = rigaSP.Item("DESCRIZIONE_BREVE").ToString
                    i += 1
                Next
                tabellaOrari &= "<tr><td></td><td>" & array(0) & "</td><td>" & array(1) & "</td><td>" & array(2) & "</td><td>" & array(3) & "</td><tr>"
            Else
            tabellaOrari &= "<tr><td></td><td>SP1</td><td>SP2</td><td>SP3</td><td>SP4</td><tr>"
            End If

            Dim dat As String
            If Mese = 0 And Anno = 0 Then
                dat = Format(CInt(AnnoSelezionato.Value), "0000") & Format(CInt(MeseSelezionato.Value), "00") & Format(CInt(Giorno), "00")
            ElseIf Mese = 0 And Anno > 0 Then
                dat = Format(CInt(Anno), "0000") & Format(CInt(MeseSelezionato.Value), "00") & Format(CInt(Giorno), "00")
            ElseIf Mese > 0 And Anno = 0 Then
                dat = Format(CInt(AnnoSelezionato.Value), "0000") & Format(CInt(Mese), "00") & Format(CInt(Giorno), "00")
            ElseIf Mese > 0 And Anno > 0 Then
                dat = Format(CInt(Anno), "0000") & Format(CInt(Mese), "00") & Format(CInt(Giorno), "00")
            End If
            ...
            par.cmd.CommandText = " SELECT ORARIO," _
                ...
                & "     THEN ('style=""cursor:pointer;background-color:#B20000""') ELSE (CASE WHEN (SELECT COUNT(ID) FROM SISCOM_MI.APPUNTAMENTI_CALL_CENTER WHERE ID_STRUTTURA = " & cmbStruttura.SelectedValue & " " _
                ...
                & "     AND INDICE = 1))=0 THEN 'style=""cursor:pointer;background-color:Green""' ELSE 'style=""cursor:pointer;background-color:#DDDDDD""' END) END) AS SP1, " _
                & " (CASE WHEN (SELECT COUNT (ID) FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI_CHIUS WHERE ID_ORARIO = APPUNTAMENTI_ORARI.ID " _
                ...
                & "     AND DATA_APPUNTAMENTO = " & dat & " AND ID_ORARIO = APPUNTAMENTI_ORARI.ID AND DATA_ELIMINAZIONE IS NULL " _
                & "     AND ID_SPORTELLO IN (SELECT ID FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI WHERE APPUNTAMENTI_SPORTELLI.ID_FILIALE = " & cmbStruttura.SelectedValue & " " _
                & "     AND INDICE = 2))=0 THEN 'style=""cursor:pointer;background-color:Green""' ELSE 'style=""cursor:pointer;background-color:#DDDDDD""' END) END) AS SP2, " _
                & " (CASE WHEN (SELECT COUNT (ID) FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI_CHIUS WHERE ID_ORARIO = APPUNTAMENTI_ORARI.ID " _
                ...
                & "     AND DATA_APPUNTAMENTO = " & dat & " AND ID_ORARIO = APPUNTAMENTI_ORARI.ID AND DATA_ELIMINAZIONE IS NULL " _
                & "     AND ID_SPORTELLO IN (SELECT ID FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI WHERE APPUNTAMENTI_SPORTELLI.ID_FILIALE = " & cmbStruttura.SelectedValue & " " _
                & "     AND INDICE = 3))=0 THEN 'style=""cursor:pointer;background-color:Green""' ELSE 'style=""cursor:pointer;background-color:#DDDDDD""' END) END) AS SP3, " _
                & " (CASE WHEN (SELECT COUNT (ID) FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI_CHIUS WHERE ID_ORARIO = APPUNTAMENTI_ORARI.ID " _
                ...
                & "     AND DATA_APPUNTAMENTO = " & dat & " AND ID_ORARIO = APPUNTAMENTI_ORARI.ID AND DATA_ELIMINAZIONE IS NULL " _
                & "     AND ID_SPORTELLO IN (SELECT ID FROM SISCOM_MI.APPUNTAMENTI_SPORTELLI WHERE APPUNTAMENTI_SPORTELLI.ID_FILIALE = " & cmbStruttura.SelectedValue & " " _
                & "     AND INDICE = 4))=0 THEN 'style=""cursor:pointer;background-color:Green""' ELSE 'style=""cursor:pointer;background-color:#DDDDDD""' END) END) AS SP4 " _
            ...
            Dim stringaLinkIni = "onclick=""javascript:validNavigation=true;DettagliAppuntamenti('" & Format(CInt(Giorno), "00") & "', '" & Format(CInt(MeseSelezionato.Value), "00") & "', '" & Format(CInt(AnnoSelezionato.Value), "0000") & "'," & cmbStruttura.SelectedValue & "," & idSegnalazione.Value
            Dim stringaLinkFin = ");"""

            tabellaOrari &= "<tr><td>" & dt.Rows(0).Item("ORARIO") & "</td><td " & stringaLinkIni & ",1,1" & stringaLinkFin & " " & dt.Rows(0).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",1,2" & stringaLinkFin & " " & dt.Rows(0).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",1,3" & stringaLinkFin & " " & dt.Rows(0).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",1,4" & stringaLinkFin & " " & dt.Rows(0).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(1).Item("ORARIO") & "</td><td " & stringaLinkIni & ",2,1" & stringaLinkFin & " " & dt.Rows(1).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",2,2" & stringaLinkFin & " " & dt.Rows(1).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",2,3" & stringaLinkFin & " " & dt.Rows(1).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",2,4" & stringaLinkFin & " " & dt.Rows(1).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(2).Item("ORARIO") & "</td><td " & stringaLinkIni & ",3,1" & stringaLinkFin & " " & dt.Rows(2).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",3,2" & stringaLinkFin & " " & dt.Rows(2).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",3,3" & stringaLinkFin & " " & dt.Rows(2).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",3,4" & stringaLinkFin & " " & dt.Rows(2).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(3).Item("ORARIO") & "</td><td " & stringaLinkIni & ",4,1" & stringaLinkFin & " " & dt.Rows(3).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",4,2" & stringaLinkFin & " " & dt.Rows(3).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",4,3" & stringaLinkFin & " " & dt.Rows(3).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",4,4" & stringaLinkFin & " " & dt.Rows(3).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(4).Item("ORARIO") & "</td><td " & stringaLinkIni & ",5,1" & stringaLinkFin & " " & dt.Rows(4).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",5,2" & stringaLinkFin & " " & dt.Rows(4).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",5,3" & stringaLinkFin & " " & dt.Rows(4).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",5,4" & stringaLinkFin & " " & dt.Rows(4).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(5).Item("ORARIO") & "</td><td " & stringaLinkIni & ",6,1" & stringaLinkFin & " " & dt.Rows(5).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",6,2" & stringaLinkFin & " " & dt.Rows(5).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",6,3" & stringaLinkFin & " " & dt.Rows(5).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",6,4" & stringaLinkFin & " " & dt.Rows(5).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(6).Item("ORARIO") & "</td><td " & stringaLinkIni & ",7,1" & stringaLinkFin & " " & dt.Rows(6).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",7,2" & stringaLinkFin & " " & dt.Rows(6).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",7,3" & stringaLinkFin & " " & dt.Rows(6).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",7,4" & stringaLinkFin & " " & dt.Rows(6).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(7).Item("ORARIO") & "</td><td " & stringaLinkIni & ",8,1" & stringaLinkFin & " " & dt.Rows(7).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",8,2" & stringaLinkFin & " " & dt.Rows(7).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",8,3" & stringaLinkFin & " " & dt.Rows(7).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",8,4" & stringaLinkFin & " " & dt.Rows(7).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(8).Item("ORARIO") & "</td><td " & stringaLinkIni & ",9,1" & stringaLinkFin & " " & dt.Rows(8).Item("SP1") & ">&nbsp;</td><td  " & stringaLinkIni & ",9,2" & stringaLinkFin & " " & dt.Rows(8).Item("SP2") & ">&nbsp;</td><td  " & stringaLinkIni & ",9,3" & stringaLinkFin & " " & dt.Rows(8).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",9,4" & stringaLinkFin & " " & dt.Rows(8).Item("SP4") & ">&nbsp;</td><tr>"
            tabellaOrari &= "<tr><td>" & dt.Rows(9).Item("ORARIO") & "</td><td " & stringaLinkIni & ",10,1" & stringaLinkFin & "  " & dt.Rows(9).Item("SP1") & ">&nbsp;</td><td " & stringaLinkIni & ",10,2" & stringaLinkFin & " " & dt.Rows(9).Item("SP2") & ">&nbsp;</td><td " & stringaLinkIni & ",10,3" & stringaLinkFin & " " & dt.Rows(9).Item("SP3") & ">&nbsp;</td><td " & stringaLinkIni & ",10,4" & stringaLinkFin & " " & dt.Rows(9).Item("SP4") & ">&nbsp;</td><tr>"
    ...
    Private Sub PulisciBloccoDate()
        ...
        End Try
    End Sub
    Private Sub SettaBlocchiVuoti(ByVal dataInizio As Date)
        Try
            Dim mpContentPlaceHolder As ContentPlaceHolder
            mpContentPlaceHolder = CType(Master.FindControl("CPContenuto"), ContentPlaceHolder)
    ...
    Protected Sub btnMese_Click(sender As Object, e As System.EventArgs) Handles btnMese.Click
        ...
        End Try
    End Sub
    Protected Sub btnGiorno_Click(sender As Object, e As System.EventArgs) Handles btnGiorno.Click
        Try
    ...
    Protected Sub btnIndietro_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnIndietro.Click
        Try
            Dim DataIndietro As Date = CDate(GiornoSelezionato.Value & "/" & MeseSelezionato.Value & "/" & AnnoSelezionato.Value).AddDays(-7)
            'Select Case DataIndietro.DayOfWeek
            '    Case 0
            '        DataIndietro = DataIndietro.AddDays(-6)
            '    Case 1
            '        DataIndietro = DataIndietro.AddDays(-7)
            '    Case 2
            '        DataIndietro = DataIndietro.AddDays(-1)
            '    Case 3
            '        DataIndietro = DataIndietro.AddDays(-2)
            '    Case 4
            '        DataIndietro = DataIndietro.AddDays(-3)
            '    Case 5
            '        DataIndietro = DataIndietro.AddDays(-4)
            '    Case 6
            '        DataIndietro = DataIndietro.AddDays(-5)
            'End Select
            ...
            'If MeseSelezionato.Value.PadLeft(2, "0") <> MeseSelezionatoPrec.Value.PadLeft(2, "0") Then
            '    GiornoSelezionato.Value = CInt(DateTime.DaysInMonth(AnnoSelezionato.Value, MeseSelezionato.Value)) - 6
            '    DataIndietro = CDate(GiornoSelezionato.Value & "/" & MeseSelezionato.Value & "/" & AnnoSelezionato.Value)
            '    MeseSelezionatoPrec.Value = MeseSelezionato.Value
            'End If
            SettaMese()
            CalcolaQuattroSlotDisponibili()
        Catch ex As Exception
    ...
    Protected Sub btnAvanti_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnAvanti.Click
        Try
            Dim DataAvanti As Date = CDate(GiornoSelezionato.Value & "/" & MeseSelezionato.Value & "/" & AnnoSelezionato.Value).AddDays(7)
            'MeseSelezionatoPrec.Value = MeseSelezionato.Value
            'Select Case DataAvanti.DayOfWeek
            '    Case 0
            '        DataAvanti = DataAvanti.AddDays(1)
            '    Case 1
            '        DataAvanti = DataAvanti.AddDays(7)
            '    Case 2
            '        DataAvanti = DataAvanti.AddDays(6)
            '    Case 3
            '        DataAvanti = DataAvanti.AddDays(5)
            '    Case 4
            '        DataAvanti = DataAvanti.AddDays(4)
            '    Case 5
            '        DataAvanti = DataAvanti.AddDays(3)
            '    Case 6
            '        DataAvanti = DataAvanti.AddDays(2)
            'End Select
            ...
            'If MeseSelezionato.Value.PadLeft(2, "0") <> MeseSelezionatoPrec.Value.PadLeft(2, "0") Then
            '    GiornoSelezionato.Value = 1
            '    DataAvanti = CDate(GiornoSelezionato.Value & "/" & MeseSelezionato.Value & "/" & AnnoSelezionato.Value)
            '    MeseSelezionatoPrec.Value = MeseSelezionato.Value
            'End If
            SettaMese()
            CalcolaQuattroSlotDisponibili()
