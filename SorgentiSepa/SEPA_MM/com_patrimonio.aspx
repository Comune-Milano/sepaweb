<%@ Page Language="VB" AutoEventWireup="false" CodeFile="com_patrimonio.aspx.vb" Inherits="com_patrimonio" %>
...
<body bgcolor="lightsteelblue">
    ...
    <div>
        ...
        <asp:TextBox ID="txtABI" runat="server" Columns="5" CssClass="CssMaiuscolo" Font-Bold="False"
            ...
            left: 89px; position: absolute; top: 91px" TabIndex="2" Width="237px"></asp:TextBox>
        &nbsp;&nbsp;
