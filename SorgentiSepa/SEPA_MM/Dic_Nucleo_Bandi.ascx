<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Dic_Nucleo_Bandi.ascx.vb" Inherits="Dic_Nucleo" %>
...
window.showModalDialog("com_nucleo_bandi.aspx?OP=0&PR=" + a,window,'status:no;dialogWidth:433px;dialogHeight:400px;dialogHide:true;help:no;scroll:no');
}
...
else
{
    ...
    datacert = str.substring(124, 134);
    window.showModalDialog("com_nucleo_bandi.aspx?DATACERT=" + datacert + "&OP=1&RI=" + obj1.selectedIndex + "&COGNOME=" + cognome + "&NOME=" + nome + "&DATA=" + data + "&CF=" + cf + "&PARENTI=" + parenti + "&INV=" + inv + "&ASL=" + asl + "&ACC=" + acc + "&TESTO=" + obj1.options[obj1.selectedIndex].text + "&PR="  + a,'','status:no;dialogWidth:433px;dialogHeight:400px;dialogHide:true;help:no;scroll:no');
}
}
...
else
{
    ...
    descrizione=str.substring(63,163);
    window.showModalDialog("com_spese_bandi.aspx?RI=" + obj1.selectedIndex + "&CM=" + componente + "&IM=" + importo + "&DS=" + descrizione,'','status:no;dialogWidth:433px;dialogHeight:250px;dialogHide:true;help:no;scroll:no');
}
}
...
<div id="nuc" style="border: 1px solid lightsteelblue; z-index: 190; left: 10px; width: 641px;
    position: absolute; top: 106px; height: 400px;
    ...
    <p>
        ...
        <asp:Button ID="Button3" runat="server" Style="left: 593px; position: absolute;
            top: 120px; z-index: 103;" Text="/" Width="38px" TabIndex="20" ToolTip="Modifica Elemento" Visible="False" />
        <asp:Button ID="Button2" runat="server" Style="left: 591px; position: absolute;
            top: 85px; z-index: 104;" Text="-" Width="38px" TabIndex="22" 
    ...
    <p style="z-index: 114; left: 0px; position: absolute; top: 0px">
        ...
        <asp:Label ID="Label2" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="Times New Roman"
            ...
            top: 240px" Width="633px">SPESE DOCUMENTATE SUPERIORI A 10.000 Euro (solo componenti con indennità accompagnamento)</asp:Label>
        &nbsp; &nbsp;
        </p>
    <div 
        
        
        style="border-style: solid; border-color: inherit; border-width: 1px; left: 7px;
        overflow: auto; width: 565px; position: absolute; top: 32px; height: 195px; z-index: 113;">
        <asp:ListBox ID="ListBox1" runat="server" Font-Names="Courier New" Font-Size="8pt" 
            Style="border-style: none; left: 0px; position: absolute; top: 18px; z-index: 124; width: 988px; height: 157px;" 
            Rows="7"></asp:ListBox>
        ...
        <asp:Label ID="Label10" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
            ...
            Style="z-index: 109; left: 836px; position: absolute; top: 0px; width: 29px;" 
            Text="IND."></asp:Label>
            <asp:Label ID="Label14" runat="server" Font-Names="Courier New" 
            Font-Size="8pt" ForeColor="#0000C0"
            Style="z-index: 109; left: 872px; position: absolute; top: 0px" Text="DATA CERT."
    ...
    &nbsp;
    <asp:ListBox ID="ListBox2" runat="server" Style="left: 6px;
        position: absolute; top: 276px; z-index: 106; height: 106px;" 
        Width="572px" Font-Names="Courier New" Font-Size="8pt"></asp:ListBox>
    <asp:Button ID="Button5" runat="server" Style="left: 590px; position: absolute;
            top: 278px; z-index: 107;" Text="/" Width="38px" 
        ToolTip="Modifica Elemento" 
        onclientclick="document.getElementById('H1').value='0';" />
    <asp:Label ID="Label11" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
        Style="z-index: 108; left: 12px; position: absolute; top: 260px" Text="COMPONENTE"
        Width="51px"></asp:Label>
    <asp:Label ID="Label12" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
        Style="z-index: 109; left: 380px; position: absolute; top: 260px" Text="IMPORTO"
        Width="51px"></asp:Label>
    <asp:Label ID="Label13" runat="server" Font-Names="Courier New" Font-Size="8pt" ForeColor="#0000C0"
        Style="z-index: 110; left: 455px; position: absolute; top: 260px" Text="DESCRIZIONE"
        Width="51px"></asp:Label>
    &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
    ...
    <asp:Button ID="Button6" runat="server" Style="z-index: 112; left: 591px; position: absolute;
        top: 59px" Text="/" Width="38px" ToolTip="Modifica Componente" 
