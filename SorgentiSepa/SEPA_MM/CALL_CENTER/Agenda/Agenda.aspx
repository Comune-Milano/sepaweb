<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Agenda.aspx.vb" Inherits="CALL_CENTER_Agenda_Agenda" %>
    ...
    <table style="width: 100%">
        <tr>
            <td style="height: 35px; text-align: center;">
                <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">AGENDA CALL
                    CENTER </span></strong>
            </td>
        </tr>
        <tr>
