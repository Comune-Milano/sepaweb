<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DettagliAppuntamenti.aspx.vb"
    Inherits="CALL_CENTER_Agenda_DettagliAppuntamenti" %>
...
<body style="background-image: url('Immagini/Sfondo.png'); background-repeat: repeat-x;">
    ...
    <div id="contenuto" style="height: 600px; overflow: auto; position: relative; left: 10px;
        width: 98%">
        <table style="width: 100%">
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td style="text-align: left">
                    <asp:Label Text="Sede territoriale" runat="server" ID="lblFiliale" Font-Names="Arial" Font-Size="9pt" />
                </td>
                <td>
                                ...
                                <div style="overflow: auto; height: 300px;">
                                    ...
                                    <asp:DataGrid runat="server" ID="DataGridAppuntamentiSportello1" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="NOME" HeaderText="SEDE TERRITORIALE" ItemStyle-Width="10%"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="OPERATORE" HeaderText="OPERATORE" ItemStyle-Width="10%">
                                            </asp:BoundColumn>
                                            <%--<asp:BoundColumn DataField="DATA_INSERIMENTO" HeaderText="DATA INSERIMENTO" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>--%>
                                            <asp:BoundColumn DataField="APPUNTAMENTO_CON" HeaderText="UTENTE" ItemStyle-Width="10%">
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="TELEFONO" HeaderText="TELEFONO 1" ItemStyle-Width="10%">
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="CELLULARE" HeaderText="TELEFONO 2" ItemStyle-Width="10%">
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="EMAIL" HeaderText="EMAIL" ItemStyle-Width="10%"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="NOTE" HeaderText="NOTE" ItemStyle-Width="10%"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="SEGNALAZIONE" HeaderText="SEGNALAZIONE" ItemStyle-Width="10%"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="ELIMINA" HeaderText="ELIMINAZIONE" ItemStyle-Width="10%">
                                            </asp:BoundColumn>
        ...
        <table border="0" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="cmbFilialeIns" Font-Names="Arial" 
                        Font-Size="8pt" AutoPostBack="True" Width="300px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <div id="footer" style="height: 100px; text-align: right">
        <asp:Button ID="ButtonModifica" runat="server" Text="Modifica appuntamento" CssClass="bottone" />
        <asp:Button ID="ButtonSalva" runat="server" Text="Aggiungi appuntamento" CssClass="bottone" />
        <asp:Button ID="btnAggiornaForm" runat="server" Text="" CssClass="bottone" Style="display: none" />
        <asp:HiddenField runat="server" ID="idSegnalazione" Value="-1" />
