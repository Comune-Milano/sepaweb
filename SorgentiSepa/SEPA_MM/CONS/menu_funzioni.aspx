...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni.aspx.vb" Inherits="CONS_menu_funzioni" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_CONSULTAZIONE.png" Style="left: 26px;
