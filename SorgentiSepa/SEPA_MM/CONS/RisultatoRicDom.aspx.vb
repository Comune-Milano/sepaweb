...
Partial Class CONS_RisultatoRicDom
    ...
    Protected Sub btnVisualizza_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnVisualizza.Click
        ...
        Else
            'Response.Redirect("domanda.aspx?ID=" & LBLID.Text & "&ID1=-1&PROGR=-1")
            Response.Write("<script>location.replace('domanda.aspx?ID=" & LBLID.Text & "&ID1=-1&PROGR=-1&LE=0&APP=1');</script>")
        End If
    End Sub
