<%@ Page Language="VB" AutoEventWireup="false" CodeFile="correlazioni.aspx.vb" Inherits="CAMBI_correlazioni" %>
        ...
        <table id="Table1" align="center" border="1" cellpadding="1" cellspacing="1" style="z-index: 100;
            ...
            <tr>
                <td align="middle" bgcolor="aliceblue" style="text-align: center" valign="center">
                    <asp:Button ID="btnStampa" runat="server" Height="32px" Text="Stampa" Width="70px" />&nbsp; <asp:Button ID="Button1" runat="server" Height="32px" Text="Importa Nucleo" Width="109px" />
                    &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
