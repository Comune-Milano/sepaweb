<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StatodomandaCambi.aspx.vb" Inherits="CAMBI_StatodomandaCambi" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="z-index: 100; left: 10px;
        ...
        <tr>
            <td style="width: 616px; height: 30px; color: #660000;">
                <img id="STAMPA" onclick="javascript:window.print();" src="../IMG/print.jpg" style="z-index: 100; left: 427px; position: absolute;
