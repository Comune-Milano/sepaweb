    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If myReader.Read() Then
            If myReader("COD_FISCALE") = par.PulisciStrSql(Request.QueryString("CF")) Then
                par.cmd.CommandText = "DELETE FROM COMP_NUCLEO_CAMBI WHERE ID_DICHIARAZIONE=" & par.PulisciStrSql(Request.QueryString("ID")) & " AND COD_FISCALE<>'" & par.PulisciStrSql(Request.QueryString("CF")) & "'"
