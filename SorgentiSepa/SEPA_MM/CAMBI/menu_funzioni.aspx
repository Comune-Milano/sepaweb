...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni.aspx.vb" Inherits="CAMBI_menu_funzioni" %>
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image2" runat="server" Height="14px" ImageUrl="~/NuoveImm/Albero_1.gif"
                ...
                Visible="False" />
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_BandoCAMBI.png" Style="left: 26px;
