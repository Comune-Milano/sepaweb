<%@ Page Language="VB" AutoEventWireup="false" CodeFile="correlazioni1.aspx.vb" Inherits="CAMBI_correlazioni1" %>
        ...
        <table id="Table1" align="center" border="1" cellpadding="1" cellspacing="1" style="z-index: 100;
            ...
            <tr>
                <td align="middle" bgcolor="aliceblue" style="text-align: center" valign="center">
                    <asp:Button ID="btnStampa" runat="server" Height="32px" Text="Stampa" Width="70px" />&nbsp; &nbsp;<asp:Button ID="btnVisualizza" runat="server" Height="32px" Text="Chiudi" Width="70px" /></td>
            </tr>
        </table>
