...
Partial Class CAMBI_max
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False And bEseguito = False Then
            ...
            If CType(Dic_Reddito1.FindControl("lblAnnoR"), Label).Text = "2009" And lIndice_Bando <> 7 Then
                LBLENTE0.Visible = False
        ...
        CType(Dic_Dichiarazione1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"
        CType(Dic_Patrimonio1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"
        CType(Dic_Reddito1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"
        'CType(Dic_Note1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"
        CType(Dic_Sottoscrittore1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"
        CType(Dic_Integrazione1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"

        'CType(Dic_Nucleo1.FindControl("HyperLink1"), HyperLink).NavigateUrl = "CAMBI/Help_Dichiarazione.htm"
    ...
    Function VisualizzaDichiarazione()
        ...
        Try
            ...
            par.cmd.CommandText = "SELECT BANDI_CAMBIO.TIPO_BANDO,BANDI_CAMBIO.DATA_INIZIO,BANDI_CAMBIO.STATO FROM BANDI_CAMBIO,DICHIARAZIONI_CAMBI WHERE DICHIARAZIONI_CAMBI.ID=" & lIdDichiarazione & " AND DICHIARAZIONI_CAMBI.ID_BANDO=BANDI_CAMBIO.ID"
            ...
            par.cmd.CommandText = "SELECT DICHIARAZIONI_CAMBI.ID_CAF,DOMANDE_BANDO_CAMBI.N_DISTINTA,CAF_WEB.COD_CAF,DOMANDE_BANDO_CAMBI.ID_STATO FROM DOMANDE_BANDO_CAMBI,DICHIARAZIONI_CAMBI,CAF_WEB WHERE DICHIARAZIONI_CAMBI.ID_CAF=CAF_WEB.ID AND DICHIARAZIONI_CAMBI.ID=" & lIdDichiarazione & " AND DOMANDE_BANDO_CAMBI.ID_DICHIARAZIONE=DICHIARAZIONI_CAMBI.ID"
            ...
            If myReader.Read() Then
                If Session.Item("ID_CAF") = "6" Or Session.Item("id_caf") = "2" Then
                    If Session.Item("ID_CAF") = "6" Or Session.Item("id_caf") = "2" Then
                        ...
                        If par.IfNull(myReader("ID_STATO"), -1) <> "2" And par.IfNull(myReader("ID_STATO"), -1) <> "7a" And par.IfNull(myReader("ID_STATO"), -1) <> "4" Then
                            btnSalva.Visible = False
                            imgStampa.Visible = False
                            Dic_Dichiarazione1.DisattivaTutto()
                            Dic_Integrazione1.DisattivaTutto()
                        ...
                        If par.IfNull(myReader("ID_STATO"), -1) <> "7a" Or par.IfNull(myReader("ID_STATO"), -1) <> "4" Then
                            Response.Write("<script>alert('ATTENZIONE...la domanda collegata a questa dichiarazione risulta idonea o respinta. Se modifichi dei dati, ricorda di rielaborare la domanda!!');</script>")
                        End If


                        If par.IfNull(myReader("N_DISTINTA"), -1) = 0 And myReader("ID_CAF") <> Session.Item("ID_CAF") And Session.Item("ID_CAF") <> "2" Then
                            btnSalva.Visible = False
                            'Label5.Visible = False
                            imgStampa.Visible = False
                            'Label6.Visible = False
            ...
            myReader.Close()
                ...
                par.cmd.CommandText = "SELECT COUNT(ID_PRATICA) FROM EVENTI_DICHIARAZIONI_CAMBI WHERE COD_EVENTO='F132' AND ID_PRATICA=" & lIdDichiarazione
                myReader = par.cmd.ExecuteReader()
                If myReader.Read Then
            ...
            myReader.Close()
            If Fl_US <> "1" Then
                par.cmd.CommandText = "SELECT * FROM DICHIARAZIONI_CAMBI WHERE ID=" & lIdDichiarazione & " FOR UPDATE NOWAIT"
            Else
            ...
            par.cmd.CommandText = "SELECT * FROM DOMANDE_BANDO_CAMBI WHERE ID_DICHIARAZIONE=" & lIdDichiarazione
            myReader = par.cmd.ExecuteReader()
            If myReader.Read Then
                lblDomAssociata.Text = par.IfNull(myReader("PG"), "")
            End If
            myReader.Close()
            par.cmd.CommandText = "SELECT * FROM COMP_NUCLEO_CAMBI where PROGR=0 AND id_DICHIARAZIONE=" & lIdDichiarazione
            myReader = par.cmd.ExecuteReader()
            If myReader.Read() Then
                CType(Dic_Dichiarazione1.FindControl("txtCognome"), TextBox).Text = Trim(par.IfNull(myReader("COGNOME"), ""))
                CType(Dic_Dichiarazione1.FindControl("txtNome"), TextBox).Text = Trim(par.IfNull(myReader("NOME"), ""))
            ...
            par.cmd.CommandText = "SELECT * FROM SOTTOSCRITTORI_CAMBI WHERE ID_DICHIARAZIONE=" & lIdDichiarazione
            myReader = par.cmd.ExecuteReader()
            If myReader.Read() Then
            ...
            par.cmd.CommandText = "SELECT COMP_NUCLEO_CAMBI.*,T_TIPO_PARENTELA.DESCRIZIONE FROM COMP_NUCLEO_CAMBI,T_TIPO_PARENTELA where COMP_NUCLEO_CAMBI.id_DICHIARAZIONE=" & lIdDichiarazione & " AND COMP_NUCLEO_CAMBI.GRADO_PARENTELA=T_TIPO_PARENTELA.COD ORDER BY PROGR ASC"
            myReader = par.cmd.ExecuteReader()
            While myReader.Read
                ...
                End If
                MIAS = ""
                MIAS = par.MiaFormat(Trim(par.IfNull(myReader("COGNOME"), "")), 25) & " " & par.MiaFormat(Trim(par.IfNull(myReader("NOME"), "")), 25) & " " & par.MiaFormat(par.FormattaData(myReader("DATA_NASCITA")), 10) & " " & par.MiaFormat(par.IfNull(myReader("COD_FISCALE"), ""), 16) & " " & par.MiaFormat(par.IfNull(myReader("DESCRIZIONE"), ""), 25) & " " & par.MiaFormat(par.IfNull(myReader("PERC_INVAL"), ""), 6) & " " & par.MiaFormat(par.IfNull(myReader("USL"), ""), 5) & " " & par.MiaFormat(INDENNITA, 2)
                ...
                If par.IfNull(myReader("PERC_INVAL"), "0") = "100" And INDENNITA = "SI" Then
                    CType(Dic_Nucleo1.FindControl("ListBox2"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(myReader("COGNOME")) & "," & Trim(myReader("NOME")), 52) & " ", myReader("PROGR")))
                End If
                CType(Dic_Nucleo1.FindControl("txtProgr"), TextBox).Text = myReader("PROGR") + 1

                SOMMA = 0
                par.cmd.CommandText = "SELECT * FROM COMP_ELENCO_SPESE_CAMBI WHERE ID_COMPONENTE=" & myReader("ID") & " ORDER BY ID_COMPONENTE ASC"
                ...
                If SOMMA <> 0 Then
                    For i = 0 To CType(Dic_Nucleo1.FindControl("listbox2"), ListBox).Items.Count - 1
                        If MIOPROGR = CType(Dic_Nucleo1.FindControl("ListBox2"), ListBox).Items(i).Value Then
                            CType(Dic_Nucleo1.FindControl("ListBox2"), ListBox).Items(i).Text = par.MiaFormat(Trim(myReader("COGNOME")) & "," & Trim(myReader("NOME")), 52) & " " & par.MiaFormat(SOMMA, 6) & ",00   " & par.MiaFormat(DESCRIZIONE, 17)
                ...
                par.cmd.CommandText = "SELECT * FROM COMP_PATR_MOB_CAMBI WHERE ID_COMPONENTE=" & myReader("ID") & " ORDER BY ID_COMPONENTE ASC"
                myReader2 = par.cmd.ExecuteReader()
                While myReader2.Read
                    CType(Dic_Patrimonio1.FindControl("ListBox1"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(par.IfNull(myReader("COGNOME"), "")) & "," & Trim(par.IfNull(myReader("NOME"), "")), 25) & " " & par.MiaFormat(myReader2("COD_INTERMEDIARIO"), 27) & " " & par.MiaFormat(myReader2("INTERMEDIARIO"), 16) & " " & par.MiaFormat(myReader2("IMPORTO"), 8) & ",00 ", myReader("PROGR")))
                End While
                myReader2.Close()

                par.cmd.CommandText = "SELECT COMP_PATR_IMMOB_CAMBI.*,T_TIPO_PATR_IMMOB.descrizione FROM T_TIPO_PATR_IMMOB,COMP_PATR_IMMOB_CAMBI WHERE COMP_PATR_IMMOB_CAMBI.ID_COMPONENTE=" & myReader("ID") & " and COMP_PATR_IMMOB_CAMBI.ID_TIPO=T_TIPO_PATR_IMMOB.cod (+) ORDER BY COMP_PATR_IMMOB_CAMBI.ID_COMPONENTE ASC"
                myReader2 = par.cmd.ExecuteReader()
                While myReader2.Read
                    RESIDENZA = " "
                    ...
                    Else
                        RESIDENZA = "SI"
                    End If
                    CType(Dic_Patrimonio1.FindControl("ListBox2"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(myReader("COGNOME")) & "," & Trim(myReader("NOME")), 25) & " " & par.MiaFormat(myReader2("DESCRIZIONE"), 20) & " " & par.MiaFormat(myReader2("PERC_PATR_IMMOBILIARE"), 6) & " " & par.MiaFormat(Val(myReader2("VALORE")), 8) & ",00 " & par.MiaFormat(Val(myReader2("MUTUO")), 8) & ",00 " & RESIDENZA, myReader("PROGR")))
                End While
                myReader2.Close()

                par.cmd.CommandText = "SELECT * FROM DOMANDE_REDDITI_CAMBI WHERE ID_COMPONENTE=" & myReader("ID") & " ORDER BY ID_COMPONENTE ASC"
                myReader2 = par.cmd.ExecuteReader()
                While myReader2.Read
                    CType(Dic_Reddito_Conv1.FindControl("ListBox1"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(par.IfNull(myReader("COGNOME"), "")) & "," & Trim(par.IfNull(myReader("NOME"), "")), 35) & " " & par.MiaFormat(myReader2("CONDIZIONE"), 5) & " " & par.MiaFormat(myReader2("PROFESSIONE"), 5) & Chr(160) & Chr(160) & " " & par.MiaFormat(myReader2("DIPENDENTE"), 7) & ",00 " & par.MiaFormat(myReader2("PENSIONE"), 7) & ",00 " & par.MiaFormat(myReader2("AUTONOMO"), 7) & ",00 " & par.MiaFormat(myReader2("NON_IMPONIBILI"), 7) & ",00 " & par.MiaFormat(myReader2("occasionali"), 7) & ",00 " & par.MiaFormat(myReader2("DOM_AG_FAB"), 7) & ",00 " & par.MiaFormat(myReader2("ONERI"), 7) & ",00 ", myReader("PROGR")))
                End While
                myReader2.Close()


                par.cmd.CommandText = "SELECT * FROM COMP_REDDITO_CAMBI WHERE ID_COMPONENTE=" & myReader("ID") & " ORDER BY ID_COMPONENTE ASC"
                myReader2 = par.cmd.ExecuteReader()
                While myReader2.Read
                    CType(Dic_Reddito1.FindControl("ListBox1"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(myReader("COGNOME")) & "," & Trim(myReader("NOME")), 35) & " " & par.MiaFormat(myReader2("REDDITO_IRPEF"), 15) & ",00 " & par.MiaFormat(myReader2("PROV_AGRARI"), 15) & ",00", myReader("PROGR")))
                End While
                myReader2.Close()

                par.cmd.CommandText = "SELECT * FROM COMP_ALTRI_REDDITI_CAMBI WHERE ID_COMPONENTE=" & myReader("ID") & " ORDER BY ID_COMPONENTE ASC"
                myReader2 = par.cmd.ExecuteReader()
                While myReader2.Read
                    CType(Dic_Integrazione1.FindControl("ListBox1"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(myReader("COGNOME")) & "," & Trim(myReader("NOME")), 50) & " " & par.MiaFormat(Val(myReader2("IMPORTO")), 8) & ",00 ", myReader("PROGR")))
                End While
                myReader2.Close()

                par.cmd.CommandText = "SELECT COMP_DETRAZIONI_CAMBI.*,T_TIPO_DETRAZIONI.descrizione FROM T_TIPO_DETRAZIONI,COMP_DETRAZIONI_CAMBI WHERE COMP_DETRAZIONI_CAMBI.ID_COMPONENTE=" & myReader("id") & " and COMP_DETRAZIONI_CAMBI.ID_TIPO=T_TIPO_DETRAZIONI.cod (+) order by comp_detrazioni_CAMBI.id_componente asc"
                myReader2 = par.cmd.ExecuteReader()
                While myReader2.Read
                    CType(Dic_Integrazione1.FindControl("ListBox2"), ListBox).Items.Add(New ListItem(par.MiaFormat(Trim(myReader("COGNOME")) & "," & Trim(myReader("NOME")), 30) & " " & par.MiaFormat(myReader2("DESCRIZIONE"), 35) & " " & par.MiaFormat(myReader2("importo"), 8) & ",00 ", myReader("PROGR")))
                End While
                myReader2.Close()
            ...
            If CType(Dic_Reddito1.FindControl("lblAnnoR"), Label).Text = "2007" Then
                cmbAnnoReddituale.SelectedIndex = -1
                cmbAnnoReddituale.Items.FindByValue("2007").Selected = True
            ...
            If CType(Dic_Reddito1.FindControl("lblAnnoR"), Label).Text = "2008" Then
                cmbAnnoReddituale.SelectedIndex = -1
                cmbAnnoReddituale.Items.FindByValue("2008").Selected = True
                CType(Dic_Reddito_Conv1.FindControl("label3"), Label).Text = "REDDITO DICHIARATO/PERCEPITO PER L'ANNO D'IMPOSTA 2008"
            End If

            If CType(Dic_Reddito1.FindControl("lblAnnoR"), Label).Text = "2009" Then
                cmbAnnoReddituale.SelectedIndex = -1
                cmbAnnoReddituale.Items.FindByValue("2009").Selected = True
                CType(Dic_Reddito_Conv1.FindControl("label3"), Label).Text = "REDDITO DICHIARATO/PERCEPITO PER L'ANNO D'IMPOSTA 2009"
            End If
        ...
        Catch EX1 As Oracle.DataAccess.Client.OracleException
            If EX1.Number = 54 Then
                ...
                While myReader3.Read
                    ...
                    SOMMA = 0
                    par.cmd.CommandText = "SELECT * FROM COMP_ELENCO_SPESE_CAMBI WHERE ID_COMPONENTE=" & myReader3("ID") & " ORDER BY ID_COMPONENTE ASC"
                    Dim myReader2 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
                    While myReader2.Read
                        SOMMA = SOMMA + Val(myReader2("IMPORTO"))
                        DESCRIZIONE = par.IfNull(myReader2("DESCRIZIONE"), "")
                    ...
                    par.cmd.CommandText = "SELECT * FROM COMP_PATR_MOB_CAMBI WHERE ID_COMPONENTE=" & myReader3("ID") & " ORDER BY ID_COMPONENTE ASC"
                    myReader2 = par.cmd.ExecuteReader()
                    While myReader2.Read
                    ...
                    par.cmd.CommandText = "SELECT COMP_PATR_IMMOB_CAMBI.*,T_TIPO_PATR_IMMOB.descrizione FROM T_TIPO_PATR_IMMOB,COMP_PATR_IMMOB_CAMBI WHERE COMP_PATR_IMMOB_CAMBI.ID_COMPONENTE=" & myReader3("ID") & " and COMP_PATR_IMMOB_CAMBI.ID_TIPO=T_TIPO_PATR_IMMOB.cod (+) ORDER BY COMP_PATR_IMMOB_CAMBI.ID_COMPONENTE ASC"
                    myReader2 = par.cmd.ExecuteReader()
                    While myReader2.Read
                        RESIDENZA = " "
                        If myReader2("F_RESIDENZA") = "0" Then
                    ...
                    par.cmd.CommandText = "SELECT * FROM COMP_REDDITO_CAMBI WHERE ID_COMPONENTE=" & myReader3("ID") & " ORDER BY ID_COMPONENTE ASC"
                    myReader2 = par.cmd.ExecuteReader()
                    While myReader2.Read
                    ...
                    par.cmd.CommandText = "SELECT * FROM COMP_ALTRI_REDDITI_CAMBI WHERE ID_COMPONENTE=" & myReader3("ID") & " ORDER BY ID_COMPONENTE ASC"
                    myReader2 = par.cmd.ExecuteReader()
                    While myReader2.Read
                    ...
                    par.cmd.CommandText = "SELECT COMP_DETRAZIONI_CAMBI.*,T_TIPO_DETRAZIONI.descrizione FROM T_TIPO_DETRAZIONI,COMP_DETRAZIONI_CAMBI WHERE COMP_DETRAZIONI_CAMBI.ID_COMPONENTE=" & myReader3("id") & " and COMP_DETRAZIONI_CAMBI.ID_TIPO=T_TIPO_DETRAZIONI.cod (+) order by comp_detrazioni_CAMBI.id_componente asc"
                    myReader2 = par.cmd.ExecuteReader()
                    While myReader2.Read
    ...
    Protected Sub btnSalva_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSalva.Click
        ...
        Try
            ...
            par.cmd.CommandText = "SELECT comp_nucleo_CAMBI.* FROM comp_nucleo_CAMBI,DOMANDE_BANDO_CAMBI WHERE COMP_NUCLEO_CAMBI.ID_DICHIARAZIONE=DOMANDE_BANDO_CAMBI.ID_DICHIARAZIONE AND DOMANDE_BANDO_CAMBI.PROGR_COMPONENTE=0 AND  comp_nucleo_CAMBI.progr=0 and comp_nucleo_CAMBI.id_dichiarazione<>" & lIdDichiarazione & " and comp_nucleo_CAMBI.cod_fiscale='" & CType(Dic_Dichiarazione1.FindControl("txtCF"), TextBox).Text & "'"
            ...
            par.cmd.CommandText = "SELECT comp_nucleo_CAMBI.* FROM comp_nucleo_CAMBI,DOMANDE_BANDO_CAMBI WHERE COMP_NUCLEO_CAMBI.ID_DICHIARAZIONE=DOMANDE_BANDO_CAMBI.ID_DICHIARAZIONE AND comp_nucleo_CAMBI.id_dichiarazione<>" & lIdDichiarazione & " and comp_nucleo_CAMBI.cod_fiscale='" & CType(Dic_Dichiarazione1.FindControl("txtCF"), TextBox).Text & "'"
            Dim myReader23 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()
            While myReader23.Read()

                par.cmd.CommandText = "SELECT comp_nucleo_CAMBI.* FROM comp_nucleo_CAMBI,DOMANDE_BANDO_CAMBI WHERE DOMANDE_BANDO_CAMBI.PROGR_COMPONENTE=COMP_NUCLEO_CAMBI.PROGR AND COMP_NUCLEO_CAMBI.ID_DICHIARAZIONE=DOMANDE_BANDO_CAMBI.ID_DICHIARAZIONE AND COMP_NUCLEO_CAMBI.ID_DICHIARAZIONE=" & myReader23("ID_DICHIARAZIONE")
            ...
            If Dic_Nucleo1.ProgrDaCancellare <> "" Then
                sStringaSql = "DELETE FROM COMP_NUCLEO_CAMBI WHERE ID_DICHIARAZIONE=" & lIdDichiarazione & Dic_Nucleo1.ProgrDaCancellare & ")"
            ...
            For i = 0 To CType(Dic_Nucleo1.FindControl("listbox1"), ListBox).Items.Count - 1
                ...
                par.cmd.CommandText = "SELECT ID FROM COMP_NUCLEO_CAMBI WHERE ID_DICHIARAZIONE=" & lIdDichiarazione & " AND COD_FISCALE='" & par.PulisciStrSql(par.RicavaTesto(CType(Dic_Nucleo1.FindControl("listbox1"), ListBox).Items(i).Text, 64, 16)) & "'"
                Dim myReader4 As Oracle.DataAccess.Client.OracleDataReader = par.cmd.ExecuteReader()

                If myReader4.Read = False Then
                    sStringaSql = "INSERT INTO COMP_NUCLEO_CAMBI (ID,ID_DICHIARAZIONE,PROGR,COGNOME,NOME,GRADO_PARENTELA,COD_FISCALE,PERC_INVAL,DATA_NASCITA,USL,INDENNITA_ACC,SESSO" _
                                & ") VALUES (SEQ_COMP_NUCLEO_CAMBI.NEXTVAL," & lIdDichiarazione & "," & i & ",'" _
                    ...
                    par.cmd.CommandText = sStringaSql
                    par.cmd.ExecuteNonQuery()
                    par.cmd.CommandText = "SELECT SEQ_COMP_NUCLEO_CAMBI.CURRVAL FROM DUAL"
                    myReader = par.cmd.ExecuteReader()
                    If myReader.Read() Then
                ...
                Else
                    ...
                    sStringaSql = "UPDATE COMP_NUCLEO_CAMBI set PROGR=" & i & ",COGNOME='" & par.PulisciStrSql(par.RicavaTesto(CType(Dic_Nucleo1.FindControl("listbox1"), ListBox).Items(i).Text, 1, 25)) & "'," _
                ...
                par.cmd.CommandText = "DELETE FROM COMP_ELENCO_SPESE_CAMBI WHERE ID_COMPONENTE=" & idComponenti(i)
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "DELETE FROM COMP_PATR_MOB_CAMBI WHERE ID_COMPONENTE=" & idComponenti(i)
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "DELETE FROM COMP_PATR_IMMOB_CAMBI WHERE ID_COMPONENTE=" & idComponenti(i)
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "DELETE FROM COMP_REDDITO_CAMBI WHERE ID_COMPONENTE=" & idComponenti(i)
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "DELETE FROM COMP_ALTRI_REDDITI_CAMBI WHERE ID_COMPONENTE=" & idComponenti(i)
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "DELETE FROM COMP_DETRAZIONI_CAMBI WHERE ID_COMPONENTE=" & idComponenti(i)
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "DELETE FROM DOMANDE_REDDITI_CAMBI WHERE id_domanda=" & lIdDichiarazione
                par.cmd.ExecuteNonQuery()
            ...
            sStringaSql = ""
            sStringaSql = "UPDATE DICHIARAZIONI_CAMBI SET " _
                      & "PG='" & lblPG.Text & "'" & AU & ", DATA_PG='" _
            ...
            For i = 0 To CType(Dic_Nucleo1.FindControl("listbox2"), ListBox).Items.Count - 1
                If Val(par.RicavaTesto(CType(Dic_Nucleo1.FindControl("listbox2"), ListBox).Items(i).Text, 54, 6)) > 0 Then
                    ...
                    sStringaSql = "INSERT INTO COMP_ELENCO_SPESE_CAMBI (ID,ID_COMPONENTE,IMPORTO,DESCRIZIONE) VALUES (SEQ_COMP_ELENCO_SPESE_CAMBI.NEXTVAL," & idComponenti(INDICE) & "," _
            ...
            For i = 0 To CType(Dic_Patrimonio1.FindControl("listbox1"), ListBox).Items.Count - 1
                ...
                sStringaSql = "INSERT INTO COMP_PATR_MOB_CAMBI (ID,ID_COMPONENTE,COD_INTERMEDIARIO,INTERMEDIARIO,IMPORTO) VALUES (SEQ_COMP_PATR_MOB_CAMBI.NEXTVAL," & idComponenti(INDICE) & "," _
            ...
            For i = 0 To CType(Dic_Patrimonio1.FindControl("listbox2"), ListBox).Items.Count - 1
                ...
                sStringaSql = "INSERT INTO COMP_PATR_IMMOB_CAMBI (ID,ID_COMPONENTE,ID_TIPO,PERC_PATR_IMMOBILIARE,VALORE,MUTUO,F_RESIDENZA) VALUES " _
                            & " (SEQ_COMP_PATR_IMMOB_CAMBI.NEXTVAL," & idComponenti(INDICE) & "," & ID_TIPO _
            ...
            For i = 0 To CType(Dic_Reddito1.FindControl("listbox1"), ListBox).Items.Count - 1
                For j = 0 To cmbComp.Items.Count - 1
                    ...
                    End If
                Next
                sStringaSql = "INSERT INTO COMP_REDDITO_CAMBI (ID,ID_COMPONENTE,REDDITO_IRPEF,PROV_AGRARI) VALUES (SEQ_COMP_REDDITO_CAMBI.NEXTVAL," _
            ...
            sStringaSql = "DELETE FROM SOTTOSCRITTORI_CAMBI WHERE ID_DICHIARAZIONE=" & lIdDichiarazione
            par.cmd.CommandText = sStringaSql
            par.cmd.ExecuteNonQuery()
            ...
            If CType(Dic_Sottoscrittore1.FindControl("txtS"), TextBox).Text = "1" Then
                sStringaSql = "INSERT INTO SOTTOSCRITTORI_CAMBI (ID_DICHIARAZIONE) VALUES (" & lIdDichiarazione & ")"
                par.cmd.CommandText = sStringaSql
                par.cmd.ExecuteNonQuery()

                If CType(Dic_Sottoscrittore1.FindControl("cmbNazioneRes"), DropDownList).SelectedItem.Text = "ITALIA" Then
                    sStringaSql = "UPDATE SOTTOSCRITTORI_CAMBI SET " _
            ...
            For i = 0 To CType(Dic_Integrazione1.FindControl("listbox1"), ListBox).Items.Count - 1
                ...
                sStringaSql = "INSERT INTO COMP_ALTRI_REDDITI_CAMBI (ID,ID_COMPONENTE,IMPORTO) VALUES  " _
                            & " (SEQ_COMP_ALTRI_REDDITI_CAMBI.NEXTVAL," & idComponenti(INDICE) & "," _
            ...
            For i = 0 To CType(Dic_Integrazione1.FindControl("listbox2"), ListBox).Items.Count - 1
                ...
                sStringaSql = "INSERT INTO COMP_DETRAZIONI_CAMBI (ID,ID_COMPONENTE,ID_TIPO,IMPORTO) VALUES " _
                            & " (SEQ_COMP_DETRAZIONI_CAMBI.NEXTVAL," & idComponenti(INDICE) & "," & ID_TIPO _
            ...
            For i = 0 To CType(Dic_Reddito_Conv1.FindControl("listbox1"), ListBox).Items.Count - 1
                ...
                sStringaSql = "INSERT INTO DOMANDE_REDDITI_CAMBI (ID,ID_DOMANDA,ID_COMPONENTE,CONDIZIONE,PROFESSIONE,DIPENDENTE,PENSIONE,AUTONOMO,NON_IMPONIBILI,occasionali,dom_ag_fab,ONERI) VALUES (SEQ_UTENZA_REDDITI.NEXTVAL," & lIdDichiarazione & "," & idComponenti(INDICE) & ",'" _
            ...
            par.cmd.CommandText = "SELECT ID,PG FROM DOMANDE_BANDO_CAMBI WHERE ID_DICHIARAZIONE=" & lIdDichiarazione
            myReader = par.cmd.ExecuteReader()
            If myReader.Read() Then
                sStringaSql = "UPDATE DOMANDE_BANDO_CAMBI SET FL_RINNOVO='1',ISBAR=0,ISBARC=0,ISBARC_R=0,DISAGIO_F=0,DISAGIO_E=0,DISAGIO_A=0,REDDITO_ISEE=0,ID_STATO='2',fl_completa='1',FL_ESAMINATA='0',FL_ISTRUTTORIA_COMPLETA='0' WHERE ID=" & myReader("ID")
                par.cmd.CommandText = sStringaSql
                par.cmd.ExecuteNonQuery()
            ...
            par.cmd.CommandText = "SELECT * FROM DOMANDE_redditi_CAMBI WHERE ID_DOMANDA=" & lIdDichiarazione
            myReader = par.cmd.ExecuteReader()
            While myReader.Read
            ...
            While myReader1.Read
                par.cmd.CommandText = "SELECT * FROM COMP_REDDITO_CAMBI WHERE ID_COMPONENTE=" & myReader1("ID")
                myReader = par.cmd.ExecuteReader()
                While myReader.Read
                ...
                par.cmd.CommandText = "SELECT * FROM COMP_ALTRI_REDDITI_CAMBI WHERE ID_COMPONENTE=" & myReader1("ID")
                myReader = par.cmd.ExecuteReader()
                While myReader.Read
    ...
    Private Function NuovaDichiarazione()
        ...
        Try
            ...
            If myReader.Read() Then
                If myReader.HasRows = False Then
                    If lIdDichiarazione = -1 Then
                        ...
                        par.OracleConn.Close()
                        Oracle.DataAccess.Client.OracleConnection.ClearAllPools()
                        Response.Write("<script>alert('NESSUN BANDO CAMBI APERTO. Non è possibile inserire nuove dichiarazioni!');location.replace('pagina_home.aspx');</script>")
            ...
            par.cmd.CommandText = "INSERT INTO Dichiarazioni_CAMBI (ID,ID_CAF,ID_BANDO) VALUES (SEQ_DICHIARAZIONI_CAMBI.NEXTVAL," & Session.Item("ID_CAF") & "," & lIndice_Bando & ")"
            par.cmd.ExecuteNonQuery()

            par.cmd.CommandText = "SELECT SEQ_DICHIARAZIONI_CAMBI.CURRVAL FROM DUAL"
            myReader = par.cmd.ExecuteReader()
            If myReader.Read Then
    ...
    Protected Sub cmbAnnoReddituale_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbAnnoReddituale.SelectedIndexChanged
        ...
        Select Case cmbAnnoReddituale.SelectedItem.Value
            ...
            Case "2008"
                CType(Dic_Reddito_Conv1.FindControl("label3"), Label).Text = "REDDITO DICHIARATO/PERCEPITO PER L'ANNO D'IMPOSTA 2008"
                CType(Dic_Reddito1.FindControl("lblAnnoR"), Label).Text = "2008"
                CType(Dic_Patrimonio1.FindControl("lblDataMob"), Label).Text = "2008"
                CType(Dic_Patrimonio1.FindControl("lblDataImm"), Label).Text = "2008"
                CType(Dic_Integrazione1.FindControl("lblDataMob"), Label).Text = "2008"
            Case "2009"
                CType(Dic_Reddito_Conv1.FindControl("label3"), Label).Text = "REDDITO DICHIARATO/PERCEPITO PER L'ANNO D'IMPOSTA 2009"
                CType(Dic_Reddito1.FindControl("lblAnnoR"), Label).Text = "2009"
                CType(Dic_Patrimonio1.FindControl("lblDataMob"), Label).Text = "2009"
                CType(Dic_Patrimonio1.FindControl("lblDataImm"), Label).Text = "2009"
                CType(Dic_Integrazione1.FindControl("lblDataMob"), Label).Text = "2009"
        End Select
