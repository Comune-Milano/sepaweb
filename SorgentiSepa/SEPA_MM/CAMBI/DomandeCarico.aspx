<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DomandeCarico.aspx.vb" Inherits="CAMBI_DomandeCarico" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Sepa@Web - Bando Cambi - Domande in carico all'ente</title>
</head>
<body>
                ...
                <tr>
                    <td align="middle" bgcolor="floralwhite" style="height: 23px; text-align: left" valign="bottom">
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                            ForeColor="Navy">Ricerca Domande Bando Cambi Carico/Scarico</asp:Label></td>
                </tr>
                <tr>
