...
Partial Class CAMBI_StatodomandaCambi
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                ...
                sStringaSQL1 = "SELECT DOMANDE_BANDO_CAMBI.*,COMP_NUCLEO_CAMBI.COGNOME,COMP_NUCLEO_CAMBI.NOME,COMP_NUCLEO_CAMBI.id_dichiarazione,TAB_STATI.DESCRIZIONE,TAB_STATI.COD FROM TAB_STATI,DOMANDE_BANDO_CAMBI,COMP_NUCLEO_CAMBI WHERE DOMANDE_BANDO_CAMBI.ID=" & ID_DOMANDA & " AND DOMANDE_BANDO_CAMBI.ID_DICHIARAZIONE=COMP_NUCLEO_CAMBI.ID_DICHIARAZIONE AND DOMANDE_BANDO_CAMBI.PROGR_COMPONENTE=COMP_NUCLEO_CAMBI.PROGR AND DOMANDE_BANDO_CAMBI.ID_STATO=TAB_STATI.COD"
                PAR.OracleConn.Open()
                ...
                If myReader.Read() Then
                    ...
                    Dim cmd2 As Oracle.DataAccess.Client.OracleCommand = New Oracle.DataAccess.Client.OracleCommand("select isbarc_r,posizione from bandi_graduatoria_def_CAMBI where id_domanda=" & ID_DOMANDA, PAR.OracleConn)
                    ...
                    I = 1
                    Dim cmd3 As Oracle.DataAccess.Client.OracleCommand = New Oracle.DataAccess.Client.OracleCommand("select cognome,nome,cod_fiscale from comp_nucleo_CAMBI where id_dichiarazione=" & PAR.IfNull(myReader("id_dichiarazione"), -1) & " order by progr asc", PAR.OracleConn)
