<%@ Page language="VB"  AutoEventWireup="false" Inherits="CM.menu" CodeFile="./menu_sinistra.aspx.vb" EnableSessionState="ReadOnly" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body background="NuoveImm/comeblu_sx.jpg" bgColor="#003399">
		<form id="Form1" method="post" runat="server">
            ...
            &nbsp; &nbsp;&nbsp;
            <asp:TreeView ID="T1" runat="server" Font-Names="arial" Font-Size="12pt" Height="10px" NodeWrap="True" ForeColor="Red" Style="z-index: 108; left: 3px;
                position: absolute; top: 87px; color: #721c1f;" Width="115px" ImageSet="Arrows">
                <LevelStyles>
                ...
                <Nodes>
                    ...
                    <asp:TreeNode Expanded="False" Text="Cambio Intestazione" Value="500"></asp:TreeNode>
                    <asp:TreeNode Text="------------------" Value="------------------"></asp:TreeNode>
                    <asp:TreeNode Expanded="False" Text="Integrazioni"
                        Value="22" SelectAction="SelectExpand">
                        <asp:TreeNode Text="Ricerca Dom." Value="23"></asp:TreeNode>
                        <asp:TreeNode Text="Statistiche" Value="154"></asp:TreeNode>
                    </asp:TreeNode>
                    <asp:TreeNode Expanded="False" Text="Cambio Pos. Grad." Value="CPGrad"></asp:TreeNode>
                    <asp:TreeNode Expanded="False" Text="Domande B. Precedenti"
                        Value="6" ToolTip="Visualizza la situazione delle domande di bandi precedenti"></asp:TreeNode>
                    <asp:TreeNode SelectAction="None" Text="------------------" Value="------------------">
                    </asp:TreeNode>
                    <asp:TreeNode Expanded="False" Text="Carico/Scarico"
                        Value="10" SelectAction="SelectExpand">
                        <asp:TreeNode NavigateUrl="~/DomandeCarico.aspx"
                            Target="_blank" Text="Elenchi" Value="11"></asp:TreeNode>
                        <asp:TreeNode NavigateUrl="~/Scarico.aspx"
                            Target="_blank" Text="Scarico" Value="12"></asp:TreeNode>
                        <asp:TreeNode NavigateUrl="~/CercaDistinte.aspx"
                            Target="_blank" Text="Distinte" Value="13"></asp:TreeNode>
                    </asp:TreeNode>
                    <asp:TreeNode Text="------------------" Value="------------------"></asp:TreeNode>
                    <asp:TreeNode Expanded="False" Text="Prenotazioni"
                        ToolTip="Prenotazioni Domande EXTRA" Value="14" 
                        SelectAction="SelectExpand">
                        <asp:TreeNode Text="Nuova" Value="15"></asp:TreeNode>
                        <asp:TreeNode Text="Lista" Value="16"></asp:TreeNode>
                    </asp:TreeNode>
                    <asp:TreeNode Expanded="False" NavigateUrl="~/Statistiche.aspx"
                        Target="_blank" Text="Statistiche" ToolTip="Visualizza le statistiche di bando"
                        Value="9"></asp:TreeNode>
                    <asp:TreeNode Text="Calcolo CF"
                        Value="7" NavigateUrl="~/cf/codice.htm" Target="_blank"></asp:TreeNode>
                ...
                <NodeStyle BorderStyle="None" ForeColor="Black" Font-Names="Verdana" Font-Size="8pt" HorizontalPadding="5px" NodeSpacing="0px" VerticalPadding="0px" />
