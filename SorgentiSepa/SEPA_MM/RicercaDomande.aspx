<%@ Page Language="vb" AutoEventWireup="false" Inherits="CM.RicercaDomande" CodeFile="RicercaDomande.aspx.vb" EnableSessionState="ReadOnly" %>
...
//document.onkeydown=$onkeydown;
        ...
        defaultfocus="txtCognome">
            ...
            <asp:ImageButton ID="btnAnnulla" runat="server" ImageUrl="~/NuoveImm/Img_Home.png"
                Style="z-index: 101; left: 527px; position: absolute; top: 350px" TabIndex="8" CausesValidation="False" ToolTip="Home" />
            <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
                Style="z-index: 102; left: 394px; position: absolute; top: 350px" TabIndex="7" ToolTip="Avvia Ricerca" />
            &nbsp;
                ...
                <tr>
                    <td>
                        ...
                        <br />
									...
									<asp:DropDownList id="cmbStato" tabIndex="5" runat="server" Height="17px" Width="175px" style="border-right: black 1px solid; border-top: black 1px solid; z-index: 111; left: 115px; border-left: black 1px solid; border-bottom: black 1px solid; position: absolute; top: 189px" BackColor="White"></asp:DropDownList>
                                    <asp:Label ID="Label8" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                        Style="z-index: 112; left: 42px; position: absolute; top: 220px" Width="36px">Bando</asp:Label><asp:DropDownList id="cmbBando" tabIndex="6" runat="server" Height="17px" Width="175px" style="z-index: 113; left: 115px; position: absolute; top: 216px; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                                </asp:DropDownList>
