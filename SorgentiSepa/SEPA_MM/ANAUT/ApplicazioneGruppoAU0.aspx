<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ApplicazioneGruppoAU0.aspx.vb" Inherits="ANAUT_ApplicazioneGruppoAU0" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Applicazione AU</title>
    <style type="text/css">
        .style1
        {
            font-size: x-small;
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td align="center" 
                    ...
                    class="style1">
                    Attenzione...questa procedura non applica il canone in bolletta, ma calcola e 
                    memorizza i canoni di competenza derivanti da AU. Per rendere effettive i canoni 
                    calcolati usare le apposite funzioni</td>
            </tr>
            <tr>
                <td>
