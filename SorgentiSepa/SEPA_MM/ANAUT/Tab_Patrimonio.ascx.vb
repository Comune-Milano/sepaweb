...
Partial Class ANAUT_Tab_Patrimonio
    ...
    Protected Sub DataGridImmob_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGridImmob.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            e.Item.Attributes.Add("onmouseout", "if (Selezionato!=this) {this.style.backgroundColor=OldColor;OldColor='';};")
            e.Item.Attributes.Add("onclick", "if (Selezionato!=this) {if (Selezionato) {Selezionato.style.backgroundColor=SelColo;};SelColo=OldColor;};Selezionato=this;this.style.backgroundColor='#C1C1C1';" _
                                & "document.getElementById('Dic_Patrimonio1_idCompImmob').value='" & e.Item.Cells(0).Text & "';document.getElementById('Dic_Patrimonio1_idPatrImmob').value='" & e.Item.Cells(1).Text & "';document.getElementById('Dic_Patrimonio1_tipoImmob').value='" & par.IfEmpty(e.Item.Cells(4).Text, "") & "';document.getElementById('Dic_Patrimonio1_tipoPropr').value='" & Replace(e.Item.Cells(5).Text, "'", "\'") & "';document.getElementById('Dic_Patrimonio1_perc').value='" & e.Item.Cells(9).Text & "';document.getElementById('Dic_Patrimonio1_valore').value='" & e.Item.Cells(6).Text & "';document.getElementById('Dic_Patrimonio1_mutuo').value='" & e.Item.Cells(7).Text & "';document.getElementById('Dic_Patrimonio1_catastale').value='" & e.Item.Cells(12).Text & "';document.getElementById('Dic_Patrimonio1_comune').value='" & Replace(e.Item.Cells(11).Text, "'", "\'") & "';document.getElementById('Dic_Patrimonio1_vani').value='" & e.Item.Cells(10).Text & "';document.getElementById('Dic_Patrimonio1_sup').value='" & e.Item.Cells(8).Text & "';document.getElementById('Dic_Patrimonio1_indirizzo').value='" & Replace(e.Item.Cells(13).Text, "'", "\'") & "';document.getElementById('Dic_Patrimonio1_civico').value='" & par.IfEmpty(e.Item.Cells(14).Text, "") & "';document.getElementById('Dic_Patrimonio1_rendita').value='" & par.IfEmpty(e.Item.Cells(15).Text, "") & "';document.getElementById('Dic_Patrimonio1_ven').value='" & par.IfEmpty(e.Item.Cells(16).Text, "") & "';")
        End If
    End Sub

    Protected Sub btnDeleteMob_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnDeleteMob.Click
        'idCompImmob.Value = "0"
        'If idCompMob.Value = "-1" Then
    ...
    Protected Sub btnAggiungiReddM_Click(sender As Object, e As System.EventArgs) Handles btnAggiungiReddM.Click
        CaricaElencoRedditiMobiliari()
    End Sub

    Private Sub CaricaElencoRedditiMobiliari()
        CType(Me.Page, Object).CaricaPatrimMob()
    End Sub

    Private Sub CaricaElencoRedditiImmobiliari()
        CType(Me.Page, Object).CaricaPatrimImmob()
    End Sub

    Protected Sub btnAggiungiReddI_Click(sender As Object, e As System.EventArgs) Handles btnAggiungiReddI.Click
        CaricaElencoRedditiImmobiliari()
    End Sub

    Protected Sub DataGridImmob_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles DataGridImmob.SelectedIndexChanged

    End Sub

    Protected Sub DataGridMob_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles DataGridMob.SelectedIndexChanged
