    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                Dim dataRiferimento As String = Request.QueryString("RIF")
                ...
                par.cmd.CommandText = "SELECT * FROM utenza_bandi where id=" & Request.QueryString("BA") & " ORDER BY id desc"
                ...
                For Each row In dt.Rows
                    ...
                    If myReader.Read Then
                        INTESTATARIO = Trim(par.IfNull(myReader("cognome"), "") & " " & par.IfNull(myReader("nome"), ""))
                        INDIRIZZO_POSTALE = Trim(Replace(UCase(par.IfNull(myReader("presso_cor"), "")), "C/O", ""))
                ...
                Dim NomeFile1 As String = "AU" & AnnoBando & "_" & sPosteAlerAcronimo & "_DiffideNonRispondenti_" & dataRiferimento & "-" & Format(Now, "yyyyMMddHHmmss")
                ...
                Dim sr2 As StreamWriter = New StreamWriter(Server.MapPath("..\ALLEGATI\ANAGRAFE_UTENZA\DIFFIDE\") & "" & NomeFile1 & ".txt", False, System.Text.Encoding.Default)
                sr2.WriteLine(sPosteAler)
                sr2.Close()

                Dim url As String = Server.MapPath("..\ALLEGATI\ANAGRAFE_UTENZA\DIFFIDE\") & NomeFile1

                Dim urlPostAler As String = Server.MapPath("..\ALLEGATI\ANAGRAFE_UTENZA\DIFFIDE\") & NomeFile1
