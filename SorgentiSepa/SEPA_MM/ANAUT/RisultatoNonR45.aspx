<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoNonR45.aspx.vb" Inherits="ANAUT_RisultatoNonR" %>
                ...
                <tr>
                    <td>
                        ...
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Elenco
                            Non Rispondenti Un. Virtuali </strong>
                        ...
                        <img id="imgAvanti" alt="Procedi" src="../NuoveImm/Img_Procedi.png" 
                            onclick="Conferma()" 
                            style="position:absolute;cursor:pointer; top: 507px; left: 357px;"/><br />
                        <br />
                        <br />
