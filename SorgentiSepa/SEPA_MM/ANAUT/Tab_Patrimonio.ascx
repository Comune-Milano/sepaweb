...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                    ...
                                    <asp:BoundColumn DataField="PROPRIETA" HeaderText="N. INTESTATARI">
                                    </asp:BoundColumn>
                                </Columns>
                            </asp:DataGrid>
                        </div>
                            ...
                            <tr>
                                <td>
                                    <asp:ImageButton ID="btnDeleteMob" runat="server" ImageUrl="~/ANAUT/img/ImgDelete.png"
                                        ...
                                        onclientclick="document.getElementById('provenienza').value='pmobile';VerificaSelezionatoMob();return false;" />
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <div style="overflow: auto; height: 70px;" id="Div1">
                            <asp:DataGrid ID="DataGridImmob" runat="server" AutoGenerateColumns="False" Font-Bold="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="INDIRIZZO" HeaderText="INIDRIZZO">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    </asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn DataField="VENDUTO" HeaderText="VENDUTO"></asp:BoundColumn>
                                </Columns>
                            </asp:DataGrid>
                        </div>
                    </td>
                            ...
                            <tr>
                                <td>
                                    <asp:ImageButton ID="imgDeleteImmob" runat="server" ImageUrl="~/ANAUT/img/ImgDelete.png"
                                        ...
                                        onclientclick="document.getElementById('provenienza').value='pimmobile';VerificaSelezionatoImmob();return false;" />
                                </td>
                            </tr>
                        </table>
                    </td>
...
<asp:Button ID="btnAggiungiReddM" runat="server" Text="Aggiungi Reddito Mobiliare" 
    style="visibility:hidden" />
<asp:Button ID="btnAggiungiReddI" runat="server" Text="Aggiungi Reddito Immobiliare" 
    style="visibility:hidden" />
...
<asp:HiddenField ID="ven" runat="server" />
<asp:HiddenField ID="prp" runat="server" />
<script type="text/javascript" language="javascript">
    function VerificaSelezionatoMob() {
        document.getElementById('Dic_Patrimonio1_idCompImmob').value = '0';
        if (document.getElementById('Dic_Patrimonio1_idCompMob').value == '-1' || document.getElementById('Dic_Patrimonio1_idCompMob').value == '0') {
            Avviso();
        }
        else {
            Verifica();
    ...
    function VerificaSelezionatoImmob() {
        document.getElementById('Dic_Patrimonio1_idCompMob').value = '0';
        if (document.getElementById('Dic_Patrimonio1_idCompImmob').value == '-1' || document.getElementById('Dic_Patrimonio1_idCompImmob').value == '0') {
            Avviso();
        }
        else {
            Verifica();
