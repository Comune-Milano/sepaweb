<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatoNonRispondenti.aspx.vb" Inherits="ANAUT_RisultatoNonRispondenti" %>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDataStampa"
            ...
            <asp:ImageButton ID="btnRicerca" runat="server" ImageUrl="~/NuoveImm/Img_NuovaRicerca.png"
                ...
                Style="z-index: 103; left: 277px; position: absolute; top: 518px; height: 20px;" 
                                ...
                                <asp:TemplateColumn HeaderText="APPUNTAMENTO">
                                    <EditItemTemplate>
                                        <asp:TextBox runat="server" 
                                            Text='<%# DataBinder.Eval(Container, "DataItem.APPUNTAMENTO") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label runat="server" 
                                            Text='<%# DataBinder.Eval(Container, "DataItem.APPUNTAMENTO") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
