<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaNonR45.aspx.vb" Inherits="ANAUT_RicercaNonR" %>
    ...
    function CompletaData(e, obj) {
        ...
        defaultfocus="txtCognome">
                ...
                <tr>
                    <td style="width: 670px">
                        ...
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Ricerca
                            Dichiarazioni non Rispondenti Unità Virtuali</strong></span><br />
                        <br />
                        <br />
                        <br />
                        <br />
            ...
            <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
                ...
                style="z-index: 106; left: 27px; position: absolute; top: 226px; width: 608px; height: 45px;" 
                ...
                <asp:TextBox ID="txtStipulaAl" runat="server" BorderStyle="Solid" BorderWidth="1px"
                            ...
                            TabIndex="4" ToolTip="gg/mm/aaaa" Width="70px">30/09/2009</asp:TextBox>
                ...
                style="z-index: 106; left: 50px; position: absolute; top: 157px">Contratti Stipulati dal</asp:label>
