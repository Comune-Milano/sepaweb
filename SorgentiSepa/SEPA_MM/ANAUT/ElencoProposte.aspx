<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElencoProposte.aspx.vb" Inherits="ANAUT_ElencoProposte" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Elenco Proposte Decadenza</title>
    <style type="text/css">
        #elenco
        {
            height: 382px;
        ...
        <table style="left: 0px; background-image: url(../NuoveImm/SfondoMaschere.jpg); width: 674px;
            ...
            <tr>
                <td>
                    ...
                    &nbsp;Elenco Proposte di Decadenza</strong></span><br />
                    <br />
