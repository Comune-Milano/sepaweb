...
Partial Class ANAUT_NotificaISE
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If idc.Value <> "" And Len(idc.Value) = 19 Then
                ...
                Try
                    ...
                    If myReader.Read Then
                        ...
                        lblIndirizzoPostale0.Text = par.IfNull(myReader("tipo_cor"), "") & " " & par.IfNull(myReader("via_cor"), "") & " " & par.IfNull(myReader("civico_cor"), "")
                    ...
                    If Ausi = "0" Then
                        ...
                        If myReader.Read Then
                            ...
                            lblEstremi2.Text = "Tel:" & par.IfNull(myReader("n_telefono"), "") & " - Fax:" & par.IfNull(myReader("n_fax"), "") & " - n.verde:" & par.IfNull(myReader("n_telefono_verde"), "")
                            m.Value = par.Cripta("Tel:" & par.IfNull(myReader("n_telefono"), "") & " - Fax:" & par.IfNull(myReader("n_fax"), ""))
                            ...
                            o.Value = par.Cripta(par.IfNull(myReader("n_telefono_verde"), ""))
                            ...
                            p.Value = par.Cripta(Responsabile)
                            lblEstremi5.Text = "Acronimo:" & cds & "/" & par.IfNull(myReader("ACRONIMO"), "")
                            q.Value = par.Cripta(cds & "/" & par.IfNull(myReader("ACRONIMO"), ""))
                    ...
                    par.cmd.CommandText = "select * from utenza_doc_mancante where id_dichiarazione=" & idd.Value
                    myReader = par.cmd.ExecuteReader()
                    y.Value = "0"
                    If myReader.HasRows = False Then
                        Response.Write("<script>alert('Attenzione...non risulta inserita documentazione mancante nell\'apposito TAB.\nAssicurarsi di aver premuto il pulsante SALVA prima di eseguire questa funzione.');</script>")
                        y.Value = "1"
                    End If
                    myReader.Close()
                ...
                If Request.QueryString("45") = "1" Then
                    Try
                        ...
                        If myReader.Read Then
                            ...
                            End If
                            '    If par.IfNull(myReader1("LIVELLO"), -100) <> -100 Then
                            '        If myReader1("LIVELLO") Mod 2 = 1 Then
            ...
            If lblEstremi4.Text = "Resp.:" Or lblIntestatario.Text = "" Or lblIndirizzoPostale.Text = "" Or lblIndirizzoPostale0.Text = "" Or lblIndirizzoPostale1.Text = "" Or lblIndirizzo.Text = "" Or lblLocalita.Text = "" Or lblFiliale.Text = "" Or lblEstremi.Text = "" Or lblEstremi0.Text = "" Or lblEstremi1.Text = "" Or lblEstremi2.Text = "" Or lblEstremi3.Text = "" Then
                lblErrore.Visible = True
