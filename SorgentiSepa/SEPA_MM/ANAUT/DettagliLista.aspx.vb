...
Partial Class ANAUT_DettagliLista
    ...
    Private Function CaricaDatiLista()
        Try
            ...
            If Request.QueryString("IDG") = "" Then
                ...
                myReader.Close()
            Else
                PAR.cmd.CommandText = "SELECT * FROM UTENZA_GRUPPI_CONV WHERE id=" & Request.QueryString("IDG")
                Dim myReader As Oracle.DataAccess.Client.OracleDataReader = PAR.cmd.ExecuteReader()
                If myReader.Read Then
                    Label1.Text = PAR.IfNull(myReader("criteri"), "")
                    Label3.Text = "GRUPPO " & PAR.IfNull(myReader("DESCRIZIONE"), "")
                    Label4.Text = "Lista Convocabili"
                End If
                myReader.Close()
            End If
    ...
    Private Function CaricaDati()
        Try
            ...
            Else
                Tabella = "SELECT * FROM UTENZA_LISTE_CDETT WHERE ID_GRUPPO_CONV=" & Request.QueryString("IDG") & "  ORDER BY FILIALE,SEDE,INTESTATARIO"
            End If
            BindGrid()
    ...
    Protected Sub ImageButton1_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        Try
            ...
            If DT.Rows.Count > 0 Then
                DT.Columns.Remove("ID_LISTA")
                DT.Columns.Remove("ID_CONTRATTO")
                DT.Columns.Remove("ID_TAB_FILIALI")
                DT.Columns.Remove("ID_SPORTELLO")
                DT.Columns.Remove("ID_GRUPPO_CONV")
                DT.Columns.Remove("ID_LISTA_CONV")
