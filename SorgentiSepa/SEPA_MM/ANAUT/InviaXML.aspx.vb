...
Partial Class ANAUT_InviaXML
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                ...
                MiaSHTML = "</br></br></br></br></br></br><p><b><font face='Arial' size='2'>Elenco file Inviati ed Elaborati</font></b></p><table border='0' cellpadding='1' cellspacing='1' width='500px'>" & vbCrLf
                ...
                MiaSHTML = MiaSHTML & "<td width='100px'><font size='2' face='Arial'>N. Dichiarazioni</font></td>" & vbCrLf
                ...
                par.cmd.CommandText = "select * from utenza_import where id_caf=" & Session.Item("ID_CAF") & " order by data_import desc"
                ...
                While myReader.Read()
                    ...
                    MiaSHTML = MiaSHTML & "<td width='100px' bgcolor='" & MIOCOLORE & "'><font face='Arial' size='1'><p align='center'><a href='REPORT\" & Mid(par.IfNull(myReader("NOME_FILE"), "SSSSSS"), 1, Len(par.IfNull(myReader("NOME_FILE"), "SSSSSS")) - 3) & "HTM' target='_blank'><img border='0' src='../ImmMaschere/MenuTopDownload.gif'></a></font></td>" & vbCrLf
                    MiaSHTML = MiaSHTML & "</tr>" & vbCrLf
    ...
    '    'If XMLError = "" Then
    '    '    Response.Write("<script>alert('Documento xml sintatticamente corretto!');</script>")
    '    'Else
    '    '    Response.Write("Documento xml sintatticamente errato!" & XMLError)
    '    'End If
    ...
    Protected Sub ImageButton2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        Response.Write("<script>var w=null;w=window.open('ElencoXML.aspx','','height=250,top=0,left=0,width=500');</script>")
    End Sub
End Class
