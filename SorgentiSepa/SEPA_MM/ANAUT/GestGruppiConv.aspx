<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GestGruppiConv.aspx.vb" Inherits="ANAUT_GestGruppiConv" %>
    ...
    <asp:DataGrid ID="DataGridCapitoli" runat="server" AutoGenerateColumns="False" 
        ...
        <script type="text/javascript">
            ...
            function ModificaGruppo() {
                if (document.getElementById('txtid')) {
                    if (document.getElementById('txtid').value != '') {
                        document.location.href = 'NuovoGruppoConv.aspx?ID=' + document.getElementById('txtid').value;

                    }
                    else {
                        alert('Selezionare un gruppo dalla lista!');
                    }
                }
            ...
            function NuovoGruppo() {
                document.location.href = 'NuovoGruppoConv.aspx';
            }

            function Sicuro() {
            if (document.getElementById('txtid').value != '') {
                var chiediConferma
                chiediConferma = window.confirm("Attenzione, Eliminare il Gruppo selezionato?");
           ...
           <p>
                                        <img alt="Aggiungi Gruppo di Convocazione" onclick="NuovoGruppo();"
                                            src="../NuoveImm/Img_Aggiungi.png" 
                        style="cursor: pointer; left: 563px; position: absolute; top: 66px; bottom: 569px;" 
                        id="IMG1" /></p>
                                   <p>
                                        <img alt="Modifica Gruppo di Convocazione" onclick="ModificaGruppo();"
