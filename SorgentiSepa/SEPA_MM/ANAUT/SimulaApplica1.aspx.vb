...
Partial Class ANAUT_SimulaApplica1
    ...
    Private Function Cerca()
        Try
            ...
            sStringaSQL1 = "SELECT UTENZA_GRUPPI_LAVORO.*,replace(replace('<a href=£javascript:void(0)£ onclick=£window.open(''DettagliGruppoAU.aspx?ID='||UTENZA_GRUPPI_LAVORO.id||''','''','''');£>'||'Elenco AU'||'</a>','$','&'),'£','" & Chr(34) & "') as  DETTAGLI  FROM UTENZA_GRUPPI_LAVORO WHERE FL_ABUSIVI=0 and applicazione=0 and ID_BANDO_AU=" & IDAU & " ORDER BY FL_REGISTRO DESC,NOME_GRUPPO ASC"
            BindGrid()
        ...
        If conferma.Value = "1" Then
            ...
            If Elenco <> "" Then
                ...
                scriptblock = "<script language='javascript' type='text/javascript'>" _
                            & "window.open('ApplicazioneGruppoAU0.aspx?T=1','','');" _
                            & "</script>"
