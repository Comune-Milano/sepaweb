<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CreazioneListaManuale.aspx.vb" Inherits="ANAUT_CreazioneListaManuale" %>
...
<body>
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <asp:ImageButton ID="imgSelezionaTutto" runat="server" 
                        ImageUrl="~/NuoveImm/Img_SelezionaTutto.png" ToolTip="Seleziona Tutto" />
                    &nbsp;
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;
                    <img id="imgSalvaLista" alt="" src="../NuoveImm/img_SalvaListaConvocazione.png" 
    ...
    <asp:DataGrid ID="DataGridRateEmesse" runat="server" AutoGenerateColumns="False"
        ...
        Font-Strikeout="False" Font-Underline="False" AllowPaging="True" 
            PageSize="300" BackColor="White" BorderColor="#999999" BorderStyle="None" 
            BorderWidth="1px">
        ...
        <Columns>
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="ChSelezionato" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.SELEZIONA") %>' />
            ...
            <asp:BoundColumn DataField="COD_CONTRATTO_1" HeaderText="CONTRATTO">
            </asp:BoundColumn>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" Font-Names="arial" Font-Size="10pt" 
                                    Font-Strikeout="False" ForeColor="#0000CC" Text="Nome Lista Convocazione"></asp:Label>
                            </td>
