<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NuovaListaCSV.aspx.vb" Inherits="ANAUT_NuovaListaCSV" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Label ID="Label26" runat="server" 
                            Text="Crea Lista Convocazione da file CSV"></asp:Label>
                        </span><br />
                        <br />
                        <br />
                        <br />
                ...
                <table style="border: thin solid #3399FF;" width="100%">
                    <tr>
                        ...
                        <asp:Label ID="Label25" runat="server" 
                            Text="ATTENZIONE...Il file deve essere IN FORMATO CSV ed ottenuto da un file EXCEL strutturato come mostrato in figura e il nome del foglio deve essere &quot;RU&quot;. I rapporti devono essere comunque tra i convocabili e non appartenenti a nessuna lista di convocazione." 
