<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NotificaISE.aspx.vb" Inherits="ANAUT_NotificaISE" %>
...
<body>
    ...
    <script type="text/javascript">
        function Apri() {
            if (document.getElementById('a').value != '' && document.getElementById('b').value != '' && document.getElementById('c').value != '' && document.getElementById('d').value != '' && document.getElementById('xx').value != '' && document.getElementById('f').value != '' && document.getElementById('g').value != '' && document.getElementById('h').value != '' && document.getElementById('i').value != '' && document.getElementById('l').value != '' && document.getElementById('m').value != '' && document.getElementById('n').value != '' && document.getElementById('o').value != '') {
                if (document.getElementById('txtProtocollo').value != '') {
                    window.open('Stampe/NotificaISe.aspx?AU=' + document.getElementById('AU').value + '&PG=' + document.getElementById('txtProtocollo').value + '&COD=' + document.getElementById('idc').value + '&ID=' + document.getElementById('idd').value + '&1=' + document.getElementById('a').value + '&2=' + document.getElementById('b').value + '&3=' + document.getElementById('c').value + '&4=' + document.getElementById('d').value + '&5=' + document.getElementById('xx').value + '&6=' + document.getElementById('f').value + '&7=' + document.getElementById('g').value + '&8=' + document.getElementById('h').value + '&9=' + document.getElementById('i').value + '&10=' + document.getElementById('l').value + '&11=' + document.getElementById('m').value + '&12=' + document.getElementById('n').value + '&13=' + document.getElementById('o').value + '&14=' + document.getElementById('p').value + '&15=' + document.getElementById('q').value, 'NotificaISE', '');
                }
                else {
