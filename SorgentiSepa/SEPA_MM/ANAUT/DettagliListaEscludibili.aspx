<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DettagliListaEscludibili.aspx.vb"
    Inherits="ANAUT_DettagliListaEscludibili" %>
...
<body>
    ...
    <div>
        <table style="width: 100%;">
            <tr>
                <td style="font-family: ARIAL, Helvetica, sans-serif; font-size: 12pt; font-weight: bold;
                    text-align: center;">
                    ELENCO CONVOCABILI ED ESCLUDIBILI
            ...
            <tr>
                <td style="font-family: ARIAL, Helvetica, sans-serif; font-size: 12pt; font-weight: bold;
                    text-align: center;">
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="ARIAL" Font-Size="8pt"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr valign="middle">
                <td>
                    <asp:Label ID="Label4" runat="server" Font-Names="arial" Font-Size="10pt" Text="Motivazione Esclusione"></asp:Label>
                    <asp:DropDownList ID="cmbMotivi" runat="server">
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label5" runat="server" Font-Names="arial" Font-Size="10pt" Text="Escludi da Lista"></asp:Label>
                    &nbsp;
                    <asp:FileUpload ID="FileUpload1" runat="server" Font-Names="arial" Font-Size="8pt"
                        Style="z-index: 101; left: 352px; position: width: 307px;" TabIndex="1" />
                &nbsp;<asp:Label ID="Label6" runat="server" Font-Names="arial" Font-Size="8pt" 
                        Text="(Selezionare un file txt con 1 codice contratto per riga)"></asp:Label>
                    &nbsp;<asp:ImageButton ID="btnSalva0" runat="server" 
                        ImageUrl="~/NuoveImm/Img_Elabora.png" />
                </td>
            </tr>
            <tr valign="middle">
                <td>
        ...
        <asp:DataGrid ID="DataGridRateEmesse" runat="server" AutoGenerateColumns="False"
            CellPadding="3" GridLines="Vertical" Style="z-index: 11; left: 18px; top: 81px"
            Width="100%" Font-Bold="False" Font-Italic="False" Font-Names="Arial" Font-Overline="False"
            Font-Size="XX-Small" Font-Strikeout="False" Font-Underline="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="ID_LISTA" HeaderText="LISTA" Visible="False"></asp:BoundColumn>
                <asp:BoundColumn DataField="ID_CONTRATTO" HeaderText="ID_CONTRATTO" Visible="False">
                </asp:BoundColumn>
                <asp:BoundColumn DataField="COD_CONTRATTO" HeaderText="CONTRATTO"></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="INDIRIZZO_UI" HeaderText="INDIRIZZO UNITA"></asp:BoundColumn>
                <asp:BoundColumn DataField="TIPO_COR" HeaderText="TIPO IND. CORR."></asp:BoundColumn>
                <asp:BoundColumn DataField="VIA_COR" HeaderText="IND. CORR."></asp:BoundColumn>
                <asp:BoundColumn DataField="CIVICO_COR" HeaderText="CIVICO CORR."></asp:BoundColumn>
                <asp:BoundColumn DataField="LUOGO_COR" HeaderText="LUOGO CORR."></asp:BoundColumn>
                <asp:BoundColumn DataField="SIGLA_COR" HeaderText="PROVINCIA CORR."></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="TIPO_CONTRATTO" HeaderText="TIPOLOGIA CONTR."></asp:BoundColumn>
                <asp:BoundColumn DataField="TIPO_SPECIFICO" HeaderText="TIPO SPECIFICO"></asp:BoundColumn>
                <asp:BoundColumn DataField="DATA_STIPULA" HeaderText="DATA STIPULA"></asp:BoundColumn>
