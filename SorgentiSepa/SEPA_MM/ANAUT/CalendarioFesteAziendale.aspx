<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CalendarioFesteAziendale.aspx.vb" Inherits="ANAUT_CalendarioFesteAziendale" %>
        ...
        <table style="width:100%;">
            <tr bgcolor="Maroon">
                <td class="style1" style="text-align: center; font-weight: 700">
                    CALENDARIO 
                    AZIENDALE FESTIVITA&#39;&nbsp; ( in aggiunta alle festività nazionali )</td>
            </tr>
            <tr>
                <td>
                    <table style="width:100%;">
