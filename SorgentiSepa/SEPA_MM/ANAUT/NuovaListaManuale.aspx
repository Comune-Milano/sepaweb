<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NuovaListaManuale.aspx.vb" Inherits="ANAUT_NuovaListaManuale" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Label ID="Label25" runat="server" 
                            Text="ATTENZIONE...Saranno estratte solo le posizioni precedentemente inserite e non escluse nelle liste dei convocabili" 
                            style="position:absolute; top: 440px; left: 16px;" ForeColor="Maroon" 
                    ...
                    <asp:Label ID="Label11" runat="server" Text="Struttura/e" Font-Names="arial" Font-Size="8pt" 
                            ...
                            <td valign="top" style="border: 1px solid #000080" bgcolor="#EBEBEB">
                                <asp:CheckBoxList ID="chListStrutture" runat="server" AutoPostBack="True" 
                                    CausesValidation="True" Font-Names="arial" Font-Size="8pt" RepeatColumns="3">
                                </asp:CheckBoxList>
                            </td>
                        </tr>
...
&nbsp;<asp:Label ID="Label24" runat="server" Text="a" Font-Names="arial" Font-Size="8pt" 
                    ...
                    <asp:Label ID="Label21" runat="server" Text="Patrimonio Immobiliare" Font-Names="arial" Font-Size="8pt" 
                            ...
                            <tr>
                                <td>
                    <asp:Label ID="Label1" runat="server" Text="Tipo Contratto" Font-Names="arial" Font-Size="8pt" 
                                   ></asp:Label>
                                </td>
                                <td>
                                ...
                                <td>
                    <asp:Label ID="Label2" runat="server" Text="Sindacato Riferimento" Font-Names="arial" Font-Size="8pt" 
                                   ></asp:Label>
                                </td>
                                <td>
