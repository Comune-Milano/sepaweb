...
Partial Class ANAUT_VisualizzaUnita
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            Try
                ...
                par.cmd.CommandText = "SELECT * FROM PARAMETER where ID=127"
                ...
                Else
                    ...
                    If esito = "1" Then
                        Dim aulight As String = Session.Item("AULIGHT")
                        Response.Redirect(par.DeCripta(IndirizzoCollegamento) & "UnitaLight.aspx?ID=" & par.CriptaMolto(Format(Now, "yyyyMMddHH") & "#" & par.DeCriptaMolto(aulight) & "@" & Chiave), True)
                    Else
                        Response.Write("<p style='font-family: arial, Helvetica, sans-serif; font-size: 10pt; font-weight: bold'>Non è possibile effettuare il collegamento</p>")
                    End If
                End If
