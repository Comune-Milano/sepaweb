...
function AzzeraCF(C1,C2)
{
 //C1.value='';
 C2.value='0';
 if (document.getElementById('Dic_Utenza1_txtCF').value!='')
 {
 document.getElementById('Dic_Utenza1_messaggio').value='>ATTENZIONE:Dati Anagrafici modificati! Verificare e modificare le eventuali occorrenze nei vari pannelli.<';
 document.getElementById('txtbinserito').value='0';
 document.getElementById('Dic_Utenza1_txtCF').value='';
 }
}
...
if (tab=='1') {
    ...
    document.getElementById('i5').src = '../p_menu/ReddConv_0.gif';
    document.getElementById('i6').src = '../p_menu/D8_0.gif';
    document.getElementById('i7').src = '../p_menu/D7_0.gif';
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('txtTab').value=tab;
    }
if (tab=='2') {  
    if (Valorizza()==0) {
    ...
    if (document.getElementById('txtbinserito').value=='0') {
        mias=MiaFormat(document.getElementById('Dic_Utenza1_txtCognome').value,25) + ' ' + MiaFormat(document.getElementById('Dic_Utenza1_txtNome').value,25) + ' ' + MiaFormat(document.getElementById('Dic_Utenza1_txtDataNascita').value,10) + ' ' + MiaFormat(document.getElementById('Dic_Utenza1_txtCF').value,16) + ' ' + MiaFormat('CAPOFAMIGLIA', 25) + ' ' + MiaFormat('0', 6) + ' ' + MiaFormat('-----', 5) + ' ' + MiaFormat('NO', 2);
...
if (tab=='5') {  
    ...
    document.getElementById('i3').src = '../p_menu/D3_0.gif';
    document.getElementById('i4').src = '../p_menu/D4_0.gif';
    document.getElementById('i5').src = '../p_menu/ReddConv_1.gif';
    document.getElementById('i6').src = '../p_menu/D8_0.gif';
    document.getElementById('i7').src = '../p_menu/D7_0.gif';
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('txtTab').value=tab;
...
if (tab=='6') { 
    ...
    document.getElementById('i4').src = '../p_menu/D4_0.gif';
    document.getElementById('i5').src = '../p_menu/ReddConv_0.gif';
    document.getElementById('i6').src = '../p_menu/D8_1.gif';
    document.getElementById('i7').src = '../p_menu/D7_0.gif';
    document.getElementById('i8').src = '../p_menu/D9_0.gif';
    document.getElementById('txtTab').value=tab;
    }
...
if (tab == '8') {
    if (Valorizza() == 0) {
        ...
        document.getElementById('i6').src = '../p_menu/D8_0.gif';
        document.getElementById('i7').src = '../p_menu/D7_0.gif';
        document.getElementById('i8').src = '../p_menu/D9_1.gif';
        document.getElementById('txtTab').value = tab;
    }
    else {
        tabv.visibility = 'visible';
...
function Valorizza(){
valore=0;
if (document.getElementById('Dic_Utenza1_txtCognome').value==''){
 valore=1;
}
if (document.getElementById('Dic_Utenza1_txtNome').value==''){
 valore=1;
}
if (document.getElementById('Dic_Utenza1_txtCF').value==''){
 valore=1;
}
if (document.getElementById('Dic_Utenza1_txtIndRes').value==''){
 valore=1;
}
if (document.getElementById('Dic_Utenza1_txtCivicoRes').value==''){
 valore=1;
}
if (valore==1){
...
function MiaFormat(testo,lunghezza){
    //par.MiaFormat(CType(Dic_Utenza1.FindControl("txtCognome"), TextBox).Text, 25) & " " & par.MiaFormat(CType(Dic_Utenza1.FindControl("txtNome"), TextBox).Text, 25) & " " & par.MiaFormat(CType(Dic_Utenza1.FindControl("txtDataNascita"), TextBox).Text, 10) & " " & par.MiaFormat(CType(Dic_Utenza1.FindControl("txtCF"), TextBox).Text, 16)
