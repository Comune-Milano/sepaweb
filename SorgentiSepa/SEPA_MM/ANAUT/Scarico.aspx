<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Scarico.aspx.vb" Inherits="ANAUT_Scarico" %>
            ...
            <tr>
                <td align="middle" bgcolor="floralwhite" style="height: 23px; text-align: left" valign="bottom">
                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"
                        ForeColor="Navy">Anagrafe Utenza - Ricerca Dichiarazioni da inviare</asp:Label></td>
            </tr>
            <tr>
