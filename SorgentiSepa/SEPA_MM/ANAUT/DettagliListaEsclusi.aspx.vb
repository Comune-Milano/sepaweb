...
Partial Class ANAUT_DettagliListaEsclusi
    ...
    Private Function CaricaDati()
        Try
            ...
            Tabella = "SELECT * FROM UTENZA_LISTE_CDETT WHERE ID_LISTA=" & Request.QueryString("ID") & " and MOTIVAZIONE IS NOT NULL ORDER BY FILIALE,SEDE,INTESTATARIO"
        ...
        Try
            ...
            For Each oDataGridItem In Me.DataGridRateEmesse.Items
                ...
                If chkExport.Checked Then
                    Trovato = True
                    PAR.cmd.CommandText = "UPDATE UTENZA_LISTE_CDETT SET MOTIVAZIONE=NULL  WHERE ID_LISTA=" & PAR.IfNull(dt.Rows(I).Item("ID_LISTA"), "-1") & " AND ID_CONTRATTO=" & PAR.IfNull(dt.Rows(I).Item("ID_CONTRATTO"), "-1")
