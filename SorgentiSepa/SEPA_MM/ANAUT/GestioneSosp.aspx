<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GestioneSosp.aspx.vb" Inherits="ANAUT_GestioneSosp" %>
...
<script type="text/javascript" src="../Contratti/moo.fx.pack.js"></script>
    <title>Gestione Motivi Sospensione</title>
    <style type="text/css">
        .style1
        {
            height: 19px;
...
<br/>
            ...
            <tr>
                <td style="width: 674px">
                   <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; 
                    Gestione Motivazioni Sospensioni appuntamenti</strong><br />
                    </span><br />
                    <br />
                    <br />
    ...
    <div id="ContenitoreVoci" 
                        ...
                        style="border: 1px solid #990000; overflow: auto; width: 531px; height: 315px; position:absolute; top: 66px; left: 14px;">
    <asp:DataGrid ID="DataGridCapitoli" runat="server" AutoGenerateColumns="False" 
        ...
        <script type="text/javascript">
            ...
            function Sicuro() {
                var chiediConferma
                chiediConferma = window.confirm("Attenzione, Eliminare la motivazione selezionata?");
