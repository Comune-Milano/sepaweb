    ...
    Protected Sub btnElabora_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnElabora.Click
        ...
        Try
            If FileUpload1.HasFile = True Then
                ...
                nFile = Server.MapPath("..\FileTemp\") & Format(Now, "yyyyMMddHHmmss") & "_" & FileUpload1.FileName
                ...
                Do While rdr.Read()
                    ...
                    row.Item("DESCRIZIONE") = rdr.Item(16).ToString
                ...
                Me.txtNote.Text = "MOROSITA' TROVATE: " & Conta1
    ...
    Protected Sub btn_Salva_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Salva.Click
        ...
        Try
            ...
            If Me.txtVisualizza.Value = 0 Then
                Response.Write("<script>alert('Nessun risutlato di morosità da salvare, riprovare ad elaborare il file!');</script>")
                Exit Sub

            End If

            If Me.txtModificato.Text = 0 Then
                Response.Write("<script>alert('Nessuna morosità trovata da salvare, riprovare ad elaborare il file!');</script>")
                Exit Sub
            End If
            ...
            If Strings.Len(Me.txtNote.Text) > 0 Then
                Me.txtNote.Text = Me.txtNote.Text & vbCrLf & "MOROSITA MODIFICATE: "
            End If
            ...
            For Each oDataGridItem In Me.DataGridExcel.Items
                ...
                'CONSTROLLO DEL CAMPO CODICE ESITO (se valorizzato e presente nel DATABASE)
                If oDataGridItem.Cells(18).Text = "&nbsp;" Then
                    ID = -1
                Else
                    ID = par.IfEmpty(Strings.Trim(oDataGridItem.Cells(18).Text), -1)
                End If

                If oDataGridItem.Cells(15).Text = "&nbsp;" Then
                    ID_TIPO = -1
                Else
                    ID_TIPO = par.IfEmpty(Strings.Trim(oDataGridItem.Cells(15).Text), -1)
                End If
                ...
                If ID > 0 Then
                    ...
                    If myReader1.Read Then
                        ...
                        If Strings.Len(Me.txtNote.Text) > 0 Then
                            Me.txtNote.Text = Me.txtNote.Text & vbCrLf & "BOLLETTINO: " & par.IfNull(myReader1("BOLLETTINO"), "") & " del CONTRATTO: " & par.IfNull(myReader1("COD_CONTRATTO"), "") & " esito: " & oDataGridItem.Cells(16).Text
                        End If
                        ...
                        par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("data", par.AggiustaData(oDataGridItem.Cells(17).Text)))

                        par.cmd.Parameters.Add(New Oracle.DataAccess.Client.OracleParameter("id_tipo", RitornaNullSeIntegerMenoUno(par.IfEmpty(oDataGridItem.Cells(15).Text, -1))))
