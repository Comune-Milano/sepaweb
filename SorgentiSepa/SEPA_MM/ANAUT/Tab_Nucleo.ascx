                ...
                <tr>
                        ...
                        <div style="overflow-x: hidden; overflow-y: auto; width: 100%; height: 70px;" id="elencoComp">
                            <asp:DataGrid ID="DataGridComponenti" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="TELEFONO1" HeaderText="TELEFONO1" Visible="False">
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="TELEFONO2" HeaderText="TELEFONO2" Visible="False">
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="EMAIL1" HeaderText="EMAIL1" Visible="False">
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="EMAIL2" HeaderText="EMAIL2" Visible="False">
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="FL_L104" HeaderText="L104" Visible="False">
                                    </asp:BoundColumn>
                                </Columns>
                            </asp:DataGrid>
                        </div>
                    ...
                    <td style="vertical-align: top;">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/ANAUT/img/ImgDelete.png"
                                        ToolTip="Elimina Componente" Style="width: 16px;" 
                                        OnClientClick="document.getElementById('provenienza').value='nucleo';VerificaSelezionato();return false;" />
                                </td>
                            </tr>
                        </table>
                    </td>
...
<asp:Button ID="btnAggiungiNucleo" runat="server" Text="Aggiungi Nucleo" Style="visibility: hidden" />
<asp:Button ID="btnAggiungiSpesa" runat="server" Text="Aggiungi Spesa Componente"
...
<div>
    ...
    <asp:HiddenField ID="telefono1" runat="server" />
    <asp:HiddenField ID="telefono2" runat="server" />
    <asp:HiddenField ID="mail1" runat="server" />
    <asp:HiddenField ID="mail2" runat="server" />
    <asp:HiddenField ID="l104" runat="server" />
</div>
<script type="text/javascript" language="javascript">
    function VerificaSelezionato() {
        if (document.getElementById('idComp').value == '-1' || document.getElementById('idComp').value == '0') {
            Avviso();
        }
        else {
            Verifica();
