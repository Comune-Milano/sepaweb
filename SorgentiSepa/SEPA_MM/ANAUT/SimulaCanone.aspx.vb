...
Partial Class ANAUT_SimulaCanone
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                Dim IDDichiarazione As String = Request.QueryString("ID")
                Dim S As String = ""
                ...
                par.cmd.CommandText = "SELECT utenza_dichiarazioni.*,UNITA_IMMOBILIARI.ID AS IDUNITA FROM utenza_dichiarazioni,SISCOM_MI.UNITA_IMMOBILIARI WHERE UNITA_IMMOBILIARI.COD_UNITA_IMMOBILIARE=UTENZA_DICHIARAZIONI.POSIZIONE AND UTENZA_DICHIARAZIONI.ID=" & IDDichiarazione
                ...
                If myReader.Read() Then
                    ...
                    Label1.Text = Replace(S, vbCrLf, "</br>")
                End If
                myReader.Close()
                par.cmd.Dispose()
