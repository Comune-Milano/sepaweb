<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SimulazioneGruppoAU.aspx.vb" Inherits="ANAUT_SimulazioneGruppoAU" %>
        ...
        <table style="width:100%;">
            <tr>
                <td align="left" 
                    ...
                    SIMULAZIONE APPLICAZIONE AU</td>
            </tr>
            <tr>
                <td>
                    &nbsp; &nbsp;</td>
                ...
                <asp:datagrid id="DataGrid1" runat="server" Font-Names="Arial" 
                        ...
                        CellPadding="4" ForeColor="#333333">
							...
							<Columns>
							    ...
							    <asp:BoundColumn DataField="PG_DICHIARAZIONE_AU_2009" HeaderText="PG AU">
                                    <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                        Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                        Font-Strikeout="False" Font-Underline="False" Wrap="False" />
