...
Partial Class ANAUT_Convocabili
    ...
    Protected Sub btnProcedi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnProcedi.Click
        Try
            ...
            If s <> "" Then
                s = Mid(s, 1, Len(s) - 1)
                If b = True Then
                    s = " AND UTENZA_FILIALI.ID IN (" & s & ")"
                Else
                    s = " UTENZA_FILIALI.ID IN (" & s & ")"
                End If
                b = True
            End If
            ...
            If s <> "" Then
                s = Mid(s, 1, Len(s) - 1)
                If b = True Then
                    s = " AND UTENZA_SPORTELLI.ID IN (" & s & ")"
                Else
                    s = " UTENZA_SPORTELLI.ID IN (" & s & ")"
                End If
                b = True
            End If
            ...
            If cmbCompDa.SelectedItem.Text <> "--" Or cmbCompA.SelectedItem.Text <> "--" Then
                ...
                If cmbCompDa.SelectedItem.Text <> "--" And cmbCompA.SelectedItem.Text = "--" Then
                    If b = True Then
                        s = " AND ec1.num_comp>=" & cmbCompDa.SelectedItem.Text
                    Else
                        s = " ec1.num_comp>=" & cmbCompDa.SelectedItem.Text
                    End If
                    NumComponenti = "da " & cmbCompDa.SelectedItem.Text
                End If
                If cmbCompDa.SelectedItem.Text = "--" And cmbCompA.SelectedItem.Text <> "--" Then
                    If b = True Then
                        s = " AND ec1.num_comp<=" & cmbCompA.SelectedItem.Text
                    Else
                        s = " ec1.num_comp<=" & cmbCompA.SelectedItem.Text
                    End If
                ...
                If cmbCompDa.SelectedItem.Text <> "--" And cmbCompA.SelectedItem.Text <> "--" Then
                    If b = True Then
                        s = " AND ec1.num_comp>=" & cmbCompDa.SelectedItem.Text & " AND EC1.NUM_COMP<=" & cmbCompA.SelectedItem.Text
                    Else
                        s = " ec1.num_comp>=" & cmbCompDa.SelectedItem.Text & " AND EC1.NUM_COMP<=" & cmbCompA.SelectedItem.Text
                    End If
            ...
            If cmb100Non.SelectedItem.Text = "SI" Or cmb100Non.SelectedItem.Text = "NO" Then
                If cmb100Non.SelectedItem.Text = "SI" Then
                    If b = True Then
                        s = " AND ec1.NUM_COMP_100<>'0'"
                    Else
                        s = " ec1.NUM_COMP_100<>'0'"
                    End If
            ...
            If cmb100Acc.SelectedItem.Text = "SI" Or cmb100Acc.SelectedItem.Text = "NO" Then
                If cmb100Acc.SelectedItem.Text = "SI" Then
                    If b = True Then
                        s = " AND ec1.NUM_COMP_100_CON<>'0'"
                    Else
                        s = " ec1.NUM_COMP_100_CON<>'0'"
                    End If
            ...
            If cmbDip.SelectedItem.Text = "SI" Or cmbDip.SelectedItem.Text = "NO" Then
                If cmbDip.SelectedItem.Text = "SI" Then
                    If b = True Then
                        s = " AND ec1.redd_prev_dip='1'"
                    Else
                        s = " ec1.redd_prev_dip='1'"
                    End If
                    RedditoDip = "SI"
                End If
                ...
                If cmbDip.SelectedItem.Text = "NO" Then
                    If b = True Then
                        s = " AND ec1.redd_prev_dip='0'"
                    Else
                        s = " ec1.redd_prev_dip='0'"
                    End If
                    RedditoDip = "NO"
                End If
                b = True
            ...
            If cmbImmobiliare.SelectedItem.Text = "SI" Or cmbImmobiliare.SelectedItem.Text = "NO" Then
                If cmbImmobiliare.SelectedItem.Text = "SI" Then
                    If b = True Then
                        s = " AND EC1.redd_immobiliari <>'0'"
                    Else
                        s = " EC1.redd_immobiliari <>'0'"
                    End If
                    RedditoImm = "SI"
                End If
