<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaNonR.aspx.vb" Inherits="ANAUT_RicercaNonR" %>
    ...
    function CompletaData(e, obj) {
        ...
        defaultfocus="txtCognome">
                ...
                <tr>
                    <td style="width: 670px">
                        ...
                        <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; Ricerca
                            Dichiarazioni non Rispondenti Unità Reali</strong></span><br />
                        <br />
                        <br />
                        <br />
                        <br />
            ...
            <asp:ImageButton ID="btnCerca" runat="server" ImageUrl="~/NuoveImm/Img_AvviaRicerca.png"
                Style="z-index: 101; left: 406px; position: absolute; top: 379px" 
                TabIndex="8" ToolTip="Avvia Ricerca" />
									<asp:label id="Label2" runat="server" 
                Font-Size="8pt" Font-Names="Arial" Font-Bold="True" 
                
                style="z-index: 104; left: 50px; position: absolute; top: 129px; height: 12px;">Sede Territoriale</asp:label>
                ...
                style="z-index: 106; left: 27px; position: absolute; top: 308px; width: 608px; height: 45px;" 
                ...
                style="z-index: 106; left: 27px; position: absolute; top: 250px; width: 608px; height: 45px;" 
                ForeColor="#CC0000">ATTENZIONE...Non saranno considerati gli appuntamenti SOSPESI PER POSTA, SOSPESI PER SINDACATO e AVVENUTI .</asp:label>
                <asp:TextBox ID="txtStipulaAl" runat="server" BorderStyle="Solid" BorderWidth="1px"
                            ...
                            MaxLength="10" Style="z-index: 113; left: 287px; position: absolute; top: 180px"
                            TabIndex="6" ToolTip="gg/mm/aaaa" Width="70px">30/06/2012</asp:TextBox>
                ...
                style="z-index: 106; left: 50px; position: absolute; top: 211px; height: 29px; width: 397px;">Escludi contratti chiusi dopo l&#39;invio dopo la notifica dell&#39;appuntamento</asp:label>
                ...
                style="border: 1px solid black; z-index: 111; left: 173px; position: absolute; top: 97px"></asp:DropDownList>
