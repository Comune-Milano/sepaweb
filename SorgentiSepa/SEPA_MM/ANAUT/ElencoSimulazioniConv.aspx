<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElencoSimulazioniConv.aspx.vb" Inherits="ANAUT_ElencoSimulazioniConv" %>
            ...
            <tr>
                <td style="width: 674px">
                   <span style="font-size: 14pt; color: #801f1c; font-family: Arial"><strong>&nbsp; 
                    Elenco Simulazioni Convocazioni AU</strong><br />
                    </span><br />
                    <br />
                    <br />
    ...
    <asp:DataGrid ID="DataGridCapitoli" runat="server" AutoGenerateColumns="False" 
            ...
            ForeColor="#333333" GridLines="None">
                    ...
                    <asp:Image ID="imgEsci" runat="server" 
                        style="position:absolute; top: 512px; left: 586px; cursor:pointer" 
                    ...
                    <asp:ImageButton ID="ImgBtnElimina" runat="server" ImageUrl="~/NuoveImm/Img_Elimina.png"
                        Style="left: 563px; position: absolute; top: 67px; height: 12px;" 
                        ToolTip="Elimina la voce selezionata" onclientclick="Sicuro();" />

   <asp:ImageButton ID="imgConferma" runat="server" ImageUrl="~/NuoveImm/Img_Conferma_Simulazione.png"
                        Style="left: 563px; position: absolute; top: 99px; " 
                        ToolTip="Conferma" onclientclick="SicuroConferma();" />
        ...
        <script type="text/javascript">
           ...
           function Sicuro() {
                if (document.getElementById('txtid').value != '') {
                    var chiediConferma
                    chiediConferma = window.confirm("Attenzione, Eliminare la Simulazione selezionata?");
        ...
        style='position:absolute; background-color:#ffffff; text-align:center; width:95%; height:95%; top:20px; left:10px; z-index:10; border:1px dashed #660000;font:verdana; font-size:10px; visibility: hidden;'></br><img src='../Contratti/Immagini/load.gif' alt='Elaborazione in corso' ></br>Elaborazione in corso</br></div>"
