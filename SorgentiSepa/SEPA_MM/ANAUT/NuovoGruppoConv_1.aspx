<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NuovoGruppoConv_1.aspx.vb" Inherits="ANAUT_NuovoGruppoConv_1" %>
        ...
        <table style="width:100%;">
            <tr>
                <td style="font-family: ARIAL, Helvetica, sans-serif; font-size: 12pt; font-weight: bold; text-align: center;">
                    Nuovo Gruppo - Ricerca da liste Convocabili - Step 2
                    -
            ...
            <tr>
                ...
                <asp:ImageButton ID="imgSelezionaTutto" runat="server" 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;
                    <img id="imgSalvaLista" alt="" src="../NuoveImm/Img_SalvaGruppoConvocazione.png" 
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" Font-Names="arial" Font-Size="10pt" 
                                    Font-Strikeout="False" ForeColor="#0000CC" Text="Nome Gruppo"></asp:Label>
                            </td>
