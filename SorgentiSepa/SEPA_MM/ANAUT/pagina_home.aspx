	...
	<body bgColor="#f2f5f1" onload="document.getElementById('txtmessaggio').style.visibilty='hidden';" background="../NuoveImm/sfondocopertina.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <img src="../immagini/sistemiesoluzionisrl.gif" style="z-index: 111; left: 26px; position: absolute;
                top: 497px" />
            &nbsp; &nbsp;&nbsp;
            <asp:Image ID="Image1" runat="server" ImageUrl="~/NuoveImm/Albero_1.gif" Style="left: 154px;
                position: absolute; top: 407px" />
            <asp:Image ID="Image2" runat="server" ImageUrl="~/NuoveImm/Albero_1.gif" Style="left: 154px;
                position: absolute; top: 432px" />
            <asp:HyperLink ID="HyperLink3" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" NavigateUrl="~/ANAUT/Autenticazione.aspx?OP=1" Style="left: 169px;
                position: absolute; top: 407px" Target="_self">Inviaci i dati dell'utenza E.R.P. e degli alloggi del Comune di Milano</asp:HyperLink>
            <asp:HyperLink ID="HyperLink4" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" NavigateUrl="~/ANAUT/Autenticazione.aspx?OP=2" Style="left: 169px;
                position: absolute; top: 432px" Target="_self">Scarica i dati dell'utenza E.R.P. e degli alloggi del Comune di Milano</asp:HyperLink>
