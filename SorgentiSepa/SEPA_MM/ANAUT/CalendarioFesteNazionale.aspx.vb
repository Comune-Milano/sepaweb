...
Partial Class ANAUT_CalendarioFesteNazionale
    ...
    Private Function BindGrid()
        Try
            ...
            Dim da As New Oracle.DataAccess.Client.OracleDataAdapter("select note,substr(giorno,3,2)||'/'||substr(giorno,1,2) as giorno1 from UTENZA_FESTIVITA_ST order by giorno asc", par.OracleConn)
            Dim ds As New Data.DataSet()

            da.Fill(ds, "UTENZA_FESTIVITA_ST")
    ...
    Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        If e.Item.Cells(0).Text <> "GIORNO/MESE" Then
    ...
    Protected Sub imgSalva_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgSalva.Click
        Try
            ...
            par.cmd.CommandText = "Insert into SEPA.UTENZA_FESTIVITA_ST (ID, GIORNO, NOTE) Values (SEQ_UTENZA_FESTIVITA.NEXTVAL, '" & cmbMese.SelectedItem.Value & Format(CInt(cmbGiorno.SelectedItem.Text), "00") & "', '" & par.PulisciStrSql(txtNote.Text) & "')"
    ...
    Protected Sub imgElimina_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgElimina.Click
        If H1.Value <> "0" Then
            SceltaJQuery("Eliminare il giorno selezionato? Non sarà più possibile annullare questa operazione.", "btnEliminaGiorno", "Attenzione...", "")

        Else
            MessJQuery("Scegliere un giorno dalla lista.", 0, "Attenzione")
        End If
    End Sub
    ...
    Protected Sub btnEliminaGiorno_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnEliminaGiorno.Click
        ...
        Try
            ...
            par.cmd.CommandText = "DELETE FROM SEPA.UTENZA_FESTIVITA_ST WHERE GIORNO='" & Mid(Replace(LBLID.Value, "/", ""), 3, 2) & Mid(Replace(LBLID.Value, "/", ""), 1, 2) & "'"
            par.cmd.ExecuteNonQuery()
