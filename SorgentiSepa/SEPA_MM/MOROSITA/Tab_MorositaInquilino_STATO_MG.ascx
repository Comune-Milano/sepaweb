<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_MorositaInquilino_STATO_MG.ascx.vb" Inherits="Tab_Morosita_STATO_MG" %>
<table id="T_MG">
    <tr>
        <td>
    ...
    <tr>
        <td>
            <div style="border-right: #0000cc thin solid; border-top: #0000cc thin solid; visibility: visible;
                ...
                </asp:DataGrid></div><table id="Table1_MG">
    <tr>
