...
Partial Class MOROSITA_RicercaReportMorosita
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.txtDataEMISSIONE_DAL.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
            Me.txtDataEMISSIONE_AL.Attributes.Add("onkeypress", "javascript:CompletaData(event,this);")
    ...
    Protected Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnStampa.Click
        ...
        Try
            ...
            'If RBList1.Items(0).Selected = True Then
            TipoGestione = "MG"
            ...
            If Strings.Len(Me.txtDataEMISSIONE_AL.Text) > 0 Then
                ...
                If Strings.Len(Me.txtDataEMISSIONE_DAL.Text) > 0 Then
                    ...
                    If par.AggiustaData(Me.txtDataEMISSIONE_DAL.Text) > par.AggiustaData(Me.txtDataEMISSIONE_AL.Text) Then
                        Response.Write("<script>alert('Attenzione...Controllare il range delle date!');</script>")
                        ControlloCampi = False
                        Exit Sub
                    End If
            ...
            If ControlloCampi = True Then
                ...
                Response.Write("<script>window.open('Flussi_Morosita.aspx?DAL=" & par.IfEmpty(par.AggiustaData(Me.txtDataRIF_DAL.Text), "") _
                                                                       & "&AL=" & par.IfEmpty(par.AggiustaData(Me.txtDataRIF_AL.Text), "") _
                                                                       & "&E_DAL=" & par.IfEmpty(par.AggiustaData(Me.txtDataEMISSIONE_DAL.Text), "") _
                                                                       & "&E_AL=" & par.IfEmpty(par.AggiustaData(Me.txtDataEMISSIONE_AL.Text), "") _
                                                                   & "&TIPO=" & TipoGestione _
                                    & "','STAMPA" & Format(Now, "hhss") & "');self.close();</script>")
