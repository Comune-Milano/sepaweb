<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni.aspx.vb" Inherits="MOROSITA_menu_funzioni" %>
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image3" runat="server" 
                ImageUrl="~/MOROSITA/Immagini/Titolo_Morosita.png" Style="left: 24px;
