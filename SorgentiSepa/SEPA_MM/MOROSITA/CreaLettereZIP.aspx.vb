...
Partial Class Morosita_CreaLettere3
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim i, j As Integer
        Dim IndiceMorositaLettera1 As String = ""
        Dim IndiceMorositaLettera2 As String = ""
        ...
        If Not IsPostBack Then
            Try
                IndiceMorositaLettera1 = Request.QueryString("IDMOR_LETTERA_1")
                IndiceMorositaLettera2 = Request.QueryString("IDMOR_LETTERA_2")

                Dim strNomeFile As String = ""

                If IndiceMorositaLettera1 <> "-1" And IndiceMorositaLettera2 <> "-1" Then
                    strNomeFile = "MOROSITA' MG - MA "
                ElseIf IndiceMorositaLettera2 <> "-1" Then
                    strNomeFile = "MOROSITA' MA "
                Else
                    strNomeFile = "MOROSITA' MG "
                End If


                MiaSHTML = "<table border='0' cellpadding='1' cellspacing='1' width='700px'>" & vbCrLf
                MiaSHTML = MiaSHTML & "<tr>" & vbCrLf
                MiaSHTML = MiaSHTML & "<td width='300px'><font face='Arial' size='2'>Nome del File</font></td>" & vbCrLf
                ...
                For Each foundFile As String In My.Computer.FileSystem.GetFiles(Server.MapPath("..\ALLEGATI\MOROSITA_CONTRATTI\"), FileIO.SearchOption.SearchTopLevelOnly, "MorositaLettera_" & IndiceMorositaLettera1 & "-*.zip")
                ...
                For Each foundFile As String In My.Computer.FileSystem.GetFiles(Server.MapPath("..\ALLEGATI\MOROSITA_CONTRATTI\"), FileIO.SearchOption.SearchTopLevelOnly, "MorositaLettera_" & IndiceMorositaLettera2 & "-*.zip")
                ...
                If i > 0 Then
                    For j = 0 To i - 1
                        MiaSHTML = MiaSHTML & "<tr>" & vbCrLf
                        MiaSHTML = MiaSHTML & "<td width='300px' bgcolor='" & MIOCOLORE & "'><font face='Arial' size='1'><a href='../ALLEGATI/MOROSITA_CONTRATTI/" & RicavaFile(ElencoFile(j)) & "' target='_blank'>" & RicavaFile(ElencoFile(j)) & "</a></font></td>" & vbCrLf
                        MiaSHTML = MiaSHTML & "<td width='250px' bgcolor='" & MIOCOLORE & "'><font face='Arial' size='1'>" & strNomeFile & "</font></td>" & vbCrLf
