<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaReportContabili.aspx.vb" Inherits="MOROSITA_RicercaReportContabili" %>
            ...
            <tr>
                <td>
                    <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">
                        Ricerca Report Contabili</span></strong>
                <table id="Table2">
                            <tr>
                                <td class="style6">
                                    </td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblProtocollo0" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                                ForeColor="Black" Style="z-index: 100; left: 48px; top: 96px"
                                                Width="120px">Tipo di gestione:
                                    </asp:Label>
                                 </td>
                                <td>
                            ...
                            <tr>
                                <td class="style1">
                                    <asp:Label ID="Label7" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"
                                        Style="z-index: 100; left: 48px; top: 64px" Width="125px">Competenza Bollette dal:</asp:Label>
                                </td>
                                <td class="style1">
                                    <table>
                                        <tr>
