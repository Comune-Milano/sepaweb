<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaDebitoriMultiselezione2.aspx.vb" Inherits="MOROSITA_RicercaDebitoriMultiselezione2" %>
...
<body>
    ...
    <div style="overflow: auto; height: 780px; width: 100%;">
                    ...
                    <asp:View ID="View1" runat="server">
                        <table border="0" cellpadding="0" cellspacing="0" width="99%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    &nbsp;
                                    <asp:Button ID="ButtonRiepilogoBollette" Text="STAMPA RIEPILOGO BOLLETTE" runat="server"
                                        Width="80%" Style="cursor: pointer; background-color: #507CD1; border: 1px solid #507CD1;
                                        color: White; font-size: 7pt" Height="30px" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <td style="width: 100%">
                                                    <asp:DataGrid runat="server" ID="DataGridInquilini" AutoGenerateColumns="False" CellPadding="1"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="DEBITO2" HeaderText="SALDO ATTUALE" ItemStyle-HorizontalAlign="Right"
                            ...
                            <tr>
                                <td style="width: 100%; text-align: right">
                                    <br />
                                    <asp:Button ID="ButtonNuovaRicerca" Text="NUOVA RICERCA" runat="server" Width="15%"
                                        Style="cursor: pointer; background-color: #507CD1; border: 1px solid #507CD1;
                                        color: White; font-size: 7pt" Height="30px" />
                                    <asp:Button ID="ButtonProcediDettaglioInquilini" Text="STAMPA DETTAGLIO INQUILINI"
                                        runat="server" Width="15%" Style="background-color: #507CD1; border: 1px solid #507CD1;
                                        color: White; font-size: 7pt" Height="30px" />
                                </td>
                            </tr>
                        </table>
