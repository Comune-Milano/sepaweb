...
Partial Class MOROSITA_RisultatiMultiselezione
    Inherits PageSetIdMode
    Dim par As New CM.Global
    Dim listaQueryInquilini3Mesi As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquilini3MesiCount As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquilini312Mesi As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquilini312MesiCount As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquilini12Mesi As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquilini12MesiCount As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquiliniAllMesi As New System.Collections.Generic.List(Of String)
    Dim listaQueryInquiliniAllMesiCount As New System.Collections.Generic.List(Of String)
    ...
    Private Sub caricaDatiTutti()
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    queryInquiliniallMesi = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquiliniAllMesi.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                ...
                par.cmd.CommandText = queryInquiliniallMesi & " group by id_Stato_morosita "
                ...
                For Each riga As Data.DataRow In dataTableALL.Rows
                    Select Case riga.Item(2).ToString
                        Case "0"
                            nRUmorosiAltriALL += CDec(riga.Item(1))
                            RUmorosiAltriALLMesi += CDec(riga.Item(0))
                        Case "1"
                            nRUmorosiMMALL += CDec(riga.Item(1))
                            RUmorosiMMALLMesi += CDec(riga.Item(0))
                        Case "2"
                            nRUmorosiCSALL += CDec(riga.Item(1))
                            RUmorosiCSALLMesi += CDec(riga.Item(0))
                        Case "3"
                            nRUmorosiPLALL += CDec(riga.Item(1))
                            RUmorosiPLALLMesi += CDec(riga.Item(0))
                        Case Else
                            nRUmorosiAltriALL += CDec(riga.Item(1))
                            RUmorosiAltriALLMesi += CDec(riga.Item(0))
                    End Select
                ...
                nRUmorosiALL = nRUmorosiAltriALL + nRUmorosiMMALL + nRUmorosiCSALL + nRUmorosiPLALL
                RUmorosiALLMesi = RUmorosiAltriALLMesi + RUmorosiMMALLMesi + RUmorosiCSALLMesi + RUmorosiPLALLMesi
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    querySommebolMesi = "SELECT " _
                                   ...
                                   & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.num_bollette_ALER,0)+nvl(num_bollette_global,0)),'999g999g999g990d99')) as bollette " _
                                   & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                   & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                   & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                   & " SISCOM_MI.ANAGRAFICA, " _
    ...
    Private Sub caricaDatiTuttiCreditori()
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    queryInquiliniALLMesiCredito = "SELECT " _
                                    & " trim(to_char(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0),'999g999g999g990d99')) as DEBITO " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            listaContratti = Left(listaContratti, Len(listaContratti) - 1)
                            listaQueryInquiliniAllMesiCredito.Add("SELECT trim(to_char(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0),'999g999g999g990d99')) as DEBITO " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
    ...
    Private Sub caricaDati3Mesi()
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                Dim queryInquilini3MesiCount As String = ""
                Dim querySomme3Mesi As String = ""
                If ListaM(0) = "-1" Then


                    queryInquilini3Mesi = "SELECT /*rownum, presso_cor as intestatario,*/ " _
                                    & " trim(to_char(NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0),'999g999g999g990d99')) as DEBITO, RAPPORTI_UTENZA.ID, " _
                                    ...
                                    & " AS INTESTATARIO ," _
                                    & " TRIM (TO_CHAR( NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0),'9G999G999G999G999G990D99'))   as DEBITO2," _
                                    ...
                                    & " AND SISCOM_MI.COMPLESSI_IMMOBILIARI.ID <> 1 " _
                                    & " AND SALDI_MESE.ID_CONTRATTO = RAPPORTI_UTENZA.ID " _
                                    & " and NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0)>0 " _
                                    & " AND MESE=" & mese & " AND ANNO=" & anno _
                                    & " and rapporti_utenza.id=" & ListaM(1) & ".id "

                    

                    queryInquilini3MesiCount = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    ...
                    querySomme3Mesi = "SELECT " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0)),'999g999g999g990d99')) as SALDO_TOTALE, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)),'999g999g999g990d99')) as SALDO_GLOBAL, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0)),'999g999g999g990d99')) as SALDO_ALER, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.CANONE_ALER_3,0)),'999g999g999g990d99')) as CANONE_ALER, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.SERVIZI_ALER_3,0)),'999g999g999g990d99')) as SERVIZI_ALER " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquilini3MesiCount.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.saldo_global_3,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_3,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    ...
                    Next
                    For Each Items As String In listaQueryInquilini3MesiCount
                        queryInquilini3MesiCount &= Items & " UNION "
                    Next
                    ...
                    queryInquilini3MesiCount = Left(queryInquilini3MesiCount, Len(queryInquilini3MesiCount) - 6)
                ...
                par.cmd.CommandText = queryInquilini3Mesi & " order by 4"
                ...
                par.cmd.CommandText = queryInquilini3MesiCount & " GROUP BY ID_STATO_MOROSITA"
                Dim dataAdaptercount As New Oracle.DataAccess.Client.OracleDataAdapter(par.cmd)
                Dim dataTablecount As New Data.DataTable
                dataAdaptercount.Fill(dataTablecount)
                ...
                For Each riga As Data.DataRow In dataTablecount.Rows
                    Select Case riga.Item(2).ToString
                        Case "0"
                            nRUmorosiAltri += CDec(riga.Item(1))
                            RUmorosiAltri3Mesi += CDec(riga.Item(0))
                        Case "1"
                            nRUmorosiMM += CDec(riga.Item(1))
                            RUmorosiMM3Mesi += CDec(riga.Item(0))
                        Case "2"
                            nRUmorosiCS += CDec(riga.Item(1))
                            RUmorosiCS3Mesi += CDec(riga.Item(0))
                        Case "3"
                            nRUmorosiPL += CDec(riga.Item(1))
                            RUmorosiPL3Mesi += CDec(riga.Item(0))
                        Case Else
                            nRUmorosiAltri += CDec(riga.Item(1))
                            RUmorosiAltri3Mesi += CDec(riga.Item(0))
                    End Select
                ...
                nRUmorosi = nRUmorosiAltri + nRUmorosiMM + nRUmorosiCS + nRUmorosiPL
                RUmorosi3Mesi = RUmorosiAltri3Mesi + RUmorosiMM3Mesi + RUmorosiCS3Mesi + RUmorosiPL3Mesi
    ...
    Private Sub caricaDati312Mesi()
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                Dim queryInquilini312Mesicount As String = ""
                Dim querySomme312Mesi As String = ""
                If ListaM(0) = "-1" Then
                    queryInquilini312Mesi = "SELECT /*rownum, presso_cor as intestatario,*/ " _
                                    & " trim(to_char(NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0),'999g999g999g990d99')) as DEBITO, RAPPORTI_UTENZA.ID, " _
                                    & " trim(RAPPORTI_UTENZA.COD_CONTRATTO) as  CODICE_CONTRATTO ," _
                                    & " case when ANAGRAFICA.RAGIONE_SOCIALE is not null " _
                                    & " then  trim(RAGIONE_SOCIALE) " _
                                    & " else  RTRIM(LTRIM(COGNOME ||' ' ||ANAGRAFICA.NOME)) end " _
                                    & " AS INTESTATARIO ," _
                                    & " TRIM (TO_CHAR( NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0),'9G999G999G999G999G990D99'))   as DEBITO2," _
                                    & " trim(RAPPORTI_UTENZA.COD_TIPOLOGIA_CONTR_LOC) as ""COD_TIPOLOGIA_CONTR_LOC""," _
                                    & " substr(TIPOLOGIA_RAPP_CONTRATTUALE.DESCRIZIONE,1,25) as ""POSIZIONE_CONTRATTO""," _
                                    & " UNITA_IMMOBILIARI.COD_UNITA_IMMOBILIARE AS COD_UNITA_IMMOBILIARE ," _
                                    & " trim(UNITA_IMMOBILIARI.COD_TIPOLOGIA) as ""COD_TIPOLOGIA""," _
                                    ...
                                    & " AND SISCOM_MI.COMPLESSI_IMMOBILIARI.ID <> 1 " _
                                    & " AND SALDI_MESE.ID_CONTRATTO = RAPPORTI_UTENZA.ID " _
                                    & " and NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0)>0 " _
                                    & " AND MESE=" & mese & " AND ANNO=" & anno _
                                    & " and rapporti_utenza.id=" & ListaM(1) & ".id "

                    queryInquilini312Mesicount = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    ...
                    querySomme312Mesi = "SELECT " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0)),'999g999g999g990d99')) as SALDO_TOTALE, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)),'999g999g999g990d99')) as SALDO_GLOBAL, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0)),'999g999g999g990d99')) as SALDO_ALER, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.CANONE_ALER_12,0)),'999g999g999g990d99')) as CANONE_ALER, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.SERVIZI_ALER_12,0)),'999g999g999g990d99')) as SERVIZI_ALER " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquilini312MesiCount.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.saldo_global_12,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_12,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    ...
                    Next
                    For Each Items As String In listaQueryInquilini312MesiCount
                        queryInquilini312Mesicount &= Items & " UNION "
                    Next
                    ...
                    queryInquilini312Mesicount = Left(queryInquilini312Mesicount, Len(queryInquilini312Mesicount) - 6)
                ...
                par.cmd.CommandText = queryInquilini312Mesi & " order by 4"
                Dim dataAdapter As New Oracle.DataAccess.Client.OracleDataAdapter(par.cmd)
                Dim dataTable As New Data.DataTable
                dataAdapter.Fill(dataTable)
                DataGridInquilini312Mesi.DataSource = dataTable
                DataGridInquilini312Mesi.DataBind()


                par.cmd.CommandText = queryInquilini312Mesicount & " GROUP BY ID_STATO_MOROSITA"
                Dim dataAdaptercount As New Oracle.DataAccess.Client.OracleDataAdapter(par.cmd)
                Dim dataTablecount As New Data.DataTable
                dataAdaptercount.Fill(dataTablecount)
                ...
                For Each riga As Data.DataRow In dataTablecount.Rows
                    Select Case riga.Item(2).ToString
                        Case "0"
                            nRUmorosiAltri312 += CDec(riga.Item(1))
                            RUmorosiAltri312Mesi += CDec(riga.Item(0))
                        Case "1"
                            nRUmorosiMM312 += CDec(riga.Item(1))
                            RUmorosiMM312Mesi += CDec(riga.Item(0))
                        Case "2"
                            nRUmorosiCS312 += CDec(riga.Item(1))
                            RUmorosiCS312Mesi += CDec(riga.Item(0))
                        Case "3"
                            nRUmorosiPL312 += CDec(riga.Item(1))
                            RUmorosiPL312Mesi += CDec(riga.Item(0))
                        Case Else
                            nRUmorosiAltri312 += CDec(riga.Item(1))
                            RUmorosiAltri312Mesi += CDec(riga.Item(0))
                    End Select
                ...
                nRUmorosi312 = nRUmorosiAltri312 + nRUmorosiMM312 + nRUmorosiCS312 + nRUmorosiPL312
                RUmorosi312Mesi = RUmorosiAltri312Mesi + RUmorosiMM312Mesi + RUmorosiCS312Mesi + RUmorosiPL312Mesi
    ...
    Private Sub caricaDati12Mesi()
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                Dim queryInquilini12Mesicount As String = ""
                Dim querySomme12Mesi As String = ""
                If ListaM(0) = "-1" Then
                    queryInquilini12Mesi = "SELECT /*rownum, presso_cor as intestatario,*/ " _
                                    & " trim(to_char(NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0),'999g999g999g990d99')) as DEBITO, RAPPORTI_UTENZA.ID, " _
                                    & " trim(RAPPORTI_UTENZA.COD_CONTRATTO) as  CODICE_CONTRATTO ," _
                                    & " case when ANAGRAFICA.RAGIONE_SOCIALE is not null " _
                                    & " then  trim(RAGIONE_SOCIALE) " _
                                    & " else  RTRIM(LTRIM(COGNOME ||' ' ||ANAGRAFICA.NOME)) end " _
                                    & " AS INTESTATARIO ," _
                                    & " TRIM (TO_CHAR( NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0),'9G999G999G999G999G990D99'))   as DEBITO2," _
                                    & " trim(RAPPORTI_UTENZA.COD_TIPOLOGIA_CONTR_LOC) as ""COD_TIPOLOGIA_CONTR_LOC""," _
                                    & " substr(TIPOLOGIA_RAPP_CONTRATTUALE.DESCRIZIONE,1,25) as ""POSIZIONE_CONTRATTO""," _
                                    & " UNITA_IMMOBILIARI.COD_UNITA_IMMOBILIARE AS COD_UNITA_IMMOBILIARE ," _
                                    & " trim(UNITA_IMMOBILIARI.COD_TIPOLOGIA) as ""COD_TIPOLOGIA""," _
                                    ...
                                    & " AND SISCOM_MI.COMPLESSI_IMMOBILIARI.ID <> 1 " _
                                    & " AND SALDI_MESE.ID_CONTRATTO = RAPPORTI_UTENZA.ID " _
                                    & " and NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0)>0 " _
                                    & " AND MESE=" & mese & " AND ANNO=" & anno _
                                    & " and rapporti_utenza.id=" & ListaM(1) & ".id "

                    queryInquilini12Mesicount = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    ...
                    querySomme12Mesi = "SELECT " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0)),'999g999g999g990d99')) as SALDO_TOTALE, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)),'999g999g999g990d99')) as SALDO_GLOBAL, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0)),'999g999g999g990d99')) as SALDO_ALER, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.CANONE_ALER_x,0)),'999g999g999g990d99')) as CANONE_ALER, " _
                                    & " trim(to_char(SUM(NVL(SISCOM_MI.SALDI_MESE.SERVIZI_ALER_x,0)),'999g999g999g990d99')) as SERVIZI_ALER " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquilini12MesiCount.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.saldo_global_x,0)+NVL(SISCOM_MI.SALDI_MESE.saldo_aler_x,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    ...
                    Next
                    For Each Items As String In listaQueryInquilini12MesiCount
                        queryInquilini12Mesicount &= Items & " UNION "
                    Next
                    ...
                    queryInquilini12Mesicount = Left(queryInquilini12Mesicount, Len(queryInquilini12Mesicount) - 6)
                ...
                par.cmd.CommandText = queryInquilini12Mesi & " order by 4"
                Dim dataAdapter As New Oracle.DataAccess.Client.OracleDataAdapter(par.cmd)
                Dim dataTable As New Data.DataTable
                dataAdapter.Fill(dataTable)
                DataGridInquilini12Mesi.DataSource = dataTable
                DataGridInquilini12Mesi.DataBind()


                par.cmd.CommandText = queryInquilini12Mesicount & " GROUP BY ID_STATO_MOROSITA"
                Dim dataAdaptercount As New Oracle.DataAccess.Client.OracleDataAdapter(par.cmd)
                Dim dataTablecount As New Data.DataTable
                dataAdaptercount.Fill(dataTablecount)
                ...
                For Each riga As Data.DataRow In dataTablecount.Rows
                    Select Case riga.Item(2).ToString
                        Case "0"
                            nRUmorosiAltri12 += CDec(riga.Item(1))
                            RUmorosiAltri12Mesi += CDec(riga.Item(0))
                        Case "1"
                            nRUmorosiMM12 += CDec(riga.Item(1))
                            RUmorosiMM12Mesi += CDec(riga.Item(0))
                        Case "2"
                            nRUmorosiCS12 += CDec(riga.Item(1))
                            RUmorosiCS12Mesi += CDec(riga.Item(0))
                        Case "3"
                            nRUmorosiPL12 += CDec(riga.Item(1))
                            RUmorosiPL12Mesi += CDec(riga.Item(0))
                        Case Else
                            nRUmorosiAltri12 += CDec(riga.Item(1))
                            RUmorosiAltri12Mesi += CDec(riga.Item(0))
                    End Select
                ...
                nRUmorosi12 = nRUmorosiAltri12 + nRUmorosiMM12 + nRUmorosiCS12 + nRUmorosiPL12
                RUmorosi12Mesi = RUmorosiAltri12Mesi + RUmorosiMM12Mesi + RUmorosiCS12Mesi + RUmorosiPL12Mesi
    ...
    End Sub
    Protected Sub DataGridInquilini3Mesi_PageIndexChanged(source As Object, e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGridInquilini3Mesi.PageIndexChanged
        DataGridInquilini3Mesi.CurrentPageIndex = e.NewPageIndex
        caricaDati3Mesi()
    End Sub
    Protected Sub DataGridInquilini312Mesi_PageIndexChanged(source As Object, e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGridInquilini312Mesi.PageIndexChanged
        DataGridInquilini312Mesi.CurrentPageIndex = e.NewPageIndex
        caricaDati312Mesi()
    End Sub
    Protected Sub DataGridInquilini12Mesi_PageIndexChanged(source As Object, e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGridInquilini12Mesi.PageIndexChanged
    ...
    Protected Sub btnStampa_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnStampa.Click
        Try
            ...
            pdfConverter1.PdfHeaderOptions.HeaderText = UCase("Analisi contabile del credito")
            ...
            'pdfConverter1.PdfHeaderOptions.HeaderSubtitleText = parametriDiRicerca.Text
            ...
            pdfConverter1.PdfFooterOptions.FooterText = "Analisi contabile del credito, stampato da " & Session.Item("NOME_OPERATORE") & " il " & Format(Now, "dd/MM/yyyy") & " alle " & Format(Now, "HH:mm")
    ...
    Private Sub caricaMorosita()
        ...
        labelMorositaAssegnatariPraticheLegali.Text = Format(CDec(MorositaPL3Mesi.Text) + CDec(MorositaPL312Mesi.Text) + CDec(MorositaPL12Mesi.Text), "##,#0.00")
        labelMorositaAltriAssegnatari.Text = Format(CDec(MorositaAltri3Mesi.Text) + CDec(MorositaAltri12Mesi.Text) + CDec(MorositaAltri312Mesi.Text), "##,#0.00")
        labelSaldoContabileALER.Text = Format(CDec(labelMorositaCanoni.Text) + CDec(labelMorositaServizi.Text), "##,#0.00")
    End Sub
End Class