...
Partial Class MOROSITA_RisultatiMultiselezione2
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If IsNothing(Session.Item("LISTAMOROSITA")) Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "msg", "alert('E\' necessario selezionare almeno un inquilino! Ripetere la ricerca!');location.href='RicercaDebitoriMultiSelezione2.aspx';", True)
            End If
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    queryInquiliniALLMesiCredito = "SELECT " _
                                    & " NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0) as DEBITO " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            listaContratti = Left(listaContratti, Len(listaContratti) - 1)
                            listaQueryInquiliniAllMesiCredito.Add("SELECT NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0) as DEBITO " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                                    & " SISCOM_MI.ANAGRAFICA, " _
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    ...
                    queryInquilini3Mesi = "SELECT /*rownum, presso_cor as intestatario,*/ " _
                                    & " trim(to_char(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0),'999g999g999g990d99')) as DEBITO, RAPPORTI_UTENZA.ID, " _
                    ...
                    queryInquilini3MesiCount = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquilini3MesiCount.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
        ...
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    ...
                    queryInquilini312Mesicount = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquilini312MesiCount.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
        ...
        Try
            ...
            If Not IsNothing(ListaM) Then
                ...
                If ListaM(0) = "-1" Then
                    ...
                    queryInquilini12Mesicount = "SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                ...
                Else
                    ...
                    While i < 40 And fine = False
                        ...
                        If listaContratti <> "" Then
                            ...
                            listaQueryInquilini12MesiCount.Add("SELECT TRIM (TO_CHAR(sum(NVL(SISCOM_MI.SALDI_MESE.SALDO_GLOBAL,0)+NVL(SISCOM_MI.SALDI_MESE.SALDO_ALER,0)),'9G999G999G999G999G990D99')) as DEBITO2 " _
                                    & " ,count(id_stato_morosita),id_stato_morosita " _
                                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
    ...
    Protected Sub btnIndietro_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnIndietro.Click
        ScriptManager.RegisterClientScriptBlock(Me, Me.GetType(), "redirect", "location.href='RicercaDebitoriMultiSelezione2.aspx';", True)
    End Sub
    Protected Sub btnStampa_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnStampa.Click
        Try
            ...
            pdfConverter1.PdfFooterOptions.FooterText = "Analisi statistica del credito, stampato da " & Session.Item("NOME_OPERATORE") & " il " & Format(Now, "dd/MM/yyyy") & " alle " & Format(Now, "HH:mm")
    ...
    Private Sub eliminaTabellaTemporanea()
        ...
        Catch ex As Exception
            chiudiConnessione()
            'ScriptManager.RegisterStartupScript(Me, Me.GetType(), "msg", "alert('Si è verificato un errore nella ricerca!');location.href='RicercaDebitoriMultiSelezione2.aspx';", True)
        End Try
    End Sub
