<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Tab_MorositaInquilino_Bol_TUTTE.ascx.vb" Inherits="Tab_Morosita_BolletteTUTTE" %>
            ...
            <table>
                <tr>
                    <td style="height: 16px;">
                        <asp:ImageButton ID="btn_DettBollette" runat="server"  
                            ImageUrl="~/MOROSITA/Immagini/DettaglioBollette1.png" 
                            onclientclick="ApriBolTutte();"  />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td style="height: 14px"><asp:ImageButton ID="btn_Export" runat="server"  
