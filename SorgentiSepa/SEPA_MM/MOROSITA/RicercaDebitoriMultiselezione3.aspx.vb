...
Partial Class MOROSITA_RicercaDebitoriMultiselezione3
    ...
    Private Sub caricaAreaCanone()
        ...
        End Try
    End Sub
    Protected Sub CheckBoxFiliali_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxFiliali.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxQuartieri_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxQuartieri.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxComplessi_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxComplessi.CheckedChanged
        Try
        ...
        End Try
    End Sub
    Protected Sub CheckBoxEdifici_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxEdifici.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxIndirizzi_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxIndirizzi.CheckedChanged
        Try
        ...
        End Try
    End Sub
    Protected Sub CheckBoxTipologiaRapporto_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxTipologiaRapporto.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxContrattoSpecifico_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxContrattoSpecifico.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxTipologiaUI_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxTipologiaUI.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxStatoContratto_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxStatoContratto.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxAreaCanone_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxAreaCanone.CheckedChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxListFiliali_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListFiliali.SelectedIndexChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxListQuartieri_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListQuartieri.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListQuartieri.Items
                If Items.Selected = False Then
    ...
    End Sub
    Protected Sub CheckBoxListComplessi_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListComplessi.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListComplessi.Items
                If Items.Selected = False Then
        ...
        End Try
    End Sub
    Protected Sub CheckBoxListEdifici_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListEdifici.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListEdifici.Items
                If Items.Selected = False Then
    ...
    End Sub
    Protected Sub CheckBoxListIndirizzi_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListIndirizzi.SelectedIndexChanged
        Try
    ...
    End Sub
    Protected Sub CheckBoxListTipologiaRapporti_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListTipologiaRapporti.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListTipologiaRapporti.Items
                If Items.Selected = False Then
    ...
    End Sub
    Protected Sub CheckBoxListContrattoSpecifico_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListContrattoSpecifico.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListContrattoSpecifico.Items
                If Items.Selected = False Then
    ...
    End Sub
    Protected Sub CheckBoxListTipologiaUI_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListTipologiaUI.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListTipologiaUI.Items
                If Items.Selected = False Then
    ...
    End Sub
    Protected Sub CheckBoxListStatoContratto_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListStatoContratto.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListStatoContratto.Items
                If Items.Selected = False Then
    ...
    End Sub
    Protected Sub CheckBoxListAreaCanone_SELECTedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxListAreaCanone.SelectedIndexChanged
        Try
            Dim controlloSeTuttiSelezionati As Boolean = True
            For Each Items As ListItem In CheckBoxListAreaCanone.Items
                If Items.Selected = False Then
    ...
    Private Sub caricaInquilini()
        Try
            ...
            ElseIf statoINCORSO = True And statoCHIUSO = False Then
                condizioneStatoContratto = " AND RAPPORTI_UTENZA.DATA_RICONSEGNA IS NULL "
            ElseIf statoINCORSO = False And statoCHIUSO = True Then
                condizioneStatoContratto = " AND RAPPORTI_UTENZA.DATA_RICONSEGNA IS NOT NULL "
        ...
        End Try
    End Sub
    Protected Sub DataGridInquilini_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGridInquilini.PageIndexChanged
        Try
    ...
    End Sub
    Protected Sub DropDownListOrdinamento_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListOrdinamento.SelectedIndexChanged
        'caricaInquilini()
    End Sub
    ...
    '    caricaInquilini()
    'End Sub
    Private Sub stipulaDal_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles stipulaDal.TextChanged
        'caricaInquilini()
    End Sub
    Private Sub stipulaAl_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles stipulaAl.TextChanged
        'caricaInquilini()
    End Sub
    Private Sub PreCaricaRiepilogo()
        ...
        End Try
    End Sub
    Protected Sub ButtonRiepilogoGenerale_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonRiepilogoGenerale.Click
        Try
            caricaInquilini2()
            'PreCaricaRiepilogo()
            Dim lista As System.Collections.Generic.List(Of String) = Session.Item("LISTAMOROSITA")
            If Not IsNothing(lista) Then
                ...
                Else
                    Response.Redirect("RisultatiMultiselezione3.aspx?d=" & par.AggiustaData(dataEstrazione.Text) & "&t=1")
                End If
            Else
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "msg", "alert('Nessun risultato trovato!E\' necessario reimpostare i parametri di ricerca!');", True)
            End If
        ...
        End Try
    End Sub
    Protected Sub ButtonDettaglioInquilini_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDettaglioInquilini.Click
        MultiView1.ActiveViewIndex = 1
        caricaInquilini()
    End Sub
    Protected Sub ButtonRiepilogoBollette_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonRiepilogoBollette.Click
        Try
            caricaInquilini2()
            'PreCaricaRiepilogo()
            Dim lista As System.Collections.Generic.List(Of String) = Session.Item("LISTAMOROSITA")
            If Not IsNothing(lista) Then
                If lista.Count <= 0 Then
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "msg", "alert('Nessun risultato trovato!E\' necessario reimpostare i parametri di ricerca!');", True)
                Else
                    Response.Redirect("RisultatiMultiselezione3.aspx?d=" & par.AggiustaData(dataEstrazione.Text) & "&t=3")
                End If
            Else
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "msg", "alert('Nessun risultato trovato!E\' necessario reimpostare i parametri di ricerca!');", True)
            End If
    ...
    Private Sub caricaInquilini2()
        Try
            ...
            If condizioneAreaCanone <> "" Or _
                ...
                par.cmd.CommandText = "CREATE TABLE " & nomeTabellaTemporanea & "(id number) "
                par.cmd.ExecuteNonQuery()

                par.cmd.CommandText = "INSERT INTO " & nomeTabellaTemporanea & " (SELECT RAPPORTI_UTENZA.ID " _
                    & " FROM SISCOM_MI.COMPLESSI_IMMOBILIARI, " _
                    & " SISCOM_MI.TIPOLOGIA_RAPP_CONTRATTUALE, " _
                    & " SISCOM_MI.RAPPORTI_UTENZA, " _
                    & " SISCOM_MI.ANAGRAFICA, " _
    ...
    Protected Sub ButtonProcediDettaglioInquilini_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonProcediDettaglioInquilini.Click
        Try
            PreCaricaRiepilogo()
            Dim lista As System.Collections.Generic.List(Of String) = Session.Item("LISTAMOROSITA")
            If Not IsNothing(lista) Then
                ...
                Else
                    Response.Redirect("RisultatiMultiselezione3.aspx?d=" & par.AggiustaData(dataEstrazione.Text) & "&t=2")
                End If
            Else
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "msg", "alert('E\' necessario selezionare almeno un inquilino!');", True)
            End If
    ...
    Protected Sub ButtonNuovaRicerca_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonNuovaRicerca.Click
