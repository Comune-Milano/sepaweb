<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RisultatiMultiselezione.aspx.vb"
    Inherits="MOROSITA_RisultatiMultiselezione" %>
                ...
                <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse"
                    ...
                    <tr>
                        <td colspan="8" style="height: 20.1pt; color: #ffffff; font-size: 15.0pt; font-weight: 700;
                            ...
                            border-top: 1.0pt solid windowtext; border-bottom: 1.0pt solid windowtext; padding-left: 1px;
                            padding-right: 1px; padding-top: 1px; background: #507CD1;">
                            Saldo Contabile e Riepilogo Morosità
                        </td>
                    </tr>
                    <tr>
                        <td colspan="8" style="height: 20.1pt; color: #ffffff; font-size: 12.0pt; font-weight: 700;
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 12.5%">
                            Saldo Contabile assegnatari con M.M.
                        </td>
                        <td style="text-align: left; width: 12.5%">
                            Saldo Contabile assegnatari con richiesta di C.S.
                        </td>
                        <td style="text-align: left; width: 12.5%">
                            Saldo Contabile assegnatari con P.L.
                        </td>
                        <td style="text-align: left; width: 12.5%">
                            Saldo Contabile altri assegnatari
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center">
                    ...
                    <tr style="height: 16.5pt">
                        <td colspan="4" height="176" rowspan="3" style="height: 132.0pt; color: black; font-size: 11.0pt;
                            ...
                            <%--<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="text-align: center; width: 50%; height: 70px">
                                        <asp:Label ID="labelAssegnatariMorosi" runat="server" Style="border-style: none;
                                            border-color: inherit; border-width: 0px; text-align: center;" Font-Names="Arial"
                                            Font-Size="10pt" Height="18px">0,00</asp:Label>
                                    </td>
                                </tr>
                        ...
                        <td colspan="4" style="color: black; font-size: 11.0pt; font-weight: 400; font-style: normal;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="width: 50%; text-align: center">
                                        <asp:Label ID="labelSaldoContabileTotale" runat="server" Style="border-style: none;
                                            border-color: inherit; border-width: 0px; text-align: center;" Font-Names="Arial"
                                            Font-Size="10pt">0,00</asp:Label>
                                    </td>
                                </tr>
                    ...
                    <tr style="height: 16.5pt">
                        <td colspan="2" height="110" rowspan="2" style="height: 82.5pt; color: black; font-size: 11.0pt;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="height: 40pt; text-align: center;">
                                        <asp:Label ID="labelMorositaExGestori" runat="server" Style="border-style: none;
                                            border-color: inherit; border-width: 0px; text-align: center;" Font-Names="Arial"
                                            Font-Size="10pt">0,00</asp:Label>
                                    </td>
                                </tr>
                        ...
                        <td colspan="2" style="color: black; font-size: 11.0pt; font-weight: 400; font-style: normal;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="width: 50%; text-align: center">
                                        <asp:Label ID="labelSaldoContabileALER" runat="server" Style="border-style: none;
                                            border-color: inherit; border-width: 0px; text-align: center;" Font-Names="Arial"
                                            Font-Size="10pt">0,00</asp:Label>
                                    </td>
                                </tr>
                    ...
                    <tr style="height: 16.5pt">
                        <td height="66" style="height: 49.5pt; color: black; font-size: 11.0pt; font-weight: 400;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="width: 100%; height: 24pt; text-align: center">
                                        <asp:Label ID="labelMorositaCanoni" runat="server" Style="border-style: none; border-color: inherit;
                                            border-width: 0px; text-align: center;" Font-Names="Arial" Font-Size="10pt" Height="18px">0,00</asp:Label>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td style="color: black; font-size: 11.0pt; font-weight: 400; font-style: normal;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="width: 100%; height: 24pt; text-align: center">
                                        <asp:Label ID="labelMorositaServizi" runat="server" Style="border-style: none; border-color: inherit;
                                            border-width: 0px; text-align: center;" Font-Names="Arial" Font-Size="10pt">0,00</asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td rowspan="4" colspan="4" style="text-align: center; height: 16.5pt; color: black;
                            font-size: 11.0pt; font-weight: 400; font-style: normal; text-decoration: none;
                            font-family: Book Antiqua , sans-serif; text-align: center; vertical-align: middle;
                            white-space: normal; border-left: .5pt solid windowtext; border-right-style: none;
                            border-right-color: inherit; border-right-width: medium; border-top: 0pt solid windowtext;
                            border-bottom: .5pt solid windowtext; padding-left: 1px; padding-right: 1px;
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:Label ID="labelMorositaAssegnatariMM" runat="server" Style="border: 0px; text-align: right">0,00</asp:Label>
                        </td>
                        <td style="text-align: center">
                            <asp:Label ID="labelMorositaContributoSociale" runat="server" Style="border: 0px;
                                text-align: right">0,00</asp:Label>
                        </td>
                        <td style="text-align: center">
                            <asp:Label ID="labelMorositaAssegnatariPraticheLegali" runat="server" Style="border: 0px;
                                text-align: right">0,00</asp:Label>
                        </td>
                        <td style="text-align: center">
                            <asp:Label ID="labelMorositaAltriAssegnatari" runat="server" Style="border: 0px;
                                text-align: right">0,00</asp:Label>
                        </td>
                    </tr>
                    <tr style="height: 17.25pt">
