...
Partial Class Tab_Morosita_BolletteTUTTE
    ...
    Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Morosita_BolletteTUTTE_txtSel1').value='Hai selezionato: " & e.Item.Cells(1).Text & "';document.getElementById('Tab_Morosita_BolletteTUTTE_txtIdComponente').value='" & e.Item.Cells(0).Text & "'")
    ...
    Protected Sub btn_DettBollette_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_DettBollette.Click
        Me.txtIdComponente.Value = 1
    End Sub
