...
'M.AV. Global Service: PRIMA del 2009 (NUM_LETTERA=1)
Partial Class Tab_Morosita_STATO_MG
    ...
    Protected Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        ...
        '    e.Item.Attributes.Add("onclick", "this.style.backgroundColor='red';document.getElementById('Tab_Morosita_STATO_MG_txtSel1').value='Hai selezionato: " & e.Item.Cells(1).Text & "';document.getElementById('Tab_Morosita_STATO_MG_txtIdComponente').value='" & e.Item.Cells(0).Text & "'")
