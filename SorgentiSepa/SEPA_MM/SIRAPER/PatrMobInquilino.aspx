<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PatrMobInquilino.aspx.vb"
    Inherits="SIRAPER_PatrMobInquilino" %>
...
<head runat="server">
    ...
    <title>Patrimonio Mobiliare Inquilino</title>
</head>
                        ...
                        <td>
                            <div style="width: 950px; height: 325px; overflow: auto;">
                                <strong><span style="font-size: 14pt; color: #801f1c; font-family: Arial">
                                    <asp:DataGrid ID="dgvPatrMobInqui" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="ANNO RIFERIMENTO">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtannorif" runat="server" Font-Names="Arial" Font-Size="8" MaxLength="4"
                                                        CssClass="CssMaiuscolo" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.ANNO_RIFERIMENTO") %>'
                                            ...
                                            <asp:TemplateColumn HeaderText="CODICE INTERMEDIARIO O GESTORE">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtcodintermediario" runat="server" Font-Names="Arial" Font-Size="8"
                                                        CssClass="CssMaiuscolo" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.CODICE_GESTORE") %>'
                                                        Style="text-align: right;"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                    Font-Underline="False" HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateColumn HeaderText="DENOMINAZIONE INTERMEDIARIO O GESTORE">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtdenintermediario" runat="server" Font-Names="Arial" Font-Size="8"
                                                        CssClass="CssMaiuscolo" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.DENOMINAZIONE_GESTORE") %>'
                                                        Style="text-align: right;"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                    Font-Underline="False" HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateColumn HeaderText="IMPORTO DEL PATRIMONIO MOBILIARE">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtimporto" runat="server" Font-Names="Arial" Font-Size="8" CssClass="CssMaiuscolo"
                                                        Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.IMPORTO_PATRIMONIO") %>'
                                                        Style="text-align: right;"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                    Font-Underline="False" HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateColumn HeaderText="VALORE PATRIMONIO MOBILIARE NETTO IMPRESE INDIVIDUALI">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtvalore" runat="server" Font-Names="Arial" Font-Size="8" CssClass="CssMaiuscolo"
                                                        Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.VALORE_PATRIMONIO") %>'
                                                        Style="text-align: right;"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                    Font-Underline="False" HorizontalAlign="Center" />
            ...
            <td>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: center">
                            <img alt="Uscita" 
                                onclick="caricamentoincorso();return ConfEsciPatrInquilino();" 
                                src="Immagini/logout.png" style="cursor:pointer" />
                        </td>
                        <td style="width: 40%">
                            &nbsp;
                        </td>
