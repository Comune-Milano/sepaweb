...
Partial Class Dic_Integrazione
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            btnAgg1.Attributes.Add("OnClick", "javascript:AggiungiInt();document.getElementById('H1').value='0';document.getElementById('txtModificato').value='1';")
            btnModifica.Attributes.Add("OnClick", "javascript:ModificaInt();document.getElementById('H1').value='0';document.getElementById('txtModificato').value='1';")
            btnAggiungi.Attributes.Add("OnClick", "javascript:AggiungiDet();document.getElementById('H1').value='0';document.getElementById('txtModificato').value='1';")
            btnMod.Attributes.Add("OnClick", "javascript:ModificaDet();document.getElementById('H1').value='0';document.getElementById('txtModificato').value='1';")
            ...
            btnCanc1.Attributes.Add("OnClick", "javascript:document.getElementById('H1').value='0';document.getElementById('txtModificato').value='1';")
            '**********modifiche campi***********
            'Dim CTRL As Control
