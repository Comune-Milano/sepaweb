...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu_funzioni.aspx.vb" Inherits="ASS_ESTERNA_menu_funzioni" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body background="../NuoveImm/comeblu_up.jpg">
		<form id="Form1" method="post" runat="server">
            ...
            <asp:Image ID="Image3" runat="server" ImageUrl="~/NuoveImm/Titolo_ABBINAMENTO_DEC.png" Style="left: 26px;
                position: absolute; top: 3px" />
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="arial" Font-Size="9pt"
                ForeColor="#721C1F" Style="left: 615px; position: absolute; top: 33px">Chiudi</asp:LinkButton>
        </form>
		<script type="text/javascript">
		function spegni()
		{
