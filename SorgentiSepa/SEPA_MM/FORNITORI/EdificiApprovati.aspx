<%@ Page Title="" Language="VB" MasterPageFile="~/FORNITORI/OpenPage.master" AutoEventWireup="false" CodeFile="EdificiApprovati.aspx.vb" Inherits="FORNITORI_EdificiApprovati" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPTitolo" Runat="Server">
     <asp:Label ID="lblTitolo" runat="server" Text="Lista degli edifici approvati in altri cronoprogrammi"></asp:Label>
</asp:Content>
