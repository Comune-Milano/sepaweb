...
Partial Class FORNITORI_ProgrammaAttivitaEventi
    ...
    Private Sub BindGrid()
        ...
        sStrSql = "SELECT ID_PROGRAMMA_ATTIVITA, " _
                & " (SELECT OPERATORE FROM SEPA.OPERATORI WHERE ID = ID_OPERATORE) AS OPERATORE, " _
                & " TO_DATE (SUBSTR(DATA_ORA,1,8), 'yyyymmdd') AS DATA_EVENTO, " _
                & " MOTIVAZIONE " _
                & " FROM SISCOM_MI.EVENTI_PROGRAMMA_ATTIVITA "
    End Sub
