<%@ Page Title="" Language="VB" MasterPageFile="~/FORNITORI/HomePage.master" AutoEventWireup="false" CodeFile="TipoIrregolarita.aspx.vb" Inherits="FORNITORI_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="CPTitolo" runat="Server">
    <asp:Label ID="lblTitolo" runat="server" Text="Tipologie Non Conformità"></asp:Label>
</asp:Content>
    ...
    <telerik:RadGrid ID="RadGridTipi" runat="server" AllowPaging="True"
        ...
        <MasterTableView CommandItemDisplay="Top" EditMode="Batch" runat="server">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DESCRIZIONE" HeaderText="TIPOLOGIA NON CONFORMITA'"
