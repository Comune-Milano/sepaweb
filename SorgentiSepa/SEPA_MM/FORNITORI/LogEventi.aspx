<%@ Page Title="" Language="VB" MasterPageFile="~/FORNITORI/HomePage.master" AutoEventWireup="false"
    CodeFile="LogEventi.aspx.vb" Inherits="FORNITORI_Default" %>
    ...
    <telerik:RadGrid ID="RadGridRPTLOG" runat="server" AllowSorting="True" ResolvedRenderMode="Classic"
        ...
        <MasterTableView>
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="ODL" HeaderText="ODL">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="EVENTO" HeaderText="EVENTO">
                </telerik:GridBoundColumn>
