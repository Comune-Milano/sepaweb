<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Dic_Patrimonio_Utenza.ascx.vb" Inherits="Dic_Patrimonio" %>
...
window.showModalDialog("com_patrimonioI.aspx?OP=0&COMPONENTE=" + mioval,window,'status:no;dialogWidth:433px;dialogHeight:470px;dialogHide:true;help:no;scroll:no');
}
...
else
{
    ...
    res = '  ';
    catastale = str.substring(81, 84);
    comune = str.substring(85, 115);
    vani = str.substring(116, 118);
    sup = str.substring(119, 126);
    pie = str.substring(127, 133);
    ind = str.substring(134, 159);
    civ = str.substring(160, 165);
    rendita = str.substring(166, 174);
   
    
    nome=obj1.options[obj1.selectedIndex].value;
    window.showModalDialog("com_patrimonioI.aspx?RENDITA=" + rendita + "&ANNOREDD=" + document.getElementById('Dic_Patrimonio1_annoRedd').value + "&OP=1&RI=" + obj1.selectedIndex + "&COMPONENTE=" + mioval + "&COMP=" + nome + "&TIPO=" + tipo + "&PER=" + perc + "&VAL=" + valore + "&MU=" + mutuo + "&RES=" + res + "&SUP=" + sup + "&VANI=" + vani + "&comune=" + comune + "&CATASTALE=" + catastale + "&PIE=" + pie + "&IND=" + ind + "&CIV=" + civ, '', 'status:no;dialogWidth:433px;dialogHeight:470px;dialogHide:true;help:no;scroll:no');
   // window.showModalDialog("com_patrimonioI.aspx?OP=1&RI=" + obj1.selectedIndex + "&COMPONENTE=" + mioval + "&ANNOREDD=" + document.getElementById('Dic_Patrimonio1_annoRedd').value + "&COMP=" + nome + "&TIPO=" + tipo + "&PER=" + perc + "&RENDITA=" + rendita + "&VAL=" + valore + "&MU=" + mutuo + "&RES=" + res + "&SUP=" + sup + "&VANI=" + vani + "&comune=" + comune + "&CATASTALE=" + catastale + "&PIE=" + pie + "&IND=" + ind + "&CIV=" + civ, '', 'status:no;dialogWidth:433px;dialogHeight:460px;dialogHide:true;help:no;scroll:no');
...
<div id="pat" style="border-right: lightsteelblue 1px solid; border-top: lightsteelblue 1px solid;
    ...
    <asp:Label ID="lblDataImm" runat="server" CssClass="CssLabel" Font-Bold="True" Font-Names="times"
        ...
        style="overflow: auto; position: absolute; width: 581px; height: 132px; top: 169px; left: 8px;">
    <asp:ListBox ID="ListBox2" runat="server" Style="z-index: 106; left: 4px;
        position: absolute; top: 21px; width: 1322px; height: 93px;" Font-Names="Courier New" 
    ...
    <asp:Label ID="Label11" runat="server" Font-Bold="False" Font-Names="Courier New"
        ...
        position: absolute; top: 1px" Width="55px">VALORE</asp:Label>
    <asp:Label ID="Label12" runat="server" Font-Bold="False" Font-Names="Courier New"
        ...
        position: absolute; top: 1px" Width="55px">MUTUO</asp:Label>
    <asp:Label ID="Label17" runat="server" Font-Bold="False" Font-Names="Courier New"
        Font-Size="8pt" ForeColor="#0000C0" Height="18px" Style="z-index: 116; left: 881px;
        ...
        Font-Size="8pt" ForeColor="#0000C0" Height="18px" Style="z-index: 116; left: 928px;
        ...
        Font-Size="8pt" ForeColor="#0000C0" Height="18px" Style="z-index: 116; left: 1232px;
        position: absolute; top: 1px; width: 91px;" ToolTip="Piena Proprietà">Rendita Cat.</asp:Label>
    <asp:Label ID="Label16" runat="server" Font-Bold="False" Font-Names="Courier New"
        Font-Size="8pt" ForeColor="#0000C0" Height="18px" Style="z-index: 116; left: 826px;
        position: absolute; top: 1px; width: 22px;" ToolTip="Numero Vani">VANI</asp:Label>
    <asp:Label ID="Label15" runat="server" Font-Bold="False" Font-Names="Courier New"
        Font-Size="8pt" ForeColor="#0000C0" Height="18px" Style="z-index: 116; left: 606px;
    ...
    <asp:Label ID="Label14" runat="server" Font-Bold="False" Font-Names="Courier New"
        Font-Size="8pt" ForeColor="#0000C0" Height="18px" Style="z-index: 116; left: 576px;
        position: absolute; top: 1px; width: 22px;" ToolTip="Categoria Catastale">C.C.</asp:Label>
                </div>
