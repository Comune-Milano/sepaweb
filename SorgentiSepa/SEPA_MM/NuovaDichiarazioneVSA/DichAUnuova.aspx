                ...
                <table style="width: 100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="8" align="center">
                            <br />
                            <asp:Image ID="imgAlert" runat="server" ImageUrl="~/IMG/Alert.gif" Visible="true" style="display:none"/>
                                ...
                                <tr>
                                    <td style="width: 500px; text-align: right;">
                                        <asp:Button runat="server" CssClass="bottone" Text="Passa alla domanda" ID="imgVaiDomanda"
                                            ToolTip="Passa alla domanda" Width="130px" BackColor="#FFFF84" 
                                            Visible="False" />
...
/* SCRIPT TAB NUCLEO */
    ...
    function ModificaPatrimMob() {
        if (document.getElementById('Dic_Patrimonio1_idCompMob').value == 0 || document.getElementById('Dic_Patrimonio1_idCompMob').value == -1) {
         ...
         document.getElementById('caric').style.visibility = 'visible';
            ...
            var dialogResults = window.showModalDialog('com_patrimonio.aspx?OP=1&RI=' + document.getElementById('Dic_Patrimonio1_idPatrMob').value + '&IDCONN='+ <%=vIdConnessione %> +'&COMPONENTE=' + componente + '&COMP=' + componente + '&ABI=' + abi + '&INT=' + inter + '&IMP=' + imp + '&TIPO=' + tipo + '&IDDICH=' + <%=lIdDichiarazione %>, window,'status:no;dialogWidth:433px;dialogHeight:300px;dialogHide:true;help:no;scroll:no');
    ...
    function AggiungiPatrimonioI() {
     document.getElementById('caric').style.visibility = 'visible';
        ...
        var dialogResults = window.showModalDialog('com_patrimonioI.aspx?OP=0&COMPONENTE=' + a + '&IDDICH=' + <%=lIdDichiarazione %> + '&IDCONN='+ <%=vIdConnessione %>,window,'status:no;dialogWidth:433px;dialogHeight:420px;dialogHide:true;help:no;scroll:no');
        if (dialogResults != undefined)
            {
                if (dialogResults == '1')
                {
