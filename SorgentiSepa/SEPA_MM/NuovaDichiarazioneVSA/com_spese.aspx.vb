...
Partial Class ANAUT_com_spese
    ...
    Private Sub ModificaSpese()
        Try
            ...
            par.cmd.CommandText = "UPDATE COMP_ELENCO_SPESE_VSA SET IMPORTO=" & par.VirgoleInPunti(par.IfEmpty(txtImporto.Text, 0)) & ",DESCRIZIONE='" & par.PulisciStrSql(txtDescrizione.Text) & "' WHERE ID=" & txtRiga.Text
