...
Partial Class SICUREZZA_Eventi
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Session.Add("ERRORE", "Provenienza: Sicurezza - Eventi Segnalazione - Page_Load - " & ex.Message)
    ...
    Private Sub NoMenu()
        ...
        Catch ex As Exception
            Session.Add("ERRORE", "Provenienza: Sicurezza - Eventi - NoMenu - " & ex.Message)
            Response.Redirect("../Errore.aspx", False)
        End Try
    End Sub
    ...
    Private Sub CaricaEventiSegnalazione()
        ...
        Catch ex As Exception
            connData.chiudi()
            Session.Add("ERRORE", "Provenienza: Sicurezza - Eventi Segnalazione - CaricaEventiSegnalazione - " & ex.Message)
            Response.Redirect("../Errore.aspx", False)
        End Try
    End Sub
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        Try
            ...
            End If
        Catch ex As Exception
            Session.Add("ERRORE", "Provenienza: Sicurezza - Eventi Segnalazione - Page_LoadComplete - " & ex.Message)
            Response.Redirect("../Errore.aspx", False)
        End Try
    End Sub
