...
Partial Class Bando
    ...
    Private Function CaricaBando()
        ...
        For I = 0 To 15
            ...
            par.cmd.CommandText = "SELECT * FROM PARAMETRI_BANDO WHERE TIPO_PARAMETRO=" & I & " AND ID_BANDO=" & INDICE_BANDO & " ORDER BY ID ASC"
            myReader = par.cmd.ExecuteReader()
            While myReader.Read
        ...
        Response.Write("<head>")
        Response.Write("")
        Response.Write("<title>STAMPA BANDO E.R.P. LOMBARDIA</title>")
        Response.Write("")
        Response.Write("")
        Response.Write("</head>")
        Response.Write("<BODY >")
        ...
        Response.Write("<p align='center'><b>DATI BANDO</b></p>")
        Response.Write("</td>")
        Response.Write("</tr>")
        Response.Write("")
        Response.Write("<tr>")
