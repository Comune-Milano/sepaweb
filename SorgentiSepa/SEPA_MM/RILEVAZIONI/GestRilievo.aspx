<%@ Page Title="" Language="VB" MasterPageFile="~/RILEVAZIONI/HomePage.master" AutoEventWireup="false"
    CodeFile="GestRilievo.aspx.vb" Inherits="RILEVAZIONI_GestRilievo" %>
    ...
    <div class="dialB" id="divInsB" style="visibility: hidden">
        <div id="InserimentoP" class="dialCTransparent">
            <table style="width: 100%;" class="tblDiv">
                ...
                <tr style="text-align: left">
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Attivo" Font-Names="arial" Font-Size="8pt"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left">
                        <asp:DropDownList ID="cmbAttivo" runat="server" CssClass="CssMaiuscolo" Width="120px">
