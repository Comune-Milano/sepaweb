<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProvaTel.aspx.vb" Inherits="RILEVAZIONI_ProvaTel" %>
...
<body>
                        ...
                        <td>
                            <div id="divOverContent" style="width: 100%; overflow: auto;">
                                <table style="width: 100%;">
                                    ...
                                    <tr valign="top">
                                        <td style="width: 97%;">
                                            <div id="divOverContentRisultati">
                                                <telerik:RadGrid ID="RadGrid1" runat="server" Culture="it-IT"
                                                    GroupPanelPosition="Top" ResolvedRenderMode="Classic" 
                                                    OnNeedDataSource="RadGrid1_NeedDataSource" AllowPaging="True" 
                                                    CssClass="styleDataGrid" PageSize="100" ShowGroupPanel="True">
    ...
    <asp:HiddenField ID="HfContenteDivHeight" runat="server" ClientIDMode="Static" Value="200" />
