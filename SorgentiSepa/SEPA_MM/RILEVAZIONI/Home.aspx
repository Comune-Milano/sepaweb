<%@ Page Title="" Language="VB" MasterPageFile="~/RILEVAZIONI/HomePage.master" AutoEventWireup="false" CodeFile="Home.aspx.vb" Inherits="RILEVAZIONI_Default" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="text-align: center; color: #801f1c; font-family: Arial; font-size: 20pt; font-weight: bold;">
                <center>
                    <asp:Label ID="lblTitolo" runat="server" Text="Rilievo"></asp:Label></center>
            </td>
        </tr>
    </table>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 10%;">
                <table align="right">
                    <tr>
                        <td>
                            <img alt="Guida per l'Utente" src="../Standard/Immagini/guida.png" title="Guida per l'Utente" style="cursor: pointer" onclick="window.open('Guida_ModuloRilievi.pdf');" />
                        </td>
                    </tr>
                </table>
            </td>
