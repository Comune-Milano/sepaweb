...
Partial Class RILEVAZIONI_ReportUIrilev
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                caricaStudioProf()
            End If
            Me.cmbTipoUI.Attributes.Add("onclick", "javascript:visibleMotivazioni()")
    ...
    Protected Sub btnAvvia_Click(sender As Object, e As System.EventArgs) Handles btnAvvia.Click
        ...
        If cmbTipoUI.SelectedValue = 1 Then
            parametriDaPassare &= "?Rilevati=1&MOT=" & cmbMotivazione.SelectedValue
        Else
            parametriDaPassare &= "?MOT=" & cmbMotivazione.SelectedValue
        End If
        ...
        Response.Redirect("RisultatiUIrilev.aspx" & parametriDaPassare & "", False)
    End Sub
    ...
    Protected Sub cmbTipoUI_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles cmbTipoUI.SelectedIndexChanged
        caricaSedeTerr()
    End Sub
End Class
