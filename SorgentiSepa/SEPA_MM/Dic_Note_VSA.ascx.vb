...
Partial Class Dic_Note_VSA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            CaricaLista()
            lblAggDocumenti.Text = "<a href='javascript:void(0)' onclick=" & Chr(34) & "window.open('Locatari/AggiungiDocAlleg.aspx','AggDocumenti','top=0,left=0,width=580,height=400,resizable=no,menubar=no,toolbar=no,scrollbars=no');" & Chr(34) & ">Aggiungi nuovo doc.allegato</a>"
            ...
            End If
        End If
        ListBox1.Attributes.Add("OnClick", "javascript:obj1=document.getElementById('Dic_Note1_ListBox1');if (obj1.selectedIndex!=-1) {document.getElementById('Dic_Note1_V2').value=obj1.options[obj1.selectedIndex].text;}")
